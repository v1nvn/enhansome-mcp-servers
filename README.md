...
Checkout [awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients/) ⭐ 6,123 | 🐛 53 | 📅 2025-12-23 and [glama.ai/mcp/clients](https://glama.ai/mcp/clients).
...
* [mindsdb/mindsdb](https://github.com/mindsdb/mindsdb) ⭐ 38,119 | 🐛 184 | 🌐 Python | 📅 2025-12-25 - Connect and unify data across various platforms and databases with [MindsDB as a single MCP server](https://docs.mindsdb.com/mcp/overview).
* [PipedreamHQ/pipedream](https://github.com/PipedreamHQ/pipedream/tree/master/modelcontextprotocol) ⭐ 10,913 | 🐛 4,434 | 🌐 JavaScript | 📅 2025-12-25 ☁️ 🏠 - Connect with 2,500 APIs with 8,000+ prebuilt tools, and manage servers for your users, in your own app.
* [metatool-ai/metatool-app](https://github.com/metatool-ai/metatool-app) ⭐ 1,825 | 🐛 56 | 🌐 TypeScript | 📅 2025-12-23 📇 ☁️ 🏠 🍎 🪟 🐧 - MetaMCP is the one unified middleware MCP server that manages your MCP connections with GUI.
* [julien040/anyquery](https://github.com/julien040/anyquery) ⭐ 1,573 | 🐛 7 | 🌐 Go | 📅 2025-11-11 🏎️ 🏠 ☁️ - Query more than 40 apps with one binary using SQL. It can also connect to your PostgreSQL, MySQL, or SQLite compatible database. Local-first and private by design.
* [duaraghav8/MCPJungle](https://github.com/duaraghav8/MCPJungle) ⭐ 754 | 🐛 48 | 🌐 Go | 📅 2025-12-11 🏎️ 🏠 - Self-hosted MCP Server registry for enterprise AI Agents
* [TheLunarCompany/lunar#mcpx](https://github.com/TheLunarCompany/lunar/tree/main/mcpx) ⭐ 342 | 🐛 5 | 🌐 TypeScript | 📅 2025-12-25 📇 🏠  ☁️ 🍎 🪟 🐧 - MCPX is a production-ready, open-source gateway to manage MCP servers at scale—centralize tool discovery, access controls, call prioritization, and usage tracking to simplify agent workflows.
* [1mcp/agent](https://github.com/1mcp-app/agent) ⭐ 325 | 🐛 2 | 🌐 TypeScript | 📅 2025-12-25 📇 ☁️ 🏠 🍎 🪟 🐧 - A unified Model Context Protocol server implementation that aggregates multiple MCP servers into one.
...
* [ahujasid/blender-mcp](https://github.com/ahujasid/blender-mcp) ⭐ 14,637 | 🐛 35 | 🌐 Python | 📅 2025-12-08 🐍 - MCP server for working with Blender
* [abhiemj/manim-mcp-server](https://github.com/abhiemj/manim-mcp-server) ⭐ 529 | 🐛 5 | 🌐 Python | 📅 2025-05-19 🐍 🏠 🪟 🐧 - A local MCP server that generates animations using Manim.
* [samuelgursky/davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp) ⭐ 444 | 🐛 10 | 🌐 Python | 📅 2025-10-20 🐍 - MCP server integration for DaVinci Resolve providing powerful tools for video editing, color grading, media management, and project control
...
* [cantian-ai/bazi-mcp](https://github.com/cantian-ai/bazi-mcp) ⭐ 229 | 🐛 3 | 🌐 TypeScript | 📅 2025-10-11 📇 🏠 ☁️ 🍎 🪟 - Provides comprehensive and accurate Bazi (Chinese Astrology) charting and analysis
...
* [yuna0x0/anilist-mcp](https://github.com/yuna0x0/anilist-mcp) ⭐ 64 | 🐛 0 | 🌐 TypeScript | 📅 2025-11-28 📇 ☁️ - A MCP server integrating AniList API for anime and manga information
...
* [raveenb/fal-mcp-server](https://github.com/raveenb/fal-mcp-server) ⭐ 17 | 🐛 21 | 🌐 Python | 📅 2025-12-23 🐍 ☁️ - Generate AI images, videos, and music using Fal.ai models (FLUX, Stable Diffusion, MusicGen) directly in Claude Desktop
...
* [the-momentum/fhir-mcp-server](https://github.com/the-momentum/fhir-mcp-server) ⭐ 46 | 🐛 6 | 🌐 Python | 📅 2025-10-23 🐍 🏠 ☁️ - MCP Server that connects AI agents to FHIR servers. One example use case is querying patient history in natural language.
...
* [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) ⭐ 24,754 | 🐛 29 | 🌐 TypeScript | 📅 2025-12-20 - Official Microsoft Playwright MCP server, enabling LLMs to interact with web pages through structured accessibility snapshots
* [agent-infra/mcp-server-browser](https://github.com/bytedance/UI-TARS-desktop/tree/main/packages/agent-infra/mcp-servers/browser) ⭐ 20,114 | 🐛 310 | 🌐 TypeScript | 📅 2025-12-25 📇 🏠 - Browser automation capabilities using Puppeteer, both support local and remote browser connection.
* [browsermcp/mcp](https://github.com/browsermcp/mcp) ⭐ 5,272 | 🐛 103 | 🌐 TypeScript | 📅 2025-04-24 📇 🏠 - Automate your local Chrome browser
* [executeautomation/playwright-mcp-server](https://github.com/executeautomation/mcp-playwright) ⭐ 5,089 | 🐛 16 | 🌐 TypeScript | 📅 2025-12-13 📇 - An MCP server using Playwright for browser automation and webscrapping
* [browserbase/mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase) ⭐ 2,966 | 🐛 25 | 🌐 TypeScript | 📅 2025-12-10 🎖️ 📇 - Automate browser interactions in the cloud (e.g. web navigation, data extraction, form filling, and more)
* [operative\_sh/web-eval-agent](https://github.com/Operative-Sh/web-eval-agent) ⭐ 1,227 | 🐛 11 | 🌐 Python | 📅 2025-12-23 🐍 🏠 🍎 - An MCP Server that autonomously debugs web applications with browser-use browser agents
...
* [kimtaeyoon83/mcp-server-youtube-transcript](https://github.com/kimtaeyoon83/mcp-server-youtube-transcript) ⭐ 362 | 🐛 6 | 🌐 TypeScript | 📅 2025-12-24 📇 ☁️ - Fetch YouTube subtitles and transcripts for AI analysis
* [eat-pray-ai/yutu](https://github.com/eat-pray-ai/yutu) ⭐ 354 | 🐛 1 | 🌐 Go | 📅 2025-12-25 🏎️ 🏠 🍎 🐧 🪟 - A fully functional MCP server and CLI for YouTube to automate YouTube operation
...
* [eyalzh/browser-control-mcp](https://github.com/eyalzh/browser-control-mcp) ⭐ 221 | 🐛 13 | 🌐 TypeScript | 📅 2025-12-20 📇 🏠 - An MCP server paired with a browser extension that enables LLM clients to control the user's browser (Firefox).
...
* [ndthanhdev/mcp-browser-kit](https://github.com/ndthanhdev/mcp-browser-kit) ⭐ 45 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-25 📇 🏠 - An MCP Server that enables AI assistants to interact with your local browsers.
...
* [awslabs/mcp](https://github.com/awslabs/mcp) ⭐ 7,720 | 🐛 209 | 🌐 Python | 📅 2025-12-24 🎖️ ☁️ - AWS MCP servers for seamless integration with AWS services and resources.
* [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) ⭐ 3,221 | 🐛 42 | 🌐 TypeScript | 📅 2025-12-22 🎖️ 📇 ☁️ - Integration with Cloudflare services including Workers, KV, R2, and D1
* [flux159/mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) ⭐ 1,229 | 🐛 11 | 🌐 TypeScript | 📅 2025-12-18 📇 ☁️/🏠 - Typescript implementation of Kubernetes cluster operations for pods, deployments, services.
...
* [weibaohui/k8m](https://github.com/weibaohui/k8m) ⭐ 744 | 🐛 18 | 🌐 Go | 📅 2025-12-24 🏎️ ☁️/🏠 - Provides MCP multi-cluster Kubernetes management and operations, featuring a management interface, logging, and nearly 50 built-in tools covering common DevOps and development scenarios. Supports both standard and CRD resources.
...
* [weibaohui/kom](https://github.com/weibaohui/kom) ⭐ 139 | 🐛 2 | 🌐 Go | 📅 2025-12-24 🏎️ ☁️/🏠 - Provides MCP multi-cluster Kubernetes management and operations. It can be integrated as an SDK into your own project and includes nearly 50 built-in tools covering common DevOps and development scenarios. Supports both standard and CRD resources.
...
* [aliyun/alibaba-cloud-ops-mcp-server](https://github.com/aliyun/alibaba-cloud-ops-mcp-server) ⭐ 88 | 🐛 8 | 🌐 Python | 📅 2025-12-26 🎖️ 🐍 ☁️ - A MCP server that enables AI assistants to operation resources on Alibaba Cloud, supporting ECS, Cloud Monitor, OOS and widely used cloud products.
* [StacklokLabs/mkp](https://github.com/StacklokLabs/mkp) ⭐ 55 | 🐛 5 | 🌐 Go | 📅 2025-12-26 🏎️ ☁️ - MKP is a Model Context Protocol (MCP) server for Kubernetes that allows LLM-powered applications to interact with Kubernetes clusters. It provides tools for listing and applying Kubernetes resources through the MCP protocol.
...
* [pibblokto/cert-manager-mcp-server](https://github.com/pibblokto/cert-manager-mcp-server) ⭐ 15 | 🐛 0 | 🌐 Python | 📅 2025-08-25 🐍 🍎/🐧 ☁️ - mcp server for [cert-manager](https://github.com/cert-manager/cert-manager) ⭐ 13,419 | 🐛 216 | 🌐 Go | 📅 2025-12-26 management and troubleshooting
...
* [pydantic/pydantic-ai/mcp-run-python](https://github.com/pydantic/pydantic-ai/tree/main/mcp-run-python) ⭐ 13,974 | 🐛 405 | 🌐 Python | 📅 2025-12-25 🐍 🏠 - Run Python code in a secure sandbox via MCP tool calls
* [dagger/container-use](https://github.com/dagger/container-use) ⭐ 3,361 | 🐛 64 | 🌐 Go | 📅 2025-12-08 🏎️ 🏠 🐧 🍎 🪟 - Containerized environments for coding agents. Multiple agents can work independently, isolated in fresh containers and git branches. No conflicts, many experiments. Full execution history, terminal access to agent environments, git workflow. Any agent/model/infra stack.
...
* [oraios/serena](https://github.com/oraios/serena) ⭐ 17,686 | 🐛 77 | 🌐 Python | 📅 2025-12-25 🐍 🏠 - A fully-featured coding agent that relies on symbolic code operations by using language servers.
* [ezyang/codemcp](https://github.com/ezyang/codemcp) ⭐ 1,580 | 🐛 79 | 🌐 Python | 📅 2025-12-25 🐍 🏠 - Coding agent with basic read, write and command line tools.
...
* [shashankss1205/codegraphcontext](https://github.com/Shashankss1205/CodeGraphContext) ⭐ 227 | 🐛 66 | 🌐 Python | 📅 2025-11-19 🐍 🏠 🍎 🪟 🐧 An MCP server that indexes local code into a graph database to provide context to AI assistants with a graphical code visualizations for humans.
* [tiianhk/MaxMSP-MCP-Server](https://github.com/tiianhk/MaxMSP-MCP-Server) ⭐ 127 | 🐛 8 | 🌐 Max | 📅 2025-11-10 🐍 🏠 🎵 🎥 - A coding agent for Max (Max/MSP/Jitter), which is a visual programming language for music and multimedia.
* [stippi/code-assistant](https://github.com/stippi/code-assistant) ⭐ 124 | 🐛 1 | 🌐 Rust | 📅 2025-12-25 🦀 🏠 - Coding agent with basic list, read, replace\_in\_file, write, execute\_command and web search tools. Supports multiple projects concurrently.
* [nesquikm/mcp-rubber-duck](https://github.com/nesquikm/mcp-rubber-duck) ⭐ 119 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-08 📇 🏠 ☁️ - An MCP server that bridges to multiple OpenAI-compatible LLMs - your AI rubber duck debugging panel for explaining problems to various AI "ducks" and getting different perspectives
...
* [wende/cicada](https://github.com/wende/cicada) ⭐ 19 | 🐛 4 | 🌐 Python | 📅 2025-12-25 🐍 🏠 🍎 🪟 🐧 - Code Intelligence for Elixir: module search, function tracking, and PR attribution through tree-sitter AST parsing
...
* [x51xxx/codex-mcp-tool](https://github.com/x51xxx/codex-mcp-tool) ⭐ 15 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-25 📇 ☁️ - MCP server that connects your IDE or AI assistant to Codex CLI for code analysis and editing with support for multiple models (gpt-5-codex, o3, codex-1)
...
* [wonderwhy-er/DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) ⭐ 5,124 | 🐛 72 | 🌐 TypeScript | 📅 2025-12-24 📇 🏠 🍎 🪟 🐧 - A swiss-army-knife that can manage/execute programs and read/write/search/edit code and text files.
* [louis030195/terminator-mcp-agent](https://github.com/mediar-ai/terminator/tree/main/terminator-mcp-agent) ⭐ 1,223 | 🐛 10 | 🌐 Rust | 📅 2025-12-23 🦀 📇 🏠 🍎 🪟 🐧 - Desktop GUI automation using accessibility APIs. Control Windows, macOS, and Linux applications without vision models or screenshots. Supports workflow recording, structured data extraction, and browser DOM inspection.
...
* [aymericzip/intlayer](https://github.com/aymericzip/intlayer) ⭐ 466 | 🐛 23 | 🌐 TypeScript | 📅 2025-12-25 📇 ☁️ 🏠 - A MCP Server that enhance your IDE with AI-powered assistance for Intlayer i18n / CMS tool: smart CLI access, access to the docs.
...
* [elie222/inbox-zero](https://github.com/elie222/inbox-zero/tree/main/apps/mcp-server) ⭐ 9,629 | 🐛 84 | 🌐 TypeScript | 📅 2025-12-25 🐍 ☁️ - An MCP server for Inbox Zero. Adds functionality on top of Gmail like finding out which emails you need to reply to or need to follow up on.
...
* [korotovsky/slack-mcp-server](https://github.com/korotovsky/slack-mcp-server) ⭐ 1,033 | 🐛 29 | 🌐 Go | 📅 2025-12-25 📇 ☁️ - The most powerful MCP server for Slack Workspaces.
* [chigwell/telegram-mcp](https://github.com/chigwell/telegram-mcp) ⭐ 509 | 🐛 6 | 🌐 Python | 📅 2025-12-25 🐍 🏠 - Telegram API integration for accessing user data, managing dialogs (chats, channels, groups), retrieving messages, sending messages and handling read status.
* [line/line-bot-mcp-server](https://github.com/line/line-bot-mcp-server) ⭐ 505 | 🐛 20 | 🌐 TypeScript | 📅 2025-12-25 🎖 📇 ☁️ - MCP Server for Integrating LINE Official Account
...
* [InditexTech/mcp-teams-server](https://github.com/InditexTech/mcp-teams-server) ⭐ 340 | 🐛 8 | 🌐 Python | 📅 2025-10-20 🐍 ☁️ - MCP server that integrates Microsoft Teams messaging (read, post, mention, list members and threads)
* [chaindead/telegram-mcp](https://github.com/chaindead/telegram-mcp) ⭐ 257 | 🐛 7 | 🌐 Go | 📅 2025-08-21 🏎️ 🏠 - Telegram API integration for accessing user data, managing dialogs (chats, channels, groups), retrieving messages, and handling read status
...
* [carterlasalle/mac\_messages\_mcp](https://github.com/carterlasalle/mac_messages_mcp) ⭐ 207 | 🐛 8 | 🌐 Python | 📅 2025-09-09 🏠 🍎 🚀 - An MCP server that securely interfaces with your iMessage database via the Model Context Protocol (MCP), allowing LLMs to query and analyze iMessage conversations. It includes robust phone number validation, attachment processing, contact management, group chat handling, and full support for sending and receiving messages.
...
* [discourse/discourse-mcp](https://github.com/discourse/discourse-mcp) ⭐ 30 | 🐛 2 | 🌐 TypeScript | 📅 2025-12-26 🎖️ 💎 ☁️ 🏠 💬 🍎 🪟 🐧 - Official Discourse MCP server for forum integration. Search topics, read posts, manage categories and tags, discover users, and interact with Discourse communities.
...
* [antv/mcp-server-chart](https://github.com/antvis/mcp-server-chart) ⭐ 3,364 | 🐛 11 | 🌐 TypeScript | 📅 2025-12-24 🎖️ 📇 ☁️ - A Model Context Protocol server for generating visual charts using [AntV](https://github.com/antvis).
* [hustcc/mcp-mermaid](https://github.com/hustcc/mcp-mermaid) ⭐ 342 | 🐛 4 | 🌐 TypeScript | 📅 2025-12-16 📇 🏠 - Generate [mermaid](https://mermaid.js.org/) diagram and chart with AI MCP dynamically.
...
* [googleapis/genai-toolbox](https://github.com/googleapis/genai-toolbox) ⭐ 11,949 | 🐛 162 | 🌐 Go | 📅 2025-12-24 🏎️ ☁️ - Open source MCP server specializing in easy, fast, and secure tools for Databases.

* [get-convex/convex-backend](https://stack.convex.dev/convex-mcp-server) 📇 ☁️ - Convex database integration to introspect tables, functions, and run oneoff queries ([Source](https://github.com/get-convex/convex-backend/blob/main/npm-packages/convex/src/cli/mcp.ts) ⭐ 8,677 | 🐛 109 | 🌐 Rust | 📅 2025-12-25)

* [bram2w/baserow](https://github.com/bram2w/baserow) ⭐ 3,607 | 🐛 1,043 | 🌐 Python | 📅 2025-12-25 - Baserow database integration with table search, list, and row create, read, update, and delete capabilities.

* [supabase-community/supabase-mcp](https://github.com/supabase-community/supabase-mcp) ⭐ 2,346 | 🐛 69 | 🌐 TypeScript | 📅 2025-12-23 🎖️ 📇 ☁️ - Official Supabase MCP server to connect AI assistants directly with your Supabase project and allows them to perform tasks like managing tables, fetching config, and querying data.

* [crystaldba/postgres-mcp](https://github.com/crystaldba/postgres-mcp) ⭐ 1,705 | 🐛 36 | 🌐 Python | 📅 2025-11-11 🐍 🏠 - All-in-one MCP server for Postgres development and operations, with tools for performance analysis, tuning, and health checks

* [qdrant/mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant) ⭐ 1,145 | 🐛 34 | 🌐 Python | 📅 2025-12-10 🐍 🏠 - A Qdrant MCP server
...
* [benborla29/mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) ⭐ 1,010 | 🐛 30 | 🌐 JavaScript | 📅 2025-11-18 ☁️ 🏠 - MySQL database integration in NodeJS with configurable access controls and schema inspection
...
* [ClickHouse/mcp-clickhouse](https://github.com/ClickHouse/mcp-clickhouse) ⭐ 629 | 🐛 24 | 🌐 Python | 📅 2025-12-16 🐍 ☁️ - ClickHouse database integration with schema inspection and query capabilities

* [xing5/mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) ⭐ 569 | 🐛 16 | 🌐 Python | 📅 2025-12-06 🐍 ☁️ - A Model Context Protocol server for interacting with Google Sheets. This server provides tools to create, read, update, and manage spreadsheets through the Google Sheets API.

* [neondatabase/mcp-server-neon](https://github.com/neondatabase/mcp-server-neon) ⭐ 531 | 🐛 17 | 🌐 TypeScript | 📅 2025-12-24 📇 ☁️ — An MCP Server for creating and managing Postgres databases using Neon Serverless Postgres
...
* [subnetmarco/pgmcp](https://github.com/subnetmarco/pgmcp) ⭐ 516 | 🐛 1 | 🌐 Go | 📅 2025-09-25 🏎️ 🏠 - Natural language PostgreSQL queries with automatic streaming, read-only safety, and universal database compatibility.
...
* [redis/mcp-redis](https://github.com/redis/mcp-redis) ⭐ 371 | 🐛 7 | 🌐 Python | 📅 2025-12-15 🐍 🏠 - The Redis official MCP Server offers an interface to manage and search data in Redis.

* [FreePeak/db-mcp-server](https://github.com/FreePeak/db-mcp-server) ⭐ 325 | 🐛 12 | 🌐 Go | 📅 2025-12-20 🏎️ 🏠 – A high-performance multi-database MCP server built with Golang, supporting MySQL & PostgreSQL (NoSQL coming soon). Includes built-in tools for query execution, transaction management, schema exploration, query building, and performance analysis, with seamless Cursor integration for enhanced database workflows.

* [pab1it0/prometheus-mcp-server](https://github.com/pab1it0/prometheus-mcp-server) ⭐ 324 | 🐛 2 | 🌐 Python | 📅 2025-12-17 🐍 ☁️ -  Query and analyze Prometheus, open-source monitoring system.
...
* [confluentinc/mcp-confluent](https://github.com/confluentinc/mcp-confluent) ⭐ 123 | 🐛 9 | 🌐 TypeScript | 📅 2025-12-25 🐍 ☁️ - Confluent integration to interact with Confluent Kafka and Confluent Cloud REST APIs.
...
* [pgtuner\_mcp](https://github.com/isdaniel/pgtuner_mcp) ⭐ 12 | 🐛 0 | 🌐 Python | 📅 2025-12-15 🐍🗄️ - provides AI-powered PostgreSQL performance tuning capabilities.
...
* [ferrants/memvid-mcp-server](https://github.com/ferrants/memvid-mcp-server) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2025-06-20 🐍 🏠 - Python Streamable HTTP Server you can run locally to interact with [memvid](https://github.com/Olow304/memvid) ⭐ 10,518 | 🐛 12 | 🌐 Python | 📅 2025-12-22 storage and semantic search.
...
* [dbt-labs/dbt-mcp](https://github.com/dbt-labs/dbt-mcp) ⭐ 445 | 🐛 23 | 🌐 Python | 📅 2025-12-19 🎖️ 🐍 🏠 ☁️ - Official MCP server for [dbt (data build tool)](https://www.getdbt.com/product/what-is-dbt) providing integration with dbt Core/Cloud CLI, project metadata discovery, model information, and semantic layer querying capabilities.
...
* [eyaltoledano/claude-task-master](https://github.com/eyaltoledano/claude-task-master) ⭐ 24,430 | 🐛 148 | 🌐 JavaScript | 📅 2025-12-24 📇 ☁️ 🏠 - AI-powered task management system for AI-driven development. Features PRD parsing, task expansion, multi-provider support (Claude, OpenAI, Gemini, Perplexity, xAI), and selective tool loading for optimized context usage.
* [GLips/Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 12,326 | 🐛 37 | 🌐 TypeScript | 📅 2025-10-14 📇 🏠 - Provide coding agents direct access to Figma data to help them one-shot design implementation.
* [idosal/git-mcp](https://github.com/idosal/git-mcp) ⭐ 7,264 | 🐛 48 | 🌐 TypeScript | 📅 2025-08-22 📇 ☁️ - [gitmcp.io](https://gitmcp.io/) is a generic remote MCP server to connect to ANY [GitHub](https://www.github.com) repository or project for documentation
* [21st-dev/Magic-MCP](https://github.com/21st-dev/magic-mcp) ⭐ 4,040 | 🐛 21 | 🌐 TypeScript | 📅 2025-12-23 - Create crafted UI components inspired by the best 21st.dev design engineers.
* [haris-musa/excel-mcp-server](https://github.com/haris-musa/excel-mcp-server) ⭐ 3,025 | 🐛 37 | 🌐 Python | 📅 2025-12-22 🐍 🏠 - An Excel manipulation server providing workbook creation, data operations, formatting, and advanced features (charts, pivot tables, formulae).
* [mobile-next/mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 2,784 | 🐛 32 | 🌐 TypeScript | 📅 2025-12-09 📇 🏠 🐧 🍎 - MCP Server for Android/iOS application and device automation, development and app scraping. Simulator/Emulator/Physical devices like iPhone, Google Pixel, Samsung supported.
* [Jpisnice/shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,554 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-25 📇 🏠 - MCP server that gives AI assistants seamless access to shadcn/ui v4 components, blocks, demos, and metadata.
* [cjo4m06/mcp-shrimp-task-manager](https://github.com/cjo4m06/mcp-shrimp-task-manager) ⭐ 1,937 | 🐛 37 | 🌐 JavaScript | 📅 2025-08-21 📇 ☁️ 🏠 – A programming-focused task management system that boosts coding agents like Cursor AI with advanced task memory, self-reflection, and dependency management. [ShrimpTaskManager](https://cjo4m06.github.io/mcp-shrimp-task-manager)
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 1,346 | 🐛 12 | 🌐 JavaScript | 📅 2025-12-16 📇 🏠 🍎 - A Model Context Protocol (MCP) server for interacting with iOS simulators. This server allows you to interact with iOS simulators by getting information about them, controlling UI interactions, and inspecting UI elements.
* [isaacphi/mcp-language-server](https://github.com/isaacphi/mcp-language-server) ⭐ 1,337 | 🐛 43 | 🌐 Go | 📅 2025-12-02 🏎️ 🏠 - MCP Language Server helps MCP enabled clients navigate codebases more easily by giving them access to semantic tools like get definition, references, rename, and diagnostics.
* [jetbrains/mcpProxy](https://github.com/JetBrains/mcpProxy) ⭐ 939 | 🐛 37 | 🌐 JavaScript | 📅 2025-12-02 🎖️ 📇 🏠 - Connect to JetBrains IDE
* [lpigeon/ros-mcp-server](https://github.com/lpigeon/ros-mcp-server) ⭐ 897 | 🐛 16 | 🌐 Python | 📅 2025-12-25 🐍 🏠 🍎 🪟 🐧 - The ROS MCP Server supports robot control by converting user-issued natural language commands into ROS or ROS2 control commands.
...
* [bgauryy/octocode-mcp](https://github.com/bgauryy/octocode-mcp) ⭐ 659 | 🐛 3 | 🌐 TypeScript | 📅 2025-12-25 ☁️ 📇 🍎 🪟 🐧 - AI-powered developer assistant that enables advanced research, analysis and discovery across GitHub and NPM realms in realtime.
...
* [utensils/mcp-nixos](https://github.com/utensils/mcp-nixos) ⭐ 382 | 🐛 11 | 🌐 HTML | 📅 2025-12-03 🐍 🏠 - MCP server providing accurate information about NixOS packages, system options, Home Manager configurations, and nix-darwin macOS settings to prevent AI hallucinations.
...
* [OpenZeppelin/contracts-wizard](https://github.com/OpenZeppelin/contracts-wizard/tree/master/packages/mcp) ⭐ 291 | 🐛 38 | 🌐 TypeScript | 📅 2025-12-25 - A Model Context Protocol (MCP) server that allows AI agents to generate secure smart contracts in multiples languages based on [OpenZeppelin Wizard templates](https://wizard.openzeppelin.com/).
...
* [public-ui/kolibri](https://github.com/public-ui/kolibri) ⭐ 240 | 🐛 159 | 🌐 TypeScript | 📅 2025-12-26 📇 ☁️ 🏠 - Streaming KoliBri MCP server (NPM: `@public-ui/mcp`) delivering 200+ guaranteed accessible web component samples, specs, docs, and scenarios via hosted HTTP endpoint or local `kolibri-mcp` CLI.
* [joshuarileydev/app-store-connect-mcp-server](https://github.com/JoshuaRileyDev/app-store-connect-mcp-server) ⭐ 237 | 🐛 6 | 🌐 TypeScript | 📅 2025-09-02 📇 🏠 - An MCP server to communicate with the App Store Connect API for iOS Developers
...
* [hloiseaufcms/mcp-gopls](https://github.com/hloiseaufcms/mcp-gopls) ⭐ 53 | 🐛 0 | 🌐 Go | 📅 2025-12-22 🏎️ 🏠 - A MCP server for interacting with [Go's Language Server Protocol (gopls)](https://github.com/golang/tools/tree/master/gopls) ⭐ 7,848 | 🐛 105 | 🌐 Go | 📅 2025-12-25 and benefit from advanced Go code analysis features.
...
* [Rootly-AI-Labs/Rootly-MCP-server](https://github.com/Rootly-AI-Labs/Rootly-MCP-server) ⭐ 36 | 🐛 1 | 🌐 Python | 📅 2025-12-26 🎖️ 🐍 ☁️ 🍎 - MCP server for the incident management platform [Rootly](https://rootly.com/).
...
* [api7/apisix-mcp](https://github.com/api7/apisix-mcp) ⭐ 29 | 🐛 2 | 🌐 TypeScript | 📅 2025-06-16 🎖️ 📇 🏠 MCP Server that support for querying and managing all resource in [Apache APISIX](https://github.com/apache/apisix) ⭐ 16,014 | 🐛 326 | 🌐 Lua | 📅 2025-12-26.
...
* [j4c0bs/mcp-server-sql-analyzer](https://github.com/j4c0bs/mcp-server-sql-analyzer) ⭐ 26 | 🐛 0 | 🌐 Python | 📅 2025-07-01 🐍 - MCP server that provides SQL analysis, linting, and dialect conversion using [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 8,740 | 🐛 7 | 🌐 Python | 📅 2025-12-25
...
* [hechtcarmel/jetbrains-index-mcp-plugin](https://github.com/hechtcarmel/jetbrains-index-mcp-plugin) ⭐ 22 | 🐛 8 | 🌐 Kotlin | 📅 2025-12-23 ☕ 🏠 - A JetBrains IDE plugin that exposes an MCP server, enabling AI coding assistants to leverage the IDE's indexing and refactoring capabilities (rename, safe delete, find references, call hierarchy, type hierarchy, diagnostics and more).
* [higress-group/higress-ops-mcp-server](https://github.com/higress-group/higress-ops-mcp-server) ⭐ 22 | 🐛 6 | 🌐 Python | 📅 2025-03-29 🐍 🏠 - MCP server that provides comprehensive tools for managing [Higress](https://github.com/alibaba/higress) ⭐ 7,158 | 🐛 710 | 🌐 Go | 📅 2025-12-24 gateway configurations and operations.
...
* [sbroenne/mcp-server-excel](https://github.com/sbroenne/mcp-server-excel) ⭐ 12 | 🐛 4 | 🌐 C# | 📅 2025-12-25 #️⃣ 🏠 🪟 - Full-featured Excel MCP server. 173 operations: Power Query, DAX, VBA, PivotTables, Tables, Charts, ranges, formatting. 100% Excel compatibility - uses Excel app instead of creating .xlsx files. Windows only.
...
* [narumiruna/gitingest-mcp](https://github.com/narumiruna/gitingest-mcp) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2025-11-21 🐍 🏠 - A MCP server that uses [gitingest](https://github.com/cyclotruc/gitingest) ⭐ 13,447 | 🐛 29 | 🌐 Python | 📅 2025-12-19 to convert any Git repository into a simple text digest of its codebase.
...
* [dorukardahan/twitterapi-docs-mcp](https://github.com/dorukardahan/twitterapi-docs-mcp) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2025-12-26 📇 🏠 - Offline access to TwitterAPI.io documentation for AI assistants. 52 API endpoints, guides, pricing info, and authentication docs.
...
* [mckinsey/vizro-mcp](https://github.com/mckinsey/vizro/tree/main/vizro-mcp) ⭐ 3,506 | 🐛 49 | 🌐 Python | 📅 2025-12-25 🎖️ 🐍 🏠 - Tools and templates to create validated and maintainable data charts and dashboards.
...
* [datalayer/jupyter-mcp-server](https://github.com/datalayer/jupyter-mcp-server) ⭐ 829 | 🐛 20 | 🌐 Python | 📅 2025-12-25 🐍 🏠 - Model Context Protocol (MCP) Server for Jupyter.
* [DataEval/dingo](https://github.com/DataEval/dingo) ⭐ 602 | 🐛 5 | 🌐 JavaScript | 📅 2025-12-25 🎖️ 🐍 🏠 🍎 🪟 🐧 - MCP server for the Dingo: a comprehensive data quality evaluation tool. Server Enables interaction with Dingo's rule-based and LLM-based evaluation capabilities and rules\&prompts listing.
...
* [stack-chan/stack-chan](https://github.com/stack-chan/stack-chan) ⭐ 1,014 | 🐛 27 | 🌐 TypeScript | 📅 2025-12-26 📇 📟 - A JavaScript-driven M5Stack-embedded super-kawaii robot with MCP server functionality for AI-controlled interactions and emotions.
...
* [microsoft/markitdown](https://github.com/microsoft/markitdown/tree/main/packages/markitdown-mcp) ⭐ 84,614 | 🐛 407 | 🌐 Python | 📅 2025-12-01 🎖️ 🐍 🏠 - MCP tool access to MarkItDown -- a library that converts many file formats (local or remote) to Markdown for LLM consumption.
* [mickaelkerjean/filestash](https://github.com/mickael-kerjean/filestash/tree/master/server/plugin/plg_handler_mcp) ⭐ 13,250 | 🐛 58 | 🌐 JavaScript | 📅 2025-12-22 🏎️ ☁️ - Remote Storage Access: SFTP, S3, FTP, SMB, NFS, WebDAV, GIT, FTPS, gcloud, azure blob, sharepoint, etc.
* [mark3labs/mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server) ⭐ 568 | 🐛 16 | 🌐 Go | 📅 2025-11-24 🏎️ 🏠 - Golang implementation for local file system access.
...
* [8b-is/smart-tree](https://github.com/8b-is/smart-tree) ⭐ 197 | 🐛 0 | 🌐 Rust | 📅 2025-12-08 🦀 🏠 🍎 🪟 🐧 - AI-native directory visualization with semantic analysis, ultra-compressed formats for AI consumption, and 10x token reduction. Supports quantum-semantic mode with intelligent file categorization.
...
* [longportapp/openapi](https://github.com/longportapp/openapi/tree/main/mcp) ⭐ 329 | 🐛 79 | 🌐 Rust | 📅 2025-12-15 - 🐍 ☁️ - LongPort OpenAPI provides real-time stock market data, provides AI access analysis and trading capabilities through MCP.
...
* [narumiruna/yfinance-mcp](https://github.com/narumiruna/yfinance-mcp) ⭐ 78 | 🐛 0 | 🌐 Python | 📅 2025-12-08 🐍 ☁️ - An MCP server that uses yfinance to obtain information from Yahoo Finance.
...
* [Coding-Solo/godot-mcp](https://github.com/Coding-Solo/godot-mcp) ⭐ 1,256 | 🐛 32 | 🌐 JavaScript | 📅 2025-08-09 📇 🏠 - A MCP server for interacting with the Godot game engine, providing tools for editing, running, debugging, and managing scenes in Godot projects.
* [CoderGamester/mcp-unity](https://github.com/CoderGamester/mcp-unity) ⭐ 1,160 | 🐛 6 | 🌐 C# | 📅 2025-12-09 #️⃣ 🏠 - MCP Server for Unity3d Game Engine integration for game development
* [IvanMurzak/Unity-MCP](https://github.com/IvanMurzak/Unity-MCP) ⭐ 654 | 🐛 35 | 🌐 C# | 📅 2025-12-25 #️⃣ 🏠 🍎 🪟 🐧 - MCP Server for Unity Editor and for a game made with Unity
...
* [upstash/context7](https://github.com/upstash/context7) ⭐ 40,085 | 🐛 90 | 🌐 TypeScript | 📅 2025-12-25 📇 ☁️ - Up-to-date code documentation for LLMs and AI code editors.
* [topoteretes/cognee](https://github.com/topoteretes/cognee/tree/dev/cognee-mcp) ⭐ 10,499 | 🐛 27 | 🌐 Python | 📅 2025-12-23 📇 🏠 - Memory manager for AI apps and Agents using various graph and vector stores and allowing ingestion from 30+ data sources
...
* [apecloud/ApeRAG](https://github.com/apecloud/ApeRAG) ⭐ 990 | 🐛 51 | 🌐 Python | 📅 2025-12-06 🐍 ☁️ 🏠 - Production-ready RAG platform combining Graph RAG, vector search, and full-text search. Best choice for building your own Knowledge Graph and for Context Engineering
* [vectorize-io/hindsight](https://github.com/vectorize-io/hindsight) ⭐ 815 | 🐛 8 | 🌐 Python | 📅 2025-12-24 🐍 ☁️ 🏠 - Hindsight: Agent Memory That Works Like Human Memory - Built for AI Agents to manage Long Term Memory
* [mem0ai/mem0-mcp](https://github.com/mem0ai/mem0-mcp) ⭐ 544 | 🐛 10 | 🌐 Python | 📅 2025-12-07 🐍 🏠 - A Model Context Protocol server for Mem0 that helps manage coding preferences and patterns, providing tools for storing, retrieving and semantically handling code implementations, best practices and technical documentation in IDEs like Cursor and Windsurf
...
* [agentic-mcp-tools/memora](https://github.com/agentic-mcp-tools/memora) ⭐ 49 | 🐛 0 | 🌐 Python | 📅 2025-12-25 🐍 🏠 ☁️ - Persistent memory with knowledge graph visualization, semantic/hybrid search, cloud sync (S3/R2), and cross-session context management.
* [shinpr/mcp-local-rag](https://github.com/shinpr/mcp-local-rag) ⭐ 45 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-24 📇 🏠 - Privacy-first document search server running entirely locally. Supports semantic search over PDFs, DOCX, TXT, and Markdown files with LanceDB vector storage and local embeddings - no API keys or cloud services required.
...
* [QGIS MCP](https://github.com/jjsantos01/qgis_mcp) ⭐ 732 | 🐛 8 | 🌐 Python | 📅 2025-10-01 - connects QGIS Desktop to Claude AI through the MCP. This integration enables prompt-assisted project creation, layer loading, code execution, and more.
...
* [jagan-shanmugam/open-streetmap-mcp](https://github.com/jagan-shanmugam/open-streetmap-mcp) ⭐ 150 | 🐛 8 | 🌐 Python | 📅 2025-07-12 🐍 🏠 - An OpenStreetMap MCP server with location-based services and geospatial data.
...
* [gomarble-ai/facebook-ads-mcp-server](https://github.com/gomarble-ai/facebook-ads-mcp-server) ⭐ 203 | 🐛 1 | 🌐 Python | 📅 2025-08-21 🐍 ☁️ - MCP server acting as an interface to the Facebook Ads, enabling programmatic access to Facebook Ads data and management features.
* [gomarble-ai/google-ads-mcp-server](https://github.com/gomarble-ai/google-ads-mcp-server) ⭐ 85 | 🐛 3 | 🌐 Python | 📅 2025-12-17 🐍 ☁️ - MCP server acting as an interface to the Google Ads, enabling programmatic access to Google Ads data and management features.
...
* [AdsMCP/tiktok-ads-mcp-server](https://github.com/AdsMCP/tiktok-ads-mcp-server) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2025-10-20 🐍 ☁️ - A Model Context Protocol server for TikTok Ads API integration, enabling AI assistants to manage campaigns, analyze performance metrics, handle audiences and creatives with OAuth authentication flow.
...
* [netdata/netdata#Netdata](https://github.com/netdata/netdata/blob/master/src/web/mcp/README.md) ⭐ 77,140 | 🐛 241 | 🌐 C | 📅 2025-12-23 🎖️ 🏠 ☁️ 📟 🍎 🪟 🐧 - Discovery, exploration, reporting and root cause analysis using all observability data, including metrics, logs, systems, containers, processes, and network connections
* [grafana/mcp-grafana](https://github.com/grafana/mcp-grafana) ⭐ 2,024 | 🐛 62 | 🌐 Go | 📅 2025-12-25 🎖️ 🐍 🏠 ☁️ - Search dashboards, investigate incidents and query datasources in your Grafana instance
* [getsentry/sentry-mcp](https://github.com/getsentry/sentry-mcp) ⭐ 485 | 🐛 47 | 🌐 TypeScript | 📅 2025-12-19 🐍 ☁️ - Sentry.io integration for error tracking and performance monitoring
...
* [sunriseapps/imagesorcery-mcp](https://github.com/sunriseapps/imagesorcery-mcp) ⭐ 259 | 🐛 4 | 🌐 Python | 📅 2025-09-23 🐍 🏠 🐧 🍎 🪟 - ComputerVision-based 🪄 sorcery of image recognition and editing tools for AI assistants.
...
* [blazickjp/arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) ⭐ 1,976 | 🐛 32 | 🌐 Python | 📅 2025-08-19 ☁️ 🐍 - Search ArXiv research papers
* [luminati-io/brightdata-mcp](https://github.com/luminati-io/brightdata-mcp) ⭐ 1,777 | 🐛 15 | 🌐 JavaScript | 📅 2025-12-21 📇 ☁️ - Discover, extract, and interact with the web - one interface powering automated access across the public internet.
* [jae-jae/fetcher-mcp](https://github.com/jae-jae/fetcher-mcp) ⭐ 940 | 🐛 7 | 🌐 TypeScript | 📅 2025-11-24 📇 🏠 - MCP server for fetching web page content using Playwright headless browser, supporting Javascript rendering and intelligent content extraction, and outputting Markdown or HTML format.
* [nickclyde/duckduckgo-mcp-server](https://github.com/nickclyde/duckduckgo-mcp-server) ⭐ 700 | 🐛 20 | 🌐 Python | 📅 2025-03-11 🐍 ☁️ - Web search using DuckDuckGo
* [Aas-ee/open-webSearch](https://github.com/Aas-ee/open-webSearch) ⭐ 543 | 🐛 9 | 🌐 TypeScript | 📅 2025-10-26 🐍 📇 ☁️ - Web search using free multi-engine search (NO API KEYS REQUIRED) — Supports Bing, Baidu, DuckDuckGo, Brave, Exa, and CSDN.
* [brave/brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) ⭐ 437 | 🐛 14 | 🌐 TypeScript | 📅 2025-12-23 📇 ☁️ - Web search capabilities using Brave's Search API
...
* [Ihor-Sokoliuk/MCP-SearXNG](https://github.com/ihor-sokoliuk/mcp-searxng) ⭐ 367 | 🐛 9 | 🌐 TypeScript | 📅 2025-11-09 📇 🏠/☁️ - A Model Context Protocol Server for [SearXNG](https://docs.searxng.org)
...
* [jae-jae/g-search-mcp](https://github.com/jae-jae/g-search-mcp) ⭐ 236 | 🐛 5 | 🌐 TypeScript | 📅 2025-06-14 📇 🏠 - A powerful MCP server for Google search that enables parallel searching with multiple keywords simultaneously.
...
* [deadletterq/mcp-opennutrition](https://github.com/deadletterq/mcp-opennutrition) ⭐ 146 | 🐛 0 | 🌐 TypeScript | 📅 2025-06-11 📇 🏠 - Local MCP server for searching 300,000+ foods, nutrition facts, and barcodes from the OpenNutrition database.
...
* [boikot-xyz/boikot](https://github.com/boikot-xyz/boikot) ⭐ 4 | 🐛 0 | 🌐 HTML | 📅 2025-12-25 🦀☁️ - Model Context Protocol Server for looking up company ethics information. Learn about the ethical and unethical actions of major companies.
...
* [LaurieWired/GhidraMCP](https://github.com/LaurieWired/GhidraMCP) ⭐ 6,806 | 🐛 52 | 🌐 Java | 📅 2025-06-23 ☕ 🏠 - A Model Context Protocol server for Ghidra that enables LLMs to autonomously reverse engineer applications. Provides tools for decompiling binaries, renaming methods and data, and listing methods, classes, imports, and exports.
* [mrexodia/ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) ⭐ 4,742 | 🐛 35 | 🌐 Python | 📅 2025-12-20 🐍 🏠 - MCP server for IDA Pro, allowing you to perform binary analysis with AI assistants. This plugin implement decompilation, disassembly and allows you to generate malware analysis reports automatically.
...
* [zinja-coder/jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp) ⭐ 922 | 🐛 7 | 🌐 Java | 📅 2025-12-23 ☕ 🏠 - JADX-AI-MCP is a plugin and MCP Server for the JADX decompiler that integrates directly with Model Context Protocol (MCP) to provide live reverse engineering support with LLMs like Claude.
...
* [jtang613/GhidrAssistMCP](https://github.com/jtang613/GhidrAssistMCP) ⭐ 383 | 🐛 1 | 🌐 Java | 📅 2025-12-22 ☕ 🏠 - A native Model Context Protocol server for Ghidra. Includes GUI configuration and logging, 31 powerful tools and no external dependencies.
...
* [fosdickio/binary\_ninja\_mcp](https://github.com/fosdickio/binary_ninja_mcp) ⭐ 139 | 🐛 18 | 🌐 Python | 📅 2025-12-23 🐍 🏠 🍎 🪟 🐧 - A Binary Ninja plugin, MCP server, and bridge that seamlessly integrates [Binary Ninja](https://binary.ninja) with your favorite MCP client.  It enables you to automate the process of performing binary analysis and reverse engineering.
* [radareorg/r2mcp](https://github.com/radareorg/radare2-mcp) ⭐ 116 | 🐛 2 | 🌐 C | 📅 2025-12-09 🍎🪟🐧🏠🌊 - MCP server for Radare2 disassembler. Provides AI with capability to disassemble and look into binaries for reverse engineering.
...
* [karanb192/reddit-mcp-buddy](https://github.com/karanb192/reddit-mcp-buddy) ⭐ 325 | 🐛 7 | 🌐 TypeScript | 📅 2025-11-04 📇 🏠 - Browse Reddit posts, search content, and analyze user activity without API keys. Works out-of-the-box with Claude Desktop.
* [HagaiHen/facebook-mcp-server](https://github.com/HagaiHen/facebook-mcp-server) ⭐ 83 | 🐛 0 | 🌐 Python | 📅 2025-08-20 🐍 ☁️ - Integrates with Facebook Pages to enable direct management of posts, comments, and engagement metrics through the Graph API for streamlined social media management.
...
* [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 3,850 | 🐛 172 | 🌐 Python | 📅 2025-11-26 🐍 ☁️ - MCP server for Atlassian products (Confluence and Jira). Supports Confluence Cloud, Jira Cloud, and Jira Server/Data Center. Provides comprehensive tools for searching, reading, creating, and managing content across Atlassian workspaces.
* [nguyenvanduocit/jira-mcp](https://github.com/nguyenvanduocit/jira-mcp) ⭐ 73 | 🐛 2 | 🌐 Go | 📅 2025-11-10 🏎️ ☁️ - A Go-based MCP connector for Jira that enables AI assistants like Claude to interact with Atlassian Jira. This tool provides a seamless interface for AI models to perform common Jira operations including issue management, sprint planning, and workflow transitions.
* [effytech/freshdesk-mcp](https://github.com/effytech/freshdesk_mcp) ⭐ 35 | 🐛 2 | 🌐 Python | 📅 2025-10-06 🐍 ☁️ - MCP server that integrates with Freshdesk, enabling AI models to interact with Freshdesk modules and perform various support operations.
...
* [mbailey/voice-mcp](https://github.com/mbailey/voice-mcp) ⭐ 518 | 🐛 19 | 🌐 Python | 📅 2025-12-25 🐍 🏠 - Complete voice interaction server supporting speech-to-text, text-to-speech, and real-time voice conversations through local microphone, OpenAI-compatible APIs, and LiveKit integration
...
* [github/github-mcp-server](https://github.com/github/github-mcp-server) ⭐ 25,427 | 🐛 258 | 🌐 Go | 📅 2025-12-24 📇 ☁️ - Official GitHub server for integration with repository management, PRs, issues, and more.
...
* [taylorwilsdon/google\_workspace\_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) ⭐ 1,020 | 🐛 37 | 🌐 Python | 📅 2025-12-24 🐍 ☁️ 🍎 🪟 🐧 - Comprehensive Google Workspace MCP server with full support for Google Calendar, Drive, Gmail, and Docs, Forms, Chats, Slides and Sheets over stdio, Streamable HTTP and SSE transports.
* [MarkusPfundstein/mcp-gsuite](https://github.com/MarkusPfundstein/mcp-gsuite) ⭐ 467 | 🐛 22 | 🌐 Python | 📅 2025-04-14 🐍 ☁️ - Integration with gmail and Google Calendar.
...
* [modelcontextprotocol/server-everything](https://github.com/modelcontextprotocol/servers/tree/main/src/everything) ⭐ 75,011 | 🐛 247 | 🌐 TypeScript | 📅 2025-12-19 📇 🏠 - MCP server that exercises all the features of the MCP protocol
* [mediar-ai/screenpipe](https://github.com/mediar-ai/screenpipe) ⭐ 16,262 | 🐛 235 | 🌐 TypeScript | 📅 2025-12-09 - 🎖️ 🦀 🏠 🍎 Local-first system capturing screen/audio with timestamped indexing, SQL/embedding storage, semantic search, LLM-powered history analysis, and event-triggered actions - enables building context-aware AI agents through a NextJS plugin ecosystem.
* [Klavis-AI/YouTube](https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/youtube) ⭐ 5,552 | 🐛 52 | 🌐 Python | 📅 2025-12-25 🐍 📇 - Extract and convert YouTube video information.
* [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 3,850 | 🐛 172 | 🌐 Python | 📅 2025-11-26 🐍 ☁️ - MCP server for Atlassian products (Confluence and Jira). Supports Confluence Cloud, Jira Cloud, and Jira Server/Data Center. Provides comprehensive tools for searching, reading, creating, and managing content across Atlassian workspaces.
* [metorial/metorial](https://github.com/metorial/metorial) ⭐ 3,191 | 🐛 2 | 🌐 TypeScript | 📅 2025-12-26 - 🎖️ 📇 ☁️ Connect AI agents to 600+ integrations with a single interface - OAuth, scaling, and monitoring included
* [MarkusPfundstein/mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian) ⭐ 2,580 | 🐛 67 | 🌐 Python | 📅 2025-06-28 🐍 ☁️ 🏠 - Interacting with Obsidian via REST API
...
* [calclavia/mcp-obsidian](https://github.com/calclavia/mcp-obsidian) ⭐ 1,243 | 🐛 17 | 🌐 JavaScript | 📅 2025-08-15 📇 🏠 - This is a connector to allow Claude Desktop (or any MCP client) to read and search any directory containing Markdown notes (such as an Obsidian vault).
...
* [apify/actors-mcp-server](https://github.com/apify/actors-mcp-server) ⭐ 659 | 🐛 32 | 🌐 TypeScript | 📅 2025-12-24 📇 ☁️ - Use 3,000+ pre-built cloud tools, known as Actors, to extract data from websites, e-commerce, social media, search engines, maps, and more
* [rusiaaman/wcgw](https://github.com/rusiaaman/wcgw/blob/main/src/wcgw/client/mcp_server/Readme.md) ⭐ 626 | 🐛 6 | 🌐 Python | 📅 2025-12-25 🐍 🏠 - Autonomous shell execution, computer control and coding agent. (Mac)
* [tevonsb/homeassistant-mcp](https://github.com/tevonsb/homeassistant-mcp) ⭐ 502 | 🐛 16 | 🌐 TypeScript | 📅 2025-02-01 📇 🏠 - Access Home Assistant data and control devices (lights, switches, thermostats, etc).
* [anaisbetts/mcp-youtube](https://github.com/anaisbetts/mcp-youtube) ⭐ 481 | 🐛 12 | 🌐 JavaScript | 📅 2025-03-20 📇 ☁️ - Fetch YouTube subtitles
* [PV-Bhat/vibe-check-mcp-server](https://github.com/PV-Bhat/vibe-check-mcp-server) ⭐ 436 | 🐛 13 | 🌐 TypeScript | 📅 2025-12-02 📇 ☁️ - An MCP server that prevents cascading errors and scope creep by calling a "Vibe-check" agent to ensure user alignment.
...
* [ivnvxd/mcp-server-odoo](https://github.com/ivnvxd/mcp-server-odoo) ⭐ 121 | 🐛 15 | 🌐 Python | 📅 2025-12-15 🐍 ☁️/🏠 - Connect AI assistants to Odoo ERP systems for business data access, record management, and workflow automation.
...
* [Rai220/think-mcp](https://github.com/Rai220/think-mcp) ⭐ 85 | 🐛 2 | 🌐 Python | 📅 2025-04-16 🐍 🏠 - Enhances any agent's reasoning capabilities by integrating the think-tools, as described in [Anthropic's article](https://www.anthropic.com/engineering/claude-think-tool).
...
* [anki-mcp/anki-mcp-desktop](https://github.com/anki-mcp/anki-mcp-desktop) ⭐ 60 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-14 📇 🏠 🍎 🪟 🐧 - Enterprise-grade Anki integration with natural language interaction, comprehensive note/deck management, and one-click MCPB installation. Built on NestJS with comprehensive test coverage.
...
* [HenryHaoson/Yuque-MCP-Server](https://github.com/HenryHaoson/Yuque-MCP-Server) ⭐ 40 | 🐛 5 | 🌐 TypeScript | 📅 2025-10-31 - 📇 ☁️ A Model-Context-Protocol (MCP) server for integrating with Yuque API, allowing AI models to manage documents, interact with knowledge bases, search content, and access analytics data from the Yuque platform.
...
* [FastMCP](https://github.com/jlowin/fastmcp) ⭐ 21,421 | 🐛 236 | 🌐 Python | 📅 2025-12-26 🐍 - A high-level framework for building MCP servers in Python
* [FastMCP](https://github.com/punkpeye/fastmcp) ⭐ 2,841 | 🐛 38 | 🌐 TypeScript | 📅 2025-12-22 📇 - A high-level framework for building MCP servers in TypeScript
