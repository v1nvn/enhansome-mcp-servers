...
Checkout [awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients/) ⭐ 6,125 | 🐛 53 | 📅 2025-12-23 and [glama.ai/mcp/clients](https://glama.ai/mcp/clients).
...
* [mindsdb/mindsdb](https://github.com/mindsdb/mindsdb) ⭐ 38,127 | 🐛 184 | 🌐 Python | 📅 2025-12-27 - Connect and unify data across various platforms and databases with [MindsDB as a single MCP server](https://docs.mindsdb.com/mcp/overview).
* [PipedreamHQ/pipedream](https://github.com/PipedreamHQ/pipedream/tree/master/modelcontextprotocol) ⭐ 10,917 | 🐛 4,388 | 🌐 JavaScript | 📅 2025-12-27 ☁️ 🏠 - Connect with 2,500 APIs with 8,000+ prebuilt tools, and manage servers for your users, in your own app.
* [metatool-ai/metatool-app](https://github.com/metatool-ai/metatool-app) ⭐ 1,829 | 🐛 56 | 🌐 TypeScript | 📅 2025-12-23 📇 ☁️ 🏠 🍎 🪟 🐧 - MetaMCP is the one unified middleware MCP server that manages your MCP connections with GUI.
...
* [duaraghav8/MCPJungle](https://github.com/duaraghav8/MCPJungle) ⭐ 758 | 🐛 48 | 🌐 Go | 📅 2025-12-11 🏎️ 🏠 - Self-hosted MCP Server registry for enterprise AI Agents
* [TheLunarCompany/lunar#mcpx](https://github.com/TheLunarCompany/lunar/tree/main/mcpx) ⭐ 371 | 🐛 5 | 🌐 TypeScript | 📅 2025-12-25 📇 🏠  ☁️ 🍎 🪟 🐧 - MCPX is a production-ready, open-source gateway to manage MCP servers at scale—centralize tool discovery, access controls, call prioritization, and usage tracking to simplify agent workflows.
* [1mcp/agent](https://github.com/1mcp-app/agent) ⭐ 327 | 🐛 2 | 🌐 TypeScript | 📅 2025-12-27 📇 ☁️ 🏠 🍎 🪟 🐧 - A unified Model Context Protocol server implementation that aggregates multiple MCP servers into one.
...
* [sxhxliang/mcp-access-point](https://github.com/sxhxliang/mcp-access-point) ⭐ 157 | 🐛 2 | 🌐 Rust | 📅 2025-10-30 📇 ☁️ 🏠 🍎 🪟 🐧 - Turn a web service into an MCP server in one click without making any code changes.
...
* [juspay/neurolink](https://github.com/juspay/neurolink) ⭐ 101 | 🐛 399 | 🌐 TypeScript | 📅 2025-12-27 📇 ☁️ 🏠 🍎 🪟 🐧 - Making enterprise AI infrastructure universally accessible. Edge-first platform unifying 12 providers and 100+ models with multi-agent orchestration, HITL workflows, guardrails middleware, and context summarization.
...
* [portel-dev/ncp](https://github.com/portel-dev/ncp) ⭐ 55 | 🐛 0 | 🌐 JavaScript | 📅 2025-12-27 📇 ☁️ 🏠 🍎 🪟 🐧 - NCP orchestrates your entire MCP ecosystem through intelligent discovery, eliminating token overhead while maintaining 98.2% accuracy.
...
* [ahujasid/blender-mcp](https://github.com/ahujasid/blender-mcp) ⭐ 14,659 | 🐛 35 | 🌐 Python | 📅 2025-12-08 🐍 - MCP server for working with Blender
...
* [samuelgursky/davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp) ⭐ 447 | 🐛 10 | 🌐 Python | 📅 2025-10-20 🐍 - MCP server integration for DaVinci Resolve providing powerful tools for video editing, color grading, media management, and project control
...
* [8enSmith/mcp-open-library](https://github.com/8enSmith/mcp-open-library) ⭐ 48 | 🐛 1 | 🌐 TypeScript | 📅 2025-11-20 📇 ☁️ - A MCP server for the Open Library API that enables AI assistants to search for book information.
...
* [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) ⭐ 24,828 | 🐛 30 | 🌐 TypeScript | 📅 2025-12-27 - Official Microsoft Playwright MCP server, enabling LLMs to interact with web pages through structured accessibility snapshots
* [agent-infra/mcp-server-browser](https://github.com/bytedance/UI-TARS-desktop/tree/main/packages/agent-infra/mcp-servers/browser) ⭐ 20,129 | 🐛 311 | 🌐 TypeScript | 📅 2025-12-25 📇 🏠 - Browser automation capabilities using Puppeteer, both support local and remote browser connection.
* [browsermcp/mcp](https://github.com/browsermcp/mcp) ⭐ 5,280 | 🐛 103 | 🌐 TypeScript | 📅 2025-04-24 📇 🏠 - Automate your local Chrome browser
...
* [browserbase/mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase) ⭐ 2,977 | 🐛 25 | 🌐 TypeScript | 📅 2025-12-10 🎖️ 📇 - Automate browser interactions in the cloud (e.g. web navigation, data extraction, form filling, and more)
...
* [pskill9/web-search](https://github.com/pskill9/web-search) ⭐ 379 | 🐛 7 | 🌐 JavaScript | 📅 2024-12-30 📇 🏠 - An MCP server that enables free web searching using Google search results, with no API keys required.
...
* [awslabs/mcp](https://github.com/awslabs/mcp) ⭐ 7,731 | 🐛 205 | 🌐 Python | 📅 2025-12-27 🎖️ ☁️ - AWS MCP servers for seamless integration with AWS services and resources.
* [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) ⭐ 3,226 | 🐛 45 | 🌐 TypeScript | 📅 2025-12-22 🎖️ 📇 ☁️ - Integration with Cloudflare services including Workers, KV, R2, and D1
* [flux159/mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) ⭐ 1,231 | 🐛 12 | 🌐 TypeScript | 📅 2025-12-18 📇 ☁️/🏠 - Typescript implementation of Kubernetes cluster operations for pods, deployments, services.
* [manusa/Kubernetes MCP Server](https://github.com/manusa/kubernetes-mcp-server) ⭐ 914 | 🐛 51 | 🌐 Go | 📅 2025-12-23 🏎️ 🏠 A - powerful Kubernetes MCP server with additional support for OpenShift. Besides providing CRUD operations for **any** Kubernetes resource, this server provides specialized tools to interact with your cluster.
...
* [weibaohui/k8m](https://github.com/weibaohui/k8m) ⭐ 744 | 🐛 18 | 🌐 Go | 📅 2025-12-28 🏎️ ☁️/🏠 - Provides MCP multi-cluster Kubernetes management and operations, featuring a management interface, logging, and nearly 50 built-in tools covering common DevOps and development scenarios. Supports both standard and CRD resources.
* [strowk/mcp-k8s-go](https://github.com/strowk/mcp-k8s-go) ⭐ 367 | 🐛 10 | 🌐 Go | 📅 2025-12-22 🏎️ ☁️/🏠 - Kubernetes cluster operations through MCP
* [nwiizo/tfmcp](https://github.com/nwiizo/tfmcp) ⭐ 348 | 🐛 1 | 🌐 Rust | 📅 2025-12-27 - 🦀 🏠 - A Terraform MCP server allowing AI assistants to manage and operate Terraform environments, enabling reading configurations, analyzing plans, applying configurations, and managing Terraform state.
...
* [pibblokto/cert-manager-mcp-server](https://github.com/pibblokto/cert-manager-mcp-server) ⭐ 15 | 🐛 0 | 🌐 Python | 📅 2025-08-25 🐍 🍎/🐧 ☁️ - mcp server for [cert-manager](https://github.com/cert-manager/cert-manager) ⭐ 13,423 | 🐛 217 | 🌐 Go | 📅 2025-12-27 management and troubleshooting
...
* [pydantic/pydantic-ai/mcp-run-python](https://github.com/pydantic/pydantic-ai/tree/main/mcp-run-python) ⭐ 14,002 | 🐛 406 | 🌐 Python | 📅 2025-12-27 🐍 🏠 - Run Python code in a secure sandbox via MCP tool calls
* [dagger/container-use](https://github.com/dagger/container-use) ⭐ 3,368 | 🐛 64 | 🌐 Go | 📅 2025-12-08 🏎️ 🏠 🐧 🍎 🪟 - Containerized environments for coding agents. Multiple agents can work independently, isolated in fresh containers and git branches. No conflicts, many experiments. Full execution history, terminal access to agent environments, git workflow. Any agent/model/infra stack.
...
* [oraios/serena](https://github.com/oraios/serena) ⭐ 17,773 | 🐛 79 | 🌐 Python | 📅 2025-12-27 🐍 🏠 - A fully-featured coding agent that relies on symbolic code operations by using language servers.
* [ezyang/codemcp](https://github.com/ezyang/codemcp) ⭐ 1,587 | 🐛 79 | 🌐 Python | 📅 2025-12-25 🐍 🏠 - Coding agent with basic read, write and command line tools.
* [rinadelph/Agent-MCP](https://github.com/rinadelph/Agent-MCP) ⭐ 1,091 | 🐛 15 | 🌐 TypeScript | 📅 2025-10-09 🐍 🏠 - A framework for creating multi-agent systems using MCP for coordinated AI collaboration, featuring task management, shared context, and RAG capabilities.
...
* [shashankss1205/codegraphcontext](https://github.com/Shashankss1205/CodeGraphContext) ⭐ 247 | 🐛 67 | 🌐 Python | 📅 2025-11-19 🐍 🏠 🍎 🪟 🐧 An MCP server that indexes local code into a graph database to provide context to AI assistants with a graphical code visualizations for humans.
...
* [nesquikm/mcp-rubber-duck](https://github.com/nesquikm/mcp-rubber-duck) ⭐ 120 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-08 📇 🏠 ☁️ - An MCP server that bridges to multiple OpenAI-compatible LLMs - your AI rubber duck debugging panel for explaining problems to various AI "ducks" and getting different perspectives
* [jinzcdev/leetcode-mcp-server](https://github.com/jinzcdev/leetcode-mcp-server) ⭐ 77 | 🐛 4 | 🌐 TypeScript | 📅 2025-05-31 📇 ☁️ - MCP server enabling automated access to **LeetCode**'s programming problems, solutions, submissions and public data with optional authentication for user-specific features (e.g., notes), supporting both `leetcode.com` (global) and `leetcode.cn` (China) sites.
...
* [sim-xia/blind-auditor](https://github.com/Sim-xia/Blind-Auditor) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2025-12-10 - 🐍 🏠 🍎 🪟 🐧 A zero-cost MCP server that forces AI to self-correct generation messages using prompt injection, independent self-audition and context isolation.
...
* [wonderwhy-er/DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) ⭐ 5,132 | 🐛 72 | 🌐 TypeScript | 📅 2025-12-24 📇 🏠 🍎 🪟 🐧 - A swiss-army-knife that can manage/execute programs and read/write/search/edit code and text files.
...
* [aymericzip/intlayer](https://github.com/aymericzip/intlayer) ⭐ 494 | 🐛 23 | 🌐 TypeScript | 📅 2025-12-27 📇 ☁️ 🏠 - A MCP Server that enhance your IDE with AI-powered assistance for Intlayer i18n / CMS tool: smart CLI access, access to the docs.
...
* [tufantunc/ssh-mcp](https://github.com/tufantunc/ssh-mcp) ⭐ 184 | 🐛 3 | 🌐 TypeScript | 📅 2025-12-15 📇 🏠 🐧 🪟 - MCP server exposing SSH control for Linux and Windows servers via Model Context Protocol. Securely execute remote shell commands with password or SSH key authentication.
...
* [elie222/inbox-zero](https://github.com/elie222/inbox-zero/tree/main/apps/mcp-server) ⭐ 9,645 | 🐛 84 | 🌐 TypeScript | 📅 2025-12-27 🐍 ☁️ - An MCP server for Inbox Zero. Adds functionality on top of Gmail like finding out which emails you need to reply to or need to follow up on.
* [lharries/whatsapp-mcp](https://github.com/lharries/whatsapp-mcp) ⭐ 5,169 | 🐛 92 | 🌐 Go | 📅 2025-07-13 🐍 🏎️ - An MCP server for searching your personal WhatsApp messages, contacts and sending messages to individuals or groups
...
* [saseq/discord-mcp](https://github.com/SaseQ/discord-mcp) ⭐ 141 | 🐛 1 | 🌐 Java | 📅 2025-08-11 ☕ 📇 🏠 💬 - A MCP server for the Discord integration. Enable your AI assistants to seamlessly interact with Discord. Enhance your Discord experience with powerful automation capabilities.
...
* [antv/mcp-server-chart](https://github.com/antvis/mcp-server-chart) ⭐ 3,376 | 🐛 10 | 🌐 TypeScript | 📅 2025-12-27 🎖️ 📇 ☁️ - A Model Context Protocol server for generating visual charts using [AntV](https://github.com/antvis).
* [hustcc/mcp-mermaid](https://github.com/hustcc/mcp-mermaid) ⭐ 345 | 🐛 4 | 🌐 TypeScript | 📅 2025-12-16 📇 🏠 - Generate [mermaid](https://mermaid.js.org/) diagram and chart with AI MCP dynamically.
...
* [googleapis/genai-toolbox](https://github.com/googleapis/genai-toolbox) ⭐ 11,969 | 🐛 165 | 🌐 Go | 📅 2025-12-27 🏎️ ☁️ - Open source MCP server specializing in easy, fast, and secure tools for Databases.

* [get-convex/convex-backend](https://stack.convex.dev/convex-mcp-server) 📇 ☁️ - Convex database integration to introspect tables, functions, and run oneoff queries ([Source](https://github.com/get-convex/convex-backend/blob/main/npm-packages/convex/src/cli/mcp.ts) ⭐ 8,708 | 🐛 112 | 🌐 Rust | 📅 2025-12-27)

* [bram2w/baserow](https://github.com/bram2w/baserow) ⭐ 3,616 | 🐛 1,043 | 🌐 Python | 📅 2025-12-26 - Baserow database integration with table search, list, and row create, read, update, and delete capabilities.
...
* [crystaldba/postgres-mcp](https://github.com/crystaldba/postgres-mcp) ⭐ 1,714 | 🐛 37 | 🌐 Python | 📅 2025-11-11 🐍 🏠 - All-in-one MCP server for Postgres development and operations, with tools for performance analysis, tuning, and health checks
...
* [benborla29/mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) ⭐ 1,014 | 🐛 31 | 🌐 JavaScript | 📅 2025-11-18 ☁️ 🏠 - MySQL database integration in NodeJS with configurable access controls and schema inspection
...
* [alexanderzuev/supabase-mcp-server](https://github.com/alexander-zuev/supabase-mcp-server) ⭐ 816 | 🐛 5 | 🌐 Python | 📅 2025-09-26 - Supabase MCP Server with support for SQL query execution and database exploration tools
...
* [xing5/mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) ⭐ 571 | 🐛 16 | 🌐 Python | 📅 2025-12-06 🐍 ☁️ - A Model Context Protocol server for interacting with Google Sheets. This server provides tools to create, read, update, and manage spreadsheets through the Google Sheets API.

* [neondatabase/mcp-server-neon](https://github.com/neondatabase/mcp-server-neon) ⭐ 531 | 🐛 19 | 🌐 TypeScript | 📅 2025-12-24 📇 ☁️ — An MCP Server for creating and managing Postgres databases using Neon Serverless Postgres
...
* [chroma-core/chroma-mcp](https://github.com/chroma-core/chroma-mcp) ⭐ 451 | 🐛 20 | 🌐 Python | 📅 2025-09-17 🎖️ 🐍 ☁️ 🏠 - Chroma MCP server to access local and cloud Chroma instances for retrieval capabilities
...
* [domdomegg/airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server) ⭐ 375 | 🐛 8 | 🌐 TypeScript | 📅 2025-12-17 📇 🏠 - Airtable database integration with schema inspection, read and write capabilities

* [redis/mcp-redis](https://github.com/redis/mcp-redis) ⭐ 373 | 🐛 7 | 🌐 Python | 📅 2025-12-15 🐍 🏠 - The Redis official MCP Server offers an interface to manage and search data in Redis.
...
* [pab1it0/prometheus-mcp-server](https://github.com/pab1it0/prometheus-mcp-server) ⭐ 325 | 🐛 2 | 🌐 Python | 📅 2025-12-17 🐍 ☁️ -  Query and analyze Prometheus, open-source monitoring system.
...
* [kiliczsh/mcp-mongo-server](https://github.com/kiliczsh/mcp-mongo-server) ⭐ 270 | 🐛 2 | 🌐 TypeScript | 📅 2025-05-27 📇 🏠 - A Model Context Protocol Server for MongoDB
...
* [weaviate/mcp-server-weaviate](https://github.com/weaviate/mcp-server-weaviate) ⭐ 160 | 🐛 5 | 🌐 Go | 📅 2025-05-22 🐍 📇 ☁️ - An MCP Server to connect to your Weaviate collections as a knowledge base as well as using Weaviate as a chat memory store.
...
* [confluentinc/mcp-confluent](https://github.com/confluentinc/mcp-confluent) ⭐ 124 | 🐛 9 | 🌐 TypeScript | 📅 2025-12-27 🐍 ☁️ - Confluent integration to interact with Confluent Kafka and Confluent Cloud REST APIs.
...
* [memgraph/mcp-memgraph](https://github.com/memgraph/ai-toolkit/tree/main/integrations/mcp-memgraph) ⭐ 65 | 🐛 25 | 🌐 Python | 📅 2025-12-19 🐍 🏠 - Memgraph MCP Server - includes a tool to run a query against Memgraph and a schema resource.
...
* [rashidazarang/airtable-mcp](https://github.com/rashidazarang/airtable-mcp) ⭐ 60 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-26 🐍 ☁️ - Connect AI tools directly to Airtable. Query, create, update, and delete records using natural language. Features include base management, table operations, schema manipulation, record filtering, and data migration through a standardized MCP interface.
...
* [ferrants/memvid-mcp-server](https://github.com/ferrants/memvid-mcp-server) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2025-06-20 🐍 🏠 - Python Streamable HTTP Server you can run locally to interact with [memvid](https://github.com/Olow304/memvid) ⭐ 10,528 | 🐛 12 | 🌐 Python | 📅 2025-12-28 storage and semantic search.
...
* [dbt-labs/dbt-mcp](https://github.com/dbt-labs/dbt-mcp) ⭐ 447 | 🐛 23 | 🌐 Python | 📅 2025-12-19 🎖️ 🐍 🏠 ☁️ - Official MCP server for [dbt (data build tool)](https://www.getdbt.com/product/what-is-dbt) providing integration with dbt Core/Cloud CLI, project metadata discovery, model information, and semantic layer querying capabilities.
...
* [aywengo/kafka-schema-reg-mcp](https://github.com/aywengo/kafka-schema-reg-mcp) ⭐ 27 | 🐛 1 | 🌐 Python | 📅 2025-12-27 🐍 ☁️ 🏠 🍎 🪟 🐧 - Comprehensive Kafka Schema Registry MCP server with 48 tools for multi-registry management, schema migration, and enterprise features.
...
* [idosal/git-mcp](https://github.com/idosal/git-mcp) ⭐ 7,281 | 🐛 48 | 🌐 TypeScript | 📅 2025-08-22 📇 ☁️ - [gitmcp.io](https://gitmcp.io/) is a generic remote MCP server to connect to ANY [GitHub](https://www.github.com) repository or project for documentation
* [21st-dev/Magic-MCP](https://github.com/21st-dev/magic-mcp) ⭐ 4,044 | 🐛 21 | 🌐 TypeScript | 📅 2025-12-23 - Create crafted UI components inspired by the best 21st.dev design engineers.
* [haris-musa/excel-mcp-server](https://github.com/haris-musa/excel-mcp-server) ⭐ 3,028 | 🐛 37 | 🌐 Python | 📅 2025-12-22 🐍 🏠 - An Excel manipulation server providing workbook creation, data operations, formatting, and advanced features (charts, pivot tables, formulae).
* [mobile-next/mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 2,794 | 🐛 33 | 🌐 TypeScript | 📅 2025-12-09 📇 🏠 🐧 🍎 - MCP Server for Android/iOS application and device automation, development and app scraping. Simulator/Emulator/Physical devices like iPhone, Google Pixel, Samsung supported.
* [Jpisnice/shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,560 | 🐛 2 | 🌐 TypeScript | 📅 2025-12-26 📇 🏠 - MCP server that gives AI assistants seamless access to shadcn/ui v4 components, blocks, demos, and metadata.
* [cjo4m06/mcp-shrimp-task-manager](https://github.com/cjo4m06/mcp-shrimp-task-manager) ⭐ 1,938 | 🐛 37 | 🌐 JavaScript | 📅 2025-08-21 📇 ☁️ 🏠 – A programming-focused task management system that boosts coding agents like Cursor AI with advanced task memory, self-reflection, and dependency management. [ShrimpTaskManager](https://cjo4m06.github.io/mcp-shrimp-task-manager)
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 1,357 | 🐛 12 | 🌐 JavaScript | 📅 2025-12-16 📇 🏠 🍎 - A Model Context Protocol (MCP) server for interacting with iOS simulators. This server allows you to interact with iOS simulators by getting information about them, controlling UI interactions, and inspecting UI elements.
* [isaacphi/mcp-language-server](https://github.com/isaacphi/mcp-language-server) ⭐ 1,343 | 🐛 44 | 🌐 Go | 📅 2025-12-02 🏎️ 🏠 - MCP Language Server helps MCP enabled clients navigate codebases more easily by giving them access to semantic tools like get definition, references, rename, and diagnostics.
* [jetbrains/mcpProxy](https://github.com/JetBrains/mcpProxy) ⭐ 939 | 🐛 37 | 🌐 JavaScript | 📅 2025-12-02 🎖️ 📇 🏠 - Connect to JetBrains IDE
* [lpigeon/ros-mcp-server](https://github.com/lpigeon/ros-mcp-server) ⭐ 900 | 🐛 17 | 🌐 Python | 📅 2025-12-27 🐍 🏠 🍎 🪟 🐧 - The ROS MCP Server supports robot control by converting user-issued natural language commands into ROS or ROS2 control commands.
* [snaggle-ai/openapi-mcp-server](https://github.com/snaggle-ai/openapi-mcp-server) ⭐ 866 | 🐛 0 | 🌐 TypeScript | 📅 2025-10-26 🏎️ 🏠 - Connect any HTTP/REST API server using an Open API spec (v3)
...
* [admica/FileScopeMCP](https://github.com/admica/FileScopeMCP) ⭐ 272 | 🐛 8 | 🌐 HTML | 📅 2025-09-04 🐍 📇 🦀 - Analyzes your codebase identifying important files based on dependency relationships. Generates diagrams and importance scores, helping AI assistants understand the codebase.
* [public-ui/kolibri](https://github.com/public-ui/kolibri) ⭐ 240 | 🐛 159 | 🌐 TypeScript | 📅 2025-12-28 📇 ☁️ 🏠 - Streaming KoliBri MCP server (NPM: `@public-ui/mcp`) delivering 200+ guaranteed accessible web component samples, specs, docs, and scenarios via hosted HTTP endpoint or local `kolibri-mcp` CLI.
* [joshuarileydev/app-store-connect-mcp-server](https://github.com/JoshuaRileyDev/app-store-connect-mcp-server) ⭐ 238 | 🐛 6 | 🌐 TypeScript | 📅 2025-09-02 📇 🏠 - An MCP server to communicate with the App Store Connect API for iOS Developers
...
* [augmnt/augments-mcp-server](https://github.com/augmnt/augments-mcp-server) ⭐ 93 | 🐛 0 | 🌐 Python | 📅 2025-11-10 📇 ☁️ 🏠 - Transform Claude Code with intelligent, real-time access to 90+ framework documentation sources. Get accurate, up-to-date code generation that follows current best practices for React, Next.js, Laravel, FastAPI, Tailwind CSS, and more.
...
* [hloiseaufcms/mcp-gopls](https://github.com/hloiseaufcms/mcp-gopls) ⭐ 53 | 🐛 0 | 🌐 Go | 📅 2025-12-22 🏎️ 🏠 - A MCP server for interacting with [Go's Language Server Protocol (gopls)](https://github.com/golang/tools/tree/master/gopls) ⭐ 7,850 | 🐛 105 | 🌐 Go | 📅 2025-12-27 and benefit from advanced Go code analysis features.
...
* [veelenga/claude-mermaid](https://github.com/veelenga/claude-mermaid/) ⭐ 30 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-22 📇 🏠 🍎 🪟 🐧 - A Mermaid diagram rendering MCP server for Claude Code with live reload functionality, supporting multiple export formats (SVG, PNG, PDF) and themes.
* [api7/apisix-mcp](https://github.com/api7/apisix-mcp) ⭐ 29 | 🐛 2 | 🌐 TypeScript | 📅 2025-06-16 🎖️ 📇 🏠 MCP Server that support for querying and managing all resource in [Apache APISIX](https://github.com/apache/apisix) ⭐ 16,019 | 🐛 328 | 🌐 Lua | 📅 2025-12-26.
...
* [j4c0bs/mcp-server-sql-analyzer](https://github.com/j4c0bs/mcp-server-sql-analyzer) ⭐ 26 | 🐛 0 | 🌐 Python | 📅 2025-07-01 🐍 - MCP server that provides SQL analysis, linting, and dialect conversion using [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 8,746 | 🐛 7 | 🌐 Python | 📅 2025-12-26
...
* [themesberg/flowbite-mcp](https://github.com/themesberg/flowbite-mcp) ⭐ 23 | 🐛 0 | 🌐 JavaScript | 📅 2025-12-11 📇 🏠 🍎 🪟 🐧 - MCP server that provides AI assistance for an open-source UI framework based on Tailwind CSS
...
* [higress-group/higress-ops-mcp-server](https://github.com/higress-group/higress-ops-mcp-server) ⭐ 22 | 🐛 6 | 🌐 Python | 📅 2025-03-29 🐍 🏠 - MCP server that provides comprehensive tools for managing [Higress](https://github.com/alibaba/higress) ⭐ 7,166 | 🐛 703 | 🌐 Go | 📅 2025-12-26 gateway configurations and operations.
...
* [yiwenlu66/PiloTY](https://github.com/yiwenlu66/PiloTY) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2025-12-09 🐍 🏠 - AI pilot for PTY operations enabling agents to control interactive terminals with stateful sessions, SSH connections, and background process management
...
* [sbroenne/mcp-server-excel](https://github.com/sbroenne/mcp-server-excel) ⭐ 12 | 🐛 2 | 🌐 C# | 📅 2025-12-27 #️⃣ 🏠 🪟 - Full-featured Excel MCP server. 173 operations: Power Query, DAX, VBA, PivotTables, Tables, Charts, ranges, formatting. 100% Excel compatibility - uses Excel app instead of creating .xlsx files. Windows only.
...
* [narumiruna/gitingest-mcp](https://github.com/narumiruna/gitingest-mcp) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2025-11-21 🐍 🏠 - A MCP server that uses [gitingest](https://github.com/cyclotruc/gitingest) ⭐ 13,472 | 🐛 29 | 🌐 Python | 📅 2025-12-19 to convert any Git repository into a simple text digest of its codebase.
...
* [mckinsey/vizro-mcp](https://github.com/mckinsey/vizro/tree/main/vizro-mcp) ⭐ 3,508 | 🐛 49 | 🌐 Python | 📅 2025-12-27 🎖️ 🐍 🏠 - Tools and templates to create validated and maintainable data charts and dashboards.
...
* [datalayer/jupyter-mcp-server](https://github.com/datalayer/jupyter-mcp-server) ⭐ 830 | 🐛 20 | 🌐 Python | 📅 2025-12-25 🐍 🏠 - Model Context Protocol (MCP) Server for Jupyter.
* [DataEval/dingo](https://github.com/DataEval/dingo) ⭐ 603 | 🐛 6 | 🌐 JavaScript | 📅 2025-12-25 🎖️ 🐍 🏠 🍎 🪟 🐧 - MCP server for the Dingo: a comprehensive data quality evaluation tool. Server Enables interaction with Dingo's rule-based and LLM-based evaluation capabilities and rules\&prompts listing.
...
* [horw/esp-mcp](https://github.com/horw/esp-mcp) ⭐ 119 | 🐛 31 | 🌐 Python | 📅 2025-12-27 📟 - Workflow for fixing build issues in ESP32 series chips using ESP-IDF.
...
* [microsoft/markitdown](https://github.com/microsoft/markitdown/tree/main/packages/markitdown-mcp) ⭐ 84,690 | 🐛 408 | 🌐 Python | 📅 2025-12-01 🎖️ 🐍 🏠 - MCP tool access to MarkItDown -- a library that converts many file formats (local or remote) to Markdown for LLM consumption.
* [mickaelkerjean/filestash](https://github.com/mickael-kerjean/filestash/tree/master/server/plugin/plg_handler_mcp) ⭐ 13,258 | 🐛 59 | 🌐 JavaScript | 📅 2025-12-22 🏎️ ☁️ - Remote Storage Access: SFTP, S3, FTP, SMB, NFS, WebDAV, GIT, FTPS, gcloud, azure blob, sharepoint, etc.
* [mark3labs/mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server) ⭐ 568 | 🐛 17 | 🌐 Go | 📅 2025-11-24 🏎️ 🏠 - Golang implementation for local file system access.
...
* [Coding-Solo/godot-mcp](https://github.com/Coding-Solo/godot-mcp) ⭐ 1,266 | 🐛 32 | 🌐 JavaScript | 📅 2025-08-09 📇 🏠 - A MCP server for interacting with the Godot game engine, providing tools for editing, running, debugging, and managing scenes in Godot projects.
* [CoderGamester/mcp-unity](https://github.com/CoderGamester/mcp-unity) ⭐ 1,167 | 🐛 6 | 🌐 C# | 📅 2025-12-09 #️⃣ 🏠 - MCP Server for Unity3d Game Engine integration for game development
* [IvanMurzak/Unity-MCP](https://github.com/IvanMurzak/Unity-MCP) ⭐ 662 | 🐛 36 | 🌐 C# | 📅 2025-12-28 #️⃣ 🏠 🍎 🪟 🐧 - MCP Server for Unity Editor and for a game made with Unity
...
* [upstash/context7](https://github.com/upstash/context7) ⭐ 40,238 | 🐛 93 | 🌐 TypeScript | 📅 2025-12-26 📇 ☁️ - Up-to-date code documentation for LLMs and AI code editors.
* [topoteretes/cognee](https://github.com/topoteretes/cognee/tree/dev/cognee-mcp) ⭐ 10,621 | 🐛 29 | 🌐 Python | 📅 2025-12-23 📇 🏠 - Memory manager for AI apps and Agents using various graph and vector stores and allowing ingestion from 30+ data sources
...
* [apecloud/ApeRAG](https://github.com/apecloud/ApeRAG) ⭐ 992 | 🐛 51 | 🌐 Python | 📅 2025-12-06 🐍 ☁️ 🏠 - Production-ready RAG platform combining Graph RAG, vector search, and full-text search. Best choice for building your own Knowledge Graph and for Context Engineering
* [vectorize-io/hindsight](https://github.com/vectorize-io/hindsight) ⭐ 844 | 🐛 8 | 🌐 Python | 📅 2025-12-24 🐍 ☁️ 🏠 - Hindsight: Agent Memory That Works Like Human Memory - Built for AI Agents to manage Long Term Memory
...
* [pi22by7/In-Memoria](https://github.com/pi22by7/In-Memoria) ⭐ 132 | 🐛 4 | 🌐 Rust | 📅 2025-12-23 📇 🦀 🏠 🍎 🐧 🪟 - Persistent intelligence infrastructure for agentic development that gives AI coding assistants cumulative memory and pattern learning. Hybrid TypeScript/Rust implementation with local-first storage using SQLite + SurrealDB for semantic analysis and incremental codebase understanding.
* [entanglr/zettelkasten-mcp](https://github.com/entanglr/zettelkasten-mcp) ⭐ 129 | 🐛 12 | 🌐 Python | 📅 2025-04-25 🐍 🏠 - A Model Context Protocol (MCP) server that implements the Zettelkasten knowledge management methodology, allowing you to create, link, and search atomic notes through Claude and other MCP-compatible clients.
...
* [shinpr/mcp-local-rag](https://github.com/shinpr/mcp-local-rag) ⭐ 45 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-27 📇 🏠 - Privacy-first document search server running entirely locally. Supports semantic search over PDFs, DOCX, TXT, and Markdown files with LanceDB vector storage and local embeddings - no API keys or cloud services required.
...
* [JamesANZ/cross-llm-mcp](https://github.com/JamesANZ/cross-llm-mcp) ⭐ 10 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-28 📇 🏠 - An MCP server that enables cross-LLM communication and memory sharing, allowing different AI models to collaborate and share context across conversations.
* [Smart-AI-Memory/empathy-framework](https://github.com/Smart-AI-Memory/empathy-framework) ⭐ 8 | 🐛 8 | 🌐 HTML | 📅 2025-12-27 🐍 🏠 - Five-level AI collaboration system with persistent memory and anticipatory capabilities. MCP-native integration for Claude and other LLMs with local-first architecture via MemDocs.
...
* [QGIS MCP](https://github.com/jjsantos01/qgis_mcp) ⭐ 739 | 🐛 8 | 🌐 Python | 📅 2025-10-01 - connects QGIS Desktop to Claude AI through the MCP. This integration enables prompt-assisted project creation, layer loading, code execution, and more.
...
* [pipeboard-co/meta-ads-mcp](https://github.com/pipeboard-co/meta-ads-mcp) ⭐ 386 | 🐛 6 | 🌐 Python | 📅 2025-12-19 🐍 ☁️ 🏠 - Meta Ads automation that just works. Trusted by 10,000+ businesses to analyze performance, test creatives, optimize spend, and scale results — simply and reliably.
...
* [netdata/netdata#Netdata](https://github.com/netdata/netdata/blob/master/src/web/mcp/README.md) ⭐ 77,152 | 🐛 243 | 🌐 C | 📅 2025-12-28 🎖️ 🏠 ☁️ 📟 🍎 🪟 🐧 - Discovery, exploration, reporting and root cause analysis using all observability data, including metrics, logs, systems, containers, processes, and network connections
* [grafana/mcp-grafana](https://github.com/grafana/mcp-grafana) ⭐ 2,033 | 🐛 63 | 🌐 Go | 📅 2025-12-26 🎖️ 🐍 🏠 ☁️ - Search dashboards, investigate incidents and query datasources in your Grafana instance
...
* [tumf/grafana-loki-mcp](https://github.com/tumf/grafana-loki-mcp) ⭐ 17 | 🐛 1 | 🌐 Python | 📅 2025-12-27 🐍 🏠 - An MCP server that allows querying Loki logs through the Grafana API.
...
* [exa-labs/exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) ⭐ 3,454 | 🐛 25 | 🌐 TypeScript | 📅 2025-12-22 🎖️ 📇 ☁️ – A Model Context Protocol (MCP) server lets AI assistants like Claude use the Exa AI Search API for web searches. This setup allows AI models to get real-time web information in a safe and controlled way.
* [devflowinc/trieve](https://github.com/devflowinc/trieve/tree/main/clients/mcp-server) ⭐ 2,588 | 🐛 2 | 🌐 Rust | 📅 2025-10-10 🎖️ 📇 ☁️ 🏠 - Crawl, embed, chunk, search, and retrieve information from datasets through [Trieve](https://trieve.ai)
...
* [luminati-io/brightdata-mcp](https://github.com/luminati-io/brightdata-mcp) ⭐ 1,803 | 🐛 15 | 🌐 JavaScript | 📅 2025-12-21 📇 ☁️ - Discover, extract, and interact with the web - one interface powering automated access across the public internet.
* [jae-jae/fetcher-mcp](https://github.com/jae-jae/fetcher-mcp) ⭐ 942 | 🐛 8 | 🌐 TypeScript | 📅 2025-11-24 📇 🏠 - MCP server for fetching web page content using Playwright headless browser, supporting Javascript rendering and intelligent content extraction, and outputting Markdown or HTML format.
...
* [Aas-ee/open-webSearch](https://github.com/Aas-ee/open-webSearch) ⭐ 547 | 🐛 9 | 🌐 TypeScript | 📅 2025-10-26 🐍 📇 ☁️ - Web search using free multi-engine search (NO API KEYS REQUIRED) — Supports Bing, Baidu, DuckDuckGo, Brave, Exa, and CSDN.
...
* [kagisearch/kagimcp](https://github.com/kagisearch/kagimcp) ⭐ 244 | 🐛 5 | 🌐 Python | 📅 2025-11-17 ☁️ 📇 – Official Kagi Search MCP Server
...
* [tinyfish-io/agentql-mcp](https://github.com/tinyfish-io/agentql-mcp) ⭐ 137 | 🐛 2 | 🌐 JavaScript | 📅 2025-12-27 🎖️ 📇 ☁️ - MCP server that provides [AgentQL](https://agentql.com)'s data extraction capabilities.
...
* [imprvhub/mcp-domain-availability](https://github.com/imprvhub/mcp-domain-availability) ⭐ 30 | 🐛 0 | 🌐 Python | 📅 2025-10-30 🐍 ☁️ - A Model Context Protocol (MCP) server that enables Claude Desktop to check domain availability across 50+ TLDs. Features DNS/WHOIS verification, bulk checking, and smart suggestions. Zero-clone installation via uvx.
...
* [Crawleo/Crawleo-MCP](https://github.com/Crawleo/Crawleo-MCP) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2025-12-27 ☁️ 🐍 – Crawleo Search & Crawl API
...
* [Crawleo/Crawleo-MCP](https://github.com/Crawleo/Crawleo-MCP) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2025-12-27 ☁️ 🐍 – Crawleo search & Crawling API
...
* [boikot-xyz/boikot](https://github.com/boikot-xyz/boikot) ⭐ 4 | 🐛 0 | 🌐 HTML | 📅 2025-12-27 🦀☁️ - Model Context Protocol Server for looking up company ethics information. Learn about the ethical and unethical actions of major companies.
...
* [LaurieWired/GhidraMCP](https://github.com/LaurieWired/GhidraMCP) ⭐ 6,825 | 🐛 53 | 🌐 Java | 📅 2025-06-23 ☕ 🏠 - A Model Context Protocol server for Ghidra that enables LLMs to autonomously reverse engineer applications. Provides tools for decompiling binaries, renaming methods and data, and listing methods, classes, imports, and exports.
* [mrexodia/ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) ⭐ 4,763 | 🐛 35 | 🌐 Python | 📅 2025-12-20 🐍 🏠 - MCP server for IDA Pro, allowing you to perform binary analysis with AI assistants. This plugin implement decompilation, disassembly and allows you to generate malware analysis reports automatically.
* [mariocandela/beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,778 | 🐛 6 | 🌐 Go | 📅 2025-12-24 ☁️ - Beelzebub is a honeypot framework that lets you build honeypot tools using MCP. Its purpose is to detect prompt injection or malicious agent behavior. The underlying idea is to provide the agent with tools it would never use in its normal work.
* [zinja-coder/jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp) ⭐ 938 | 🐛 7 | 🌐 Java | 📅 2025-12-27 ☕ 🏠 - JADX-AI-MCP is a plugin and MCP Server for the JADX decompiler that integrates directly with Model Context Protocol (MCP) to provide live reverse engineering support with LLMs like Claude.
* [safedep/vet](https://github.com/safedep/vet/blob/main/docs/mcp.md) ⭐ 922 | 🐛 91 | 🌐 Go | 📅 2025-12-16 🎖️ 🏎️ ☁️ 🍎 🪟 🐧 - vet-mcp checks open source packages—like those suggested by AI coding tools—for vulnerabilities and malicious code. It supports npm and PyPI, and runs locally via Docker or as a standalone binary for fast, automated vetting.
...
* [fosdickio/binary\_ninja\_mcp](https://github.com/fosdickio/binary_ninja_mcp) ⭐ 146 | 🐛 18 | 🌐 Python | 📅 2025-12-23 🐍 🏠 🍎 🪟 🐧 - A Binary Ninja plugin, MCP server, and bridge that seamlessly integrates [Binary Ninja](https://binary.ninja) with your favorite MCP client.  It enables you to automate the process of performing binary analysis and reverse engineering.
...
* [HagaiHen/facebook-mcp-server](https://github.com/HagaiHen/facebook-mcp-server) ⭐ 89 | 🐛 1 | 🌐 Python | 📅 2025-08-20 🐍 ☁️ - Integrates with Facebook Pages to enable direct management of posts, comments, and engagement metrics through the Graph API for streamlined social media management.
...
* [mbailey/voice-mcp](https://github.com/mbailey/voice-mcp) ⭐ 524 | 🐛 20 | 🌐 Python | 📅 2025-12-27 🐍 🏠 - Complete voice interaction server supporting speech-to-text, text-to-speech, and real-time voice conversations through local microphone, OpenAI-compatible APIs, and LiveKit integration
...
* [r-huijts/ns-mcp-server](https://github.com/r-huijts/ns-mcp-server) ⭐ 44 | 🐛 2 | 🌐 TypeScript | 📅 2025-08-26 📇 ☁️ - Access Dutch Railways (NS) travel information, schedules, and real-time updates
...
* [github/github-mcp-server](https://github.com/github/github-mcp-server) ⭐ 25,466 | 🐛 258 | 🌐 Go | 📅 2025-12-24 📇 ☁️ - Official GitHub server for integration with repository management, PRs, issues, and more.
...
* [taylorwilsdon/google\_workspace\_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) ⭐ 1,031 | 🐛 33 | 🌐 Python | 📅 2025-12-27 🐍 ☁️ 🍎 🪟 🐧 - Comprehensive Google Workspace MCP server with full support for Google Calendar, Drive, Gmail, and Docs, Forms, Chats, Slides and Sheets over stdio, Streamable HTTP and SSE transports.
...
* [modelcontextprotocol/server-everything](https://github.com/modelcontextprotocol/servers/tree/main/src/everything) ⭐ 75,105 | 🐛 254 | 🌐 TypeScript | 📅 2025-12-19 📇 🏠 - MCP server that exercises all the features of the MCP protocol
* [mediar-ai/screenpipe](https://github.com/mediar-ai/screenpipe) ⭐ 16,282 | 🐛 237 | 🌐 TypeScript | 📅 2025-12-09 - 🎖️ 🦀 🏠 🍎 Local-first system capturing screen/audio with timestamped indexing, SQL/embedding storage, semantic search, LLM-powered history analysis, and event-triggered actions - enables building context-aware AI agents through a NextJS plugin ecosystem.
* [Klavis-AI/YouTube](https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/youtube) ⭐ 5,556 | 🐛 52 | 🌐 Python | 📅 2025-12-25 🐍 📇 - Extract and convert YouTube video information.
* [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 3,857 | 🐛 171 | 🌐 Python | 📅 2025-11-26 🐍 ☁️ - MCP server for Atlassian products (Confluence and Jira). Supports Confluence Cloud, Jira Cloud, and Jira Server/Data Center. Provides comprehensive tools for searching, reading, creating, and managing content across Atlassian workspaces.
* [metorial/metorial](https://github.com/metorial/metorial) ⭐ 3,192 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-28 - 🎖️ 📇 ☁️ Connect AI agents to 600+ integrations with a single interface - OAuth, scaling, and monitoring included
* [MarkusPfundstein/mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian) ⭐ 2,589 | 🐛 68 | 🌐 Python | 📅 2025-06-28 🐍 ☁️ 🏠 - Interacting with Obsidian via REST API
* [chrishayuk/mcp-cli](https://github.com/chrishayuk/mcp-cli) ⭐ 1,787 | 🐛 21 | 🌐 Python | 📅 2025-12-17 🐍 🏠 - Yet another CLI tool for testing MCP servers
...
* [caol64/wenyan-mcp](https://github.com/caol64/wenyan-mcp) ⭐ 949 | 🐛 24 | 🌐 JavaScript | 📅 2025-10-31 📇 🏠 🍎 🪟 🐧 - Wenyan MCP Server, which lets AI automatically format Markdown articles and publish them to WeChat GZH.
...
* [rusiaaman/wcgw](https://github.com/rusiaaman/wcgw/blob/main/src/wcgw/client/mcp_server/Readme.md) ⭐ 627 | 🐛 6 | 🌐 Python | 📅 2025-12-25 🐍 🏠 - Autonomous shell execution, computer control and coding agent. (Mac)
* [tevonsb/homeassistant-mcp](https://github.com/tevonsb/homeassistant-mcp) ⭐ 503 | 🐛 16 | 🌐 TypeScript | 📅 2025-02-01 📇 🏠 - Access Home Assistant data and control devices (lights, switches, thermostats, etc).
...
* [wong2/mcp-cli](https://github.com/wong2/mcp-cli) ⭐ 398 | 🐛 10 | 🌐 JavaScript | 📅 2025-08-13 📇 🏠 - CLI tool for testing MCP servers
...
* [ttommyth/interactive-mcp](https://github.com/ttommyth/interactive-mcp) ⭐ 328 | 🐛 8 | 🌐 TypeScript | 📅 2025-11-20 📇 🏠 🍎 🪟 🐧 - Enables interactive LLM workflows by adding local user prompts and chat capabilities directly into the MCP loop.
...
* [roychri/mcp-server-asana](https://github.com/roychri/mcp-server-asana) ⭐ 112 | 🐛 12 | 🌐 TypeScript | 📅 2025-05-21 - 📇 ☁️ This Model Context Protocol server implementation of Asana allows you to talk to Asana API from MCP Client such as Anthropic's Claude Desktop Application, and many more.
...
* [FastMCP](https://github.com/jlowin/fastmcp) ⭐ 21,488 | 🐛 224 | 🌐 Python | 📅 2025-12-27 🐍 - A high-level framework for building MCP servers in Python
* [FastMCP](https://github.com/punkpeye/fastmcp) ⭐ 2,847 | 🐛 37 | 🌐 TypeScript | 📅 2025-12-27 📇 - A high-level framework for building MCP servers in TypeScript
