...
Checkout [awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients/) ⭐ 6,141 | 🐛 53 | 📅 2025-12-23 and [glama.ai/mcp/clients](https://glama.ai/mcp/clients).
...
* [mindsdb/mindsdb](https://github.com/mindsdb/mindsdb) ⭐ 38,139 | 🐛 186 | 🌐 Python | 📅 2025-12-30 - Connect and unify data across various platforms and databases with [MindsDB as a single MCP server](https://docs.mindsdb.com/mcp/overview).
* [PipedreamHQ/pipedream](https://github.com/PipedreamHQ/pipedream/tree/master/modelcontextprotocol) ⭐ 10,927 | 🐛 4,347 | 🌐 JavaScript | 📅 2025-12-31 ☁️ 🏠 - Connect with 2,500 APIs with 8,000+ prebuilt tools, and manage servers for your users, in your own app.
* [metatool-ai/metatool-app](https://github.com/metatool-ai/metatool-app) ⭐ 1,836 | 🐛 59 | 🌐 TypeScript | 📅 2025-12-23 📇 ☁️ 🏠 🍎 🪟 🐧 - MetaMCP is the one unified middleware MCP server that manages your MCP connections with GUI.
* [julien040/anyquery](https://github.com/julien040/anyquery) ⭐ 1,575 | 🐛 8 | 🌐 Go | 📅 2025-11-11 🏎️ 🏠 ☁️ - Query more than 40 apps with one binary using SQL. It can also connect to your PostgreSQL, MySQL, or SQLite compatible database. Local-first and private by design.
* [duaraghav8/MCPJungle](https://github.com/duaraghav8/MCPJungle) ⭐ 760 | 🐛 47 | 🌐 Go | 📅 2025-12-30 🏎️ 🏠 - Self-hosted MCP Server registry for enterprise AI Agents
* [TheLunarCompany/lunar#mcpx](https://github.com/TheLunarCompany/lunar/tree/main/mcpx) ⭐ 377 | 🐛 5 | 🌐 TypeScript | 📅 2025-12-30 📇 🏠  ☁️ 🍎 🪟 🐧 - MCPX is a production-ready, open-source gateway to manage MCP servers at scale—centralize tool discovery, access controls, call prioritization, and usage tracking to simplify agent workflows.
...
* [K-Dense-AI/claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp) ⭐ 207 | 🐛 3 | 🌐 Python | 📅 2025-11-11 🐍 ☁️ 🏠 🍎 🪟 🐧 - Intelligent search capabilities to let every model and client use [Claude Agent Skills](https://www.anthropic.com/news/skills) like native.
...
* [juspay/neurolink](https://github.com/juspay/neurolink) ⭐ 102 | 🐛 401 | 🌐 TypeScript | 📅 2025-12-30 📇 ☁️ 🏠 🍎 🪟 🐧 - Making enterprise AI infrastructure universally accessible. Edge-first platform unifying 12 providers and 100+ models with multi-agent orchestration, HITL workflows, guardrails middleware, and context summarization.
...
* [portel-dev/ncp](https://github.com/portel-dev/ncp) ⭐ 55 | 🐛 1 | 🌐 JavaScript | 📅 2025-12-30 📇 ☁️ 🏠 🍎 🪟 🐧 - NCP orchestrates your entire MCP ecosystem through intelligent discovery, eliminating token overhead while maintaining 98.2% accuracy.
* [askbudi/roundtable](https://github.com/askbudi/roundtable) ⭐ 51 | 🐛 3 | 🌐 Python | 📅 2025-10-06 📇 ☁️ 🏠 🍎 🪟 🐧 - Meta-MCP server that unifies multiple AI coding assistants (Codex, Claude Code, Cursor, Gemini) through intelligent auto-discovery and standardized MCP interface, providing zero-configuration access to the entire AI coding ecosystem.
...
* [ahujasid/blender-mcp](https://github.com/ahujasid/blender-mcp) ⭐ 14,680 | 🐛 35 | 🌐 Python | 📅 2025-12-08 🐍 - MCP server for working with Blender
...
* [raveenb/fal-mcp-server](https://github.com/raveenb/fal-mcp-server) ⭐ 19 | 🐛 22 | 🌐 Python | 📅 2025-12-23 🐍 ☁️ - Generate AI images, videos, and music using Fal.ai models (FLUX, Stable Diffusion, MusicGen) directly in Claude Desktop
...
* [genomoncology/biomcp](https://github.com/genomoncology/biomcp) ⭐ 380 | 🐛 14 | 🌐 Python | 📅 2025-12-18 🐍 ☁️ - Biomedical research MCP server providing access to PubMed, ClinicalTrials.gov, and MyVariant.info.
...
* [the-momentum/fhir-mcp-server](https://github.com/the-momentum/fhir-mcp-server) ⭐ 48 | 🐛 6 | 🌐 Python | 📅 2025-10-23 🐍 🏠 ☁️ - MCP Server that connects AI agents to FHIR servers. One example use case is querying patient history in natural language.
...
* [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) ⭐ 24,939 | 🐛 32 | 🌐 TypeScript | 📅 2025-12-31 - Official Microsoft Playwright MCP server, enabling LLMs to interact with web pages through structured accessibility snapshots
* [agent-infra/mcp-server-browser](https://github.com/bytedance/UI-TARS-desktop/tree/main/packages/agent-infra/mcp-servers/browser) ⭐ 20,302 | 🐛 312 | 🌐 TypeScript | 📅 2025-12-25 📇 🏠 - Browser automation capabilities using Puppeteer, both support local and remote browser connection.
* [browsermcp/mcp](https://github.com/browsermcp/mcp) ⭐ 5,305 | 🐛 103 | 🌐 TypeScript | 📅 2025-04-24 📇 🏠 - Automate your local Chrome browser
* [executeautomation/playwright-mcp-server](https://github.com/executeautomation/mcp-playwright) ⭐ 5,100 | 🐛 17 | 🌐 TypeScript | 📅 2025-12-13 📇 - An MCP server using Playwright for browser automation and webscrapping
* [browserbase/mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase) ⭐ 2,997 | 🐛 25 | 🌐 TypeScript | 📅 2025-12-10 🎖️ 📇 - Automate browser interactions in the cloud (e.g. web navigation, data extraction, form filling, and more)
...
* [co-browser/browser-use-mcp-server](https://github.com/co-browser/browser-use-mcp-server) ⭐ 789 | 🐛 15 | 🌐 Python | 📅 2025-07-10 🐍 - browser-use packaged as an MCP server with SSE transport. includes a dockerfile to run chromium in docker + a vnc server.
* [pskill9/web-search](https://github.com/pskill9/web-search) ⭐ 382 | 🐛 7 | 🌐 JavaScript | 📅 2024-12-30 📇 🏠 - An MCP server that enables free web searching using Google search results, with no API keys required.
...
* [freema/firefox-devtools-mcp](https://github.com/freema/firefox-devtools-mcp) ⭐ 20 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-10 📇 🏠 - Firefox browser automation via WebDriver BiDi for testing, scraping, and browser control. Supports snapshot/UID-based interactions, network monitoring, console capture, and screenshots.
...
* [awslabs/mcp](https://github.com/awslabs/mcp) ⭐ 7,749 | 🐛 205 | 🌐 Python | 📅 2025-12-31 🎖️ ☁️ - AWS MCP servers for seamless integration with AWS services and resources.
* [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) ⭐ 3,233 | 🐛 46 | 🌐 TypeScript | 📅 2025-12-22 🎖️ 📇 ☁️ - Integration with Cloudflare services including Workers, KV, R2, and D1
* [flux159/mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) ⭐ 1,237 | 🐛 11 | 🌐 TypeScript | 📅 2025-12-28 📇 ☁️/🏠 - Typescript implementation of Kubernetes cluster operations for pods, deployments, services.
* [manusa/Kubernetes MCP Server](https://github.com/manusa/kubernetes-mcp-server) ⭐ 925 | 🐛 51 | 🌐 Go | 📅 2025-12-23 🏎️ 🏠 A - powerful Kubernetes MCP server with additional support for OpenShift. Besides providing CRUD operations for **any** Kubernetes resource, this server provides specialized tools to interact with your cluster.
...
* [weibaohui/k8m](https://github.com/weibaohui/k8m) ⭐ 745 | 🐛 18 | 🌐 Go | 📅 2025-12-30 🏎️ ☁️/🏠 - Provides MCP multi-cluster Kubernetes management and operations, featuring a management interface, logging, and nearly 50 built-in tools covering common DevOps and development scenarios. Supports both standard and CRD resources.
...
* [StacklokLabs/mkp](https://github.com/StacklokLabs/mkp) ⭐ 55 | 🐛 8 | 🌐 Go | 📅 2025-12-26 🏎️ ☁️ - MKP is a Model Context Protocol (MCP) server for Kubernetes that allows LLM-powered applications to interact with Kubernetes clusters. It provides tools for listing and applying Kubernetes resources through the MCP protocol.
...
* [pibblokto/cert-manager-mcp-server](https://github.com/pibblokto/cert-manager-mcp-server) ⭐ 20 | 🐛 0 | 🌐 Python | 📅 2025-08-25 🐍 🍎/🐧 ☁️ - mcp server for [cert-manager](https://github.com/cert-manager/cert-manager) ⭐ 13,427 | 🐛 215 | 🌐 Go | 📅 2025-12-29 management and troubleshooting
...
* [pydantic/pydantic-ai/mcp-run-python](https://github.com/pydantic/pydantic-ai/tree/main/mcp-run-python) ⭐ 14,060 | 🐛 416 | 🌐 Python | 📅 2025-12-30 🐍 🏠 - Run Python code in a secure sandbox via MCP tool calls
* [dagger/container-use](https://github.com/dagger/container-use) ⭐ 3,374 | 🐛 64 | 🌐 Go | 📅 2025-12-08 🏎️ 🏠 🐧 🍎 🪟 - Containerized environments for coding agents. Multiple agents can work independently, isolated in fresh containers and git branches. No conflicts, many experiments. Full execution history, terminal access to agent environments, git workflow. Any agent/model/infra stack.
...
* [oraios/serena](https://github.com/oraios/serena) ⭐ 17,916 | 🐛 81 | 🌐 Python | 📅 2025-12-28 🐍 🏠 - A fully-featured coding agent that relies on symbolic code operations by using language servers.
...
* [shashankss1205/codegraphcontext](https://github.com/Shashankss1205/CodeGraphContext) ⭐ 292 | 🐛 54 | 🌐 Python | 📅 2025-12-31 🐍 🏠 🍎 🪟 🐧 An MCP server that indexes local code into a graph database to provide context to AI assistants with a graphical code visualizations for humans.
...
* [stippi/code-assistant](https://github.com/stippi/code-assistant) ⭐ 124 | 🐛 2 | 🌐 Rust | 📅 2025-12-26 🦀 🏠 - Coding agent with basic list, read, replace\_in\_file, write, execute\_command and web search tools. Supports multiple projects concurrently.
...
* [askbudi/roundtable](https://github.com/askbudi/roundtable) ⭐ 51 | 🐛 3 | 🌐 Python | 📅 2025-10-06 🐍 🏠 - Zero-configuration MCP server that unifies multiple AI coding assistants (Claude Code, Cursor, Codex) through intelligent auto-discovery and standardized interface. Essential infrastructure for autonomous agent development and multi-AI collaboration workflows.
...
* [wonderwhy-er/DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) ⭐ 5,144 | 🐛 72 | 🌐 TypeScript | 📅 2025-12-30 📇 🏠 🍎 🪟 🐧 - A swiss-army-knife that can manage/execute programs and read/write/search/edit code and text files.
* [louis030195/terminator-mcp-agent](https://github.com/mediar-ai/terminator/tree/main/terminator-mcp-agent) ⭐ 1,227 | 🐛 10 | 🌐 Rust | 📅 2025-12-23 🦀 📇 🏠 🍎 🪟 🐧 - Desktop GUI automation using accessibility APIs. Control Windows, macOS, and Linux applications without vision models or screenshots. Supports workflow recording, structured data extraction, and browser DOM inspection.
* [aymericzip/intlayer](https://github.com/aymericzip/intlayer) ⭐ 509 | 🐛 23 | 🌐 TypeScript | 📅 2025-12-31 📇 ☁️ 🏠 - A MCP Server that enhance your IDE with AI-powered assistance for Intlayer i18n / CMS tool: smart CLI access, access to the docs.
...
* [tufantunc/ssh-mcp](https://github.com/tufantunc/ssh-mcp) ⭐ 191 | 🐛 3 | 🌐 TypeScript | 📅 2025-12-15 📇 🏠 🐧 🪟 - MCP server exposing SSH control for Linux and Windows servers via Model Context Protocol. Securely execute remote shell commands with password or SSH key authentication.
...
* [aybelatchane/mcp-server-terminal](https://github.com/aybelatchane/mcp-server-terminal) ⭐ 4 | 🐛 3 | 🌐 Rust | 📅 2025-12-30 🦀 🏠 🍎 🪟 🐧 - Playwright for terminals - interact with TUI/CLI applications through structured Terminal State Tree representation with element detection.

### 💬 <a name="communication"></a>Communication

Integration with communication platforms for message management and channel operations. Enables AI models to interact with team communication tools.

* [elie222/inbox-zero](https://github.com/elie222/inbox-zero/tree/main/apps/mcp-server) ⭐ 9,657 | 🐛 87 | 🌐 TypeScript | 📅 2025-12-31 🐍 ☁️ - An MCP server for Inbox Zero. Adds functionality on top of Gmail like finding out which emails you need to reply to or need to follow up on.
* [lharries/whatsapp-mcp](https://github.com/lharries/whatsapp-mcp) ⭐ 5,177 | 🐛 93 | 🌐 Go | 📅 2025-07-13 🐍 🏎️ - An MCP server for searching your personal WhatsApp messages, contacts and sending messages to individuals or groups
* [korotovsky/slack-mcp-server](https://github.com/korotovsky/slack-mcp-server) ⭐ 1,042 | 🐛 30 | 🌐 Go | 📅 2025-12-25 📇 ☁️ - The most powerful MCP server for Slack Workspaces.
* [chigwell/telegram-mcp](https://github.com/chigwell/telegram-mcp) ⭐ 519 | 🐛 6 | 🌐 Python | 📅 2025-12-29 🐍 🏠 - Telegram API integration for accessing user data, managing dialogs (chats, channels, groups), retrieving messages, sending messages and handling read status.
...
* [joinly-ai/joinly](https://github.com/joinly-ai/joinly) ⭐ 417 | 🐛 3 | 🌐 Python | 📅 2025-12-01 🐍☁️ - MCP server to interact with browser-based meeting platforms (Zoom, Teams, Google Meet). Enables AI agents to send bots to online meetings, gather live transcripts, speak text, and send messages in the meeting chat.
* [softeria/ms-365-mcp-server](https://github.com/softeria/ms-365-mcp-server) ⭐ 372 | 🐛 5 | 🌐 TypeScript | 📅 2025-12-30 📇 ☁️ - MCP server that connects to Microsoft Office and the whole Microsoft 365 suite using Graph API (including Outlook, mail, files, Excel, calendar)
...
* [antv/mcp-server-chart](https://github.com/antvis/mcp-server-chart) ⭐ 3,395 | 🐛 11 | 🌐 TypeScript | 📅 2025-12-29 🎖️ 📇 ☁️ - A Model Context Protocol server for generating visual charts using [AntV](https://github.com/antvis).
...
* [googleapis/genai-toolbox](https://github.com/googleapis/genai-toolbox) ⭐ 11,998 | 🐛 158 | 🌐 Go | 📅 2025-12-31 🏎️ ☁️ - Open source MCP server specializing in easy, fast, and secure tools for Databases.

* [get-convex/convex-backend](https://stack.convex.dev/convex-mcp-server) 📇 ☁️ - Convex database integration to introspect tables, functions, and run oneoff queries ([Source](https://github.com/get-convex/convex-backend/blob/main/npm-packages/convex/src/cli/mcp.ts) ⭐ 8,768 | 🐛 115 | 🌐 Rust | 📅 2025-12-29)

* [bram2w/baserow](https://github.com/bram2w/baserow) ⭐ 3,637 | 🐛 1,048 | 🌐 Python | 📅 2025-12-30 - Baserow database integration with table search, list, and row create, read, update, and delete capabilities.

* [supabase-community/supabase-mcp](https://github.com/supabase-community/supabase-mcp) ⭐ 2,351 | 🐛 71 | 🌐 TypeScript | 📅 2025-12-30 🎖️ 📇 ☁️ - Official Supabase MCP server to connect AI assistants directly with your Supabase project and allows them to perform tasks like managing tables, fetching config, and querying data.

* [crystaldba/postgres-mcp](https://github.com/crystaldba/postgres-mcp) ⭐ 1,728 | 🐛 37 | 🌐 Python | 📅 2025-11-11 🐍 🏠 - All-in-one MCP server for Postgres development and operations, with tools for performance analysis, tuning, and health checks

* [qdrant/mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant) ⭐ 1,150 | 🐛 34 | 🌐 Python | 📅 2025-12-10 🐍 🏠 - A Qdrant MCP server

* [designcomputer/mysql\_mcp\_server](https://github.com/designcomputer/mysql_mcp_server) ⭐ 1,047 | 🐛 52 | 🌐 Python | 📅 2025-06-05 🐍 🏠 - MySQL database integration with configurable access controls, schema inspection, and comprehensive security guidelines

* [benborla29/mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) ⭐ 1,025 | 🐛 32 | 🌐 JavaScript | 📅 2025-11-18 ☁️ 🏠 - MySQL database integration in NodeJS with configurable access controls and schema inspection

* [neo4j-contrib/mcp-neo4j](https://github.com/neo4j-contrib/mcp-neo4j) ⭐ 859 | 🐛 27 | 🌐 Python | 📅 2025-12-22 🐍 🏠 - Model Context Protocol with Neo4j (Run queries, Knowledge Graph Memory, Manaage Neo4j Aura Instances)
...
* [xing5/mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) ⭐ 574 | 🐛 16 | 🌐 Python | 📅 2025-12-06 🐍 ☁️ - A Model Context Protocol server for interacting with Google Sheets. This server provides tools to create, read, update, and manage spreadsheets through the Google Sheets API.

* [neondatabase/mcp-server-neon](https://github.com/neondatabase/mcp-server-neon) ⭐ 531 | 🐛 14 | 🌐 TypeScript | 📅 2025-12-30 📇 ☁️ — An MCP Server for creating and managing Postgres databases using Neon Serverless Postgres

* [Canner/wren-engine](https://github.com/Canner/wren-engine) ⭐ 521 | 🐛 50 | 🌐 Java | 📅 2025-12-31 🐍 🦀 🏠 - The Semantic Engine for Model Context Protocol(MCP) Clients and AI Agents
...
* [domdomegg/airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server) ⭐ 378 | 🐛 8 | 🌐 TypeScript | 📅 2025-12-17 📇 🏠 - Airtable database integration with schema inspection, read and write capabilities

* [redis/mcp-redis](https://github.com/redis/mcp-redis) ⭐ 375 | 🐛 7 | 🌐 Python | 📅 2025-12-15 🐍 🏠 - The Redis official MCP Server offers an interface to manage and search data in Redis.

* [FreePeak/db-mcp-server](https://github.com/FreePeak/db-mcp-server) ⭐ 330 | 🐛 11 | 🌐 Go | 📅 2025-12-26 🏎️ 🏠 – A high-performance multi-database MCP server built with Golang, supporting MySQL & PostgreSQL (NoSQL coming soon). Includes built-in tools for query execution, transaction management, schema exploration, query building, and performance analysis, with seamless Cursor integration for enhanced database workflows.
...
* [confluentinc/mcp-confluent](https://github.com/confluentinc/mcp-confluent) ⭐ 124 | 🐛 9 | 🌐 TypeScript | 📅 2025-12-30 🐍 ☁️ - Confluent integration to interact with Confluent Kafka and Confluent Cloud REST APIs.
...
* [pgtuner\_mcp](https://github.com/isdaniel/pgtuner_mcp) ⭐ 14 | 🐛 0 | 🌐 Python | 📅 2025-12-15 🐍🗄️ - provides AI-powered PostgreSQL performance tuning capabilities.
...
* [eyaltoledano/claude-task-master](https://github.com/eyaltoledano/claude-task-master) ⭐ 24,509 | 🐛 147 | 🌐 JavaScript | 📅 2025-12-30 📇 ☁️ 🏠 - AI-powered task management system for AI-driven development. Features PRD parsing, task expansion, multi-provider support (Claude, OpenAI, Gemini, Perplexity, xAI), and selective tool loading for optimized context usage.
* [GLips/Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 12,365 | 🐛 38 | 🌐 TypeScript | 📅 2025-10-14 📇 🏠 - Provide coding agents direct access to Figma data to help them one-shot design implementation.
* [idosal/git-mcp](https://github.com/idosal/git-mcp) ⭐ 7,295 | 🐛 48 | 🌐 TypeScript | 📅 2025-08-22 📇 ☁️ - [gitmcp.io](https://gitmcp.io/) is a generic remote MCP server to connect to ANY [GitHub](https://www.github.com) repository or project for documentation
* [21st-dev/Magic-MCP](https://github.com/21st-dev/magic-mcp) ⭐ 4,063 | 🐛 21 | 🌐 TypeScript | 📅 2025-12-23 - Create crafted UI components inspired by the best 21st.dev design engineers.
* [haris-musa/excel-mcp-server](https://github.com/haris-musa/excel-mcp-server) ⭐ 3,038 | 🐛 37 | 🌐 Python | 📅 2025-12-22 🐍 🏠 - An Excel manipulation server providing workbook creation, data operations, formatting, and advanced features (charts, pivot tables, formulae).
* [mobile-next/mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 2,807 | 🐛 33 | 🌐 TypeScript | 📅 2025-12-09 📇 🏠 🐧 🍎 - MCP Server for Android/iOS application and device automation, development and app scraping. Simulator/Emulator/Physical devices like iPhone, Google Pixel, Samsung supported.
* [Jpisnice/shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,567 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-29 📇 🏠 - MCP server that gives AI assistants seamless access to shadcn/ui v4 components, blocks, demos, and metadata.
...
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 1,368 | 🐛 14 | 🌐 JavaScript | 📅 2025-12-16 📇 🏠 🍎 - A Model Context Protocol (MCP) server for interacting with iOS simulators. This server allows you to interact with iOS simulators by getting information about them, controlling UI interactions, and inspecting UI elements.
* [isaacphi/mcp-language-server](https://github.com/isaacphi/mcp-language-server) ⭐ 1,350 | 🐛 45 | 🌐 Go | 📅 2025-12-02 🏎️ 🏠 - MCP Language Server helps MCP enabled clients navigate codebases more easily by giving them access to semantic tools like get definition, references, rename, and diagnostics.
* [jetbrains/mcpProxy](https://github.com/JetBrains/mcpProxy) ⭐ 939 | 🐛 37 | 🌐 JavaScript | 📅 2025-12-02 🎖️ 📇 🏠 - Connect to JetBrains IDE
* [lpigeon/ros-mcp-server](https://github.com/lpigeon/ros-mcp-server) ⭐ 901 | 🐛 18 | 🌐 Python | 📅 2025-12-30 🐍 🏠 🍎 🪟 🐧 - The ROS MCP Server supports robot control by converting user-issued natural language commands into ROS or ROS2 control commands.
...
* [bgauryy/octocode-mcp](https://github.com/bgauryy/octocode-mcp) ⭐ 659 | 🐛 4 | 🌐 TypeScript | 📅 2025-12-30 ☁️ 📇 🍎 🪟 🐧 - AI-powered developer assistant that enables advanced research, analysis and discovery across GitHub and NPM realms in realtime.
...
* [TencentEdgeOne/edgeone-pages-mcp](https://github.com/TencentEdgeOne/edgeone-pages-mcp) ⭐ 341 | 🐛 9 | 🌐 TypeScript | 📅 2025-10-27 📇 ☁️ - An MCP service for deploying HTML content to EdgeOne Pages and obtaining a publicly accessible URL.
...
* [hyperb1iss/droidmind](https://github.com/hyperb1iss/droidmind) ⭐ 320 | 🐛 5 | 🌐 Python | 📅 2025-12-22 🐍 🏠 - Control Android devices with AI through MCP, enabling device control, debugging, system analysis, and UI automation with a comprehensive security framework.
...
* [public-ui/kolibri](https://github.com/public-ui/kolibri) ⭐ 242 | 🐛 164 | 🌐 TypeScript | 📅 2025-12-31 📇 ☁️ 🏠 - Streaming KoliBri MCP server (NPM: `@public-ui/mcp`) delivering 200+ guaranteed accessible web component samples, specs, docs, and scenarios via hosted HTTP endpoint or local `kolibri-mcp` CLI.
* [joshuarileydev/app-store-connect-mcp-server](https://github.com/JoshuaRileyDev/app-store-connect-mcp-server) ⭐ 240 | 🐛 6 | 🌐 TypeScript | 📅 2025-09-02 📇 🏠 - An MCP server to communicate with the App Store Connect API for iOS Developers
* [Govcraft/rust-docs-mcp-server](https://github.com/Govcraft/rust-docs-mcp-server) ⭐ 235 | 🐛 14 | 🌐 Rust | 📅 2025-11-24 🦀 🏠 - Provides up-to-date documentation context for a specific Rust crate to LLMs via an MCP tool, using semantic search (embeddings) and LLM summarization.
...
* [tumf/mcp-text-editor](https://github.com/tumf/mcp-text-editor) ⭐ 178 | 🐛 2 | 🌐 Python | 📅 2025-09-07 🐍 🏠 - A line-oriented text file editor. Optimized for LLM tools with efficient partial file access to minimize token usage.
* [storybookjs/addon-mcp](https://github.com/storybookjs/addon-mcp) ⭐ 155 | 🐛 8 | 🌐 TypeScript | 📅 2025-12-30 📇 🏠 - Help agents automatically write and test stories for your UI components.
...
* [hloiseaufcms/mcp-gopls](https://github.com/hloiseaufcms/mcp-gopls) ⭐ 53 | 🐛 0 | 🌐 Go | 📅 2025-12-30 🏎️ 🏠 - A MCP server for interacting with [Go's Language Server Protocol (gopls)](https://github.com/golang/tools/tree/master/gopls) ⭐ 7,851 | 🐛 105 | 🌐 Go | 📅 2025-12-30 and benefit from advanced Go code analysis features.
...
* [zaizaizhao/mcp-swagger-server](https://github.com/zaizaizhao/mcp-swagger-server) ⭐ 45 | 🐛 3 | 🌐 TypeScript | 📅 2025-10-10 📇 ☁️ 🏠 - A Model Context Protocol (MCP) server that converts OpenAPI/Swagger specifications to MCP format, enabling AI assistants to interact with REST APIs through standardized protocol.
...
* [veelenga/claude-mermaid](https://github.com/veelenga/claude-mermaid/) ⭐ 31 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-22 📇 🏠 🍎 🪟 🐧 - A Mermaid diagram rendering MCP server for Claude Code with live reload functionality, supporting multiple export formats (SVG, PNG, PDF) and themes.
...
* [api7/apisix-mcp](https://github.com/api7/apisix-mcp) ⭐ 29 | 🐛 2 | 🌐 TypeScript | 📅 2025-06-16 🎖️ 📇 🏠 MCP Server that support for querying and managing all resource in [Apache APISIX](https://github.com/apache/apisix) ⭐ 16,035 | 🐛 326 | 🌐 Lua | 📅 2025-12-30.
...
* [j4c0bs/mcp-server-sql-analyzer](https://github.com/j4c0bs/mcp-server-sql-analyzer) ⭐ 26 | 🐛 0 | 🌐 Python | 📅 2025-07-01 🐍 - MCP server that provides SQL analysis, linting, and dialect conversion using [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 8,749 | 🐛 9 | 🌐 Python | 📅 2025-12-31
...
* [higress-group/higress-ops-mcp-server](https://github.com/higress-group/higress-ops-mcp-server) ⭐ 22 | 🐛 6 | 🌐 Python | 📅 2025-03-29 🐍 🏠 - MCP server that provides comprehensive tools for managing [Higress](https://github.com/alibaba/higress) ⭐ 7,186 | 🐛 709 | 🌐 Go | 📅 2025-12-29 gateway configurations and operations.
...
* [narumiruna/gitingest-mcp](https://github.com/narumiruna/gitingest-mcp) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2025-11-21 🐍 🏠 - A MCP server that uses [gitingest](https://github.com/cyclotruc/gitingest) ⭐ 13,500 | 🐛 29 | 🌐 Python | 📅 2025-12-31 to convert any Git repository into a simple text digest of its codebase.
...
* [mckinsey/vizro-mcp](https://github.com/mckinsey/vizro/tree/main/vizro-mcp) ⭐ 3,508 | 🐛 49 | 🌐 Python | 📅 2025-12-30 🎖️ 🐍 🏠 - Tools and templates to create validated and maintainable data charts and dashboards.
* [zcaceres/markdownify-mcp](https://github.com/zcaceres/markdownify-mcp) ⭐ 2,328 | 🐛 17 | 🌐 TypeScript | 📅 2025-09-02 📇 🏠 - An MCP server to convert almost any file or web content into Markdown
...
* [stack-chan/stack-chan](https://github.com/stack-chan/stack-chan) ⭐ 1,025 | 🐛 28 | 🌐 TypeScript | 📅 2025-12-29 📇 📟 - A JavaScript-driven M5Stack-embedded super-kawaii robot with MCP server functionality for AI-controlled interactions and emotions.
...
* [microsoft/markitdown](https://github.com/microsoft/markitdown/tree/main/packages/markitdown-mcp) ⭐ 84,811 | 🐛 412 | 🌐 Python | 📅 2025-12-01 🎖️ 🐍 🏠 - MCP tool access to MarkItDown -- a library that converts many file formats (local or remote) to Markdown for LLM consumption.
* [mickaelkerjean/filestash](https://github.com/mickael-kerjean/filestash/tree/master/server/plugin/plg_handler_mcp) ⭐ 13,289 | 🐛 59 | 🌐 JavaScript | 📅 2025-12-31 🏎️ ☁️ - Remote Storage Access: SFTP, S3, FTP, SMB, NFS, WebDAV, GIT, FTPS, gcloud, azure blob, sharepoint, etc.
...
* [XeroAPI/xero-mcp-server](https://github.com/XeroAPI/xero-mcp-server) ⭐ 163 | 🐛 18 | 🌐 TypeScript | 📅 2025-12-05 📇 ☁️ – An MCP server that integrates with Xero's API, allowing for standardized access to Xero's accounting and business features.
...
* [ariadng/metatrader-mcp-server](https://github.com/ariadng/metatrader-mcp-server) ⭐ 139 | 🐛 5 | 🌐 Python | 📅 2025-10-09 🐍 🏠 🪟 - Enable AI LLMs to execute trades using MetaTrader 5 platform
...
* [QuantConnect/mcp-server](https://github.com/QuantConnect/mcp-server) ⭐ 63 | 🐛 7 | 🌐 Python | 📅 2025-12-19 🐍 ☁️ – A Dockerized Python MCP server that bridges your local AI (e.g., Claude Desktop, etc) with the QuantConnect API—empowering you to create projects, backtest strategies, manage collaborators, and deploy live-trading workflows directly via natural-language prompts.
...
* [Coding-Solo/godot-mcp](https://github.com/Coding-Solo/godot-mcp) ⭐ 1,284 | 🐛 32 | 🌐 JavaScript | 📅 2025-08-09 📇 🏠 - A MCP server for interacting with the Godot game engine, providing tools for editing, running, debugging, and managing scenes in Godot projects.
* [CoderGamester/mcp-unity](https://github.com/CoderGamester/mcp-unity) ⭐ 1,174 | 🐛 8 | 🌐 C# | 📅 2025-12-30 #️⃣ 🏠 - MCP Server for Unity3d Game Engine integration for game development
* [IvanMurzak/Unity-MCP](https://github.com/IvanMurzak/Unity-MCP) ⭐ 684 | 🐛 30 | 🌐 C# | 📅 2025-12-29 #️⃣ 🏠 🍎 🪟 🐧 - MCP Server for Unity Editor and for a game made with Unity
...
* [hkaanengin/opendota-mcp-server](https://github.com/hkaanengin/opendota-mcp-server) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2025-12-30 🐍 🏠 ☁️ - MCP server providing AI assistants with access to Dota 2 statistics via OpenDota API. 20+ tools for player stats, hero data, and match    analysis with natural language support.

### 🧠 <a name="knowledge--memory"></a>Knowledge & Memory

Persistent memory storage using knowledge graph structures. Enables AI models to maintain and query structured information across sessions.

* [upstash/context7](https://github.com/upstash/context7) ⭐ 40,520 | 🐛 96 | 🌐 TypeScript | 📅 2025-12-30 📇 ☁️ - Up-to-date code documentation for LLMs and AI code editors.
* [topoteretes/cognee](https://github.com/topoteretes/cognee/tree/dev/cognee-mcp) ⭐ 10,696 | 🐛 36 | 🌐 Python | 📅 2025-12-29 📇 🏠 - Memory manager for AI apps and Agents using various graph and vector stores and allowing ingestion from 30+ data sources
...
* [apecloud/ApeRAG](https://github.com/apecloud/ApeRAG) ⭐ 997 | 🐛 51 | 🌐 Python | 📅 2025-12-30 🐍 ☁️ 🏠 - Production-ready RAG platform combining Graph RAG, vector search, and full-text search. Best choice for building your own Knowledge Graph and for Context Engineering
* [vectorize-io/hindsight](https://github.com/vectorize-io/hindsight) ⭐ 874 | 🐛 9 | 🌐 Python | 📅 2025-12-28 🐍 ☁️ 🏠 - Hindsight: Agent Memory That Works Like Human Memory - Built for AI Agents to manage Long Term Memory
...
* [agentic-mcp-tools/memora](https://github.com/agentic-mcp-tools/memora) ⭐ 58 | 🐛 0 | 🌐 Python | 📅 2025-12-26 🐍 🏠 ☁️ - Persistent memory with knowledge graph visualization, semantic/hybrid search, cloud sync (S3/R2), and cross-session context management.
* [shinpr/mcp-local-rag](https://github.com/shinpr/mcp-local-rag) ⭐ 47 | 🐛 2 | 🌐 TypeScript | 📅 2025-12-30 📇 🏠 - Privacy-first document search server running entirely locally. Supports semantic search over PDFs, DOCX, TXT, and Markdown files with LanceDB vector storage and local embeddings - no API keys or cloud services required.
...
* [Smart-AI-Memory/empathy-framework](https://github.com/Smart-AI-Memory/empathy-framework) ⭐ 9 | 🐛 9 | 🌐 HTML | 📅 2025-12-29 🐍 🏠 - Five-level AI collaboration system with persistent memory and anticipatory capabilities. MCP-native integration for Claude and other LLMs with local-first architecture via MemDocs.
...
* [QGIS MCP](https://github.com/jjsantos01/qgis_mcp) ⭐ 744 | 🐛 8 | 🌐 Python | 📅 2025-10-01 - connects QGIS Desktop to Claude AI through the MCP. This integration enables prompt-assisted project creation, layer loading, code execution, and more.
...
* [ip2location/mcp-ip2location-io](https://github.com/ip2location/mcp-ip2location-io) ⭐ 13 | 🐛 1 | 🌐 Python | 📅 2025-12-31 🐍 ☁️  - Official IP2Location.io MCP server to obtain the geolocation, proxy and network information of an IP address utilizing IP2Location.io API.
...
* [pipeboard-co/meta-ads-mcp](https://github.com/pipeboard-co/meta-ads-mcp) ⭐ 390 | 🐛 6 | 🌐 Python | 📅 2025-12-19 🐍 ☁️ 🏠 - Meta Ads automation that just works. Trusted by 10,000+ businesses to analyze performance, test creatives, optimize spend, and scale results — simply and reliably.
...
* [netdata/netdata#Netdata](https://github.com/netdata/netdata/blob/master/src/web/mcp/README.md) ⭐ 77,187 | 🐛 241 | 🌐 C | 📅 2025-12-30 🎖️ 🏠 ☁️ 📟 🍎 🪟 🐧 - Discovery, exploration, reporting and root cause analysis using all observability data, including metrics, logs, systems, containers, processes, and network connections
* [grafana/mcp-grafana](https://github.com/grafana/mcp-grafana) ⭐ 2,051 | 🐛 63 | 🌐 Go | 📅 2025-12-30 🎖️ 🐍 🏠 ☁️ - Search dashboards, investigate incidents and query datasources in your Grafana instance
* [getsentry/sentry-mcp](https://github.com/getsentry/sentry-mcp) ⭐ 490 | 🐛 47 | 🌐 TypeScript | 📅 2025-12-30 🐍 ☁️ - Sentry.io integration for error tracking and performance monitoring
...
* [exa-labs/exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) ⭐ 3,475 | 🐛 27 | 🌐 TypeScript | 📅 2025-12-22 🎖️ 📇 ☁️ – A Model Context Protocol (MCP) server lets AI assistants like Claude use the Exa AI Search API for web searches. This setup allows AI models to get real-time web information in a safe and controlled way.
...
* [blazickjp/arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) ⭐ 1,985 | 🐛 34 | 🌐 Python | 📅 2025-08-19 ☁️ 🐍 - Search ArXiv research papers
* [luminati-io/brightdata-mcp](https://github.com/luminati-io/brightdata-mcp) ⭐ 1,823 | 🐛 15 | 🌐 JavaScript | 📅 2025-12-30 📇 ☁️ - Discover, extract, and interact with the web - one interface powering automated access across the public internet.
...
* [nickclyde/duckduckgo-mcp-server](https://github.com/nickclyde/duckduckgo-mcp-server) ⭐ 703 | 🐛 20 | 🌐 Python | 📅 2025-03-11 🐍 ☁️ - Web search using DuckDuckGo
* [Aas-ee/open-webSearch](https://github.com/Aas-ee/open-webSearch) ⭐ 552 | 🐛 10 | 🌐 TypeScript | 📅 2025-10-26 🐍 📇 ☁️ - Web search using free multi-engine search (NO API KEYS REQUIRED) — Supports Bing, Baidu, DuckDuckGo, Brave, Exa, and CSDN.
* [brave/brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) ⭐ 447 | 🐛 17 | 🌐 TypeScript | 📅 2025-12-28 📇 ☁️ - Web search capabilities using Brave's Search API
* [genomoncology/biomcp](https://github.com/genomoncology/biomcp) ⭐ 380 | 🐛 14 | 🌐 Python | 📅 2025-12-18 🐍 ☁️ - Biomedical research server providing access to PubMed, ClinicalTrials.gov, and MyVariant.info.
* [Ihor-Sokoliuk/MCP-SearXNG](https://github.com/ihor-sokoliuk/mcp-searxng) ⭐ 370 | 🐛 11 | 🌐 TypeScript | 📅 2025-11-09 📇 🏠/☁️ - A Model Context Protocol Server for [SearXNG](https://docs.searxng.org)
...
* [kagisearch/kagimcp](https://github.com/kagisearch/kagimcp) ⭐ 247 | 🐛 5 | 🌐 Python | 📅 2025-11-17 ☁️ 📇 – Official Kagi Search MCP Server
* [jae-jae/g-search-mcp](https://github.com/jae-jae/g-search-mcp) ⭐ 238 | 🐛 5 | 🌐 TypeScript | 📅 2025-06-14 📇 🏠 - A powerful MCP server for Google search that enables parallel searching with multiple keywords simultaneously.
...
* [deadletterq/mcp-opennutrition](https://github.com/deadletterq/mcp-opennutrition) ⭐ 148 | 🐛 0 | 🌐 TypeScript | 📅 2025-06-11 📇 🏠 - Local MCP server for searching 300,000+ foods, nutrition facts, and barcodes from the OpenNutrition database.
...
* [lfnovo/content-core](https://github.com/lfnovo/content-core) ⭐ 109 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2025-11-25 🐍 🏠 - Extract content from URLs, documents, videos, and audio files using intelligent auto-engine selection. Supports web pages, PDFs, Word docs, YouTube transcripts, and more with structured JSON responses.
...
* [ConechoAI/openai-websearch-mcp](https://github.com/ConechoAI/openai-websearch-mcp/) ⭐ 80 | 🐛 5 | 🌐 Python | 📅 2025-09-12 🐍 🏠 ☁️ - This is a Python-based MCP server that provides OpenAI `web_search` build-in tool.
...
* [ricocf/mcp-wolframalpha](https://github.com/ricocf/mcp-wolframalpha) ⭐ 57 | 🐛 2 | 🌐 Python | 📅 2025-08-06 🐍 🏠 ☁️ - An MCP server lets AI assistants use the Wolfram Alpha API for real-time access to computational knowledge and data.
...
* [Linked-API/linkedapi-mcp](https://github.com/Linked-API/linkedapi-mcp) ⭐ 32 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-30 🎖️ 📇 ☁️ - MCP server that lets AI assistants control LinkedIn accounts and retrieve real-time data.
...
* [boikot-xyz/boikot](https://github.com/boikot-xyz/boikot) ⭐ 4 | 🐛 0 | 🌐 HTML | 📅 2025-12-30 🦀☁️ - Model Context Protocol Server for looking up company ethics information. Learn about the ethical and unethical actions of major companies.
...
* [LaurieWired/GhidraMCP](https://github.com/LaurieWired/GhidraMCP) ⭐ 6,875 | 🐛 55 | 🌐 Java | 📅 2025-06-23 ☕ 🏠 - A Model Context Protocol server for Ghidra that enables LLMs to autonomously reverse engineer applications. Provides tools for decompiling binaries, renaming methods and data, and listing methods, classes, imports, and exports.
* [mrexodia/ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) ⭐ 4,809 | 🐛 35 | 🌐 Python | 📅 2025-12-20 🐍 🏠 - MCP server for IDA Pro, allowing you to perform binary analysis with AI assistants. This plugin implement decompilation, disassembly and allows you to generate malware analysis reports automatically.
...
* [zinja-coder/jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp) ⭐ 971 | 🐛 7 | 🌐 Java | 📅 2025-12-29 ☕ 🏠 - JADX-AI-MCP is a plugin and MCP Server for the JADX decompiler that integrates directly with Model Context Protocol (MCP) to provide live reverse engineering support with LLMs like Claude.
...
* [jtang613/GhidrAssistMCP](https://github.com/jtang613/GhidrAssistMCP) ⭐ 388 | 🐛 1 | 🌐 Java | 📅 2025-12-22 ☕ 🏠 - A native Model Context Protocol server for Ghidra. Includes GUI configuration and logging, 31 powerful tools and no external dependencies.
...
* [fosdickio/binary\_ninja\_mcp](https://github.com/fosdickio/binary_ninja_mcp) ⭐ 153 | 🐛 19 | 🌐 Python | 📅 2025-12-23 🐍 🏠 🍎 🪟 🐧 - A Binary Ninja plugin, MCP server, and bridge that seamlessly integrates [Binary Ninja](https://binary.ninja) with your favorite MCP client.  It enables you to automate the process of performing binary analysis and reverse engineering.
...
* [mobb-dev/mobb-vibe-shield-mcp](https://github.com/mobb-dev/bugsy?tab=readme-ov-file#model-context-protocol-mcp-server) ⭐ 64 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-30 🎖️ 📇 ☁️ 🍎 🪟 🐧 - [Mobb Vibe Shield](https://vibe.mobb.ai/) identifies and remediates vulnerabilities in both human and AI-written code, ensuring your applications remain secure without slowing development.
...
* [zboralski/ida-headless-mcp](https://github.com/zboralski/ida-headless-mcp) ⭐ 24 | 🐛 1 | 🌐 Python | 📅 2025-12-30 🏎️ 🐍 🏠 🍎 🪟 🐧 - Headless IDA Pro binary analysis via MCP. Multi-session concurrency with Go orchestration and Python workers. Supports Il2CppDumper and Blutter metadata import for Unity and Flutter reverse engineering.
...
* [r-huijts/strava-mcp](https://github.com/r-huijts/strava-mcp) ⭐ 207 | 🐛 7 | 🌐 TypeScript | 📅 2025-12-16 📇 ☁️ - A Model Context Protocol (MCP) server that connects to Strava API, providing tools to access Strava data through LLMs
...
* [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 3,871 | 🐛 130 | 🌐 Python | 📅 2025-12-30 🐍 ☁️ - MCP server for Atlassian products (Confluence and Jira). Supports Confluence Cloud, Jira Cloud, and Jira Server/Data Center. Provides comprehensive tools for searching, reading, creating, and managing content across Atlassian workspaces.
...
* [mbailey/voice-mcp](https://github.com/mbailey/voice-mcp) ⭐ 530 | 🐛 22 | 🌐 Python | 📅 2025-12-30 🐍 🏠 - Complete voice interaction server supporting speech-to-text, text-to-speech, and real-time voice conversations through local microphone, OpenAI-compatible APIs, and LiveKit integration
...
* [openbnb-org/mcp-server-airbnb](https://github.com/openbnb-org/mcp-server-airbnb) ⭐ 353 | 🐛 7 | 🌐 JavaScript | 📅 2025-07-18 📇 ☁️ - Provides tools to search Airbnb and get listing details.
...
* [r-huijts/ns-mcp-server](https://github.com/r-huijts/ns-mcp-server) ⭐ 45 | 🐛 2 | 🌐 TypeScript | 📅 2025-08-26 📇 ☁️ - Access Dutch Railways (NS) travel information, schedules, and real-time updates
...
* [github/github-mcp-server](https://github.com/github/github-mcp-server) ⭐ 25,533 | 🐛 253 | 🌐 Go | 📅 2025-12-30 📇 ☁️ - Official GitHub server for integration with repository management, PRs, issues, and more.
...
* [taylorwilsdon/google\_workspace\_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) ⭐ 1,039 | 🐛 36 | 🌐 Python | 📅 2025-12-28 🐍 ☁️ 🍎 🪟 🐧 - Comprehensive Google Workspace MCP server with full support for Google Calendar, Drive, Gmail, and Docs, Forms, Chats, Slides and Sheets over stdio, Streamable HTTP and SSE transports.
...
* [modelcontextprotocol/server-everything](https://github.com/modelcontextprotocol/servers/tree/main/src/everything) ⭐ 75,266 | 🐛 258 | 🌐 TypeScript | 📅 2025-12-19 📇 🏠 - MCP server that exercises all the features of the MCP protocol
* [mediar-ai/screenpipe](https://github.com/mediar-ai/screenpipe) ⭐ 16,314 | 🐛 237 | 🌐 TypeScript | 📅 2025-12-09 - 🎖️ 🦀 🏠 🍎 Local-first system capturing screen/audio with timestamped indexing, SQL/embedding storage, semantic search, LLM-powered history analysis, and event-triggered actions - enables building context-aware AI agents through a NextJS plugin ecosystem.
* [Klavis-AI/YouTube](https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/youtube) ⭐ 5,565 | 🐛 52 | 🌐 Python | 📅 2025-12-30 🐍 📇 - Extract and convert YouTube video information.
* [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 3,871 | 🐛 130 | 🌐 Python | 📅 2025-12-30 🐍 ☁️ - MCP server for Atlassian products (Confluence and Jira). Supports Confluence Cloud, Jira Cloud, and Jira Server/Data Center. Provides comprehensive tools for searching, reading, creating, and managing content across Atlassian workspaces.
* [metorial/metorial](https://github.com/metorial/metorial) ⭐ 3,196 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-31 - 🎖️ 📇 ☁️ Connect AI agents to 600+ integrations with a single interface - OAuth, scaling, and monitoring included
* [MarkusPfundstein/mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian) ⭐ 2,611 | 🐛 68 | 🌐 Python | 📅 2025-06-28 🐍 ☁️ 🏠 - Interacting with Obsidian via REST API
...
* [anaisbetts/mcp-installer](https://github.com/anaisbetts/mcp-installer) ⭐ 1,486 | 🐛 21 | 🌐 JavaScript | 📅 2024-11-26 🐍 🏠 -  An MCP server that installs other MCP servers for you.
* [calclavia/mcp-obsidian](https://github.com/calclavia/mcp-obsidian) ⭐ 1,250 | 🐛 18 | 🌐 JavaScript | 📅 2025-08-15 📇 🏠 - This is a connector to allow Claude Desktop (or any MCP client) to read and search any directory containing Markdown notes (such as an Obsidian vault).
...
* [caol64/wenyan-mcp](https://github.com/caol64/wenyan-mcp) ⭐ 953 | 🐛 24 | 🌐 JavaScript | 📅 2025-12-29 📇 🏠 🍎 🪟 🐧 - Wenyan MCP Server, which lets AI automatically format Markdown articles and publish them to WeChat GZH.
...
* [apify/actors-mcp-server](https://github.com/apify/actors-mcp-server) ⭐ 663 | 🐛 32 | 🌐 TypeScript | 📅 2025-12-24 📇 ☁️ - Use 3,000+ pre-built cloud tools, known as Actors, to extract data from websites, e-commerce, social media, search engines, maps, and more
...
* [PV-Bhat/vibe-check-mcp-server](https://github.com/PV-Bhat/vibe-check-mcp-server) ⭐ 437 | 🐛 13 | 🌐 TypeScript | 📅 2025-12-02 📇 ☁️ - An MCP server that prevents cascading errors and scope creep by calling a "Vibe-check" agent to ensure user alignment.
* [wong2/mcp-cli](https://github.com/wong2/mcp-cli) ⭐ 400 | 🐛 10 | 🌐 JavaScript | 📅 2025-08-13 📇 🏠 - CLI tool for testing MCP servers
...
* [ivnvxd/mcp-server-odoo](https://github.com/ivnvxd/mcp-server-odoo) ⭐ 124 | 🐛 15 | 🌐 Python | 📅 2025-12-15 🐍 ☁️/🏠 - Connect AI assistants to Odoo ERP systems for business data access, record management, and workflow automation.
...
* [roychri/mcp-server-asana](https://github.com/roychri/mcp-server-asana) ⭐ 112 | 🐛 13 | 🌐 TypeScript | 📅 2025-05-21 - 📇 ☁️ This Model Context Protocol server implementation of Asana allows you to talk to Asana API from MCP Client such as Anthropic's Claude Desktop Application, and many more.
...
* [anki-mcp/anki-mcp-desktop](https://github.com/anki-mcp/anki-mcp-desktop) ⭐ 63 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-14 📇 🏠 🍎 🪟 🐧 - Enterprise-grade Anki integration with natural language interaction, comprehensive note/deck management, and one-click MCPB installation. Built on NestJS with comprehensive test coverage.
...
> \[!NOTE]
> More frameworks, utilities, and other developer tools are available at <https://github.com/punkpeye/awesome-mcp-devtools> ⭐ 386 | 🐛 11 | 📅 2025-12-10

* [FastMCP](https://github.com/jlowin/fastmcp) ⭐ 21,570 | 🐛 224 | 🌐 Python | 📅 2025-12-31 🐍 - A high-level framework for building MCP servers in Python
* [FastMCP](https://github.com/punkpeye/fastmcp) ⭐ 2,854 | 🐛 37 | 🌐 TypeScript | 📅 2025-12-27 📇 - A high-level framework for building MCP servers in TypeScript
