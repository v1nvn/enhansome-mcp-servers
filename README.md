...
Checkout [awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients/) ⭐ 6,162 | 🐛 53 | 📅 2025-12-23 and [glama.ai/mcp/clients](https://glama.ai/mcp/clients).
...
* [mindsdb/mindsdb](https://github.com/mindsdb/mindsdb) ⭐ 38,221 | 🐛 207 | 🌐 Python | 📅 2026-01-09 - Connect and unify data across various platforms and databases with [MindsDB as a single MCP server](https://docs.mindsdb.com/mcp/overview).
* [PipedreamHQ/pipedream](https://github.com/PipedreamHQ/pipedream/tree/master/modelcontextprotocol) ⭐ 10,953 | 🐛 4,352 | 🌐 JavaScript | 📅 2026-01-10 ☁️ 🏠 - Connect with 2,500 APIs with 8,000+ prebuilt tools, and manage servers for your users, in your own app.
* [metatool-ai/metatool-app](https://github.com/metatool-ai/metatool-app) ⭐ 1,883 | 🐛 62 | 🌐 TypeScript | 📅 2025-12-23 📇 ☁️ 🏠 🍎 🪟 🐧 - MetaMCP is the one unified middleware MCP server that manages your MCP connections with GUI.
* [julien040/anyquery](https://github.com/julien040/anyquery) ⭐ 1,580 | 🐛 8 | 🌐 Go | 📅 2025-11-11 🏎️ 🏠 ☁️ - Query more than 40 apps with one binary using SQL. It can also connect to your PostgreSQL, MySQL, or SQLite compatible database. Local-first and private by design.
* [duaraghav8/MCPJungle](https://github.com/duaraghav8/MCPJungle) ⭐ 786 | 🐛 47 | 🌐 Go | 📅 2026-01-09 🏎️ 🏠 - Self-hosted MCP Server registry for enterprise AI Agents
* [TheLunarCompany/lunar#mcpx](https://github.com/TheLunarCompany/lunar/tree/main/mcpx) ⭐ 380 | 🐛 5 | 🌐 TypeScript | 📅 2026-01-09 📇 🏠  ☁️ 🍎 🪟 🐧 - MCPX is a production-ready, open-source gateway to manage MCP servers at scale—centralize tool discovery, access controls, call prioritization, and usage tracking to simplify agent workflows.
* [1mcp/agent](https://github.com/1mcp-app/agent) ⭐ 341 | 🐛 6 | 🌐 TypeScript | 📅 2026-01-09 📇 ☁️ 🏠 🍎 🪟 🐧 - A unified Model Context Protocol server implementation that aggregates multiple MCP servers into one.
...
* [K-Dense-AI/claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp) ⭐ 251 | 🐛 3 | 🌐 Python | 📅 2025-11-11 🐍 ☁️ 🏠 🍎 🪟 🐧 - Intelligent search capabilities to let every model and client use [Claude Agent Skills](https://www.anthropic.com/news/skills) like native.
...
* [VeriTeknik/pluggedin-mcp-proxy](https://github.com/VeriTeknik/pluggedin-mcp-proxy) ⭐ 116 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-26  📇 🏠 - A comprehensive proxy server that combines multiple MCP servers into a single interface with extensive visibility features. It provides discovery and management of tools, prompts, resources, and templates across servers, plus a playground for debugging when building MCP servers.
* [juspay/neurolink](https://github.com/juspay/neurolink) ⭐ 103 | 🐛 409 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️ 🏠 🍎 🪟 🐧 - Making enterprise AI infrastructure universally accessible. Edge-first platform unifying 12 providers and 100+ models with multi-agent orchestration, HITL workflows, guardrails middleware, and context summarization.
...
* [portel-dev/ncp](https://github.com/portel-dev/ncp) ⭐ 58 | 🐛 1 | 🌐 JavaScript | 📅 2026-01-05 📇 ☁️ 🏠 🍎 🪟 🐧 - NCP orchestrates your entire MCP ecosystem through intelligent discovery, eliminating token overhead while maintaining 98.2% accuracy.
...
* [ahujasid/blender-mcp](https://github.com/ahujasid/blender-mcp) ⭐ 14,893 | 🐛 36 | 🌐 Python | 📅 2026-01-08 🐍 - MCP server for working with Blender
...
* [samuelgursky/davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp) ⭐ 457 | 🐛 10 | 🌐 Python | 📅 2026-01-01 🐍 - MCP server integration for DaVinci Resolve providing powerful tools for video editing, color grading, media management, and project control
...
* [genomoncology/biomcp](https://github.com/genomoncology/biomcp) ⭐ 386 | 🐛 14 | 🌐 Python | 📅 2026-01-08 🐍 ☁️ - Biomedical research MCP server providing access to PubMed, ClinicalTrials.gov, and MyVariant.info.
...
* [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) ⭐ 25,304 | 🐛 38 | 🌐 TypeScript | 📅 2026-01-09 - Official Microsoft Playwright MCP server, enabling LLMs to interact with web pages through structured accessibility snapshots
* [agent-infra/mcp-server-browser](https://github.com/bytedance/UI-TARS-desktop/tree/main/packages/agent-infra/mcp-servers/browser) ⭐ 21,889 | 🐛 311 | 🌐 TypeScript | 📅 2026-01-05 📇 🏠 - Browser automation capabilities using Puppeteer, both support local and remote browser connection.
* [browsermcp/mcp](https://github.com/browsermcp/mcp) ⭐ 5,395 | 🐛 104 | 🌐 TypeScript | 📅 2025-04-24 📇 🏠 - Automate your local Chrome browser
* [executeautomation/playwright-mcp-server](https://github.com/executeautomation/mcp-playwright) ⭐ 5,129 | 🐛 18 | 🌐 TypeScript | 📅 2025-12-13 📇 - An MCP server using Playwright for browser automation and webscrapping
* [browserbase/mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase) ⭐ 3,021 | 🐛 25 | 🌐 TypeScript | 📅 2025-12-10 🎖️ 📇 - Automate browser interactions in the cloud (e.g. web navigation, data extraction, form filling, and more)
...
* [pskill9/web-search](https://github.com/pskill9/web-search) ⭐ 387 | 🐛 7 | 🌐 JavaScript | 📅 2024-12-30 📇 🏠 - An MCP server that enables free web searching using Google search results, with no API keys required.
...
* [eyalzh/browser-control-mcp](https://github.com/eyalzh/browser-control-mcp) ⭐ 228 | 🐛 14 | 🌐 TypeScript | 📅 2025-12-26 📇 🏠 - An MCP server paired with a browser extension that enables LLM clients to control the user's browser (Firefox).
...
* [hanzili/comet-mcp](https://github.com/hanzili/comet-mcp) ⭐ 83 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-09 📇 🏠 🍎 - Connect to Perplexity Comet browser for agentic web browsing, deep research, and real-time task monitoring.
...
* [fradser/mcp-server-apple-reminders](https://github.com/FradSer/mcp-server-apple-reminders) ⭐ 3 | 🐛 12 | 🌐 TypeScript | 📅 2026-01-08 📇 🏠 🍎 - An MCP server for interacting with Apple Reminders on macOS
...
* [awslabs/mcp](https://github.com/awslabs/mcp) ⭐ 7,829 | 🐛 184 | 🌐 Python | 📅 2026-01-09 🎖️ ☁️ - AWS MCP servers for seamless integration with AWS services and resources.
...
* [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) ⭐ 3,267 | 🐛 49 | 🌐 TypeScript | 📅 2026-01-08 🎖️ 📇 ☁️ - Integration with Cloudflare services including Workers, KV, R2, and D1
* [flux159/mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) ⭐ 1,251 | 🐛 13 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️/🏠 - Typescript implementation of Kubernetes cluster operations for pods, deployments, services.
* [manusa/Kubernetes MCP Server](https://github.com/manusa/kubernetes-mcp-server) ⭐ 973 | 🐛 50 | 🌐 Go | 📅 2026-01-10 🏎️ 🏠 A - powerful Kubernetes MCP server with additional support for OpenShift. Besides providing CRUD operations for **any** Kubernetes resource, this server provides specialized tools to interact with your cluster.
...
* [weibaohui/k8m](https://github.com/weibaohui/k8m) ⭐ 750 | 🐛 17 | 🌐 Go | 📅 2026-01-10 🏎️ ☁️/🏠 - Provides MCP multi-cluster Kubernetes management and operations, featuring a management interface, logging, and nearly 50 built-in tools covering common DevOps and development scenarios. Supports both standard and CRD resources.
...
* [pibblokto/cert-manager-mcp-server](https://github.com/pibblokto/cert-manager-mcp-server) ⭐ 21 | 🐛 0 | 🌐 Python | 📅 2025-08-25 🐍 🍎/🐧 ☁️ - mcp server for [cert-manager](https://github.com/cert-manager/cert-manager) ⭐ 13,450 | 🐛 215 | 🌐 Go | 📅 2026-01-10 management and troubleshooting
...
* [pydantic/pydantic-ai/mcp-run-python](https://github.com/pydantic/pydantic-ai/tree/main/mcp-run-python) ⭐ 14,216 | 🐛 451 | 🌐 Python | 📅 2026-01-10 🐍 🏠 - Run Python code in a secure sandbox via MCP tool calls
* [dagger/container-use](https://github.com/dagger/container-use) ⭐ 3,407 | 🐛 64 | 🌐 Go | 📅 2025-12-08 🏎️ 🏠 🐧 🍎 🪟 - Containerized environments for coding agents. Multiple agents can work independently, isolated in fresh containers and git branches. No conflicts, many experiments. Full execution history, terminal access to agent environments, git workflow. Any agent/model/infra stack.
...
* [oraios/serena](https://github.com/oraios/serena) ⭐ 18,396 | 🐛 89 | 🌐 Python | 📅 2026-01-10 🐍 🏠 - A fully-featured coding agent that relies on symbolic code operations by using language servers.
...
* [rinadelph/Agent-MCP](https://github.com/rinadelph/Agent-MCP) ⭐ 1,114 | 🐛 15 | 🌐 TypeScript | 📅 2025-10-09 🐍 🏠 - A framework for creating multi-agent systems using MCP for coordinated AI collaboration, featuring task management, shared context, and RAG capabilities.
* [shashankss1205/codegraphcontext](https://github.com/Shashankss1205/CodeGraphContext) ⭐ 323 | 🐛 73 | 🌐 Python | 📅 2026-01-09 🐍 🏠 🍎 🪟 🐧 An MCP server that indexes local code into a graph database to provide context to AI assistants with a graphical code visualizations for humans.
* [juehang/vscode-mcp-server](https://github.com/juehang/vscode-mcp-server) ⭐ 310 | 🐛 5 | 🌐 TypeScript | 📅 2026-01-07 📇 🏠 - A MCP Server that allows AI such as Claude to read from the directory structure in a VS Code workspace, see problems picked up by linter(s) and the language server, read code files, and make edits.
...
* [agentic-mcp-tools/owlex](https://github.com/agentic-mcp-tools/owlex) ⭐ 28 | 🐛 1 | 🌐 Python | 📅 2026-01-08 🐍 🏠 🍎 🪟 🐧 - AI council server: query CLI agents (Claude Code, Codex, Gemini, and OpenCode) in parallel with deliberation rounds
* [gabrielmaialva33/winx-code-agent](https://github.com/gabrielmaialva33/winx-code-agent) ⭐ 23 | 🐛 7 | 🌐 Rust | 📅 2026-01-05 🦀 🏠 - A high-performance Rust reimplementation of WCGW for code agents, providing shell execution and advanced file management capabilities for LLMs via MCP.
...
* [wonderwhy-er/DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) ⭐ 5,208 | 🐛 74 | 🌐 TypeScript | 📅 2026-01-09 📇 🏠 🍎 🪟 🐧 - A swiss-army-knife that can manage/execute programs and read/write/search/edit code and text files.
* [louis030195/terminator-mcp-agent](https://github.com/mediar-ai/terminator/tree/main/terminator-mcp-agent) ⭐ 1,242 | 🐛 9 | 🌐 Rust | 📅 2026-01-09 🦀 📇 🏠 🍎 🪟 🐧 - Desktop GUI automation using accessibility APIs. Control Windows, macOS, and Linux applications without vision models or screenshots. Supports workflow recording, structured data extraction, and browser DOM inspection.
* [aymericzip/intlayer](https://github.com/aymericzip/intlayer) ⭐ 534 | 🐛 23 | 🌐 TypeScript | 📅 2026-01-09 📇 ☁️ 🏠 - A MCP Server that enhance your IDE with AI-powered assistance for Intlayer i18n / CMS tool: smart CLI access, access to the docs.
...
* [tufantunc/ssh-mcp](https://github.com/tufantunc/ssh-mcp) ⭐ 202 | 🐛 3 | 🌐 TypeScript | 📅 2026-01-03 📇 🏠 🐧 🪟 - MCP server exposing SSH control for Linux and Windows servers via Model Context Protocol. Securely execute remote shell commands with password or SSH key authentication.
...
* [elie222/inbox-zero](https://github.com/elie222/inbox-zero/tree/main/apps/mcp-server) ⭐ 9,764 | 🐛 96 | 🌐 TypeScript | 📅 2026-01-09 🐍 ☁️ - An MCP server for Inbox Zero. Adds functionality on top of Gmail like finding out which emails you need to reply to or need to follow up on.
* [lharries/whatsapp-mcp](https://github.com/lharries/whatsapp-mcp) ⭐ 5,188 | 🐛 98 | 🌐 Go | 📅 2025-07-13 🐍 🏎️ - An MCP server for searching your personal WhatsApp messages, contacts and sending messages to individuals or groups
* [korotovsky/slack-mcp-server](https://github.com/korotovsky/slack-mcp-server) ⭐ 1,084 | 🐛 34 | 🌐 Go | 📅 2026-01-08 📇 ☁️ - The most powerful MCP server for Slack Workspaces.
* [chigwell/telegram-mcp](https://github.com/chigwell/telegram-mcp) ⭐ 542 | 🐛 6 | 🌐 Python | 📅 2025-12-29 🐍 🏠 - Telegram API integration for accessing user data, managing dialogs (chats, channels, groups), retrieving messages, sending messages and handling read status.
* [line/line-bot-mcp-server](https://github.com/line/line-bot-mcp-server) ⭐ 510 | 🐛 19 | 🌐 TypeScript | 📅 2026-01-07 🎖 📇 ☁️ - MCP Server for Integrating LINE Official Account
...
* [softeria/ms-365-mcp-server](https://github.com/softeria/ms-365-mcp-server) ⭐ 384 | 🐛 6 | 🌐 TypeScript | 📅 2025-12-30 📇 ☁️ - MCP server that connects to Microsoft Office and the whole Microsoft 365 suite using Graph API (including Outlook, mail, files, Excel, calendar)
...
* [agentmail-toolkit/mcp](https://github.com/agentmail-to/agentmail-toolkit/tree/main/mcp) ⭐ 40 | 🐛 2 | 🌐 TypeScript | 📅 2025-12-17 🐍 💬 - An MCP server to create inboxes on the fly to send, receive, and take actions on email. We aren't AI agents for email, but email for AI Agents.
...
* [antv/mcp-server-chart](https://github.com/antvis/mcp-server-chart) ⭐ 3,482 | 🐛 12 | 🌐 TypeScript | 📅 2025-12-29 🎖️ 📇 ☁️ - A Model Context Protocol server for generating visual charts using [AntV](https://github.com/antvis).
* [hustcc/mcp-mermaid](https://github.com/hustcc/mcp-mermaid) ⭐ 359 | 🐛 4 | 🌐 TypeScript | 📅 2025-12-16 📇 🏠 - Generate [mermaid](https://mermaid.js.org/) diagram and chart with AI MCP dynamically.
...
* [googleapis/genai-toolbox](https://github.com/googleapis/genai-toolbox) ⭐ 12,347 | 🐛 150 | 🌐 Go | 📅 2026-01-10 🏎️ ☁️ - Open source MCP server specializing in easy, fast, and secure tools for Databases.

* [get-convex/convex-backend](https://stack.convex.dev/convex-mcp-server) 📇 ☁️ - Convex database integration to introspect tables, functions, and run oneoff queries ([Source](https://github.com/get-convex/convex-backend/blob/main/npm-packages/convex/src/cli/mcp.ts) ⭐ 9,025 | 🐛 117 | 🌐 Rust | 📅 2026-01-10)

* [bram2w/baserow](https://github.com/bram2w/baserow) ⭐ 3,731 | 🐛 1,051 | 🌐 Python | 📅 2026-01-09 - Baserow database integration with table search, list, and row create, read, update, and delete capabilities.

* [supabase-community/supabase-mcp](https://github.com/supabase-community/supabase-mcp) ⭐ 2,375 | 🐛 72 | 🌐 TypeScript | 📅 2026-01-09 🎖️ 📇 ☁️ - Official Supabase MCP server to connect AI assistants directly with your Supabase project and allows them to perform tasks like managing tables, fetching config, and querying data.

* [crystaldba/postgres-mcp](https://github.com/crystaldba/postgres-mcp) ⭐ 1,796 | 🐛 40 | 🌐 Python | 📅 2025-11-11 🐍 🏠 - All-in-one MCP server for Postgres development and operations, with tools for performance analysis, tuning, and health checks

* [qdrant/mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant) ⭐ 1,158 | 🐛 36 | 🌐 Python | 📅 2025-12-10 🐍 🏠 - A Qdrant MCP server

* [designcomputer/mysql\_mcp\_server](https://github.com/designcomputer/mysql_mcp_server) ⭐ 1,059 | 🐛 54 | 🌐 Python | 📅 2025-06-05 🐍 🏠 - MySQL database integration with configurable access controls, schema inspection, and comprehensive security guidelines

* [benborla29/mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) ⭐ 1,044 | 🐛 34 | 🌐 JavaScript | 📅 2025-11-18 ☁️ 🏠 - MySQL database integration in NodeJS with configurable access controls and schema inspection
...
* [ClickHouse/mcp-clickhouse](https://github.com/ClickHouse/mcp-clickhouse) ⭐ 644 | 🐛 27 | 🌐 Python | 📅 2025-12-16 🐍 ☁️ - ClickHouse database integration with schema inspection and query capabilities
...
* [neondatabase/mcp-server-neon](https://github.com/neondatabase/mcp-server-neon) ⭐ 530 | 🐛 13 | 🌐 TypeScript | 📅 2026-01-07 📇 ☁️ — An MCP Server for creating and managing Postgres databases using Neon Serverless Postgres
...
* [centralmind/gateway](https://github.com/centralmind/gateway) ⭐ 510 | 🐛 15 | 🌐 Go | 📅 2025-07-18 🏎️ 🏠 🍎 🪟 - MCP and MCP SSE Server that automatically generate API based on database schema and data. Supports PostgreSQL, Clickhouse, MySQL, Snowflake, BigQuery, Supabase
...
* [redis/mcp-redis](https://github.com/redis/mcp-redis) ⭐ 383 | 🐛 7 | 🌐 Python | 📅 2025-12-15 🐍 🏠 - The Redis official MCP Server offers an interface to manage and search data in Redis.

* [domdomegg/airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server) ⭐ 382 | 🐛 9 | 🌐 TypeScript | 📅 2026-01-07 📇 🏠 - Airtable database integration with schema inspection, read and write capabilities
...
* [FreePeak/db-mcp-server](https://github.com/FreePeak/db-mcp-server) ⭐ 336 | 🐛 12 | 🌐 Go | 📅 2025-12-26 🏎️ 🏠 – A high-performance multi-database MCP server built with Golang, supporting MySQL & PostgreSQL (NoSQL coming soon). Includes built-in tools for query execution, transaction management, schema exploration, query building, and performance analysis, with seamless Cursor integration for enhanced database workflows.

* [pab1it0/prometheus-mcp-server](https://github.com/pab1it0/prometheus-mcp-server) ⭐ 332 | 🐛 4 | 🌐 Python | 📅 2025-12-17 🐍 ☁️ -  Query and analyze Prometheus, open-source monitoring system.
...
* [confluentinc/mcp-confluent](https://github.com/confluentinc/mcp-confluent) ⭐ 128 | 🐛 11 | 🌐 TypeScript | 📅 2026-01-09 🐍 ☁️ - Confluent integration to interact with Confluent Kafka and Confluent Cloud REST APIs.
...
* [jparkerweb/mcp-sqlite](https://github.com/jparkerweb/mcp-sqlite) ⭐ 79 | 🐛 1 | 🌐 JavaScript | 📅 2025-06-02 📇 🏠 - Model Context Protocol (MCP) server that provides comprehensive SQLite database interaction capabilities.
...
* [Zhwt/go-mcp-mysql](https://github.com/Zhwt/go-mcp-mysql) ⭐ 48 | 🐛 2 | 🌐 Go | 📅 2025-08-19 🏎️ 🏠 – Easy to use, zero dependency MySQL MCP server built with Golang with configurable readonly mode and schema inspection.
...
* [ferrants/memvid-mcp-server](https://github.com/ferrants/memvid-mcp-server) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2025-06-20 🐍 🏠 - Python Streamable HTTP Server you can run locally to interact with [memvid](https://github.com/Olow304/memvid) ⭐ 11,868 | 🐛 26 | 🌐 Rust | 📅 2026-01-10 storage and semantic search.
...
* [hydrolix/mcp-hydrolix](https://github.com/hydrolix/mcp-hydrolix) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2026-01-09 🎖️ 🐍 ☁️ - Hydrolix time-series datalake integration providing schema exploration and query capabilities to LLM-based workflows.
...
* [dbt-labs/dbt-mcp](https://github.com/dbt-labs/dbt-mcp) ⭐ 453 | 🐛 22 | 🌐 Python | 📅 2026-01-09 🎖️ 🐍 🏠 ☁️ - Official MCP server for [dbt (data build tool)](https://www.getdbt.com/product/what-is-dbt) providing integration with dbt Core/Cloud CLI, project metadata discovery, model information, and semantic layer querying capabilities.
...
* [eyaltoledano/claude-task-master](https://github.com/eyaltoledano/claude-task-master) ⭐ 24,714 | 🐛 155 | 🌐 JavaScript | 📅 2026-01-07 📇 ☁️ 🏠 - AI-powered task management system for AI-driven development. Features PRD parsing, task expansion, multi-provider support (Claude, OpenAI, Gemini, Perplexity, xAI), and selective tool loading for optimized context usage.
* [GLips/Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 12,461 | 🐛 38 | 🌐 TypeScript | 📅 2026-01-01 📇 🏠 - Provide coding agents direct access to Figma data to help them one-shot design implementation.
* [idosal/git-mcp](https://github.com/idosal/git-mcp) ⭐ 7,346 | 🐛 48 | 🌐 TypeScript | 📅 2025-08-22 📇 ☁️ - [gitmcp.io](https://gitmcp.io/) is a generic remote MCP server to connect to ANY [GitHub](https://www.github.com) repository or project for documentation
* [21st-dev/Magic-MCP](https://github.com/21st-dev/magic-mcp) ⭐ 4,096 | 🐛 21 | 🌐 TypeScript | 📅 2025-12-23 - Create crafted UI components inspired by the best 21st.dev design engineers.
* [haris-musa/excel-mcp-server](https://github.com/haris-musa/excel-mcp-server) ⭐ 3,106 | 🐛 37 | 🌐 Python | 📅 2025-12-22 🐍 🏠 - An Excel manipulation server providing workbook creation, data operations, formatting, and advanced features (charts, pivot tables, formulae).
* [mobile-next/mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 3,025 | 🐛 32 | 🌐 TypeScript | 📅 2026-01-05 📇 🏠 🐧 🍎 - MCP Server for Android/iOS application and device automation, development and app scraping. Simulator/Emulator/Physical devices like iPhone, Google Pixel, Samsung supported.
* [Jpisnice/shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,585 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-29 📇 🏠 - MCP server that gives AI assistants seamless access to shadcn/ui v4 components, blocks, demos, and metadata.
...
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 1,422 | 🐛 13 | 🌐 JavaScript | 📅 2025-12-31 📇 🏠 🍎 - A Model Context Protocol (MCP) server for interacting with iOS simulators. This server allows you to interact with iOS simulators by getting information about them, controlling UI interactions, and inspecting UI elements.
* [isaacphi/mcp-language-server](https://github.com/isaacphi/mcp-language-server) ⭐ 1,376 | 🐛 45 | 🌐 Go | 📅 2026-01-01 🏎️ 🏠 - MCP Language Server helps MCP enabled clients navigate codebases more easily by giving them access to semantic tools like get definition, references, rename, and diagnostics.
* [jetbrains/mcpProxy](https://github.com/JetBrains/mcpProxy) ⭐ 938 | 🐛 37 | 🌐 JavaScript | 📅 2026-01-07 🎖️ 📇 🏠 - Connect to JetBrains IDE
* [lpigeon/ros-mcp-server](https://github.com/lpigeon/ros-mcp-server) ⭐ 918 | 🐛 18 | 🌐 Python | 📅 2026-01-09 🐍 🏠 🍎 🪟 🐧 - The ROS MCP Server supports robot control by converting user-issued natural language commands into ROS or ROS2 control commands.
...
* [bgauryy/octocode-mcp](https://github.com/bgauryy/octocode-mcp) ⭐ 666 | 🐛 3 | 🌐 TypeScript | 📅 2026-01-09 ☁️ 📇 🍎 🪟 🐧 - AI-powered developer assistant that enables advanced research, analysis and discovery across GitHub and NPM realms in realtime.
...
* [utensils/mcp-nixos](https://github.com/utensils/mcp-nixos) ⭐ 387 | 🐛 4 | 🌐 Python | 📅 2026-01-07 🐍 🏠 - MCP server providing accurate information about NixOS packages, system options, Home Manager configurations, and nix-darwin macOS settings to prevent AI hallucinations.
* [gitkraken/gk-cli](https://github.com/gitkraken/gk-cli) ⭐ 346 | 🐛 14 | 📅 2025-12-22 🎖️ 🏎️ 🏠 ☁️ 🍎 🪟 🐧 - A CLI for interacting with GitKraken APIs. Includes an MCP server via `gk mcp` that not only wraps GitKraken APIs, but also Jira, GitHub, GitLab, and more. Works with local tools and remote services.
...
* [joshuarileydev/app-store-connect-mcp-server](https://github.com/JoshuaRileyDev/app-store-connect-mcp-server) ⭐ 253 | 🐛 6 | 🌐 TypeScript | 📅 2025-09-02 📇 🏠 - An MCP server to communicate with the App Store Connect API for iOS Developers
* [public-ui/kolibri](https://github.com/public-ui/kolibri) ⭐ 243 | 🐛 156 | 🌐 TypeScript | 📅 2026-01-10 📇 ☁️ 🏠 - Streaming KoliBri MCP server (NPM: `@public-ui/mcp`) delivering 200+ guaranteed accessible web component samples, specs, docs, and scenarios via hosted HTTP endpoint or local `kolibri-mcp` CLI.
...
* [storybookjs/addon-mcp](https://github.com/storybookjs/addon-mcp) ⭐ 162 | 🐛 9 | 🌐 TypeScript | 📅 2026-01-09 📇 🏠 - Help agents automatically write and test stories for your UI components.
...
* [hloiseaufcms/mcp-gopls](https://github.com/hloiseaufcms/mcp-gopls) ⭐ 59 | 🐛 0 | 🌐 Go | 📅 2026-01-07 🏎️ 🏠 - A MCP server for interacting with [Go's Language Server Protocol (gopls)](https://github.com/golang/tools/tree/master/gopls) ⭐ 7,864 | 🐛 107 | 🌐 Go | 📅 2026-01-09 and benefit from advanced Go code analysis features.
* [qainsights/jmeter-mcp-server](https://github.com/QAInsights/jmeter-mcp-server) ⭐ 57 | 🐛 6 | 🌐 Python | 📅 2025-06-15 🐍 🏠 - JMeter MCP Server for performance testing
...
* [api7/apisix-mcp](https://github.com/api7/apisix-mcp) ⭐ 30 | 🐛 2 | 🌐 TypeScript | 📅 2025-06-16 🎖️ 📇 🏠 MCP Server that support for querying and managing all resource in [Apache APISIX](https://github.com/apache/apisix) ⭐ 16,062 | 🐛 340 | 🌐 Lua | 📅 2026-01-08.
...
* [j4c0bs/mcp-server-sql-analyzer](https://github.com/j4c0bs/mcp-server-sql-analyzer) ⭐ 26 | 🐛 0 | 🌐 Python | 📅 2025-07-01 🐍 - MCP server that provides SQL analysis, linting, and dialect conversion using [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 8,791 | 🐛 14 | 🌐 Python | 📅 2026-01-09
...
* [higress-group/higress-ops-mcp-server](https://github.com/higress-group/higress-ops-mcp-server) ⭐ 22 | 🐛 6 | 🌐 Python | 📅 2025-03-29 🐍 🏠 - MCP server that provides comprehensive tools for managing [Higress](https://github.com/alibaba/higress) ⭐ 7,258 | 🐛 730 | 🌐 Go | 📅 2026-01-10 gateway configurations and operations.
...
* [sbroenne/mcp-server-excel](https://github.com/sbroenne/mcp-server-excel) ⭐ 13 | 🐛 4 | 🌐 C# | 📅 2026-01-09 #️⃣ 🏠 🪟 - Full-featured Excel MCP server. 173 operations: Power Query, DAX, VBA, PivotTables, Tables, Charts, ranges, formatting. 100% Excel compatibility - uses Excel app instead of creating .xlsx files. Windows only.
...
* [narumiruna/gitingest-mcp](https://github.com/narumiruna/gitingest-mcp) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2025-11-21 🐍 🏠 - A MCP server that uses [gitingest](https://github.com/cyclotruc/gitingest) ⭐ 13,564 | 🐛 29 | 🌐 Python | 📅 2026-01-02 to convert any Git repository into a simple text digest of its codebase.
...
* [InsForge/insforge-mcp](https://github.com/InsForge/insforge-mcp) ⭐ 6 | 🐛 6 | 🌐 TypeScript | 📅 2026-01-10 📇 ☁️ - AI-native backend-as-a-service platform enabling AI agents to build and manage full-stack applications. Provides Auth, Database (PostgreSQL), Storage, and Functions as production-grade infrastructure, reducing MVP development time from weeks to hours.
...
* [hoklims/stacksfinder-mcp](https://github.com/hoklims/stacksfinder-mcp) ⭐ 1 | 🐛 1 | 🌐 TypeScript | 📅 2026-01-07 📇 🏠 🍎 🪟 🐧 - Deterministic tech stack recommendations with 6-dimension scoring. Analyze, compare technologies, get optimal stack suggestions for any project type. 10 tools (4 free, 6 Pro).
...
* [pzalutski-pixel/sharplens-mcp](https://github.com/pzalutski-pixel/sharplens-mcp) ⭐ 0 | 🐛 0 | 🌐 C# | 📅 2026-01-01 #️⃣ 🏠 - 58 semantic C#/.NET analysis tools via Roslyn. Navigation, refactoring, find usages, and code intelligence for AI agents.
...
* [mckinsey/vizro-mcp](https://github.com/mckinsey/vizro/tree/main/vizro-mcp) ⭐ 3,517 | 🐛 56 | 🌐 Python | 📅 2026-01-09 🎖️ 🐍 🏠 - Tools and templates to create validated and maintainable data charts and dashboards.
* [zcaceres/markdownify-mcp](https://github.com/zcaceres/markdownify-mcp) ⭐ 2,342 | 🐛 18 | 🌐 TypeScript | 📅 2025-09-02 📇 🏠 - An MCP server to convert almost any file or web content into Markdown
...
* [DataEval/dingo](https://github.com/DataEval/dingo) ⭐ 614 | 🐛 6 | 🌐 JavaScript | 📅 2026-01-07 🎖️ 🐍 🏠 🍎 🪟 🐧 - MCP server for the Dingo: a comprehensive data quality evaluation tool. Server Enables interaction with Dingo's rule-based and LLM-based evaluation capabilities and rules\&prompts listing.
...
* [horw/esp-mcp](https://github.com/horw/esp-mcp) ⭐ 123 | 🐛 31 | 🌐 Python | 📅 2025-12-27 📟 - Workflow for fixing build issues in ESP32 series chips using ESP-IDF.
* [yoelbassin/gnuradioMCP](https://github.com/yoelbassin/gnuradioMCP) ⭐ 24 | 🐛 0 | 🌐 Python | 📅 2026-01-05 🐍 📟 🏠 - An MCP server for GNU Radio that enables LLMs to autonomously create and modify RF `.grc` flowcharts.
...
* [microsoft/markitdown](https://github.com/microsoft/markitdown/tree/main/packages/markitdown-mcp) ⭐ 85,092 | 🐛 414 | 🌐 Python | 📅 2026-01-08 🎖️ 🐍 🏠 - MCP tool access to MarkItDown -- a library that converts many file formats (local or remote) to Markdown for LLM consumption.
* [mickaelkerjean/filestash](https://github.com/mickael-kerjean/filestash/tree/master/server/plugin/plg_handler_mcp) ⭐ 13,374 | 🐛 60 | 🌐 JavaScript | 📅 2026-01-07 🏎️ ☁️ - Remote Storage Access: SFTP, S3, FTP, SMB, NFS, WebDAV, GIT, FTPS, gcloud, azure blob, sharepoint, etc.
...
* [longportapp/openapi](https://github.com/longportapp/openapi/tree/main/mcp) ⭐ 334 | 🐛 82 | 🌐 Rust | 📅 2025-12-15 - 🐍 ☁️ - LongPort OpenAPI provides real-time stock market data, provides AI access analysis and trading capabilities through MCP.
...
* [polygon-io/mcp\_polygon)](https://github.com/polygon-io/mcp_polygon) ⭐ 239 | 🐛 17 | 🌐 Python | 📅 2025-11-18) 🐍 ☁️ -  An MCP server that provides access to [Polygon.io](https://polygon.io/) financial market data APIs for stocks, indices, forex, options, and more.
...
* [ariadng/metatrader-mcp-server](https://github.com/ariadng/metatrader-mcp-server) ⭐ 143 | 🐛 5 | 🌐 Python | 📅 2025-10-09 🐍 🏠 🪟 - Enable AI LLMs to execute trades using MetaTrader 5 platform
...
* [kukapay/crypto-indicators-mcp](https://github.com/kukapay/crypto-indicators-mcp) ⭐ 105 | 🐛 5 | 🌐 JavaScript | 📅 2025-12-06 🐍 ☁️ - An MCP server providing a range of cryptocurrency technical analysis indicators and strategie.
...
* [ThomasMarches/substrate-mcp-rs](https://github.com/ThomasMarches/substrate-mcp-rs) ⭐ 12 | 🐛 0 | 🌐 Rust | 📅 2025-10-12 🦀 🏠 - An MCP server implementation to interact with Substrate-based blockchains. Built with Rust and interfacing the [subxt](https://github.com/paritytech/subxt) ⭐ 475 | 🐛 92 | 🌐 Rust | 📅 2026-01-09 crate.
...
* [Coding-Solo/godot-mcp](https://github.com/Coding-Solo/godot-mcp) ⭐ 1,351 | 🐛 21 | 🌐 JavaScript | 📅 2026-01-05 📇 🏠 - A MCP server for interacting with the Godot game engine, providing tools for editing, running, debugging, and managing scenes in Godot projects.
* [CoderGamester/mcp-unity](https://github.com/CoderGamester/mcp-unity) ⭐ 1,207 | 🐛 8 | 🌐 C# | 📅 2026-01-06 #️⃣ 🏠 - MCP Server for Unity3d Game Engine integration for game development
* [IvanMurzak/Unity-MCP](https://github.com/IvanMurzak/Unity-MCP) ⭐ 735 | 🐛 33 | 🌐 C# | 📅 2026-01-09 #️⃣ 🏠 🍎 🪟 🐧 - MCP Server for Unity Editor and for a game made with Unity
...
* [opgginc/opgg-mcp](https://github.com/opgginc/opgg-mcp) ⭐ 58 | 🐛 2 | 🌐 TypeScript | 📅 2026-01-01 📇 ☁️ - Access real-time gaming data across popular titles like League of Legends, TFT, and Valorant, offering champion analytics, esports schedules, meta compositions, and character statistics.
...
* [upstash/context7](https://github.com/upstash/context7) ⭐ 41,400 | 🐛 78 | 🌐 TypeScript | 📅 2026-01-09 📇 ☁️ - Up-to-date code documentation for LLMs and AI code editors.
* [topoteretes/cognee](https://github.com/topoteretes/cognee/tree/dev/cognee-mcp) ⭐ 10,819 | 🐛 39 | 🌐 Python | 📅 2026-01-09 📇 🏠 - Memory manager for AI apps and Agents using various graph and vector stores and allowing ingestion from 30+ data sources
* [vectorize-io/hindsight](https://github.com/vectorize-io/hindsight) ⭐ 1,048 | 🐛 10 | 🌐 Python | 📅 2026-01-09 🐍 ☁️ 🏠 - Hindsight: Agent Memory That Works Like Human Memory - Built for AI Agents to manage Long Term Memory
...
* [apecloud/ApeRAG](https://github.com/apecloud/ApeRAG) ⭐ 1,007 | 🐛 54 | 🌐 Python | 📅 2026-01-07 🐍 ☁️ 🏠 - Production-ready RAG platform combining Graph RAG, vector search, and full-text search. Best choice for building your own Knowledge Graph and for Context Engineering
* [mem0ai/mem0-mcp](https://github.com/mem0ai/mem0-mcp) ⭐ 552 | 🐛 12 | 🌐 Python | 📅 2025-12-07 🐍 🏠 - A Model Context Protocol server for Mem0 that helps manage coding preferences and patterns, providing tools for storing, retrieving and semantically handling code implementations, best practices and technical documentation in IDEs like Cursor and Windsurf
...
* [agentic-mcp-tools/memora](https://github.com/agentic-mcp-tools/memora) ⭐ 73 | 🐛 0 | 🌐 Python | 📅 2026-01-08 🐍 🏠 ☁️ - Persistent memory with knowledge graph visualization, semantic/hybrid search, cloud sync (S3/R2), and cross-session context management.
* [shinpr/mcp-local-rag](https://github.com/shinpr/mcp-local-rag) ⭐ 54 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-08 📇 🏠 - Privacy-first document search server running entirely locally. Supports semantic search over PDFs, DOCX, TXT, and Markdown files with LanceDB vector storage and local embeddings - no API keys or cloud services required.
...
* [Smart-AI-Memory/empathy-framework](https://github.com/Smart-AI-Memory/empathy-framework) ⭐ 9 | 🐛 9 | 🌐 HTML | 📅 2026-01-09 🐍 🏠 - Five-level AI collaboration system with persistent memory and anticipatory capabilities. MCP-native integration for Claude and other LLMs with local-first architecture via MemDocs.
...
* [mahdin75/geoserver-mcp](https://github.com/mahdin75/geoserver-mcp) ⭐ 54 | 🐛 1 | 🌐 Python | 📅 2025-12-13 🏠 – A Model Context Protocol (MCP) server implementation that connects LLMs to the GeoServer REST API, enabling AI assistants to interact with geospatial data and services.
...
* [netdata/netdata#Netdata](https://github.com/netdata/netdata/blob/master/src/web/mcp/README.md) ⭐ 77,294 | 🐛 242 | 🌐 C | 📅 2026-01-10 🎖️ 🏠 ☁️ 📟 🍎 🪟 🐧 - Discovery, exploration, reporting and root cause analysis using all observability data, including metrics, logs, systems, containers, processes, and network connections
* [grafana/mcp-grafana](https://github.com/grafana/mcp-grafana) ⭐ 2,099 | 🐛 63 | 🌐 Go | 📅 2026-01-09 🎖️ 🐍 🏠 ☁️ - Search dashboards, investigate incidents and query datasources in your Grafana instance
* [getsentry/sentry-mcp](https://github.com/getsentry/sentry-mcp) ⭐ 493 | 🐛 47 | 🌐 TypeScript | 📅 2026-01-10 🐍 ☁️ - Sentry.io integration for error tracking and performance monitoring
...
* [last9/last9-mcp-server](https://github.com/last9/last9-mcp-server) ⭐ 48 | 🐛 2 | 🌐 Go | 📅 2026-01-09 - Seamlessly bring real-time production context—logs, metrics, and traces—into your local environment to auto-fix code faster
...
* [sunriseapps/imagesorcery-mcp](https://github.com/sunriseapps/imagesorcery-mcp) ⭐ 266 | 🐛 4 | 🌐 Python | 📅 2025-09-23 🐍 🏠 🐧 🍎 🪟 - ComputerVision-based 🪄 sorcery of image recognition and editing tools for AI assistants.
...
* [strato-space/media-gen-mcp](https://github.com/strato-space/media-gen-mcp) ⭐ 7 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-30 📇 ☁️ 🏠 - TypeScript MCP server for OpenAI Images/Videos and Google GenAI (Veo) media generation, editing, and asset downloads.
...
* [exa-labs/exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) ⭐ 3,519 | 🐛 29 | 🌐 TypeScript | 📅 2026-01-06 🎖️ 📇 ☁️ – A Model Context Protocol (MCP) server lets AI assistants like Claude use the Exa AI Search API for web searches. This setup allows AI models to get real-time web information in a safe and controlled way.
* [devflowinc/trieve](https://github.com/devflowinc/trieve/tree/main/clients/mcp-server) ⭐ 2,594 | 🐛 2 | 🌐 Rust | 📅 2025-10-10 🎖️ 📇 ☁️ 🏠 - Crawl, embed, chunk, search, and retrieve information from datasets through [Trieve](https://trieve.ai)
* [blazickjp/arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) ⭐ 2,022 | 🐛 34 | 🌐 Python | 📅 2025-08-19 ☁️ 🐍 - Search ArXiv research papers
* [luminati-io/brightdata-mcp](https://github.com/luminati-io/brightdata-mcp) ⭐ 1,873 | 🐛 13 | 🌐 JavaScript | 📅 2026-01-08 📇 ☁️ - Discover, extract, and interact with the web - one interface powering automated access across the public internet.
...
* [nickclyde/duckduckgo-mcp-server](https://github.com/nickclyde/duckduckgo-mcp-server) ⭐ 715 | 🐛 21 | 🌐 Python | 📅 2025-03-11 🐍 ☁️ - Web search using DuckDuckGo
* [Aas-ee/open-webSearch](https://github.com/Aas-ee/open-webSearch) ⭐ 563 | 🐛 9 | 🌐 TypeScript | 📅 2025-10-26 🐍 📇 ☁️ - Web search using free multi-engine search (NO API KEYS REQUIRED) — Supports Bing, Baidu, DuckDuckGo, Brave, Exa, and CSDN.
* [brave/brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) ⭐ 495 | 🐛 16 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️ - Web search capabilities using Brave's Search API
* [genomoncology/biomcp](https://github.com/genomoncology/biomcp) ⭐ 386 | 🐛 14 | 🌐 Python | 📅 2026-01-08 🐍 ☁️ - Biomedical research server providing access to PubMed, ClinicalTrials.gov, and MyVariant.info.
* [Ihor-Sokoliuk/MCP-SearXNG](https://github.com/ihor-sokoliuk/mcp-searxng) ⭐ 383 | 🐛 11 | 🌐 TypeScript | 📅 2025-11-09 📇 🏠/☁️ - A Model Context Protocol Server for [SearXNG](https://docs.searxng.org)
...
* [scrapeless-ai/scrapeless-mcp-server](https://github.com/scrapeless-ai/scrapeless-mcp-server) ⭐ 143 | 🐛 0 | 🌐 TypeScript | 📅 2025-09-23 🐍 ☁️ - The Scrapeless Model Context Protocol service acts as an MCP server connector to the Google SERP API, enabling web search within the MCP ecosystem without leaving it.
...
* [mikechao/brave-search-mcp](https://github.com/mikechao/brave-search-mcp) ⭐ 90 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-09 📇 ☁️ - Web, Image, News, Video, and Local Point of Interest search capabilities using Brave's Search API
...
* [adawalli/nexus](https://github.com/adawalli/nexus) ⭐ 18 | 🐛 9 | 🌐 TypeScript | 📅 2026-01-07 📇 ☁️ - AI-powered web search server using Perplexity Sonar models with source citations. Zero-install setup via NPX.
...
* [LaurieWired/GhidraMCP](https://github.com/LaurieWired/GhidraMCP) ⭐ 7,024 | 🐛 59 | 🌐 Java | 📅 2025-06-23 ☕ 🏠 - A Model Context Protocol server for Ghidra that enables LLMs to autonomously reverse engineer applications. Provides tools for decompiling binaries, renaming methods and data, and listing methods, classes, imports, and exports.
* [mrexodia/ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) ⭐ 4,947 | 🐛 35 | 🌐 Python | 📅 2026-01-09 🐍 🏠 - MCP server for IDA Pro, allowing you to perform binary analysis with AI assistants. This plugin implement decompilation, disassembly and allows you to generate malware analysis reports automatically.
* [mariocandela/beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,804 | 🐛 6 | 🌐 Go | 📅 2025-12-24 ☁️ - Beelzebub is a honeypot framework that lets you build honeypot tools using MCP. Its purpose is to detect prompt injection or malicious agent behavior. The underlying idea is to provide the agent with tools it would never use in its normal work.
* [zinja-coder/jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp) ⭐ 1,045 | 🐛 8 | 🌐 Java | 📅 2026-01-08 ☕ 🏠 - JADX-AI-MCP is a plugin and MCP Server for the JADX decompiler that integrates directly with Model Context Protocol (MCP) to provide live reverse engineering support with LLMs like Claude.
...
* [jtang613/GhidrAssistMCP](https://github.com/jtang613/GhidrAssistMCP) ⭐ 393 | 🐛 3 | 🌐 Java | 📅 2026-01-06 ☕ 🏠 - A native Model Context Protocol server for Ghidra. Includes GUI configuration and logging, 31 powerful tools and no external dependencies.
* [zinja-coder/apktool-mcp-server](https://github.com/zinja-coder/apktool-mcp-server) ⭐ 273 | 🐛 0 | 🌐 Python | 📅 2025-09-12 🐍 🏠 - APKTool MCP Server is a MCP server for the Apk Tool to provide automation in reverse engineering of Android APKs.
...
* [radareorg/r2mcp](https://github.com/radareorg/radare2-mcp) ⭐ 120 | 🐛 2 | 🌐 C | 📅 2025-12-09 🍎🪟🐧🏠🌊 - MCP server for Radare2 disassembler. Provides AI with capability to disassemble and look into binaries for reverse engineering.
...
* [atomicchonk/roadrecon\_mcp\_server](https://github.com/atomicchonk/roadrecon_mcp_server) ⭐ 47 | 🐛 1 | 🌐 Python | 📅 2025-03-30 🐍 🪟 🏠 MCP server for analyzing ROADrecon gather results from Azure tenant enumeration
...
* [anwerj/youtube-uploader-mcp](https://github.com/anwerj/youtube-uploader-mcp) ⭐ 31 | 🐛 1 | 🌐 Go | 📅 2025-10-11 🏎️ ☁️ - AI‑powered YouTube uploader—no CLI, no YouTube Studio. Uploade videos directly from MCP clients with all AI capabilities.
...
* [r-huijts/strava-mcp](https://github.com/r-huijts/strava-mcp) ⭐ 215 | 🐛 5 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️ - A Model Context Protocol (MCP) server that connects to Strava API, providing tools to access Strava data through LLMs
...
* [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 3,934 | 🐛 137 | 🌐 Python | 📅 2026-01-06 🐍 ☁️ - MCP server for Atlassian products (Confluence and Jira). Supports Confluence Cloud, Jira Cloud, and Jira Server/Data Center. Provides comprehensive tools for searching, reading, creating, and managing content across Atlassian workspaces.
...
* [aikts/yandex-tracker-mcp](https://github.com/aikts/yandex-tracker-mcp) ⭐ 33 | 🐛 8 | 🌐 Python | 📅 2026-01-09 🐍 ☁️ 🏠 - MCP Server for Yandex Tracker. Provides tools for searching and retrieving information about issues, queues, users.
...
* [mbailey/voice-mcp](https://github.com/mbailey/voice-mcp) ⭐ 559 | 🐛 26 | 🌐 Python | 📅 2026-01-10 🐍 🏠 - Complete voice interaction server supporting speech-to-text, text-to-speech, and real-time voice conversations through local microphone, OpenAI-compatible APIs, and LiveKit integration
...
* [github/github-mcp-server](https://github.com/github/github-mcp-server) ⭐ 25,757 | 🐛 237 | 🌐 Go | 📅 2026-01-09 📇 ☁️ - Official GitHub server for integration with repository management, PRs, issues, and more.
...
* [kopfrechner/gitlab-mr-mcp](https://github.com/kopfrechner/gitlab-mr-mcp) ⭐ 72 | 🐛 8 | 🌐 JavaScript | 📅 2026-01-07 📇 ☁️ - Interact seamlessly with issues and merge requests of your GitLab projects.
...
* [taylorwilsdon/google\_workspace\_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) ⭐ 1,088 | 🐛 44 | 🌐 Python | 📅 2026-01-07 🐍 ☁️ 🍎 🪟 🐧 - Comprehensive Google Workspace MCP server with full support for Google Calendar, Drive, Gmail, and Docs, Forms, Chats, Slides and Sheets over stdio, Streamable HTTP and SSE transports.
...
* [modelcontextprotocol/server-everything](https://github.com/modelcontextprotocol/servers/tree/main/src/everything) ⭐ 75,848 | 🐛 260 | 🌐 TypeScript | 📅 2026-01-07 📇 🏠 - MCP server that exercises all the features of the MCP protocol
* [mediar-ai/screenpipe](https://github.com/mediar-ai/screenpipe) ⭐ 16,381 | 🐛 242 | 🌐 TypeScript | 📅 2025-12-09 - 🎖️ 🦀 🏠 🍎 Local-first system capturing screen/audio with timestamped indexing, SQL/embedding storage, semantic search, LLM-powered history analysis, and event-triggered actions - enables building context-aware AI agents through a NextJS plugin ecosystem.
* [Klavis-AI/YouTube](https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/youtube) ⭐ 5,581 | 🐛 54 | 🌐 Python | 📅 2026-01-09 🐍 📇 - Extract and convert YouTube video information.
* [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 3,934 | 🐛 137 | 🌐 Python | 📅 2026-01-06 🐍 ☁️ - MCP server for Atlassian products (Confluence and Jira). Supports Confluence Cloud, Jira Cloud, and Jira Server/Data Center. Provides comprehensive tools for searching, reading, creating, and managing content across Atlassian workspaces.
* [metorial/metorial](https://github.com/metorial/metorial) ⭐ 3,199 | 🐛 1 | 🌐 TypeScript | 📅 2026-01-10 - 🎖️ 📇 ☁️ Connect AI agents to 600+ integrations with a single interface - OAuth, scaling, and monitoring included
* [MarkusPfundstein/mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian) ⭐ 2,667 | 🐛 68 | 🌐 Python | 📅 2025-06-28 🐍 ☁️ 🏠 - Interacting with Obsidian via REST API
* [chrishayuk/mcp-cli](https://github.com/chrishayuk/mcp-cli) ⭐ 1,798 | 🐛 23 | 🌐 Python | 📅 2025-12-29 🐍 🏠 - Yet another CLI tool for testing MCP servers
* [anaisbetts/mcp-installer](https://github.com/anaisbetts/mcp-installer) ⭐ 1,491 | 🐛 21 | 🌐 JavaScript | 📅 2024-11-26 🐍 🏠 -  An MCP server that installs other MCP servers for you.
* [calclavia/mcp-obsidian](https://github.com/calclavia/mcp-obsidian) ⭐ 1,266 | 🐛 16 | 🌐 JavaScript | 📅 2026-01-02 📇 🏠 - This is a connector to allow Claude Desktop (or any MCP client) to read and search any directory containing Markdown notes (such as an Obsidian vault).
...
* [apify/actors-mcp-server](https://github.com/apify/actors-mcp-server) ⭐ 683 | 🐛 31 | 🌐 TypeScript | 📅 2026-01-09 📇 ☁️ - Use 3,000+ pre-built cloud tools, known as Actors, to extract data from websites, e-commerce, social media, search engines, maps, and more
...
* [tevonsb/homeassistant-mcp](https://github.com/tevonsb/homeassistant-mcp) ⭐ 512 | 🐛 17 | 🌐 TypeScript | 📅 2025-02-01 📇 🏠 - Access Home Assistant data and control devices (lights, switches, thermostats, etc).
...
* [blurrah/mcp-graphql](https://github.com/blurrah/mcp-graphql) ⭐ 345 | 🐛 12 | 🌐 TypeScript | 📅 2025-09-08 📇 ☁️ - Allows the AI to query GraphQL servers
...
* [marcelmarais/Spotify](https://github.com/marcelmarais/spotify-mcp-server) ⭐ 210 | 🐛 6 | 🌐 TypeScript | 📅 2026-01-05 - 📇 🏠 Control Spotify playback and manage playlists.
...
* [ivnvxd/mcp-server-odoo](https://github.com/ivnvxd/mcp-server-odoo) ⭐ 129 | 🐛 14 | 🌐 Python | 📅 2025-12-15 🐍 ☁️/🏠 - Connect AI assistants to Odoo ERP systems for business data access, record management, and workflow automation.
...
* [johannesbrandenburger/typst-mcp](https://github.com/johannesbrandenburger/typst-mcp) ⭐ 94 | 🐛 4 | 🌐 Python | 📅 2025-12-08 🐍 🏠 - MCP server for Typst, a markup-based typesetting system. It provides tools for converting between LaTeX and Typst, validating Typst syntax, and generating images from Typst code.
...
* [anki-mcp/anki-mcp-desktop](https://github.com/anki-mcp/anki-mcp-desktop) ⭐ 72 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-14 📇 🏠 🍎 🪟 🐧 - Enterprise-grade Anki integration with natural language interaction, comprehensive note/deck management, and one-click MCPB installation. Built on NestJS with comprehensive test coverage.
...
> \[!NOTE]
> More frameworks, utilities, and other developer tools are available at <https://github.com/punkpeye/awesome-mcp-devtools> ⭐ 397 | 🐛 10 | 📅 2026-01-06

* [FastMCP](https://github.com/jlowin/fastmcp) ⭐ 21,812 | 🐛 223 | 🌐 Python | 📅 2026-01-10 🐍 - A high-level framework for building MCP servers in Python
* [FastMCP](https://github.com/punkpeye/fastmcp) ⭐ 2,866 | 🐛 35 | 🌐 TypeScript | 📅 2026-01-06 📇 - A high-level framework for building MCP servers in TypeScript
