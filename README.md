...
* [mindsdb/mindsdb](https://github.com/mindsdb/mindsdb) ⭐ 38,221 | 🐛 206 | 🌐 Python | 📅 2026-01-09 - Connect and unify data across various platforms and databases with [MindsDB as a single MCP server](https://docs.mindsdb.com/mcp/overview).
* [PipedreamHQ/pipedream](https://github.com/PipedreamHQ/pipedream/tree/master/modelcontextprotocol) ⭐ 10,949 | 🐛 4,353 | 🌐 JavaScript | 📅 2026-01-09 ☁️ 🏠 - Connect with 2,500 APIs with 8,000+ prebuilt tools, and manage servers for your users, in your own app.
* [metatool-ai/metatool-app](https://github.com/metatool-ai/metatool-app) ⭐ 1,882 | 🐛 62 | 🌐 TypeScript | 📅 2025-12-23 📇 ☁️ 🏠 🍎 🪟 🐧 - MetaMCP is the one unified middleware MCP server that manages your MCP connections with GUI.
* [julien040/anyquery](https://github.com/julien040/anyquery) ⭐ 1,581 | 🐛 8 | 🌐 Go | 📅 2025-11-11 🏎️ 🏠 ☁️ - Query more than 40 apps with one binary using SQL. It can also connect to your PostgreSQL, MySQL, or SQLite compatible database. Local-first and private by design.
* [duaraghav8/MCPJungle](https://github.com/duaraghav8/MCPJungle) ⭐ 781 | 🐛 47 | 🌐 Go | 📅 2026-01-08 🏎️ 🏠 - Self-hosted MCP Server registry for enterprise AI Agents
* [TheLunarCompany/lunar#mcpx](https://github.com/TheLunarCompany/lunar/tree/main/mcpx) ⭐ 380 | 🐛 5 | 🌐 TypeScript | 📅 2026-01-08 📇 🏠  ☁️ 🍎 🪟 🐧 - MCPX is a production-ready, open-source gateway to manage MCP servers at scale—centralize tool discovery, access controls, call prioritization, and usage tracking to simplify agent workflows.
* [1mcp/agent](https://github.com/1mcp-app/agent) ⭐ 342 | 🐛 8 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️ 🏠 🍎 🪟 🐧 - A unified Model Context Protocol server implementation that aggregates multiple MCP servers into one.
...
* [K-Dense-AI/claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp) ⭐ 248 | 🐛 3 | 🌐 Python | 📅 2025-11-11 🐍 ☁️ 🏠 🍎 🪟 🐧 - Intelligent search capabilities to let every model and client use [Claude Agent Skills](https://www.anthropic.com/news/skills) like native.
...
* [sitbon/magg](https://github.com/sitbon/magg) ⭐ 125 | 🐛 5 | 🌐 Python | 📅 2025-08-07 🍎 🪟 🐧 ☁️ 🏠 🐍 - Magg: A meta-MCP server that acts as a universal hub, allowing LLMs to autonomously discover, install, and orchestrate multiple MCP servers - essentially giving AI assistants the power to extend their own capabilities on-demand.
* [VeriTeknik/pluggedin-mcp-proxy](https://github.com/VeriTeknik/pluggedin-mcp-proxy) ⭐ 115 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-26  📇 🏠 - A comprehensive proxy server that combines multiple MCP servers into a single interface with extensive visibility features. It provides discovery and management of tools, prompts, resources, and templates across servers, plus a playground for debugging when building MCP servers.
...
* [portel-dev/ncp](https://github.com/portel-dev/ncp) ⭐ 57 | 🐛 1 | 🌐 JavaScript | 📅 2026-01-05 📇 ☁️ 🏠 🍎 🪟 🐧 - NCP orchestrates your entire MCP ecosystem through intelligent discovery, eliminating token overhead while maintaining 98.2% accuracy.
...
* [ahujasid/blender-mcp](https://github.com/ahujasid/blender-mcp) ⭐ 14,881 | 🐛 36 | 🌐 Python | 📅 2026-01-08 🐍 - MCP server for working with Blender
...
* [samuelgursky/davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp) ⭐ 456 | 🐛 10 | 🌐 Python | 📅 2026-01-01 🐍 - MCP server integration for DaVinci Resolve providing powerful tools for video editing, color grading, media management, and project control
...
* [diivi/aseprite-mcp](https://github.com/diivi/aseprite-mcp) ⭐ 101 | 🐛 3 | 🌐 Python | 📅 2025-09-02 🐍 🏠 - MCP server using the Aseprite API to create pixel art
...
* [raveenb/fal-mcp-server](https://github.com/raveenb/fal-mcp-server) ⭐ 21 | 🐛 22 | 🌐 Python | 📅 2025-12-23 🐍 ☁️ - Generate AI images, videos, and music using Fal.ai models (FLUX, Stable Diffusion, MusicGen) directly in Claude Desktop
...
* [molanojustin/smithsonian-mcp](https://github.com/molanojustin/smithsonian-mcp) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-01-05 🐍 ☁️ - MCP server that provides AI assistants with access to the Smithsonian Institution's Open Access collections.
...
* [genomoncology/biomcp](https://github.com/genomoncology/biomcp) ⭐ 384 | 🐛 14 | 🌐 Python | 📅 2026-01-08 🐍 ☁️ - Biomedical research MCP server providing access to PubMed, ClinicalTrials.gov, and MyVariant.info.
...
* [wso2/fhir-mcp-server](https://github.com/wso2/fhir-mcp-server) ⭐ 75 | 🐛 1 | 🌐 Python | 📅 2025-12-11 🐍 🏠 ☁️ - Model Context Protocol server for Fast Healthcare Interoperability Resources (FHIR) APIs. Provides seamless integration with FHIR servers, enabling AI assistants to search, retrieve, create, update, and analyze clinical healthcare data with SMART-on-FHIR authentication support.
...
* [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) ⭐ 25,253 | 🐛 39 | 🌐 TypeScript | 📅 2026-01-07 - Official Microsoft Playwright MCP server, enabling LLMs to interact with web pages through structured accessibility snapshots
* [agent-infra/mcp-server-browser](https://github.com/bytedance/UI-TARS-desktop/tree/main/packages/agent-infra/mcp-servers/browser) ⭐ 21,043 | 🐛 311 | 🌐 TypeScript | 📅 2026-01-05 📇 🏠 - Browser automation capabilities using Puppeteer, both support local and remote browser connection.
* [browsermcp/mcp](https://github.com/browsermcp/mcp) ⭐ 5,385 | 🐛 103 | 🌐 TypeScript | 📅 2025-04-24 📇 🏠 - Automate your local Chrome browser
* [executeautomation/playwright-mcp-server](https://github.com/executeautomation/mcp-playwright) ⭐ 5,125 | 🐛 18 | 🌐 TypeScript | 📅 2025-12-13 📇 - An MCP server using Playwright for browser automation and webscrapping
* [browserbase/mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase) ⭐ 3,019 | 🐛 25 | 🌐 TypeScript | 📅 2025-12-10 🎖️ 📇 - Automate browser interactions in the cloud (e.g. web navigation, data extraction, form filling, and more)
* [operative\_sh/web-eval-agent](https://github.com/Operative-Sh/web-eval-agent) ⭐ 1,231 | 🐛 11 | 🌐 Python | 📅 2026-01-08 🐍 🏠 🍎 - An MCP Server that autonomously debugs web applications with browser-use browser agents
...
* [pskill9/web-search](https://github.com/pskill9/web-search) ⭐ 386 | 🐛 7 | 🌐 JavaScript | 📅 2024-12-30 📇 🏠 - An MCP server that enables free web searching using Google search results, with no API keys required.
...
* [recursechat/mcp-server-apple-shortcuts](https://github.com/recursechat/mcp-server-apple-shortcuts) ⭐ 263 | 🐛 4 | 🌐 JavaScript | 📅 2024-12-22 📇 🏠 🍎 - An MCP Server Integration with Apple Shortcuts
...
* [hanzili/comet-mcp](https://github.com/hanzili/comet-mcp) ⭐ 74 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-07 📇 🏠 🍎 - Connect to Perplexity Comet browser for agentic web browsing, deep research, and real-time task monitoring.
...
* [lightpanda-io/gomcp](https://github.com/lightpanda-io/gomcp) ⭐ 46 | 🐛 3 | 🌐 Go | 📅 2025-06-23 🏎 🏠/☁️ 🐧/🍎 - An MCP server in Go for Lightpanda, the ultra fast headless browser designed for web automation
...
* [awslabs/mcp](https://github.com/awslabs/mcp) ⭐ 7,826 | 🐛 190 | 🌐 Python | 📅 2026-01-09 🎖️ ☁️ - AWS MCP servers for seamless integration with AWS services and resources.
* [txn2/kubefwd](https://github.com/txn2/kubefwd) ⭐ 4,001 | 🐛 0 | 🌐 Go | 📅 2026-01-08 🏎️ 🏠 - Kubernetes bulk port forwarding with service discovery, /etc/hosts management, traffic monitoring, and pod log streaming
* [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) ⭐ 3,263 | 🐛 49 | 🌐 TypeScript | 📅 2026-01-08 🎖️ 📇 ☁️ - Integration with Cloudflare services including Workers, KV, R2, and D1
* [flux159/mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) ⭐ 1,254 | 🐛 13 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️/🏠 - Typescript implementation of Kubernetes cluster operations for pods, deployments, services.
* [manusa/Kubernetes MCP Server](https://github.com/manusa/kubernetes-mcp-server) ⭐ 967 | 🐛 51 | 🌐 Go | 📅 2026-01-08 🏎️ 🏠 A - powerful Kubernetes MCP server with additional support for OpenShift. Besides providing CRUD operations for **any** Kubernetes resource, this server provides specialized tools to interact with your cluster.
...
* [weibaohui/k8m](https://github.com/weibaohui/k8m) ⭐ 751 | 🐛 17 | 🌐 Go | 📅 2026-01-09 🏎️ ☁️/🏠 - Provides MCP multi-cluster Kubernetes management and operations, featuring a management interface, logging, and nearly 50 built-in tools covering common DevOps and development scenarios. Supports both standard and CRD resources.
...
* [pibblokto/cert-manager-mcp-server](https://github.com/pibblokto/cert-manager-mcp-server) ⭐ 21 | 🐛 0 | 🌐 Python | 📅 2025-08-25 🐍 🍎/🐧 ☁️ - mcp server for [cert-manager](https://github.com/cert-manager/cert-manager) ⭐ 13,447 | 🐛 215 | 🌐 Go | 📅 2026-01-09 management and troubleshooting
...
* [pydantic/pydantic-ai/mcp-run-python](https://github.com/pydantic/pydantic-ai/tree/main/mcp-run-python) ⭐ 14,199 | 🐛 448 | 🌐 Python | 📅 2026-01-08 🐍 🏠 - Run Python code in a secure sandbox via MCP tool calls
* [dagger/container-use](https://github.com/dagger/container-use) ⭐ 3,405 | 🐛 64 | 🌐 Go | 📅 2025-12-08 🏎️ 🏠 🐧 🍎 🪟 - Containerized environments for coding agents. Multiple agents can work independently, isolated in fresh containers and git branches. No conflicts, many experiments. Full execution history, terminal access to agent environments, git workflow. Any agent/model/infra stack.
* [ckanthony/openapi-mcp](https://github.com/ckanthony/openapi-mcp) ⭐ 166 | 🐛 3 | 🌐 Go | 📅 2025-11-07 🏎️ ☁️ - OpenAPI-MCP: Dockerized MCP Server to allow your AI agent to access any API with existing api docs.
...
* [oraios/serena](https://github.com/oraios/serena) ⭐ 18,340 | 🐛 87 | 🌐 Python | 📅 2026-01-06 🐍 🏠 - A fully-featured coding agent that relies on symbolic code operations by using language servers.
* [ezyang/codemcp](https://github.com/ezyang/codemcp) ⭐ 1,593 | 🐛 79 | 🌐 Python | 📅 2025-12-25 🐍 🏠 - Coding agent with basic read, write and command line tools.
* [rinadelph/Agent-MCP](https://github.com/rinadelph/Agent-MCP) ⭐ 1,113 | 🐛 15 | 🌐 TypeScript | 📅 2025-10-09 🐍 🏠 - A framework for creating multi-agent systems using MCP for coordinated AI collaboration, featuring task management, shared context, and RAG capabilities.
* [shashankss1205/codegraphcontext](https://github.com/Shashankss1205/CodeGraphContext) ⭐ 321 | 🐛 72 | 🌐 Python | 📅 2026-01-09 🐍 🏠 🍎 🪟 🐧 An MCP server that indexes local code into a graph database to provide context to AI assistants with a graphical code visualizations for humans.
* [juehang/vscode-mcp-server](https://github.com/juehang/vscode-mcp-server) ⭐ 309 | 🐛 5 | 🌐 TypeScript | 📅 2026-01-07 📇 🏠 - A MCP Server that allows AI such as Claude to read from the directory structure in a VS Code workspace, see problems picked up by linter(s) and the language server, read code files, and make edits.
* [stippi/code-assistant](https://github.com/stippi/code-assistant) ⭐ 131 | 🐛 2 | 🌐 Rust | 📅 2026-01-02 🦀 🏠 - Coding agent with basic list, read, replace\_in\_file, write, execute\_command and web search tools. Supports multiple projects concurrently.
* [tiianhk/MaxMSP-MCP-Server](https://github.com/tiianhk/MaxMSP-MCP-Server) ⭐ 130 | 🐛 8 | 🌐 Max | 📅 2025-11-10 🐍 🏠 🎵 🎥 - A coding agent for Max (Max/MSP/Jitter), which is a visual programming language for music and multimedia.
* [nesquikm/mcp-rubber-duck](https://github.com/nesquikm/mcp-rubber-duck) ⭐ 123 | 🐛 7 | 🌐 TypeScript | 📅 2026-01-08 📇 🏠 ☁️ - An MCP server that bridges to multiple OpenAI-compatible LLMs - your AI rubber duck debugging panel for explaining problems to various AI "ducks" and getting different perspectives
...
* [wonderwhy-er/DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) ⭐ 5,200 | 🐛 74 | 🌐 TypeScript | 📅 2026-01-08 📇 🏠 🍎 🪟 🐧 - A swiss-army-knife that can manage/execute programs and read/write/search/edit code and text files.
* [louis030195/terminator-mcp-agent](https://github.com/mediar-ai/terminator/tree/main/terminator-mcp-agent) ⭐ 1,240 | 🐛 9 | 🌐 Rust | 📅 2026-01-08 🦀 📇 🏠 🍎 🪟 🐧 - Desktop GUI automation using accessibility APIs. Control Windows, macOS, and Linux applications without vision models or screenshots. Supports workflow recording, structured data extraction, and browser DOM inspection.
* [aymericzip/intlayer](https://github.com/aymericzip/intlayer) ⭐ 532 | 🐛 23 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️ 🏠 - A MCP Server that enhance your IDE with AI-powered assistance for Intlayer i18n / CMS tool: smart CLI access, access to the docs.
* [ferrislucas/iterm-mcp](https://github.com/ferrislucas/iterm-mcp) ⭐ 507 | 🐛 14 | 🌐 TypeScript | 📅 2025-09-20 🖥️ 🛠️ 💬 - A Model Context Protocol server that provides access to iTerm. You can run commands and ask questions about what you see in the iTerm terminal.
...
* [tufantunc/ssh-mcp](https://github.com/tufantunc/ssh-mcp) ⭐ 200 | 🐛 3 | 🌐 TypeScript | 📅 2026-01-03 📇 🏠 🐧 🪟 - MCP server exposing SSH control for Linux and Windows servers via Model Context Protocol. Securely execute remote shell commands with password or SSH key authentication.
...
* [elie222/inbox-zero](https://github.com/elie222/inbox-zero/tree/main/apps/mcp-server) ⭐ 9,757 | 🐛 94 | 🌐 TypeScript | 📅 2026-01-09 🐍 ☁️ - An MCP server for Inbox Zero. Adds functionality on top of Gmail like finding out which emails you need to reply to or need to follow up on.
* [lharries/whatsapp-mcp](https://github.com/lharries/whatsapp-mcp) ⭐ 5,188 | 🐛 94 | 🌐 Go | 📅 2025-07-13 🐍 🏎️ - An MCP server for searching your personal WhatsApp messages, contacts and sending messages to individuals or groups
* [korotovsky/slack-mcp-server](https://github.com/korotovsky/slack-mcp-server) ⭐ 1,080 | 🐛 32 | 🌐 Go | 📅 2026-01-08 📇 ☁️ - The most powerful MCP server for Slack Workspaces.
* [chigwell/telegram-mcp](https://github.com/chigwell/telegram-mcp) ⭐ 539 | 🐛 6 | 🌐 Python | 📅 2025-12-29 🐍 🏠 - Telegram API integration for accessing user data, managing dialogs (chats, channels, groups), retrieving messages, sending messages and handling read status.
* [line/line-bot-mcp-server](https://github.com/line/line-bot-mcp-server) ⭐ 511 | 🐛 19 | 🌐 TypeScript | 📅 2026-01-07 🎖 📇 ☁️ - MCP Server for Integrating LINE Official Account
...
* [softeria/ms-365-mcp-server](https://github.com/softeria/ms-365-mcp-server) ⭐ 383 | 🐛 6 | 🌐 TypeScript | 📅 2025-12-30 📇 ☁️ - MCP server that connects to Microsoft Office and the whole Microsoft 365 suite using Graph API (including Outlook, mail, files, Excel, calendar)
* [InditexTech/mcp-teams-server](https://github.com/InditexTech/mcp-teams-server) ⭐ 344 | 🐛 8 | 🌐 Python | 📅 2025-10-20 🐍 ☁️ - MCP server that integrates Microsoft Teams messaging (read, post, mention, list members and threads)
...
* [carterlasalle/mac\_messages\_mcp](https://github.com/carterlasalle/mac_messages_mcp) ⭐ 213 | 🐛 8 | 🌐 Python | 📅 2025-09-09 🏠 🍎 🚀 - An MCP server that securely interfaces with your iMessage database via the Model Context Protocol (MCP), allowing LLMs to query and analyze iMessage conversations. It includes robust phone number validation, attachment processing, contact management, group chat handling, and full support for sending and receiving messages.
* [saseq/discord-mcp](https://github.com/SaseQ/discord-mcp) ⭐ 148 | 🐛 1 | 🌐 Java | 📅 2025-08-11 ☕ 📇 🏠 💬 - A MCP server for the Discord integration. Enable your AI assistants to seamlessly interact with Discord. Enhance your Discord experience with powerful automation capabilities.
...
* [discourse/discourse-mcp](https://github.com/discourse/discourse-mcp) ⭐ 32 | 🐛 2 | 🌐 TypeScript | 📅 2026-01-07 🎖️ 💎 ☁️ 🏠 💬 🍎 🪟 🐧 - Official Discourse MCP server for forum integration. Search topics, read posts, manage categories and tags, discover users, and interact with Discourse communities.
...
* [Infobip/mcp](https://github.com/infobip/mcp) ⭐ 22 | 🐛 6 | 📅 2026-01-07 🎖️ ☁️ - Official Infobip MCP server for integrating Infobip global cloud communication platform. It equips AI agents with communication superpowers, allowing them to send and receive SMS and RCS messages, interact with WhatsApp and Viber, automate communication workflows, and manage customer data, all in a production-ready environment.
...
* [jtalk22/slack-mcp-server](https://github.com/jtalk22/slack-mcp-server) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2026-01-09 📇 ☁️ 🏠 🍎 🪟 - Access Slack DMs, channels, and message history using browser tokens. Includes Web UI for claude.ai.
...
* [antv/mcp-server-chart](https://github.com/antvis/mcp-server-chart) ⭐ 3,477 | 🐛 12 | 🌐 TypeScript | 📅 2025-12-29 🎖️ 📇 ☁️ - A Model Context Protocol server for generating visual charts using [AntV](https://github.com/antvis).
* [hustcc/mcp-mermaid](https://github.com/hustcc/mcp-mermaid) ⭐ 358 | 🐛 4 | 🌐 TypeScript | 📅 2025-12-16 📇 🏠 - Generate [mermaid](https://mermaid.js.org/) diagram and chart with AI MCP dynamically.
...
* [googleapis/genai-toolbox](https://github.com/googleapis/genai-toolbox) ⭐ 12,320 | 🐛 149 | 🌐 Go | 📅 2026-01-08 🏎️ ☁️ - Open source MCP server specializing in easy, fast, and secure tools for Databases.

* [get-convex/convex-backend](https://stack.convex.dev/convex-mcp-server) 📇 ☁️ - Convex database integration to introspect tables, functions, and run oneoff queries ([Source](https://github.com/get-convex/convex-backend/blob/main/npm-packages/convex/src/cli/mcp.ts) ⭐ 8,997 | 🐛 116 | 🌐 Rust | 📅 2026-01-09)

* [bram2w/baserow](https://github.com/bram2w/baserow) ⭐ 3,729 | 🐛 1,045 | 🌐 Python | 📅 2026-01-08 - Baserow database integration with table search, list, and row create, read, update, and delete capabilities.

* [supabase-community/supabase-mcp](https://github.com/supabase-community/supabase-mcp) ⭐ 2,372 | 🐛 72 | 🌐 TypeScript | 📅 2026-01-09 🎖️ 📇 ☁️ - Official Supabase MCP server to connect AI assistants directly with your Supabase project and allows them to perform tasks like managing tables, fetching config, and querying data.

* [crystaldba/postgres-mcp](https://github.com/crystaldba/postgres-mcp) ⭐ 1,783 | 🐛 40 | 🌐 Python | 📅 2025-11-11 🐍 🏠 - All-in-one MCP server for Postgres development and operations, with tools for performance analysis, tuning, and health checks

* [qdrant/mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant) ⭐ 1,158 | 🐛 36 | 🌐 Python | 📅 2025-12-10 🐍 🏠 - A Qdrant MCP server

* [designcomputer/mysql\_mcp\_server](https://github.com/designcomputer/mysql_mcp_server) ⭐ 1,060 | 🐛 53 | 🌐 Python | 📅 2025-06-05 🐍 🏠 - MySQL database integration with configurable access controls, schema inspection, and comprehensive security guidelines

* [benborla29/mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) ⭐ 1,040 | 🐛 34 | 🌐 JavaScript | 📅 2025-11-18 ☁️ 🏠 - MySQL database integration in NodeJS with configurable access controls and schema inspection

* [neo4j-contrib/mcp-neo4j](https://github.com/neo4j-contrib/mcp-neo4j) ⭐ 867 | 🐛 27 | 🌐 Python | 📅 2025-12-22 🐍 🏠 - Model Context Protocol with Neo4j (Run queries, Knowledge Graph Memory, Manaage Neo4j Aura Instances)
...
* [ClickHouse/mcp-clickhouse](https://github.com/ClickHouse/mcp-clickhouse) ⭐ 641 | 🐛 26 | 🌐 Python | 📅 2025-12-16 🐍 ☁️ - ClickHouse database integration with schema inspection and query capabilities

* [xing5/mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) ⭐ 587 | 🐛 17 | 🌐 Python | 📅 2025-12-06 🐍 ☁️ - A Model Context Protocol server for interacting with Google Sheets. This server provides tools to create, read, update, and manage spreadsheets through the Google Sheets API.

* [neondatabase/mcp-server-neon](https://github.com/neondatabase/mcp-server-neon) ⭐ 531 | 🐛 13 | 🌐 TypeScript | 📅 2026-01-07 📇 ☁️ — An MCP Server for creating and managing Postgres databases using Neon Serverless Postgres

* [Canner/wren-engine](https://github.com/Canner/wren-engine) ⭐ 524 | 🐛 51 | 🌐 Java | 📅 2026-01-09 🐍 🦀 🏠 - The Semantic Engine for Model Context Protocol(MCP) Clients and AI Agents
...
* [chroma-core/chroma-mcp](https://github.com/chroma-core/chroma-mcp) ⭐ 462 | 🐛 20 | 🌐 Python | 📅 2025-09-17 🎖️ 🐍 ☁️ 🏠 - Chroma MCP server to access local and cloud Chroma instances for retrieval capabilities

* [redis/mcp-redis](https://github.com/redis/mcp-redis) ⭐ 382 | 🐛 7 | 🌐 Python | 📅 2025-12-15 🐍 🏠 - The Redis official MCP Server offers an interface to manage and search data in Redis.
...
* [domdomegg/airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server) ⭐ 381 | 🐛 9 | 🌐 TypeScript | 📅 2026-01-07 📇 🏠 - Airtable database integration with schema inspection, read and write capabilities

* [FreePeak/db-mcp-server](https://github.com/FreePeak/db-mcp-server) ⭐ 335 | 🐛 12 | 🌐 Go | 📅 2025-12-26 🏎️ 🏠 – A high-performance multi-database MCP server built with Golang, supporting MySQL & PostgreSQL (NoSQL coming soon). Includes built-in tools for query execution, transaction management, schema exploration, query building, and performance analysis, with seamless Cursor integration for enhanced database workflows.

* [pab1it0/prometheus-mcp-server](https://github.com/pab1it0/prometheus-mcp-server) ⭐ 330 | 🐛 2 | 🌐 Python | 📅 2025-12-17 🐍 ☁️ -  Query and analyze Prometheus, open-source monitoring system.
...
* [XGenerationLab/xiyan\_mcp\_server](https://github.com/XGenerationLab/xiyan_mcp_server) ⭐ 227 | 🐛 9 | 🌐 Python | 📅 2025-09-26 📇 ☁️ — An MCP server that supports fetching data from a database using natural language queries, powered by XiyanSQL as the text-to-SQL LLM.
...
* [aliyun/alibabacloud-tablestore-mcp-server](https://github.com/aliyun/alibabacloud-tablestore-mcp-server) ⭐ 150 | 🐛 2 | 🌐 Java | 📅 2026-01-07 ☕ 🐍 ☁️ - MCP service for Tablestore, features include adding documents, semantic search for documents based on vectors and scalars, RAG-friendly, and serverless.
...
* [confluentinc/mcp-confluent](https://github.com/confluentinc/mcp-confluent) ⭐ 128 | 🐛 11 | 🌐 TypeScript | 📅 2026-01-08 🐍 ☁️ - Confluent integration to interact with Confluent Kafka and Confluent Cloud REST APIs.
...
* [tuannvm/mcp-trino](https://github.com/tuannvm/mcp-trino) ⭐ 87 | 🐛 15 | 🌐 Go | 📅 2026-01-06 🏎️ ☁️ - A Go implementation of a Model Context Protocol (MCP) server for Trino
...
* [ChristianHinge/dicom-mcp](https://github.com/ChristianHinge/dicom-mcp) ⭐ 78 | 🐛 3 | 🌐 Python | 📅 2025-12-15 🐍 ☁️ 🏠 - DICOM integration to query, read, and move medical images and reports from PACS and other DICOM compliant systems.
...
* [Couchbase-Ecosystem/mcp-server-couchbase](https://github.com/Couchbase-Ecosystem/mcp-server-couchbase) ⭐ 25 | 🐛 2 | 🌐 Python | 📅 2026-01-07 🎖️ 🐍 ☁️ 🏠 - Couchbase MCP server provides unfied access to both Capella cloud and self-managed clusters for document operations, SQL++ queries and natural language data analysis.
...
* [s2-streamstore/s2-sdk-typescript](https://github.com/s2-streamstore/s2-sdk-typescript) ⭐ 22 | 🐛 15 | 🌐 TypeScript | 📅 2026-01-06 🎖️ 📇 ☁️ - Official MCP server for the S2.dev serverless stream platform.
...
* [ferrants/memvid-mcp-server](https://github.com/ferrants/memvid-mcp-server) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2025-06-20 🐍 🏠 - Python Streamable HTTP Server you can run locally to interact with [memvid](https://github.com/Olow304/memvid) ⭐ 11,773 | 🐛 16 | 🌐 Rust | 📅 2026-01-08 storage and semantic search.
...
* [hydrolix/mcp-hydrolix](https://github.com/hydrolix/mcp-hydrolix) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-01-08 🎖️ 🐍 ☁️ - Hydrolix time-series datalake integration providing schema exploration and query capabilities to LLM-based workflows.
...
* [dbt-labs/dbt-mcp](https://github.com/dbt-labs/dbt-mcp) ⭐ 450 | 🐛 23 | 🌐 Python | 📅 2026-01-08 🎖️ 🐍 🏠 ☁️ - Official MCP server for [dbt (data build tool)](https://www.getdbt.com/product/what-is-dbt) providing integration with dbt Core/Cloud CLI, project metadata discovery, model information, and semantic layer querying capabilities.
...
* [eyaltoledano/claude-task-master](https://github.com/eyaltoledano/claude-task-master) ⭐ 24,699 | 🐛 155 | 🌐 JavaScript | 📅 2026-01-07 📇 ☁️ 🏠 - AI-powered task management system for AI-driven development. Features PRD parsing, task expansion, multi-provider support (Claude, OpenAI, Gemini, Perplexity, xAI), and selective tool loading for optimized context usage.
* [GLips/Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 12,449 | 🐛 38 | 🌐 TypeScript | 📅 2026-01-01 📇 🏠 - Provide coding agents direct access to Figma data to help them one-shot design implementation.
* [idosal/git-mcp](https://github.com/idosal/git-mcp) ⭐ 7,342 | 🐛 48 | 🌐 TypeScript | 📅 2025-08-22 📇 ☁️ - [gitmcp.io](https://gitmcp.io/) is a generic remote MCP server to connect to ANY [GitHub](https://www.github.com) repository or project for documentation
* [21st-dev/Magic-MCP](https://github.com/21st-dev/magic-mcp) ⭐ 4,089 | 🐛 21 | 🌐 TypeScript | 📅 2025-12-23 - Create crafted UI components inspired by the best 21st.dev design engineers.
* [haris-musa/excel-mcp-server](https://github.com/haris-musa/excel-mcp-server) ⭐ 3,096 | 🐛 37 | 🌐 Python | 📅 2025-12-22 🐍 🏠 - An Excel manipulation server providing workbook creation, data operations, formatting, and advanced features (charts, pivot tables, formulae).
* [mobile-next/mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 3,004 | 🐛 31 | 🌐 TypeScript | 📅 2026-01-05 📇 🏠 🐧 🍎 - MCP Server for Android/iOS application and device automation, development and app scraping. Simulator/Emulator/Physical devices like iPhone, Google Pixel, Samsung supported.
* [Jpisnice/shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,584 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-29 📇 🏠 - MCP server that gives AI assistants seamless access to shadcn/ui v4 components, blocks, demos, and metadata.
* [cjo4m06/mcp-shrimp-task-manager](https://github.com/cjo4m06/mcp-shrimp-task-manager) ⭐ 1,960 | 🐛 37 | 🌐 JavaScript | 📅 2025-08-21 📇 ☁️ 🏠 – A programming-focused task management system that boosts coding agents like Cursor AI with advanced task memory, self-reflection, and dependency management. [ShrimpTaskManager](https://cjo4m06.github.io/mcp-shrimp-task-manager)
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 1,413 | 🐛 13 | 🌐 JavaScript | 📅 2025-12-31 📇 🏠 🍎 - A Model Context Protocol (MCP) server for interacting with iOS simulators. This server allows you to interact with iOS simulators by getting information about them, controlling UI interactions, and inspecting UI elements.
* [isaacphi/mcp-language-server](https://github.com/isaacphi/mcp-language-server) ⭐ 1,371 | 🐛 45 | 🌐 Go | 📅 2026-01-01 🏎️ 🏠 - MCP Language Server helps MCP enabled clients navigate codebases more easily by giving them access to semantic tools like get definition, references, rename, and diagnostics.
* [jetbrains/mcpProxy](https://github.com/JetBrains/mcpProxy) ⭐ 938 | 🐛 37 | 🌐 JavaScript | 📅 2026-01-07 🎖️ 📇 🏠 - Connect to JetBrains IDE
* [lpigeon/ros-mcp-server](https://github.com/lpigeon/ros-mcp-server) ⭐ 916 | 🐛 18 | 🌐 Python | 📅 2026-01-08 🐍 🏠 🍎 🪟 🐧 - The ROS MCP Server supports robot control by converting user-issued natural language commands into ROS or ROS2 control commands.
...
* [bgauryy/octocode-mcp](https://github.com/bgauryy/octocode-mcp) ⭐ 667 | 🐛 4 | 🌐 TypeScript | 📅 2026-01-08 ☁️ 📇 🍎 🪟 🐧 - AI-powered developer assistant that enables advanced research, analysis and discovery across GitHub and NPM realms in realtime.
...
* [zcaceres/fetch-mcp](https://github.com/zcaceres/fetch-mcp) ⭐ 665 | 🐛 10 | 🌐 TypeScript | 📅 2025-09-02 📇 🏠 - An MCP server to flexibly fetch JSON, text, and HTML data
...
* [QuantGeekDev/docker-mcp](https://github.com/QuantGeekDev/docker-mcp) ⭐ 442 | 🐛 9 | 🌐 Python | 📅 2024-12-14 🏎️ 🏠 - Docker container management and operations through MCP
* [utensils/mcp-nixos](https://github.com/utensils/mcp-nixos) ⭐ 386 | 🐛 4 | 🌐 Python | 📅 2026-01-07 🐍 🏠 - MCP server providing accurate information about NixOS packages, system options, Home Manager configurations, and nix-darwin macOS settings to prevent AI hallucinations.
...
* [gitkraken/gk-cli](https://github.com/gitkraken/gk-cli) ⭐ 344 | 🐛 14 | 📅 2025-12-22 🎖️ 🏎️ 🏠 ☁️ 🍎 🪟 🐧 - A CLI for interacting with GitKraken APIs. Includes an MCP server via `gk mcp` that not only wraps GitKraken APIs, but also Jira, GitHub, GitLab, and more. Works with local tools and remote services.
* [r-huijts/xcode-mcp-server](https://github.com/r-huijts/xcode-mcp-server) ⭐ 340 | 🐛 0 | 🌐 TypeScript | 📅 2025-08-26 📇 🏠 🍎 - Xcode integration for project management, file operations, and build automation
...
* [OpenZeppelin/contracts-wizard](https://github.com/OpenZeppelin/contracts-wizard/tree/master/packages/mcp) ⭐ 292 | 🐛 38 | 🌐 TypeScript | 📅 2026-01-08 - A Model Context Protocol (MCP) server that allows AI agents to generate secure smart contracts in multiples languages based on [OpenZeppelin Wizard templates](https://wizard.openzeppelin.com/).
* [InditexTech/mcp-server-simulator-ios-idb](https://github.com/InditexTech/mcp-server-simulator-ios-idb) ⭐ 282 | 🐛 5 | 🌐 TypeScript | 📅 2025-09-02 📇 🏠 🍎 - A Model Context Protocol (MCP) server that enables LLMs to interact with iOS simulators (iPhone, iPad, etc.) through natural language commands.
...
* [joshuarileydev/app-store-connect-mcp-server](https://github.com/JoshuaRileyDev/app-store-connect-mcp-server) ⭐ 247 | 🐛 6 | 🌐 TypeScript | 📅 2025-09-02 📇 🏠 - An MCP server to communicate with the App Store Connect API for iOS Developers
* [public-ui/kolibri](https://github.com/public-ui/kolibri) ⭐ 243 | 🐛 155 | 🌐 TypeScript | 📅 2026-01-09 📇 ☁️ 🏠 - Streaming KoliBri MCP server (NPM: `@public-ui/mcp`) delivering 200+ guaranteed accessible web component samples, specs, docs, and scenarios via hosted HTTP endpoint or local `kolibri-mcp` CLI.
...
* [storybookjs/addon-mcp](https://github.com/storybookjs/addon-mcp) ⭐ 162 | 🐛 10 | 🌐 TypeScript | 📅 2026-01-08 📇 🏠 - Help agents automatically write and test stories for your UI components.
...
* [janreges/ai-distiller-mcp](https://github.com/janreges/ai-distiller) ⭐ 121 | 🐛 8 | 🌐 C | 📅 2025-08-03 🏎️ 🏠 - Extracts essential code structure from large codebases into AI-digestible format, helping AI agents write code that correctly uses existing APIs on the first attempt.
...
* [docker/hub-mcp](https://github.com/docker/hub-mcp) ⭐ 108 | 🐛 2 | 🌐 TypeScript | 📅 2026-01-01 🎖️ 📇 ☁️ 🏠 - Official MCP server to interact with Docker Hub, providing access to repositories, hub search and Docker Hardened Images
...
* [aashari/mcp-server-atlassian-bitbucket](https://github.com/aashari/mcp-server-atlassian-bitbucket) ⭐ 98 | 🐛 12 | 🌐 TypeScript | 📅 2026-01-07 📇 ☁️ - Atlassian Bitbucket Cloud integration. Enables AI systems to interact with repositories, pull requests, workspaces, and code in real time.
...
* [hloiseaufcms/mcp-gopls](https://github.com/hloiseaufcms/mcp-gopls) ⭐ 57 | 🐛 0 | 🌐 Go | 📅 2026-01-07 🏎️ 🏠 - A MCP server for interacting with [Go's Language Server Protocol (gopls)](https://github.com/golang/tools/tree/master/gopls) ⭐ 7,865 | 🐛 107 | 🌐 Go | 📅 2026-01-08 and benefit from advanced Go code analysis features.
* [qainsights/jmeter-mcp-server](https://github.com/QAInsights/jmeter-mcp-server) ⭐ 56 | 🐛 6 | 🌐 Python | 📅 2025-06-15 🐍 🏠 - JMeter MCP Server for performance testing
...
* [buildkite/buildkite-mcp-server](https://github.com/buildkite/buildkite-mcp-server) ⭐ 42 | 🐛 10 | 🌐 Go | 📅 2026-01-05 🎖️ 🏎️ 🏠 ☁️ 🍎 🪟 🐧 - Official MCP server for Buildkite. Create new pipelines, diagnose and fix failures, trigger builds, monitor job queues, and more.
...
* [zenml-io/mcp-zenml](https://github.com/zenml-io/mcp-zenml) ⭐ 40 | 🐛 1 | 🌐 Python | 📅 2026-01-08 🐍 🏠 ☁️ - An MCP server to connect with your [ZenML](https://www.zenml.io) MLOps and LLMOps pipelines
...
* [veelenga/claude-mermaid](https://github.com/veelenga/claude-mermaid/) ⭐ 33 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-07 📇 🏠 🍎 🪟 🐧 - A Mermaid diagram rendering MCP server for Claude Code with live reload functionality, supporting multiple export formats (SVG, PNG, PDF) and themes.
...
* [api7/apisix-mcp](https://github.com/api7/apisix-mcp) ⭐ 30 | 🐛 2 | 🌐 TypeScript | 📅 2025-06-16 🎖️ 📇 🏠 MCP Server that support for querying and managing all resource in [Apache APISIX](https://github.com/apache/apisix) ⭐ 16,059 | 🐛 332 | 🌐 Lua | 📅 2026-01-08.
* [hechtcarmel/jetbrains-index-mcp-plugin](https://github.com/hechtcarmel/jetbrains-index-mcp-plugin) ⭐ 30 | 🐛 8 | 🌐 Kotlin | 📅 2026-01-07 ☕ 🏠 - A JetBrains IDE plugin that exposes an MCP server, enabling AI coding assistants to leverage the IDE's indexing and refactoring capabilities (rename, safe delete, find references, call hierarchy, type hierarchy, diagnostics and more).
...
* [j4c0bs/mcp-server-sql-analyzer](https://github.com/j4c0bs/mcp-server-sql-analyzer) ⭐ 26 | 🐛 0 | 🌐 Python | 📅 2025-07-01 🐍 - MCP server that provides SQL analysis, linting, and dialect conversion using [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 8,787 | 🐛 15 | 🌐 Python | 📅 2026-01-09
...
* [higress-group/higress-ops-mcp-server](https://github.com/higress-group/higress-ops-mcp-server) ⭐ 22 | 🐛 6 | 🌐 Python | 📅 2025-03-29 🐍 🏠 - MCP server that provides comprehensive tools for managing [Higress](https://github.com/alibaba/higress) ⭐ 7,256 | 🐛 727 | 🌐 Go | 📅 2026-01-07 gateway configurations and operations.
...
* [currents-dev/currents-mcp](https://github.com/currents-dev/currents-mcp) ⭐ 14 | 🐛 3 | 🌐 TypeScript | 📅 2026-01-07 🎖️ 📇 ☁️ Enable AI Agents to fix Playwright test failures reported to [Currents](https://currents.dev).
...
* [sbroenne/mcp-server-excel](https://github.com/sbroenne/mcp-server-excel) ⭐ 13 | 🐛 5 | 🌐 C# | 📅 2026-01-08 #️⃣ 🏠 🪟 - Full-featured Excel MCP server. 173 operations: Power Query, DAX, VBA, PivotTables, Tables, Charts, ranges, formatting. 100% Excel compatibility - uses Excel app instead of creating .xlsx files. Windows only.
* [hechtcarmel/jetbrains-debugger-mcp-plugin](https://github.com/hechtcarmel/jetbrains-debugger-mcp-plugin) ⭐ 13 | 🐛 8 | 🌐 Kotlin | 📅 2026-01-07 ☕ 🏠 - A JetBrains IDE plugin that exposes an MCP server, giving AI coding assistants full programmatic control over the debugger.
...
* [narumiruna/gitingest-mcp](https://github.com/narumiruna/gitingest-mcp) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2025-11-21 🐍 🏠 - A MCP server that uses [gitingest](https://github.com/cyclotruc/gitingest) ⭐ 13,563 | 🐛 30 | 🌐 Python | 📅 2026-01-02 to convert any Git repository into a simple text digest of its codebase.
...
* [InsForge/insforge-mcp](https://github.com/InsForge/insforge-mcp) ⭐ 6 | 🐛 5 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️ - AI-native backend-as-a-service platform enabling AI agents to build and manage full-stack applications. Provides Auth, Database (PostgreSQL), Storage, and Functions as production-grade infrastructure, reducing MVP development time from weeks to hours.
...
* [deploy-mcp/deploy-mcp](https://github.com/alexpota/deploy-mcp) ⭐ 3 | 🐛 3 | 🌐 TypeScript | 📅 2026-01-07 📇 ☁️ 🏠 - Universal deployment tracker for AI assistants with live status badges and deployment monitoring
...
* [mckinsey/vizro-mcp](https://github.com/mckinsey/vizro/tree/main/vizro-mcp) ⭐ 3,517 | 🐛 56 | 🌐 Python | 📅 2026-01-08 🎖️ 🐍 🏠 - Tools and templates to create validated and maintainable data charts and dashboards.
* [zcaceres/markdownify-mcp](https://github.com/zcaceres/markdownify-mcp) ⭐ 2,339 | 🐛 18 | 🌐 TypeScript | 📅 2025-09-02 📇 🏠 - An MCP server to convert almost any file or web content into Markdown
* [datalayer/jupyter-mcp-server](https://github.com/datalayer/jupyter-mcp-server) ⭐ 843 | 🐛 21 | 🌐 Python | 📅 2026-01-06 🐍 🏠 - Model Context Protocol (MCP) Server for Jupyter.
...
* [stack-chan/stack-chan](https://github.com/stack-chan/stack-chan) ⭐ 1,047 | 🐛 28 | 🌐 TypeScript | 📅 2025-12-29 📇 📟 - A JavaScript-driven M5Stack-embedded super-kawaii robot with MCP server functionality for AI-controlled interactions and emotions.
* [horw/esp-mcp](https://github.com/horw/esp-mcp) ⭐ 122 | 🐛 31 | 🌐 Python | 📅 2025-12-27 📟 - Workflow for fixing build issues in ESP32 series chips using ESP-IDF.
...
* [microsoft/markitdown](https://github.com/microsoft/markitdown/tree/main/packages/markitdown-mcp) ⭐ 85,075 | 🐛 415 | 🌐 Python | 📅 2026-01-08 🎖️ 🐍 🏠 - MCP tool access to MarkItDown -- a library that converts many file formats (local or remote) to Markdown for LLM consumption.
* [mickaelkerjean/filestash](https://github.com/mickael-kerjean/filestash/tree/master/server/plugin/plg_handler_mcp) ⭐ 13,372 | 🐛 60 | 🌐 JavaScript | 📅 2026-01-07 🏎️ ☁️ - Remote Storage Access: SFTP, S3, FTP, SMB, NFS, WebDAV, GIT, FTPS, gcloud, azure blob, sharepoint, etc.
* [mark3labs/mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server) ⭐ 577 | 🐛 17 | 🌐 Go | 📅 2025-11-24 🏎️ 🏠 - Golang implementation for local file system access.
...
* [8b-is/smart-tree](https://github.com/8b-is/smart-tree) ⭐ 205 | 🐛 0 | 🌐 Rust | 📅 2025-12-08 🦀 🏠 🍎 🪟 🐧 - AI-native directory visualization with semantic analysis, ultra-compressed formats for AI consumption, and 10x token reduction. Supports quantum-semantic mode with intelligent file categorization.
...
* [mcpdotdirect/evm-mcp-server](https://github.com/mcpdotdirect/evm-mcp-server) ⭐ 353 | 🐛 2 | 🌐 TypeScript | 📅 2025-11-26 📇 ☁️ - Comprehensive blockchain services for 30+ EVM networks, supporting native tokens, ERC20, NFTs, smart contracts, transactions, and ENS resolution.
...
* [polygon-io/mcp\_polygon)](https://github.com/polygon-io/mcp_polygon) ⭐ 237 | 🐛 17 | 🌐 Python | 📅 2025-11-18) 🐍 ☁️ -  An MCP server that provides access to [Polygon.io](https://polygon.io/) financial market data APIs for stocks, indices, forex, options, and more.
...
* [XeroAPI/xero-mcp-server](https://github.com/XeroAPI/xero-mcp-server) ⭐ 164 | 🐛 18 | 🌐 TypeScript | 📅 2025-12-05 📇 ☁️ – An MCP server that integrates with Xero's API, allowing for standardized access to Xero's accounting and business features.
...
* [twelvedata/mcp](https://github.com/twelvedata/mcp) ⭐ 51 | 🐛 4 | 🌐 Python | 📅 2025-10-25 🐍 ☁️ - Interact with [Twelve Data](https://twelvedata.com) APIs to access real-time and historical financial market data for your AI agents.
...
* [ThomasMarches/substrate-mcp-rs](https://github.com/ThomasMarches/substrate-mcp-rs) ⭐ 12 | 🐛 0 | 🌐 Rust | 📅 2025-10-12 🦀 🏠 - An MCP server implementation to interact with Substrate-based blockchains. Built with Rust and interfacing the [subxt](https://github.com/paritytech/subxt) ⭐ 475 | 🐛 92 | 🌐 Rust | 📅 2026-01-08 crate.
...
* [Coding-Solo/godot-mcp](https://github.com/Coding-Solo/godot-mcp) ⭐ 1,342 | 🐛 20 | 🌐 JavaScript | 📅 2026-01-05 📇 🏠 - A MCP server for interacting with the Godot game engine, providing tools for editing, running, debugging, and managing scenes in Godot projects.
* [CoderGamester/mcp-unity](https://github.com/CoderGamester/mcp-unity) ⭐ 1,201 | 🐛 8 | 🌐 C# | 📅 2026-01-06 #️⃣ 🏠 - MCP Server for Unity3d Game Engine integration for game development
* [IvanMurzak/Unity-MCP](https://github.com/IvanMurzak/Unity-MCP) ⭐ 733 | 🐛 33 | 🌐 C# | 📅 2026-01-09 #️⃣ 🏠 🍎 🪟 🐧 - MCP Server for Unity Editor and for a game made with Unity
...
* [opgginc/opgg-mcp](https://github.com/opgginc/opgg-mcp) ⭐ 57 | 🐛 2 | 🌐 TypeScript | 📅 2026-01-01 📇 ☁️ - Access real-time gaming data across popular titles like League of Legends, TFT, and Valorant, offering champion analytics, esports schedules, meta compositions, and character statistics.
...
* [upstash/context7](https://github.com/upstash/context7) ⭐ 41,294 | 🐛 78 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️ - Up-to-date code documentation for LLMs and AI code editors.
* [topoteretes/cognee](https://github.com/topoteretes/cognee/tree/dev/cognee-mcp) ⭐ 10,804 | 🐛 39 | 🌐 Python | 📅 2026-01-08 📇 🏠 - Memory manager for AI apps and Agents using various graph and vector stores and allowing ingestion from 30+ data sources
* [vectorize-io/hindsight](https://github.com/vectorize-io/hindsight) ⭐ 1,035 | 🐛 8 | 🌐 Python | 📅 2026-01-09 🐍 ☁️ 🏠 - Hindsight: Agent Memory That Works Like Human Memory - Built for AI Agents to manage Long Term Memory
...
* [jinzcdev/markmap-mcp-server](https://github.com/jinzcdev/markmap-mcp-server) ⭐ 158 | 🐛 4 | 🌐 TypeScript | 📅 2025-06-12 📇 🏠 - An MCP server built on [markmap](https://github.com/markmap/markmap) ⭐ 12,285 | 🐛 55 | 🌐 TypeScript | 📅 2025-06-12 that converts **Markdown** to interactive **mind maps**. Supports multi-format exports (PNG/JPG/SVG), live browser preview, one-click Markdown copy, and dynamic visualization features.
* [0xshellming/mcp-summarizer](https://github.com/0xshellming/mcp-summarizer) ⭐ 151 | 🐛 7 | 🌐 JavaScript | 📅 2025-02-28 📕 ☁️ - AI Summarization MCP Server, Support for multiple content types: Plain text, Web pages, PDF documents, EPUB books, HTML content
...
* [agentic-mcp-tools/memora](https://github.com/agentic-mcp-tools/memora) ⭐ 72 | 🐛 0 | 🌐 Python | 📅 2026-01-08 🐍 🏠 ☁️ - Persistent memory with knowledge graph visualization, semantic/hybrid search, cloud sync (S3/R2), and cross-session context management.
* [shinpr/mcp-local-rag](https://github.com/shinpr/mcp-local-rag) ⭐ 53 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-08 📇 🏠 - Privacy-first document search server running entirely locally. Supports semantic search over PDFs, DOCX, TXT, and Markdown files with LanceDB vector storage and local embeddings - no API keys or cloud services required.
...
* [Smart-AI-Memory/empathy-framework](https://github.com/Smart-AI-Memory/empathy-framework) ⭐ 9 | 🐛 9 | 🌐 HTML | 📅 2026-01-08 🐍 🏠 - Five-level AI collaboration system with persistent memory and anticipatory capabilities. MCP-native integration for Claude and other LLMs with local-first architecture via MemDocs.
...
* [QGIS MCP](https://github.com/jjsantos01/qgis_mcp) ⭐ 754 | 🐛 8 | 🌐 Python | 📅 2025-10-01 - connects QGIS Desktop to Claude AI through the MCP. This integration enables prompt-assisted project creation, layer loading, code execution, and more.
...
* [pipeboard-co/meta-ads-mcp](https://github.com/pipeboard-co/meta-ads-mcp) ⭐ 404 | 🐛 6 | 🌐 Python | 📅 2025-12-19 🐍 ☁️ 🏠 - Meta Ads automation that just works. Trusted by 10,000+ businesses to analyze performance, test creatives, optimize spend, and scale results — simply and reliably.
...
* [stape-io/google-tag-manager-mcp-server](https://github.com/stape-io/google-tag-manager-mcp-server) ⭐ 83 | 🐛 9 | 🌐 TypeScript | 📅 2026-01-07 📇 ☁️ – This server supports remote MCP connections, includes built-in Google OAuth, and provide an interface to the Google Tag Manager API.
...
* [stape-io/stape-mcp-server](https://github.com/stape-io/stape-mcp-server) ⭐ 5 | 🐛 2 | 🌐 TypeScript | 📅 2026-01-07 📇 ☁️ – This project implements an MCP (Model Context Protocol) server for the Stape platform. It allows interaction with the Stape API using AI assistants like Claude or AI-powered IDEs like Cursor.
* [tomba-io/tomba-mcp-server](https://github.com/tomba-io/tomba-mcp-server) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2025-11-16 📇 ☁️ - Email discovery, verification, and enrichment tools. Find email addresses, verify deliverability, enrich contact data, discover authors and LinkedIn profiles, validate phone numbers, and analyze technology stacks.
...
* [netdata/netdata#Netdata](https://github.com/netdata/netdata/blob/master/src/web/mcp/README.md) ⭐ 77,281 | 🐛 239 | 🌐 C | 📅 2026-01-09 🎖️ 🏠 ☁️ 📟 🍎 🪟 🐧 - Discovery, exploration, reporting and root cause analysis using all observability data, including metrics, logs, systems, containers, processes, and network connections
* [grafana/mcp-grafana](https://github.com/grafana/mcp-grafana) ⭐ 2,093 | 🐛 61 | 🌐 Go | 📅 2026-01-08 🎖️ 🐍 🏠 ☁️ - Search dashboards, investigate incidents and query datasources in your Grafana instance
* [getsentry/sentry-mcp](https://github.com/getsentry/sentry-mcp) ⭐ 493 | 🐛 45 | 🌐 TypeScript | 📅 2026-01-07 🐍 ☁️ - Sentry.io integration for error tracking and performance monitoring
* [pydantic/logfire-mcp](https://github.com/pydantic/logfire-mcp) ⭐ 130 | 🐛 8 | 🌐 Python | 📅 2026-01-05 🎖️ 🐍 ☁️ - Provides access to OpenTelemetry traces and metrics through Logfire
...
* [VictoriaMetrics-Community/mcp-victoriametrics](https://github.com/VictoriaMetrics-Community/mcp-victoriametrics) ⭐ 110 | 🐛 5 | 🌐 Go | 📅 2026-01-08 🎖️ 🏎️ 🏠 - Provides comprehensive integration with your [VictoriaMetrics instance APIs](https://docs.victoriametrics.com/victoriametrics/url-examples/) and [documentation](https://docs.victoriametrics.com/) for monitoring, observability, and debugging tasks related to your VictoriaMetrics instances
...
* [last9/last9-mcp-server](https://github.com/last9/last9-mcp-server) ⭐ 48 | 🐛 4 | 🌐 Go | 📅 2026-01-09 - Seamlessly bring real-time production context—logs, metrics, and traces—into your local environment to auto-fix code faster
...
* [exa-labs/exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) ⭐ 3,521 | 🐛 29 | 🌐 TypeScript | 📅 2026-01-06 🎖️ 📇 ☁️ – A Model Context Protocol (MCP) server lets AI assistants like Claude use the Exa AI Search API for web searches. This setup allows AI models to get real-time web information in a safe and controlled way.
...
* [blazickjp/arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) ⭐ 2,015 | 🐛 34 | 🌐 Python | 📅 2025-08-19 ☁️ 🐍 - Search ArXiv research papers
* [luminati-io/brightdata-mcp](https://github.com/luminati-io/brightdata-mcp) ⭐ 1,863 | 🐛 13 | 🌐 JavaScript | 📅 2026-01-08 📇 ☁️ - Discover, extract, and interact with the web - one interface powering automated access across the public internet.
...
* [nickclyde/duckduckgo-mcp-server](https://github.com/nickclyde/duckduckgo-mcp-server) ⭐ 713 | 🐛 21 | 🌐 Python | 📅 2025-03-11 🐍 ☁️ - Web search using DuckDuckGo
* [Aas-ee/open-webSearch](https://github.com/Aas-ee/open-webSearch) ⭐ 560 | 🐛 9 | 🌐 TypeScript | 📅 2025-10-26 🐍 📇 ☁️ - Web search using free multi-engine search (NO API KEYS REQUIRED) — Supports Bing, Baidu, DuckDuckGo, Brave, Exa, and CSDN.
* [brave/brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) ⭐ 492 | 🐛 16 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️ - Web search capabilities using Brave's Search API
* [genomoncology/biomcp](https://github.com/genomoncology/biomcp) ⭐ 384 | 🐛 14 | 🌐 Python | 📅 2026-01-08 🐍 ☁️ - Biomedical research server providing access to PubMed, ClinicalTrials.gov, and MyVariant.info.
* [Ihor-Sokoliuk/MCP-SearXNG](https://github.com/ihor-sokoliuk/mcp-searxng) ⭐ 382 | 🐛 11 | 🌐 TypeScript | 📅 2025-11-09 📇 🏠/☁️ - A Model Context Protocol Server for [SearXNG](https://docs.searxng.org)
...
* [kagisearch/kagimcp](https://github.com/kagisearch/kagimcp) ⭐ 256 | 🐛 5 | 🌐 Python | 📅 2025-11-17 ☁️ 📇 – Official Kagi Search MCP Server
...
* [deadletterq/mcp-opennutrition](https://github.com/deadletterq/mcp-opennutrition) ⭐ 150 | 🐛 0 | 🌐 TypeScript | 📅 2025-06-11 📇 🏠 - Local MCP server for searching 300,000+ foods, nutrition facts, and barcodes from the OpenNutrition database.
...
* [scrapeless-ai/scrapeless-mcp-server](https://github.com/scrapeless-ai/scrapeless-mcp-server) ⭐ 142 | 🐛 0 | 🌐 TypeScript | 📅 2025-09-23 🐍 ☁️ - The Scrapeless Model Context Protocol service acts as an MCP server connector to the Google SERP API, enabling web search within the MCP ecosystem without leaving it.
...
* [just-every/mcp-read-website-fast](https://github.com/just-every/mcp-read-website-fast) ⭐ 121 | 🐛 2 | 🌐 JavaScript | 📅 2025-08-29 📇 🏠 - Fast, token-efficient web content extraction for AI agents - converts websites to clean Markdown while preserving links. Features Mozilla Readability, smart caching, polite crawling with robots.txt support, and concurrent fetching.
...
* [mikechao/brave-search-mcp](https://github.com/mikechao/brave-search-mcp) ⭐ 90 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️ - Web, Image, News, Video, and Local Point of Interest search capabilities using Brave's Search API
...
* [pragmar/mcp-server-webcrawl](https://github.com/pragmar/mcp-server-webcrawl) ⭐ 37 | 🐛 0 | 🌐 Python | 📅 2025-12-08 🐍 🏠 - Advanced search and retrieval for web crawler data. Supports WARC, wget, Katana, SiteOne, and InterroBot crawlers.
...
* [boikot-xyz/boikot](https://github.com/boikot-xyz/boikot) ⭐ 4 | 🐛 0 | 🌐 HTML | 📅 2026-01-08 🦀☁️ - Model Context Protocol Server for looking up company ethics information. Learn about the ethical and unethical actions of major companies.
...
* [LaurieWired/GhidraMCP](https://github.com/LaurieWired/GhidraMCP) ⭐ 7,013 | 🐛 59 | 🌐 Java | 📅 2025-06-23 ☕ 🏠 - A Model Context Protocol server for Ghidra that enables LLMs to autonomously reverse engineer applications. Provides tools for decompiling binaries, renaming methods and data, and listing methods, classes, imports, and exports.
* [mrexodia/ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) ⭐ 4,929 | 🐛 36 | 🌐 Python | 📅 2026-01-07 🐍 🏠 - MCP server for IDA Pro, allowing you to perform binary analysis with AI assistants. This plugin implement decompilation, disassembly and allows you to generate malware analysis reports automatically.
...
* [zinja-coder/jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp) ⭐ 1,040 | 🐛 6 | 🌐 Java | 📅 2026-01-08 ☕ 🏠 - JADX-AI-MCP is a plugin and MCP Server for the JADX decompiler that integrates directly with Model Context Protocol (MCP) to provide live reverse engineering support with LLMs like Claude.
...
* [jtang613/GhidrAssistMCP](https://github.com/jtang613/GhidrAssistMCP) ⭐ 392 | 🐛 3 | 🌐 Java | 📅 2026-01-06 ☕ 🏠 - A native Model Context Protocol server for Ghidra. Includes GUI configuration and logging, 31 powerful tools and no external dependencies.
* [zinja-coder/apktool-mcp-server](https://github.com/zinja-coder/apktool-mcp-server) ⭐ 272 | 🐛 0 | 🌐 Python | 📅 2025-09-12 🐍 🏠 - APKTool MCP Server is a MCP server for the Apk Tool to provide automation in reverse engineering of Android APKs.
...
* [fosdickio/binary\_ninja\_mcp](https://github.com/fosdickio/binary_ninja_mcp) ⭐ 159 | 🐛 19 | 🌐 Python | 📅 2025-12-23 🐍 🏠 🍎 🪟 🐧 - A Binary Ninja plugin, MCP server, and bridge that seamlessly integrates [Binary Ninja](https://binary.ninja) with your favorite MCP client.  It enables you to automate the process of performing binary analysis and reverse engineering.
* [gbrigandi/mcp-server-wazuh](https://github.com/gbrigandi/mcp-server-wazuh) ⭐ 158 | 🐛 4 | 🌐 Rust | 📅 2025-12-12 🦀 🏠 🚨 🍎 🪟 🐧 - A Rust-based MCP server bridging Wazuh SIEM with AI assistants, providing real-time security alerts and event data for enhanced contextual understanding.
...
* [BurtTheCoder/mcp-virustotal](https://github.com/BurtTheCoder/mcp-virustotal) ⭐ 98 | 🐛 5 | 🌐 TypeScript | 📅 2025-03-03 📇 🪟 ☁️ - MCP server for querying the VirusTotal API. This server provides tools for scanning URLs, analyzing file hashes, and retrieving IP address reports.
...
* [king-of-the-grackles/reddit-research-mcp](https://github.com/king-of-the-grackles/reddit-research-mcp) ⭐ 73 | 🐛 0 | 🌐 Python | 📅 2025-12-11 🐍 ☁️ - AI-powered Reddit intelligence for market research and competitive analysis. Discover subreddits via semantic search across 20k+ indexed communities, fetch posts/comments with full citations, and manage research feeds. No Reddit API credentials needed.
...
* [macrocosm-os/macrocosmos-mcp](https://github.com/macrocosm-os/macrocosmos-mcp) ⭐ 27 | 🐛 0 | 🌐 Python | 📅 2026-01-08 - 🎖️ 🐍 ☁️ Access real-time X/Reddit/YouTube data directly in your LLM applications  with search phrases, users, and date filtering.
...
* [r-huijts/strava-mcp](https://github.com/r-huijts/strava-mcp) ⭐ 213 | 🐛 5 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️ - A Model Context Protocol (MCP) server that connects to Strava API, providing tools to access Strava data through LLMs
...
* [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 3,927 | 🐛 135 | 🌐 Python | 📅 2026-01-06 🐍 ☁️ - MCP server for Atlassian products (Confluence and Jira). Supports Confluence Cloud, Jira Cloud, and Jira Server/Data Center. Provides comprehensive tools for searching, reading, creating, and managing content across Atlassian workspaces.
...
* [aikts/yandex-tracker-mcp](https://github.com/aikts/yandex-tracker-mcp) ⭐ 33 | 🐛 8 | 🌐 Python | 📅 2026-01-07 🐍 ☁️ 🏠 - MCP Server for Yandex Tracker. Provides tools for searching and retrieving information about issues, queues, users.
...
* [mbailey/voice-mcp](https://github.com/mbailey/voice-mcp) ⭐ 554 | 🐛 25 | 🌐 Python | 📅 2026-01-07 🐍 🏠 - Complete voice interaction server supporting speech-to-text, text-to-speech, and real-time voice conversations through local microphone, OpenAI-compatible APIs, and LiveKit integration
...
* [github/github-mcp-server](https://github.com/github/github-mcp-server) ⭐ 25,739 | 🐛 236 | 🌐 Go | 📅 2026-01-08 📇 ☁️ - Official GitHub server for integration with repository management, PRs, issues, and more.
...
* [taylorwilsdon/google\_workspace\_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) ⭐ 1,081 | 🐛 41 | 🌐 Python | 📅 2026-01-07 🐍 ☁️ 🍎 🪟 🐧 - Comprehensive Google Workspace MCP server with full support for Google Calendar, Drive, Gmail, and Docs, Forms, Chats, Slides and Sheets over stdio, Streamable HTTP and SSE transports.
* [MarkusPfundstein/mcp-gsuite](https://github.com/MarkusPfundstein/mcp-gsuite) ⭐ 469 | 🐛 22 | 🌐 Python | 📅 2025-04-14 🐍 ☁️ - Integration with gmail and Google Calendar.
...
* [modelcontextprotocol/server-everything](https://github.com/modelcontextprotocol/servers/tree/main/src/everything) ⭐ 75,794 | 🐛 259 | 🌐 TypeScript | 📅 2026-01-07 📇 🏠 - MCP server that exercises all the features of the MCP protocol
* [mediar-ai/screenpipe](https://github.com/mediar-ai/screenpipe) ⭐ 16,378 | 🐛 242 | 🌐 TypeScript | 📅 2025-12-09 - 🎖️ 🦀 🏠 🍎 Local-first system capturing screen/audio with timestamped indexing, SQL/embedding storage, semantic search, LLM-powered history analysis, and event-triggered actions - enables building context-aware AI agents through a NextJS plugin ecosystem.
* [Klavis-AI/YouTube](https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/youtube) ⭐ 5,584 | 🐛 62 | 🌐 Python | 📅 2026-01-09 🐍 📇 - Extract and convert YouTube video information.
* [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 3,927 | 🐛 135 | 🌐 Python | 📅 2026-01-06 🐍 ☁️ - MCP server for Atlassian products (Confluence and Jira). Supports Confluence Cloud, Jira Cloud, and Jira Server/Data Center. Provides comprehensive tools for searching, reading, creating, and managing content across Atlassian workspaces.
* [metorial/metorial](https://github.com/metorial/metorial) ⭐ 3,200 | 🐛 1 | 🌐 TypeScript | 📅 2026-01-09 - 🎖️ 📇 ☁️ Connect AI agents to 600+ integrations with a single interface - OAuth, scaling, and monitoring included
* [MarkusPfundstein/mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian) ⭐ 2,658 | 🐛 68 | 🌐 Python | 📅 2025-06-28 🐍 ☁️ 🏠 - Interacting with Obsidian via REST API
* [chrishayuk/mcp-cli](https://github.com/chrishayuk/mcp-cli) ⭐ 1,797 | 🐛 23 | 🌐 Python | 📅 2025-12-29 🐍 🏠 - Yet another CLI tool for testing MCP servers
...
* [calclavia/mcp-obsidian](https://github.com/calclavia/mcp-obsidian) ⭐ 1,264 | 🐛 16 | 🌐 JavaScript | 📅 2026-01-02 📇 🏠 - This is a connector to allow Claude Desktop (or any MCP client) to read and search any directory containing Markdown notes (such as an Obsidian vault).
...
* [caol64/wenyan-mcp](https://github.com/caol64/wenyan-mcp) ⭐ 972 | 🐛 24 | 🌐 JavaScript | 📅 2025-12-29 📇 🏠 🍎 🪟 🐧 - Wenyan MCP Server, which lets AI automatically format Markdown articles and publish them to WeChat GZH.
...
* [apify/actors-mcp-server](https://github.com/apify/actors-mcp-server) ⭐ 682 | 🐛 31 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️ - Use 3,000+ pre-built cloud tools, known as Actors, to extract data from websites, e-commerce, social media, search engines, maps, and more
...
* [tevonsb/homeassistant-mcp](https://github.com/tevonsb/homeassistant-mcp) ⭐ 511 | 🐛 17 | 🌐 TypeScript | 📅 2025-02-01 📇 🏠 - Access Home Assistant data and control devices (lights, switches, thermostats, etc).
* [anaisbetts/mcp-youtube](https://github.com/anaisbetts/mcp-youtube) ⭐ 486 | 🐛 12 | 🌐 JavaScript | 📅 2025-03-20 📇 ☁️ - Fetch YouTube subtitles
* [PV-Bhat/vibe-check-mcp-server](https://github.com/PV-Bhat/vibe-check-mcp-server) ⭐ 448 | 🐛 13 | 🌐 TypeScript | 📅 2026-01-07 📇 ☁️ - An MCP server that prevents cascading errors and scope creep by calling a "Vibe-check" agent to ensure user alignment.
...
* [blurrah/mcp-graphql](https://github.com/blurrah/mcp-graphql) ⭐ 344 | 🐛 12 | 🌐 TypeScript | 📅 2025-09-08 📇 ☁️ - Allows the AI to query GraphQL servers
...
* [marcelmarais/Spotify](https://github.com/marcelmarais/spotify-mcp-server) ⭐ 210 | 🐛 5 | 🌐 TypeScript | 📅 2026-01-05 - 📇 🏠 Control Spotify playback and manage playlists.
...
* [ivnvxd/mcp-server-odoo](https://github.com/ivnvxd/mcp-server-odoo) ⭐ 127 | 🐛 14 | 🌐 Python | 📅 2025-12-15 🐍 ☁️/🏠 - Connect AI assistants to Odoo ERP systems for business data access, record management, and workflow automation.
...
* [Seym0n/tiktok-mcp](https://github.com/Seym0n/tiktok-mcp) ⭐ 121 | 🐛 1 | 🌐 JavaScript | 📅 2025-08-25 📇 ☁️ - Interact with TikTok videos
...
* [anki-mcp/anki-mcp-desktop](https://github.com/anki-mcp/anki-mcp-desktop) ⭐ 70 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-14 📇 🏠 🍎 🪟 🐧 - Enterprise-grade Anki integration with natural language interaction, comprehensive note/deck management, and one-click MCPB installation. Built on NestJS with comprehensive test coverage.
...
> \[!NOTE]
> More frameworks, utilities, and other developer tools are available at <https://github.com/punkpeye/awesome-mcp-devtools> ⭐ 395 | 🐛 10 | 📅 2026-01-06

* [FastMCP](https://github.com/jlowin/fastmcp) ⭐ 21,791 | 🐛 227 | 🌐 Python | 📅 2026-01-09 🐍 - A high-level framework for building MCP servers in Python
* [FastMCP](https://github.com/punkpeye/fastmcp) ⭐ 2,864 | 🐛 36 | 🌐 TypeScript | 📅 2026-01-06 📇 - A high-level framework for building MCP servers in TypeScript
