...
Checkout [awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients/) ⭐ 6,188 | 🐛 3 | 📅 2026-01-11 and [glama.ai/mcp/clients](https://glama.ai/mcp/clients).
...
* [mindsdb/mindsdb](https://github.com/mindsdb/mindsdb) ⭐ 38,242 | 🐛 196 | 🌐 Python | 📅 2026-01-12 - Connect and unify data across various platforms and databases with [MindsDB as a single MCP server](https://docs.mindsdb.com/mcp/overview).
* [PipedreamHQ/pipedream](https://github.com/PipedreamHQ/pipedream/tree/master/modelcontextprotocol) ⭐ 10,989 | 🐛 4,348 | 🌐 JavaScript | 📅 2026-01-11 ☁️ 🏠 - Connect with 2,500 APIs with 8,000+ prebuilt tools, and manage servers for your users, in your own app.
* [metatool-ai/metatool-app](https://github.com/metatool-ai/metatool-app) ⭐ 1,893 | 🐛 62 | 🌐 TypeScript | 📅 2025-12-23 📇 ☁️ 🏠 🍎 🪟 🐧 - MetaMCP is the one unified middleware MCP server that manages your MCP connections with GUI.
...
* [duaraghav8/MCPJungle](https://github.com/duaraghav8/MCPJungle) ⭐ 790 | 🐛 47 | 🌐 Go | 📅 2026-01-10 🏎️ 🏠 - Self-hosted MCP Server registry for enterprise AI Agents
* [TheLunarCompany/lunar#mcpx](https://github.com/TheLunarCompany/lunar/tree/main/mcpx) ⭐ 381 | 🐛 5 | 🌐 TypeScript | 📅 2026-01-11 📇 🏠  ☁️ 🍎 🪟 🐧 - MCPX is a production-ready, open-source gateway to manage MCP servers at scale—centralize tool discovery, access controls, call prioritization, and usage tracking to simplify agent workflows.
* [1mcp/agent](https://github.com/1mcp-app/agent) ⭐ 345 | 🐛 6 | 🌐 TypeScript | 📅 2026-01-09 📇 ☁️ 🏠 🍎 🪟 🐧 - A unified Model Context Protocol server implementation that aggregates multiple MCP servers into one.
* [wegotdocs/open-mcp](https://github.com/wegotdocs/open-mcp) ⭐ 322 | 🐛 229 | 🌐 TypeScript | 📅 2025-09-15 📇 🏠 🍎 🪟 🐧 - Turn a web API into an MCP server in 10 seconds and add it to the open source registry: <https://open-mcp.org>
* [K-Dense-AI/claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp) ⭐ 256 | 🐛 3 | 🌐 Python | 📅 2025-11-11 🐍 ☁️ 🏠 🍎 🪟 🐧 - Intelligent search capabilities to let every model and client use [Claude Agent Skills](https://www.anthropic.com/news/skills) like native.
* [sxhxliang/mcp-access-point](https://github.com/sxhxliang/mcp-access-point) ⭐ 158 | 🐛 2 | 🌐 Rust | 📅 2025-10-30 📇 ☁️ 🏠 🍎 🪟 🐧 - Turn a web service into an MCP server in one click without making any code changes.
* [sitbon/magg](https://github.com/sitbon/magg) ⭐ 126 | 🐛 5 | 🌐 Python | 📅 2025-08-07 🍎 🪟 🐧 ☁️ 🏠 🐍 - Magg: A meta-MCP server that acts as a universal hub, allowing LLMs to autonomously discover, install, and orchestrate multiple MCP servers - essentially giving AI assistants the power to extend their own capabilities on-demand.
...
* [juspay/neurolink](https://github.com/juspay/neurolink) ⭐ 103 | 🐛 412 | 🌐 TypeScript | 📅 2026-01-11 📇 ☁️ 🏠 🍎 🪟 🐧 - Making enterprise AI infrastructure universally accessible. Edge-first platform unifying 12 providers and 100+ models with multi-agent orchestration, HITL workflows, guardrails middleware, and context summarization.
...
* [portel-dev/ncp](https://github.com/portel-dev/ncp) ⭐ 60 | 🐛 2 | 🌐 JavaScript | 📅 2026-01-05 📇 ☁️ 🏠 🍎 🪟 🐧 - NCP orchestrates your entire MCP ecosystem through intelligent discovery, eliminating token overhead while maintaining 98.2% accuracy.
* [askbudi/roundtable](https://github.com/askbudi/roundtable) ⭐ 53 | 🐛 3 | 🌐 Python | 📅 2025-10-06 📇 ☁️ 🏠 🍎 🪟 🐧 - Meta-MCP server that unifies multiple AI coding assistants (Codex, Claude Code, Cursor, Gemini) through intelligent auto-discovery and standardized MCP interface, providing zero-configuration access to the entire AI coding ecosystem.
...
* [jaspertvdm/mcp-server-gemini-bridge](https://github.com/jaspertvdm/mcp-server-gemini-bridge) ⭐ 0 | 🐛 0 | 🌐 Dockerfile | 📅 2026-01-11 🐍 ☁️ - Bridge to Google Gemini API. Access Gemini Pro and Flash models through MCP.
* [jaspertvdm/mcp-server-ollama-bridge](https://github.com/jaspertvdm/mcp-server-ollama-bridge) ⭐ 0 | 🐛 0 | 🌐 Dockerfile | 📅 2026-01-11 🐍 🏠 - Bridge to local Ollama LLM server. Run Llama, Mistral, Qwen and other local models through MCP.
* [jaspertvdm/mcp-server-openai-bridge](https://github.com/jaspertvdm/mcp-server-openai-bridge) ⭐ 0 | 🐛 0 | 🌐 Dockerfile | 📅 2026-01-11 🐍 ☁️ - Bridge to OpenAI API. Access GPT-4, GPT-4o and other OpenAI models through MCP.
...
* [ahujasid/blender-mcp](https://github.com/ahujasid/blender-mcp) ⭐ 14,932 | 🐛 36 | 🌐 Python | 📅 2026-01-08 🐍 - MCP server for working with Blender
* [abhiemj/manim-mcp-server](https://github.com/abhiemj/manim-mcp-server) ⭐ 534 | 🐛 5 | 🌐 Python | 📅 2025-05-19 🐍 🏠 🪟 🐧 - A local MCP server that generates animations using Manim.
* [samuelgursky/davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp) ⭐ 460 | 🐛 10 | 🌐 Python | 📅 2026-01-01 🐍 - MCP server integration for DaVinci Resolve providing powerful tools for video editing, color grading, media management, and project control
* [burningion/video-editing-mcp](https://github.com/burningion/video-editing-mcp) ⭐ 236 | 🐛 5 | 🌐 Python | 📅 2025-10-09 🐍 - Add, Analyze, Search, and Generate Video Edits from your Video Jungle Collection
...
* [diivi/aseprite-mcp](https://github.com/diivi/aseprite-mcp) ⭐ 102 | 🐛 5 | 🌐 Python | 📅 2025-09-02 🐍 🏠 - MCP server using the Aseprite API to create pixel art
* [cswkim/discogs-mcp-server](https://github.com/cswkim/discogs-mcp-server) ⭐ 78 | 🐛 2 | 🌐 TypeScript | 📅 2026-01-07 📇 ☁️ - MCP server to interact with the Discogs API
...
* [TwelveTake-Studios/reaper-mcp](https://github.com/TwelveTake-Studios/reaper-mcp) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2025-12-14 🐍 🏠 🍎 🪟 🐧 - MCP server enabling AI assistants to control REAPER DAW for mixing, mastering, MIDI composition, and full music production with 129 tools
...
* [genomoncology/biomcp](https://github.com/genomoncology/biomcp) ⭐ 389 | 🐛 14 | 🌐 Python | 📅 2026-01-08 🐍 ☁️ - Biomedical research MCP server providing access to PubMed, ClinicalTrials.gov, and MyVariant.info.
* [the-momentum/apple-health-mcp-server](https://github.com/the-momentum/apple-health-mcp-server) ⭐ 94 | 🐛 7 | 🌐 Python | 📅 2026-01-04 🐍 🏠 🍎 🪟 🐧 - An MCP server that provides access to exported data from Apple Health. Data analytics included.
* [wso2/fhir-mcp-server](https://github.com/wso2/fhir-mcp-server) ⭐ 75 | 🐛 0 | 🌐 Python | 📅 2026-01-09 🐍 🏠 ☁️ - Model Context Protocol server for Fast Healthcare Interoperability Resources (FHIR) APIs. Provides seamless integration with FHIR servers, enabling AI assistants to search, retrieve, create, update, and analyze clinical healthcare data with SMART-on-FHIR authentication support.
...
* [longevity-genie/gget-mcp](https://github.com/longevity-genie/gget-mcp) ⭐ 23 | 🐛 6 | 🌐 Python | 📅 2025-10-27 🐍 🏠 ☁️ - MCP server providing a powerful bioinformatics toolkit for genomics queries and analysis, wrapping the popular `gget` library.
...
* [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) ⭐ 25,382 | 🐛 39 | 🌐 TypeScript | 📅 2026-01-09 - Official Microsoft Playwright MCP server, enabling LLMs to interact with web pages through structured accessibility snapshots
* [agent-infra/mcp-server-browser](https://github.com/bytedance/UI-TARS-desktop/tree/main/packages/agent-infra/mcp-servers/browser) ⭐ 22,862 | 🐛 313 | 🌐 TypeScript | 📅 2026-01-05 📇 🏠 - Browser automation capabilities using Puppeteer, both support local and remote browser connection.
* [browsermcp/mcp](https://github.com/browsermcp/mcp) ⭐ 5,406 | 🐛 104 | 🌐 TypeScript | 📅 2025-04-24 📇 🏠 - Automate your local Chrome browser
* [executeautomation/playwright-mcp-server](https://github.com/executeautomation/mcp-playwright) ⭐ 5,134 | 🐛 18 | 🌐 TypeScript | 📅 2025-12-13 📇 - An MCP server using Playwright for browser automation and webscrapping
* [browserbase/mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase) ⭐ 3,035 | 🐛 25 | 🌐 TypeScript | 📅 2025-12-10 🎖️ 📇 - Automate browser interactions in the cloud (e.g. web navigation, data extraction, form filling, and more)
* [operative\_sh/web-eval-agent](https://github.com/Operative-Sh/web-eval-agent) ⭐ 1,233 | 🐛 11 | 🌐 Python | 📅 2026-01-08 🐍 🏠 🍎 - An MCP Server that autonomously debugs web applications with browser-use browser agents
* [co-browser/browser-use-mcp-server](https://github.com/co-browser/browser-use-mcp-server) ⭐ 794 | 🐛 15 | 🌐 Python | 📅 2025-07-10 🐍 - browser-use packaged as an MCP server with SSE transport. includes a dockerfile to run chromium in docker + a vnc server.
* [pskill9/web-search](https://github.com/pskill9/web-search) ⭐ 390 | 🐛 7 | 🌐 JavaScript | 📅 2024-12-30 📇 🏠 - An MCP server that enables free web searching using Google search results, with no API keys required.
* [kimtaeyoon83/mcp-server-youtube-transcript](https://github.com/kimtaeyoon83/mcp-server-youtube-transcript) ⭐ 374 | 🐛 6 | 🌐 TypeScript | 📅 2025-12-24 📇 ☁️ - Fetch YouTube subtitles and transcripts for AI analysis
* [eat-pray-ai/yutu](https://github.com/eat-pray-ai/yutu) ⭐ 360 | 🐛 1 | 🌐 Go | 📅 2026-01-07 🏎️ 🏠 🍎 🐧 🪟 - A fully functional MCP server and CLI for YouTube to automate YouTube operation
* [automatalabs/mcp-server-playwright](https://github.com/Automata-Labs-team/MCP-Server-Playwright) ⭐ 273 | 🐛 9 | 🌐 JavaScript | 📅 2025-06-05 🐍 - An MCP server for browser automation using Playwright
* [recursechat/mcp-server-apple-shortcuts](https://github.com/recursechat/mcp-server-apple-shortcuts) ⭐ 265 | 🐛 4 | 🌐 JavaScript | 📅 2024-12-22 📇 🏠 🍎 - An MCP Server Integration with Apple Shortcuts
...
* [hanzili/comet-mcp](https://github.com/hanzili/comet-mcp) ⭐ 94 | 🐛 1 | 🌐 TypeScript | 📅 2026-01-09 📇 🏠 🍎 - Connect to Perplexity Comet browser for agentic web browsing, deep research, and real-time task monitoring.
...
* [freema/firefox-devtools-mcp](https://github.com/freema/firefox-devtools-mcp) ⭐ 25 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-10 📇 🏠 - Firefox browser automation via WebDriver BiDi for testing, scraping, and browser control. Supports snapshot/UID-based interactions, network monitoring, console capture, and screenshots.
* [BB-fat/browser-use-rs](https://github.com/BB-fat/browser-use-rs) ⭐ 20 | 🐛 0 | 🌐 Rust | 📅 2025-11-20 🦀 Lightweight browser automation MCP server in Rust with zero dependencies.
...
* [awslabs/mcp](https://github.com/awslabs/mcp) ⭐ 7,837 | 🐛 177 | 🌐 Python | 📅 2026-01-12 🎖️ ☁️ - AWS MCP servers for seamless integration with AWS services and resources.
...
* [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) ⭐ 3,275 | 🐛 49 | 🌐 TypeScript | 📅 2026-01-08 🎖️ 📇 ☁️ - Integration with Cloudflare services including Workers, KV, R2, and D1
* [flux159/mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) ⭐ 1,251 | 🐛 14 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️/🏠 - Typescript implementation of Kubernetes cluster operations for pods, deployments, services.
* [manusa/Kubernetes MCP Server](https://github.com/manusa/kubernetes-mcp-server) ⭐ 977 | 🐛 50 | 🌐 Go | 📅 2026-01-10 🏎️ 🏠 A - powerful Kubernetes MCP server with additional support for OpenShift. Besides providing CRUD operations for **any** Kubernetes resource, this server provides specialized tools to interact with your cluster.
...
* [weibaohui/k8m](https://github.com/weibaohui/k8m) ⭐ 751 | 🐛 18 | 🌐 Go | 📅 2026-01-11 🏎️ ☁️/🏠 - Provides MCP multi-cluster Kubernetes management and operations, featuring a management interface, logging, and nearly 50 built-in tools covering common DevOps and development scenarios. Supports both standard and CRD resources.
...
* [pibblokto/cert-manager-mcp-server](https://github.com/pibblokto/cert-manager-mcp-server) ⭐ 21 | 🐛 0 | 🌐 Python | 📅 2025-08-25 🐍 🍎/🐧 ☁️ - mcp server for [cert-manager](https://github.com/cert-manager/cert-manager) ⭐ 13,455 | 🐛 216 | 🌐 Go | 📅 2026-01-12 management and troubleshooting
...
* [pydantic/pydantic-ai/mcp-run-python](https://github.com/pydantic/pydantic-ai/tree/main/mcp-run-python) ⭐ 14,245 | 🐛 455 | 🌐 Python | 📅 2026-01-10 🐍 🏠 - Run Python code in a secure sandbox via MCP tool calls
* [dagger/container-use](https://github.com/dagger/container-use) ⭐ 3,424 | 🐛 64 | 🌐 Go | 📅 2025-12-08 🏎️ 🏠 🐧 🍎 🪟 - Containerized environments for coding agents. Multiple agents can work independently, isolated in fresh containers and git branches. No conflicts, many experiments. Full execution history, terminal access to agent environments, git workflow. Any agent/model/infra stack.
...
* [oraios/serena](https://github.com/oraios/serena) ⭐ 18,491 | 🐛 80 | 🌐 Python | 📅 2026-01-11 🐍 🏠 - A fully-featured coding agent that relies on symbolic code operations by using language servers.
* [ezyang/codemcp](https://github.com/ezyang/codemcp) ⭐ 1,594 | 🐛 79 | 🌐 Python | 📅 2025-12-25 🐍 🏠 - Coding agent with basic read, write and command line tools.
* [rinadelph/Agent-MCP](https://github.com/rinadelph/Agent-MCP) ⭐ 1,116 | 🐛 15 | 🌐 TypeScript | 📅 2025-10-09 🐍 🏠 - A framework for creating multi-agent systems using MCP for coordinated AI collaboration, featuring task management, shared context, and RAG capabilities.
* [shashankss1205/codegraphcontext](https://github.com/Shashankss1205/CodeGraphContext) ⭐ 331 | 🐛 70 | 🌐 Python | 📅 2026-01-10 🐍 🏠 🍎 🪟 🐧 An MCP server that indexes local code into a graph database to provide context to AI assistants with a graphical code visualizations for humans.
...
* [stippi/code-assistant](https://github.com/stippi/code-assistant) ⭐ 132 | 🐛 2 | 🌐 Rust | 📅 2026-01-02 🦀 🏠 - Coding agent with basic list, read, replace\_in\_file, write, execute\_command and web search tools. Supports multiple projects concurrently.
...
* [askbudi/roundtable](https://github.com/askbudi/roundtable) ⭐ 53 | 🐛 3 | 🌐 Python | 📅 2025-10-06 🐍 🏠 - Zero-configuration MCP server that unifies multiple AI coding assistants (Claude Code, Cursor, Codex) through intelligent auto-discovery and standardized interface. Essential infrastructure for autonomous agent development and multi-AI collaboration workflows.
...
* [gabrielmaialva33/winx-code-agent](https://github.com/gabrielmaialva33/winx-code-agent) ⭐ 24 | 🐛 7 | 🌐 Rust | 📅 2026-01-05 🦀 🏠 - A high-performance Rust reimplementation of WCGW for code agents, providing shell execution and advanced file management capabilities for LLMs via MCP.
...
* [sim-xia/skill-cortex-server](https://github.com/Sim-xia/skill-cortex-server) ⭐ 11 | 🐛 1 | 🌐 Python | 📅 2026-01-07 🐍 🏠 🍎 🪟 🐧 - An MCP server that enable all IDEs/CLIs to access Claude Code Skills capabilities.
...
* [wonderwhy-er/DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) ⭐ 5,219 | 🐛 74 | 🌐 TypeScript | 📅 2026-01-09 📇 🏠 🍎 🪟 🐧 - A swiss-army-knife that can manage/execute programs and read/write/search/edit code and text files.
* [louis030195/terminator-mcp-agent](https://github.com/mediar-ai/terminator/tree/main/terminator-mcp-agent) ⭐ 1,246 | 🐛 10 | 🌐 Rust | 📅 2026-01-11 🦀 📇 🏠 🍎 🪟 🐧 - Desktop GUI automation using accessibility APIs. Control Windows, macOS, and Linux applications without vision models or screenshots. Supports workflow recording, structured data extraction, and browser DOM inspection.
* [aymericzip/intlayer](https://github.com/aymericzip/intlayer) ⭐ 535 | 🐛 20 | 🌐 TypeScript | 📅 2026-01-12 📇 ☁️ 🏠 - A MCP Server that enhance your IDE with AI-powered assistance for Intlayer i18n / CMS tool: smart CLI access, access to the docs.
...
* [tufantunc/ssh-mcp](https://github.com/tufantunc/ssh-mcp) ⭐ 208 | 🐛 4 | 🌐 TypeScript | 📅 2026-01-03 📇 🏠 🐧 🪟 - MCP server exposing SSH control for Linux and Windows servers via Model Context Protocol. Securely execute remote shell commands with password or SSH key authentication.
...
* [elie222/inbox-zero](https://github.com/elie222/inbox-zero/tree/main/apps/mcp-server) ⭐ 9,781 | 🐛 91 | 🌐 TypeScript | 📅 2026-01-11 🐍 ☁️ - An MCP server for Inbox Zero. Adds functionality on top of Gmail like finding out which emails you need to reply to or need to follow up on.
* [lharries/whatsapp-mcp](https://github.com/lharries/whatsapp-mcp) ⭐ 5,195 | 🐛 99 | 🌐 Go | 📅 2025-07-13 🐍 🏎️ - An MCP server for searching your personal WhatsApp messages, contacts and sending messages to individuals or groups
* [korotovsky/slack-mcp-server](https://github.com/korotovsky/slack-mcp-server) ⭐ 1,093 | 🐛 34 | 🌐 Go | 📅 2026-01-08 📇 ☁️ - The most powerful MCP server for Slack Workspaces.
* [chigwell/telegram-mcp](https://github.com/chigwell/telegram-mcp) ⭐ 548 | 🐛 5 | 🌐 Python | 📅 2026-01-11 🐍 🏠 - Telegram API integration for accessing user data, managing dialogs (chats, channels, groups), retrieving messages, sending messages and handling read status.
...
* [softeria/ms-365-mcp-server](https://github.com/softeria/ms-365-mcp-server) ⭐ 386 | 🐛 7 | 🌐 TypeScript | 📅 2025-12-30 📇 ☁️ - MCP server that connects to Microsoft Office and the whole Microsoft 365 suite using Graph API (including Outlook, mail, files, Excel, calendar)
...
* [carterlasalle/mac\_messages\_mcp](https://github.com/carterlasalle/mac_messages_mcp) ⭐ 216 | 🐛 8 | 🌐 Python | 📅 2025-09-09 🏠 🍎 🚀 - An MCP server that securely interfaces with your iMessage database via the Model Context Protocol (MCP), allowing LLMs to query and analyze iMessage conversations. It includes robust phone number validation, attachment processing, contact management, group chat handling, and full support for sending and receiving messages.
* [saseq/discord-mcp](https://github.com/SaseQ/discord-mcp) ⭐ 151 | 🐛 1 | 🌐 Java | 📅 2025-08-11 ☕ 📇 🏠 💬 - A MCP server for the Discord integration. Enable your AI assistants to seamlessly interact with Discord. Enhance your Discord experience with powerful automation capabilities.
...
* [discourse/discourse-mcp](https://github.com/discourse/discourse-mcp) ⭐ 31 | 🐛 3 | 🌐 TypeScript | 📅 2026-01-09 🎖️ 💎 ☁️ 🏠 💬 🍎 🪟 🐧 - Official Discourse MCP server for forum integration. Search topics, read posts, manage categories and tags, discover users, and interact with Discourse communities.
...
* [antv/mcp-server-chart](https://github.com/antvis/mcp-server-chart) ⭐ 3,493 | 🐛 12 | 🌐 TypeScript | 📅 2025-12-29 🎖️ 📇 ☁️ - A Model Context Protocol server for generating visual charts using [AntV](https://github.com/antvis).
...
* [hustcc/mcp-echarts](https://github.com/hustcc/mcp-echarts) ⭐ 183 | 🐛 1 | 🌐 TypeScript | 📅 2026-01-08 📇 🏠 - Generate visual charts using [Apache ECharts](https://echarts.apache.org) with AI MCP dynamically.
...
* [googleapis/genai-toolbox](https://github.com/googleapis/genai-toolbox) ⭐ 12,375 | 🐛 152 | 🌐 Go | 📅 2026-01-12 🏎️ ☁️ - Open source MCP server specializing in easy, fast, and secure tools for Databases.

* [get-convex/convex-backend](https://stack.convex.dev/convex-mcp-server) 📇 ☁️ - Convex database integration to introspect tables, functions, and run oneoff queries ([Source](https://github.com/get-convex/convex-backend/blob/main/npm-packages/convex/src/cli/mcp.ts) ⭐ 9,101 | 🐛 122 | 🌐 Rust | 📅 2026-01-11)

* [bram2w/baserow](https://github.com/bram2w/baserow) ⭐ 3,750 | 🐛 1,051 | 🌐 Python | 📅 2026-01-09 - Baserow database integration with table search, list, and row create, read, update, and delete capabilities.

* [supabase-community/supabase-mcp](https://github.com/supabase-community/supabase-mcp) ⭐ 2,378 | 🐛 72 | 🌐 TypeScript | 📅 2026-01-09 🎖️ 📇 ☁️ - Official Supabase MCP server to connect AI assistants directly with your Supabase project and allows them to perform tasks like managing tables, fetching config, and querying data.

* [crystaldba/postgres-mcp](https://github.com/crystaldba/postgres-mcp) ⭐ 1,805 | 🐛 41 | 🌐 Python | 📅 2025-11-11 🐍 🏠 - All-in-one MCP server for Postgres development and operations, with tools for performance analysis, tuning, and health checks

* [qdrant/mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant) ⭐ 1,160 | 🐛 36 | 🌐 Python | 📅 2025-12-10 🐍 🏠 - A Qdrant MCP server

* [designcomputer/mysql\_mcp\_server](https://github.com/designcomputer/mysql_mcp_server) ⭐ 1,060 | 🐛 54 | 🌐 Python | 📅 2025-06-05 🐍 🏠 - MySQL database integration with configurable access controls, schema inspection, and comprehensive security guidelines

* [benborla29/mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) ⭐ 1,052 | 🐛 35 | 🌐 JavaScript | 📅 2025-11-18 ☁️ 🏠 - MySQL database integration in NodeJS with configurable access controls and schema inspection

* [neo4j-contrib/mcp-neo4j](https://github.com/neo4j-contrib/mcp-neo4j) ⭐ 867 | 🐛 28 | 🌐 Python | 📅 2025-12-22 🐍 🏠 - Model Context Protocol with Neo4j (Run queries, Knowledge Graph Memory, Manaage Neo4j Aura Instances)
...
* [ClickHouse/mcp-clickhouse](https://github.com/ClickHouse/mcp-clickhouse) ⭐ 646 | 🐛 27 | 🌐 Python | 📅 2025-12-16 🐍 ☁️ - ClickHouse database integration with schema inspection and query capabilities

* [xing5/mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) ⭐ 593 | 🐛 17 | 🌐 Python | 📅 2025-12-06 🐍 ☁️ - A Model Context Protocol server for interacting with Google Sheets. This server provides tools to create, read, update, and manage spreadsheets through the Google Sheets API.

* [neondatabase/mcp-server-neon](https://github.com/neondatabase/mcp-server-neon) ⭐ 531 | 🐛 13 | 🌐 TypeScript | 📅 2026-01-10 📇 ☁️ — An MCP Server for creating and managing Postgres databases using Neon Serverless Postgres

* [Canner/wren-engine](https://github.com/Canner/wren-engine) ⭐ 525 | 🐛 50 | 🌐 Java | 📅 2026-01-09 🐍 🦀 🏠 - The Semantic Engine for Model Context Protocol(MCP) Clients and AI Agents
...
* [domdomegg/airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server) ⭐ 387 | 🐛 9 | 🌐 TypeScript | 📅 2026-01-07 📇 🏠 - Airtable database integration with schema inspection, read and write capabilities
...
* [kiliczsh/mcp-mongo-server](https://github.com/kiliczsh/mcp-mongo-server) ⭐ 272 | 🐛 2 | 🌐 TypeScript | 📅 2025-05-27 📇 🏠 - A Model Context Protocol Server for MongoDB
...
* [zilliztech/mcp-server-milvus](https://github.com/zilliztech/mcp-server-milvus) ⭐ 209 | 🐛 11 | 🌐 Python | 📅 2025-12-24 🐍 🏠 ☁️ - MCP Server for Milvus / Zilliz, making it possible to interact with your database.
...
* [f4ww4z/mcp-mysql-server](https://github.com/f4ww4z/mcp-mysql-server) ⭐ 140 | 🐛 10 | 🌐 JavaScript | 📅 2025-11-14 📇 🏠 - Node.js-based MySQL database integration that provides secure MySQL database operations
...
* [confluentinc/mcp-confluent](https://github.com/confluentinc/mcp-confluent) ⭐ 129 | 🐛 11 | 🌐 TypeScript | 📅 2026-01-11 🐍 ☁️ - Confluent integration to interact with Confluent Kafka and Confluent Cloud REST APIs.
...
* [tuannvm/mcp-trino](https://github.com/tuannvm/mcp-trino) ⭐ 87 | 🐛 16 | 🌐 Go | 📅 2026-01-06 🏎️ ☁️ - A Go implementation of a Model Context Protocol (MCP) server for Trino
...
* [wenerme/wener-mssql-mcp](https://github.com/wenerme/wode/tree/develop/packages/wener-mssql-mcp) ⭐ 62 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-11 📇 🏠 - MSSQL database integration with schema inspection and query capabilities
...
* [Couchbase-Ecosystem/mcp-server-couchbase](https://github.com/Couchbase-Ecosystem/mcp-server-couchbase) ⭐ 25 | 🐛 3 | 🌐 Python | 📅 2026-01-07 🎖️ 🐍 ☁️ 🏠 - Couchbase MCP server provides unfied access to both Capella cloud and self-managed clusters for document operations, SQL++ queries and natural language data analysis.
...
* [ferrants/memvid-mcp-server](https://github.com/ferrants/memvid-mcp-server) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2025-06-20 🐍 🏠 - Python Streamable HTTP Server you can run locally to interact with [memvid](https://github.com/Olow304/memvid) ⭐ 12,154 | 🐛 27 | 🌐 Rust | 📅 2026-01-10 storage and semantic search.
...
* [dbt-labs/dbt-mcp](https://github.com/dbt-labs/dbt-mcp) ⭐ 454 | 🐛 22 | 🌐 Python | 📅 2026-01-09 🎖️ 🐍 🏠 ☁️ - Official MCP server for [dbt (data build tool)](https://www.getdbt.com/product/what-is-dbt) providing integration with dbt Core/Cloud CLI, project metadata discovery, model information, and semantic layer querying capabilities.
* [keboola/keboola-mcp-server](https://github.com/keboola/keboola-mcp-server) ⭐ 80 | 🐛 3 | 🌐 Python | 📅 2026-01-08 🐍 - interact with Keboola Connection Data Platform. This server provides tools for listing and accessing data from Keboola Storage API.
...
* [eyaltoledano/claude-task-master](https://github.com/eyaltoledano/claude-task-master) ⭐ 24,764 | 🐛 153 | 🌐 JavaScript | 📅 2026-01-11 📇 ☁️ 🏠 - AI-powered task management system for AI-driven development. Features PRD parsing, task expansion, multi-provider support (Claude, OpenAI, Gemini, Perplexity, xAI), and selective tool loading for optimized context usage.
* [GLips/Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 12,482 | 🐛 38 | 🌐 TypeScript | 📅 2026-01-01 📇 🏠 - Provide coding agents direct access to Figma data to help them one-shot design implementation.
* [idosal/git-mcp](https://github.com/idosal/git-mcp) ⭐ 7,358 | 🐛 48 | 🌐 TypeScript | 📅 2025-08-22 📇 ☁️ - [gitmcp.io](https://gitmcp.io/) is a generic remote MCP server to connect to ANY [GitHub](https://www.github.com) repository or project for documentation
* [21st-dev/Magic-MCP](https://github.com/21st-dev/magic-mcp) ⭐ 4,103 | 🐛 21 | 🌐 TypeScript | 📅 2025-12-23 - Create crafted UI components inspired by the best 21st.dev design engineers.
* [haris-musa/excel-mcp-server](https://github.com/haris-musa/excel-mcp-server) ⭐ 3,110 | 🐛 37 | 🌐 Python | 📅 2025-12-22 🐍 🏠 - An Excel manipulation server providing workbook creation, data operations, formatting, and advanced features (charts, pivot tables, formulae).
* [mobile-next/mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 3,036 | 🐛 33 | 🌐 TypeScript | 📅 2026-01-05 📇 🏠 🐧 🍎 - MCP Server for Android/iOS application and device automation, development and app scraping. Simulator/Emulator/Physical devices like iPhone, Google Pixel, Samsung supported.
* [Jpisnice/shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,590 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-29 📇 🏠 - MCP server that gives AI assistants seamless access to shadcn/ui v4 components, blocks, demos, and metadata.
* [cjo4m06/mcp-shrimp-task-manager](https://github.com/cjo4m06/mcp-shrimp-task-manager) ⭐ 1,964 | 🐛 37 | 🌐 JavaScript | 📅 2025-08-21 📇 ☁️ 🏠 – A programming-focused task management system that boosts coding agents like Cursor AI with advanced task memory, self-reflection, and dependency management. [ShrimpTaskManager](https://cjo4m06.github.io/mcp-shrimp-task-manager)
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 1,434 | 🐛 13 | 🌐 JavaScript | 📅 2025-12-31 📇 🏠 🍎 - A Model Context Protocol (MCP) server for interacting with iOS simulators. This server allows you to interact with iOS simulators by getting information about them, controlling UI interactions, and inspecting UI elements.
...
* [lpigeon/ros-mcp-server](https://github.com/lpigeon/ros-mcp-server) ⭐ 924 | 🐛 18 | 🌐 Python | 📅 2026-01-11 🐍 🏠 🍎 🪟 🐧 - The ROS MCP Server supports robot control by converting user-issued natural language commands into ROS or ROS2 control commands.
...
* [bgauryy/octocode-mcp](https://github.com/bgauryy/octocode-mcp) ⭐ 667 | 🐛 4 | 🌐 TypeScript | 📅 2026-01-12 ☁️ 📇 🍎 🪟 🐧 - AI-powered developer assistant that enables advanced research, analysis and discovery across GitHub and NPM realms in realtime.
* [zcaceres/fetch-mcp](https://github.com/zcaceres/fetch-mcp) ⭐ 667 | 🐛 10 | 🌐 TypeScript | 📅 2025-09-02 📇 🏠 - An MCP server to flexibly fetch JSON, text, and HTML data
* [ckreiling/mcp-server-docker](https://github.com/ckreiling/mcp-server-docker) ⭐ 665 | 🐛 13 | 🌐 Python | 📅 2025-06-05 🐍 🏠 - Integrate with Docker to manage containers, images, volumes, and networks.
...
* [vivekvells/mcp-pandoc](https://github.com/vivekVells/mcp-pandoc) ⭐ 477 | 🐛 4 | 🌐 Python | 📅 2025-09-16 🗄️ 🚀 - MCP server for seamless document format conversion using Pandoc, supporting Markdown, HTML, PDF, DOCX (.docx), csv and more.
...
* [utensils/mcp-nixos](https://github.com/utensils/mcp-nixos) ⭐ 390 | 🐛 4 | 🌐 Python | 📅 2026-01-07 🐍 🏠 - MCP server providing accurate information about NixOS packages, system options, Home Manager configurations, and nix-darwin macOS settings to prevent AI hallucinations.
...
* [OpenZeppelin/contracts-wizard](https://github.com/OpenZeppelin/contracts-wizard/tree/master/packages/mcp) ⭐ 292 | 🐛 39 | 🌐 TypeScript | 📅 2026-01-10 - A Model Context Protocol (MCP) server that allows AI agents to generate secure smart contracts in multiples languages based on [OpenZeppelin Wizard templates](https://wizard.openzeppelin.com/).
...
* [joshuarileydev/app-store-connect-mcp-server](https://github.com/JoshuaRileyDev/app-store-connect-mcp-server) ⭐ 259 | 🐛 7 | 🌐 TypeScript | 📅 2025-09-02 📇 🏠 - An MCP server to communicate with the App Store Connect API for iOS Developers
* [public-ui/kolibri](https://github.com/public-ui/kolibri) ⭐ 244 | 🐛 156 | 🌐 TypeScript | 📅 2026-01-12 📇 ☁️ 🏠 - Streaming KoliBri MCP server (NPM: `@public-ui/mcp`) delivering 200+ guaranteed accessible web component samples, specs, docs, and scenarios via hosted HTTP endpoint or local `kolibri-mcp` CLI.
...
* [storybookjs/addon-mcp](https://github.com/storybookjs/addon-mcp) ⭐ 163 | 🐛 9 | 🌐 TypeScript | 📅 2026-01-09 📇 🏠 - Help agents automatically write and test stories for your UI components.
...
* [yangkyeongmo@/mcp-server-apache-airflow](https://github.com/yangkyeongmo/mcp-server-apache-airflow) ⭐ 126 | 🐛 6 | 🌐 Python | 📅 2025-10-29 🐍 🏠 - MCP server that connects to [Apache Airflow](https://airflow.apache.org/) using official client.
...
* [docker/hub-mcp](https://github.com/docker/hub-mcp) ⭐ 110 | 🐛 3 | 🌐 TypeScript | 📅 2026-01-09 🎖️ 📇 ☁️ 🏠 - Official MCP server to interact with Docker Hub, providing access to repositories, hub search and Docker Hardened Images
...
* [augmnt/augments-mcp-server](https://github.com/augmnt/augments-mcp-server) ⭐ 98 | 🐛 0 | 🌐 Python | 📅 2026-01-02 📇 ☁️ 🏠 - Transform Claude Code with intelligent, real-time access to 90+ framework documentation sources. Get accurate, up-to-date code generation that follows current best practices for React, Next.js, Laravel, FastAPI, Tailwind CSS, and more.
...
* [ckanthony/gin-mcp](https://github.com/ckanthony/gin-mcp) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2025-11-07 🏎️ ☁️ 📟 🪟 🐧 🍎 - A zero-configuration Go library to automatically expose existing Gin web framework APIs as MCP tools.
...
* [kadykov/mcp-openapi-schema-explorer](https://github.com/kadykov/mcp-openapi-schema-explorer) ⭐ 62 | 🐛 4 | 🌐 TypeScript | 📅 2026-01-12 📇 ☁️ 🏠 - Token-efficient access to OpenAPI/Swagger specs via MCP Resources.
...
* [hloiseaufcms/mcp-gopls](https://github.com/hloiseaufcms/mcp-gopls) ⭐ 59 | 🐛 0 | 🌐 Go | 📅 2026-01-07 🏎️ 🏠 - A MCP server for interacting with [Go's Language Server Protocol (gopls)](https://github.com/golang/tools/tree/master/gopls) ⭐ 7,868 | 🐛 107 | 🌐 Go | 📅 2026-01-09 and benefit from advanced Go code analysis features.
...
* [aashari/mcp-server-atlassian-confluence](https://github.com/aashari/mcp-server-atlassian-confluence) ⭐ 43 | 🐛 12 | 🌐 TypeScript | 📅 2026-01-07 📇 ☁️ - Atlassian Confluence Cloud integration. Enables AI systems to interact with Confluence spaces, pages, and content with automatic ADF to Markdown conversion.
...
* [promptexecution/just-mcp](https://github.com/promptexecution/just-mcp) ⭐ 40 | 🐛 0 | 🌐 Rust | 📅 2025-12-03 🦀 🏠 - Justfile integration that enables LLMs to execute any CLI or script commands with parameters safely and easily, with environment variable support and comprehensive testing.
...
* [veelenga/claude-mermaid](https://github.com/veelenga/claude-mermaid/) ⭐ 35 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-07 📇 🏠 🍎 🪟 🐧 - A Mermaid diagram rendering MCP server for Claude Code with live reload functionality, supporting multiple export formats (SVG, PNG, PDF) and themes.
...
* [api7/apisix-mcp](https://github.com/api7/apisix-mcp) ⭐ 30 | 🐛 2 | 🌐 TypeScript | 📅 2025-06-16 🎖️ 📇 🏠 MCP Server that support for querying and managing all resource in [Apache APISIX](https://github.com/apache/apisix) ⭐ 16,068 | 🐛 340 | 🌐 Lua | 📅 2026-01-08.
...
* [j4c0bs/mcp-server-sql-analyzer](https://github.com/j4c0bs/mcp-server-sql-analyzer) ⭐ 26 | 🐛 0 | 🌐 Python | 📅 2025-07-01 🐍 - MCP server that provides SQL analysis, linting, and dialect conversion using [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 8,793 | 🐛 21 | 🌐 Python | 📅 2026-01-09
...
* [higress-group/higress-ops-mcp-server](https://github.com/higress-group/higress-ops-mcp-server) ⭐ 22 | 🐛 6 | 🌐 Python | 📅 2025-03-29 🐍 🏠 - MCP server that provides comprehensive tools for managing [Higress](https://github.com/alibaba/higress) ⭐ 7,264 | 🐛 732 | 🌐 Go | 📅 2026-01-10 gateway configurations and operations.
* [ukkit/memcord](https://github.com/ukkit/memcord) ⭐ 22 | 🐛 1 | 🌐 Python | 📅 2025-11-27 🐍 🏠 🐧 🍎 - A MCP server that keeps your chat history organized and searchable—with AI-powered summaries, secure memory, and full control.
...
* [OctoMind-dev/octomind-mcp](https://github.com/OctoMind-dev/octomind-mcp) ⭐ 21 | 🐛 4 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️ - lets your preferred AI agent create & run fully managed [Octomind](https://www.octomind.dev/) end-to-end tests from your codebase or other data sources like Jira, Slack or TestRail.
...
* [sbroenne/mcp-server-excel](https://github.com/sbroenne/mcp-server-excel) ⭐ 15 | 🐛 6 | 🌐 C# | 📅 2026-01-10 #️⃣ 🏠 🪟 - Full-featured Excel MCP server. 173 operations: Power Query, DAX, VBA, PivotTables, Tables, Charts, ranges, formatting. 100% Excel compatibility - uses Excel app instead of creating .xlsx files. Windows only.
* [currents-dev/currents-mcp](https://github.com/currents-dev/currents-mcp) ⭐ 14 | 🐛 2 | 🌐 TypeScript | 📅 2026-01-10 🎖️ 📇 ☁️ Enable AI Agents to fix Playwright test failures reported to [Currents](https://currents.dev).
...
* [ooples/token-optimizer-mcp](https://github.com/ooples/token-optimizer-mcp) ⭐ 12 | 🐛 15 | 🌐 TypeScript | 📅 2026-01-07 📇 🏠 ☁️ 🍎 🪟 🐧 - Intelligent token optimization achieving 95%+ reduction through caching, compression, and 80+ smart tools for API optimization, code analysis, and real-time monitoring.
...
* [narumiruna/gitingest-mcp](https://github.com/narumiruna/gitingest-mcp) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2025-11-21 🐍 🏠 - A MCP server that uses [gitingest](https://github.com/cyclotruc/gitingest) ⭐ 13,579 | 🐛 29 | 🌐 Python | 📅 2026-01-02 to convert any Git repository into a simple text digest of its codebase.
...
* [InsForge/insforge-mcp](https://github.com/InsForge/insforge-mcp) ⭐ 6 | 🐛 5 | 🌐 TypeScript | 📅 2026-01-10 📇 ☁️ - AI-native backend-as-a-service platform enabling AI agents to build and manage full-stack applications. Provides Auth, Database (PostgreSQL), Storage, and Functions as production-grade infrastructure, reducing MVP development time from weeks to hours.
...
* [deploy-mcp/deploy-mcp](https://github.com/alexpota/deploy-mcp) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-09 📇 ☁️ 🏠 - Universal deployment tracker for AI assistants with live status badges and deployment monitoring
...
* [hoklims/stacksfinder-mcp](https://github.com/hoklims/stacksfinder-mcp) ⭐ 1 | 🐛 1 | 🌐 TypeScript | 📅 2026-01-10 📇 🏠 🍎 🪟 🐧 - Deterministic tech stack recommendations with 6-dimension scoring. Analyze, compare technologies, get optimal stack suggestions for any project type. 10 tools (4 free, 6 Pro).
* [pzalutski-pixel/sharplens-mcp](https://github.com/pzalutski-pixel/sharplens-mcp) ⭐ 1 | 🐛 1 | 🌐 C# | 📅 2026-01-01 #️⃣ 🏠 - 58 semantic C#/.NET analysis tools via Roslyn. Navigation, refactoring, find usages, and code intelligence for AI agents.
...
* [mckinsey/vizro-mcp](https://github.com/mckinsey/vizro/tree/main/vizro-mcp) ⭐ 3,542 | 🐛 56 | 🌐 Python | 📅 2026-01-11 🎖️ 🐍 🏠 - Tools and templates to create validated and maintainable data charts and dashboards.
* [zcaceres/markdownify-mcp](https://github.com/zcaceres/markdownify-mcp) ⭐ 2,344 | 🐛 18 | 🌐 TypeScript | 📅 2025-09-02 📇 🏠 - An MCP server to convert almost any file or web content into Markdown
* [datalayer/jupyter-mcp-server](https://github.com/datalayer/jupyter-mcp-server) ⭐ 842 | 🐛 18 | 🌐 Python | 📅 2026-01-09 🐍 🏠 - Model Context Protocol (MCP) Server for Jupyter.
* [DataEval/dingo](https://github.com/DataEval/dingo) ⭐ 615 | 🐛 6 | 🌐 JavaScript | 📅 2026-01-07 🎖️ 🐍 🏠 🍎 🪟 🐧 - MCP server for the Dingo: a comprehensive data quality evaluation tool. Server Enables interaction with Dingo's rule-based and LLM-based evaluation capabilities and rules\&prompts listing.
...
* [Bright-L01/networkx-mcp-server](https://github.com/Bright-L01/networkx-mcp-server) ⭐ 11 | 🐛 2 | 🌐 Python | 📅 2026-01-05 🐍 🏠 - The first NetworkX integration for Model Context Protocol, enabling graph analysis and visualization directly in AI conversations. Supports 13 operations including centrality algorithms, community detection, PageRank, and graph visualization.
...
* [stack-chan/stack-chan](https://github.com/stack-chan/stack-chan) ⭐ 1,052 | 🐛 28 | 🌐 TypeScript | 📅 2026-01-10 📇 📟 - A JavaScript-driven M5Stack-embedded super-kawaii robot with MCP server functionality for AI-controlled interactions and emotions.
* [horw/esp-mcp](https://github.com/horw/esp-mcp) ⭐ 125 | 🐛 31 | 🌐 Python | 📅 2025-12-27 📟 - Workflow for fixing build issues in ESP32 series chips using ESP-IDF.
* [yoelbassin/gnuradioMCP](https://github.com/yoelbassin/gnuradioMCP) ⭐ 25 | 🐛 0 | 🌐 Python | 📅 2026-01-05 🐍 📟 🏠 - An MCP server for GNU Radio that enables LLMs to autonomously create and modify RF `.grc` flowcharts.
...
* [microsoft/markitdown](https://github.com/microsoft/markitdown/tree/main/packages/markitdown-mcp) ⭐ 85,146 | 🐛 414 | 🌐 Python | 📅 2026-01-08 🎖️ 🐍 🏠 - MCP tool access to MarkItDown -- a library that converts many file formats (local or remote) to Markdown for LLM consumption.
* [mickaelkerjean/filestash](https://github.com/mickael-kerjean/filestash/tree/master/server/plugin/plg_handler_mcp) ⭐ 13,398 | 🐛 61 | 🌐 JavaScript | 📅 2026-01-07 🏎️ ☁️ - Remote Storage Access: SFTP, S3, FTP, SMB, NFS, WebDAV, GIT, FTPS, gcloud, azure blob, sharepoint, etc.
* [mark3labs/mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server) ⭐ 579 | 🐛 17 | 🌐 Go | 📅 2025-11-24 🏎️ 🏠 - Golang implementation for local file system access.
...
* [isaacphi/mcp-gdrive](https://github.com/isaacphi/mcp-gdrive) ⭐ 249 | 🐛 10 | 🌐 TypeScript | 📅 2025-05-07 📇 ☁️ - Model Context Protocol (MCP) Server for reading from Google Drive and editing Google Sheets.
* [8b-is/smart-tree](https://github.com/8b-is/smart-tree) ⭐ 208 | 🐛 0 | 🌐 Rust | 📅 2025-12-08 🦀 🏠 🍎 🪟 🐧 - AI-native directory visualization with semantic analysis, ultra-compressed formats for AI consumption, and 10x token reduction. Supports quantum-semantic mode with intelligent file categorization.
...
* [willianpinho/large-file-mcp](https://github.com/willianpinho/large-file-mcp) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-06 📇 🏠 🍎 🪟 🐧 - Production-ready MCP server for intelligent handling of large files with smart chunking, navigation, streaming capabilities, regex search, and built-in LRU caching.
...
* [base/base-mcp](https://github.com/base/base-mcp) ⭐ 333 | 🐛 34 | 🌐 TypeScript | 📅 2025-06-17 🎖️ 📇 ☁️ - Base Network integration for onchain tools, allowing interaction with Base Network and Coinbase API for wallet management, fund transfers, smart contracts, and DeFi operations
...
* [aaronjmars/web3-research-mcp](https://github.com/aaronjmars/web3-research-mcp) ⭐ 149 | 🐛 0 | 🌐 TypeScript | 📅 2025-10-31 📇 ☁️ - Deep Research for crypto - free & fully local
...
* [ariadng/metatrader-mcp-server](https://github.com/ariadng/metatrader-mcp-server) ⭐ 145 | 🐛 5 | 🌐 Python | 📅 2025-10-09 🐍 🏠 🪟 - Enable AI LLMs to execute trades using MetaTrader 5 platform
...
* [narumiruna/yfinance-mcp](https://github.com/narumiruna/yfinance-mcp) ⭐ 86 | 🐛 0 | 🌐 Python | 📅 2026-01-11 🐍 ☁️ - An MCP server that uses yfinance to obtain information from Yahoo Finance.
...
* [HuggingAGI/mcp-baostock-server](https://github.com/HuggingAGI/mcp-baostock-server) ⭐ 67 | 🐛 2 | 🌐 Python | 📅 2025-04-08 🐍 ☁️ - MCP server based on baostock, providing access and analysis capabilities for Chinese stock market data.
...
* [openMF/mcp-mifosx](https://github.com/openMF/mcp-mifosx) ⭐ 18 | 🐛 4 | 🌐 Java | 📅 2026-01-08 ☁️ 🏠 -  A core banking integration for managing clients, loans, savings, shares, financial transactions and generating financial reports.
...
* [ThomasMarches/substrate-mcp-rs](https://github.com/ThomasMarches/substrate-mcp-rs) ⭐ 12 | 🐛 0 | 🌐 Rust | 📅 2025-10-12 🦀 🏠 - An MCP server implementation to interact with Substrate-based blockchains. Built with Rust and interfacing the [subxt](https://github.com/paritytech/subxt) ⭐ 476 | 🐛 93 | 🌐 Rust | 📅 2026-01-12 crate.
...
* [ahmetsbilgin/finbrain-mcp](https://github.com/ahmetsbilgin/finbrain-mcp) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-01-07 🎖️ 🐍 ☁️ 🏠 - Access institutional-grade alternative financial data directly in your LLM workflows.
...
* [Coding-Solo/godot-mcp](https://github.com/Coding-Solo/godot-mcp) ⭐ 1,366 | 🐛 22 | 🌐 JavaScript | 📅 2026-01-05 📇 🏠 - A MCP server for interacting with the Godot game engine, providing tools for editing, running, debugging, and managing scenes in Godot projects.
* [CoderGamester/mcp-unity](https://github.com/CoderGamester/mcp-unity) ⭐ 1,211 | 🐛 8 | 🌐 C# | 📅 2026-01-12 #️⃣ 🏠 - MCP Server for Unity3d Game Engine integration for game development
* [IvanMurzak/Unity-MCP](https://github.com/IvanMurzak/Unity-MCP) ⭐ 745 | 🐛 32 | 🌐 C# | 📅 2026-01-11 #️⃣ 🏠 🍎 🪟 🐧 - MCP Server for Unity Editor and for a game made with Unity
...
* [opgginc/opgg-mcp](https://github.com/opgginc/opgg-mcp) ⭐ 59 | 🐛 2 | 🌐 TypeScript | 📅 2026-01-01 📇 ☁️ - Access real-time gaming data across popular titles like League of Legends, TFT, and Valorant, offering champion analytics, esports schedules, meta compositions, and character statistics.
...
* [upstash/context7](https://github.com/upstash/context7) ⭐ 41,571 | 🐛 81 | 🌐 TypeScript | 📅 2026-01-11 📇 ☁️ - Up-to-date code documentation for LLMs and AI code editors.
* [topoteretes/cognee](https://github.com/topoteretes/cognee/tree/dev/cognee-mcp) ⭐ 10,840 | 🐛 39 | 🌐 Python | 📅 2026-01-11 📇 🏠 - Memory manager for AI apps and Agents using various graph and vector stores and allowing ingestion from 30+ data sources
* [vectorize-io/hindsight](https://github.com/vectorize-io/hindsight) ⭐ 1,076 | 🐛 10 | 🌐 Python | 📅 2026-01-09 🐍 ☁️ 🏠 - Hindsight: Agent Memory That Works Like Human Memory - Built for AI Agents to manage Long Term Memory
* [chatmcp/mcp-server-chatsum](https://github.com/chatmcp/mcp-server-chatsum) ⭐ 1,029 | 🐛 7 | 🌐 TypeScript | 📅 2024-12-04 - Query and summarize your chat messages with AI prompts.
* [apecloud/ApeRAG](https://github.com/apecloud/ApeRAG) ⭐ 1,008 | 🐛 54 | 🌐 Python | 📅 2026-01-07 🐍 ☁️ 🏠 - Production-ready RAG platform combining Graph RAG, vector search, and full-text search. Best choice for building your own Knowledge Graph and for Context Engineering
* [mem0ai/mem0-mcp](https://github.com/mem0ai/mem0-mcp) ⭐ 554 | 🐛 12 | 🌐 Python | 📅 2025-12-07 🐍 🏠 - A Model Context Protocol server for Mem0 that helps manage coding preferences and patterns, providing tools for storing, retrieving and semantically handling code implementations, best practices and technical documentation in IDEs like Cursor and Windsurf
* [graphlit-mcp-server](https://github.com/graphlit/graphlit-mcp-server) ⭐ 367 | 🐛 3 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️ - Ingest anything from Slack, Discord, websites, Google Drive, Linear or GitHub into a Graphlit project - and then search and retrieve relevant knowledge within an MCP client like Cursor, Windsurf or Cline.
...
* [agentic-mcp-tools/memora](https://github.com/agentic-mcp-tools/memora) ⭐ 75 | 🐛 0 | 🌐 Python | 📅 2026-01-11 🐍 🏠 ☁️ - Persistent memory with knowledge graph visualization, semantic/hybrid search, cloud sync (S3/R2), and cross-session context management.
...
* [Smart-AI-Memory/empathy-framework](https://github.com/Smart-AI-Memory/empathy-framework) ⭐ 9 | 🐛 9 | 🌐 HTML | 📅 2026-01-10 🐍 🏠 - Five-level AI collaboration system with persistent memory and anticipatory capabilities. MCP-native integration for Claude and other LLMs with local-first architecture via MemDocs.
...
* [smith-and-web/obsidian-mcp-server](https://github.com/smith-and-web/obsidian-mcp-server) ⭐ 5 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-10 📇 🏠 🍎 🪟 🐧 - SSE-enabled MCP server for remote Obsidian vault management with 29 tools for notes, directories, frontmatter, tags, search, and link operations. Docker-ready with health monitoring.
...
* [JamesANZ/us-legal-mcp](https://github.com/JamesANZ/us-legal-mcp) ⭐ 5 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-10 📇 ☁️ - An MCP server that provides comprehensive US legislation.
...
* [QGIS MCP](https://github.com/jjsantos01/qgis_mcp) ⭐ 758 | 🐛 8 | 🌐 Python | 📅 2025-10-01 - connects QGIS Desktop to Claude AI through the MCP. This integration enables prompt-assisted project creation, layer loading, code execution, and more.
...
* [jagan-shanmugam/open-streetmap-mcp](https://github.com/jagan-shanmugam/open-streetmap-mcp) ⭐ 151 | 🐛 8 | 🌐 Python | 📅 2025-07-12 🐍 🏠 - An OpenStreetMap MCP server with location-based services and geospatial data.
...
* [SecretiveShell/MCP-timeserver](https://github.com/SecretiveShell/MCP-timeserver) ⭐ 41 | 🐛 4 | 🌐 Python | 📅 2025-01-07 🐍 🏠 - Access the time in any timezone and get the current local time
...
* [pipeboard-co/meta-ads-mcp](https://github.com/pipeboard-co/meta-ads-mcp) ⭐ 406 | 🐛 6 | 🌐 Python | 📅 2025-12-19 🐍 ☁️ 🏠 - Meta Ads automation that just works. Trusted by 10,000+ businesses to analyze performance, test creatives, optimize spend, and scale results — simply and reliably.
...
* [gomarble-ai/facebook-ads-mcp-server](https://github.com/gomarble-ai/facebook-ads-mcp-server) ⭐ 207 | 🐛 1 | 🌐 Python | 📅 2025-08-21 🐍 ☁️ - MCP server acting as an interface to the Facebook Ads, enabling programmatic access to Facebook Ads data and management features.
* [gomarble-ai/google-ads-mcp-server](https://github.com/gomarble-ai/google-ads-mcp-server) ⭐ 88 | 🐛 3 | 🌐 Python | 📅 2025-12-17 🐍 ☁️ - MCP server acting as an interface to the Google Ads, enabling programmatic access to Google Ads data and management features.
...
* [netdata/netdata#Netdata](https://github.com/netdata/netdata/blob/master/src/web/mcp/README.md) ⭐ 77,311 | 🐛 241 | 🌐 C | 📅 2026-01-12 🎖️ 🏠 ☁️ 📟 🍎 🪟 🐧 - Discovery, exploration, reporting and root cause analysis using all observability data, including metrics, logs, systems, containers, processes, and network connections
* [grafana/mcp-grafana](https://github.com/grafana/mcp-grafana) ⭐ 2,104 | 🐛 64 | 🌐 Go | 📅 2026-01-09 🎖️ 🐍 🏠 ☁️ - Search dashboards, investigate incidents and query datasources in your Grafana instance
* [getsentry/sentry-mcp](https://github.com/getsentry/sentry-mcp) ⭐ 496 | 🐛 46 | 🌐 TypeScript | 📅 2026-01-11 🐍 ☁️ - Sentry.io integration for error tracking and performance monitoring
...
* [mpeirone/zabbix-mcp-server](https://github.com/mpeirone/zabbix-mcp-server) ⭐ 126 | 🐛 10 | 🌐 Python | 📅 2025-10-16 🐍 ☁️ 🐧 🪟 🍎 - Zabbix integration for hosts, items, triggers, templates, problems, data and more.
* [VictoriaMetrics-Community/mcp-victoriametrics](https://github.com/VictoriaMetrics-Community/mcp-victoriametrics) ⭐ 110 | 🐛 4 | 🌐 Go | 📅 2026-01-09 🎖️ 🏎️ 🏠 - Provides comprehensive integration with your [VictoriaMetrics instance APIs](https://docs.victoriametrics.com/victoriametrics/url-examples/) and [documentation](https://docs.victoriametrics.com/) for monitoring, observability, and debugging tasks related to your VictoriaMetrics instances
...
* [last9/last9-mcp-server](https://github.com/last9/last9-mcp-server) ⭐ 48 | 🐛 2 | 🌐 Go | 📅 2026-01-10 - Seamlessly bring real-time production context—logs, metrics, and traces—into your local environment to auto-fix code faster
...
* [tumf/grafana-loki-mcp](https://github.com/tumf/grafana-loki-mcp) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2026-01-05 🐍 🏠 - An MCP server that allows querying Loki logs through the Grafana API.
...
* [pminervini/deep-research-mcp](https://github.com/pminervini/deep-research-mcp) ⭐ 39 | 🐛 0 | 🌐 Python | 📅 2025-10-20 🐍 ☁️ 🏠 - Deep research MCP server for OpenAI Responses API or Open Deep Research (smolagents), with web search and code interpreter support.
* [Pantheon-Security/notebooklm-mcp-secure](https://github.com/Pantheon-Security/notebooklm-mcp-secure) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-04 📇 🏠 🍎 🪟 🐧 - Query Google NotebookLM from Claude/AI agents with 14 security hardening layers. Session-based conversations, notebook library management, and source-grounded research responses.
...
* [exa-labs/exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) ⭐ 3,531 | 🐛 29 | 🌐 TypeScript | 📅 2026-01-06 🎖️ 📇 ☁️ – A Model Context Protocol (MCP) server lets AI assistants like Claude use the Exa AI Search API for web searches. This setup allows AI models to get real-time web information in a safe and controlled way.
...
* [blazickjp/arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) ⭐ 2,027 | 🐛 34 | 🌐 Python | 📅 2025-08-19 ☁️ 🐍 - Search ArXiv research papers
* [luminati-io/brightdata-mcp](https://github.com/luminati-io/brightdata-mcp) ⭐ 1,880 | 🐛 14 | 🌐 JavaScript | 📅 2026-01-08 📇 ☁️ - Discover, extract, and interact with the web - one interface powering automated access across the public internet.
...
* [nickclyde/duckduckgo-mcp-server](https://github.com/nickclyde/duckduckgo-mcp-server) ⭐ 716 | 🐛 21 | 🌐 Python | 📅 2025-03-11 🐍 ☁️ - Web search using DuckDuckGo
* [Aas-ee/open-webSearch](https://github.com/Aas-ee/open-webSearch) ⭐ 569 | 🐛 9 | 🌐 TypeScript | 📅 2025-10-26 🐍 📇 ☁️ - Web search using free multi-engine search (NO API KEYS REQUIRED) — Supports Bing, Baidu, DuckDuckGo, Brave, Exa, and CSDN.
* [brave/brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) ⭐ 503 | 🐛 15 | 🌐 TypeScript | 📅 2026-01-11 📇 ☁️ - Web search capabilities using Brave's Search API
* [genomoncology/biomcp](https://github.com/genomoncology/biomcp) ⭐ 389 | 🐛 14 | 🌐 Python | 📅 2026-01-08 🐍 ☁️ - Biomedical research server providing access to PubMed, ClinicalTrials.gov, and MyVariant.info.
* [Ihor-Sokoliuk/MCP-SearXNG](https://github.com/ihor-sokoliuk/mcp-searxng) ⭐ 386 | 🐛 11 | 🌐 TypeScript | 📅 2025-11-09 📇 🏠/☁️ - A Model Context Protocol Server for [SearXNG](https://docs.searxng.org)
...
* [kagisearch/kagimcp](https://github.com/kagisearch/kagimcp) ⭐ 259 | 🐛 5 | 🌐 Python | 📅 2025-11-17 ☁️ 📇 – Official Kagi Search MCP Server
...
* [deadletterq/mcp-opennutrition](https://github.com/deadletterq/mcp-opennutrition) ⭐ 151 | 🐛 0 | 🌐 TypeScript | 📅 2025-06-11 📇 🏠 - Local MCP server for searching 300,000+ foods, nutrition facts, and barcodes from the OpenNutrition database.
* [andybrandt/mcp-simple-pubmed](https://github.com/andybrandt/mcp-simple-pubmed) ⭐ 148 | 🐛 4 | 🌐 Python | 📅 2025-12-17 - 🐍 ☁️  MCP to search and read medical / life sciences papers from PubMed.
...
* [mikechao/brave-search-mcp](https://github.com/mikechao/brave-search-mcp) ⭐ 89 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-11 📇 ☁️ - Web, Image, News, Video, and Local Point of Interest search capabilities using Brave's Search API
...
* [zhsama/duckduckgo-mcp-server](https://github.com/zhsama/duckduckgo-mpc-server/) ⭐ 70 | 🐛 2 | 🌐 TypeScript | 📅 2025-04-04 📇 🏠 ☁️ - This is a TypeScript-based MCP server that provides DuckDuckGo search functionality.
...
* [ricocf/mcp-wolframalpha](https://github.com/ricocf/mcp-wolframalpha) ⭐ 59 | 🐛 2 | 🌐 Python | 📅 2025-08-06 🐍 🏠 ☁️ - An MCP server lets AI assistants use the Wolfram Alpha API for real-time access to computational knowledge and data.
...
* [isnow890/naver-search-mcp](https://github.com/isnow890/naver-search-mcp) ⭐ 52 | 🐛 2 | 🌐 JavaScript | 📅 2026-01-03 📇 ☁️ - MCP server for Naver Search API integration, supporting blog, news, shopping search and DataLab analytics features.
* [ananddtyagi/webpage-screenshot-mcp](https://github.com/ananddtyagi/webpage-screenshot-mcp) ⭐ 48 | 🐛 4 | 🌐 JavaScript | 📅 2025-06-29 📇 🏠 - A MCP server for taking screenshots of webpages to use as feedback during UI developement.
...
* [imprvhub/mcp-rss-aggregator](https://github.com/imprvhub/mcp-rss-aggregator) ⭐ 20 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-07 📇 ☁️ 🏠 - Model Context Protocol Server for aggregating RSS feeds in Claude Desktop.
...
* [parallel-web/search-mcp](https://github.com/parallel-web/search-mcp) ⭐ 7 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-09 ☁️ 🔎 - Highest Accuracy Web Search for AI
...
* [LaurieWired/GhidraMCP](https://github.com/LaurieWired/GhidraMCP) ⭐ 7,043 | 🐛 63 | 🌐 Java | 📅 2025-06-23 ☕ 🏠 - A Model Context Protocol server for Ghidra that enables LLMs to autonomously reverse engineer applications. Provides tools for decompiling binaries, renaming methods and data, and listing methods, classes, imports, and exports.
* [mrexodia/ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) ⭐ 4,975 | 🐛 35 | 🌐 Python | 📅 2026-01-09 🐍 🏠 - MCP server for IDA Pro, allowing you to perform binary analysis with AI assistants. This plugin implement decompilation, disassembly and allows you to generate malware analysis reports automatically.
...
* [zinja-coder/jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp) ⭐ 1,049 | 🐛 8 | 🌐 Java | 📅 2026-01-08 ☕ 🏠 - JADX-AI-MCP is a plugin and MCP Server for the JADX decompiler that integrates directly with Model Context Protocol (MCP) to provide live reverse engineering support with LLMs like Claude.
...
* [jtang613/GhidrAssistMCP](https://github.com/jtang613/GhidrAssistMCP) ⭐ 395 | 🐛 7 | 🌐 Java | 📅 2026-01-06 ☕ 🏠 - A native Model Context Protocol server for Ghidra. Includes GUI configuration and logging, 31 powerful tools and no external dependencies.
...
* [securityfortech/secops-mcp](https://github.com/securityfortech/secops-mcp) ⭐ 170 | 🐛 3 | 🌐 Python | 📅 2025-09-17 🐍 🏠 - All-in-one security testing toolbox that brings together popular open source tools through a single MCP interface. Connected to an AI agent, it enables tasks like pentesting, bug bounty hunting, threat hunting, and more.
* [fosdickio/binary\_ninja\_mcp](https://github.com/fosdickio/binary_ninja_mcp) ⭐ 163 | 🐛 19 | 🌐 Python | 📅 2025-12-23 🐍 🏠 🍎 🪟 🐧 - A Binary Ninja plugin, MCP server, and bridge that seamlessly integrates [Binary Ninja](https://binary.ninja) with your favorite MCP client.  It enables you to automate the process of performing binary analysis and reverse engineering.
* [gbrigandi/mcp-server-wazuh](https://github.com/gbrigandi/mcp-server-wazuh) ⭐ 160 | 🐛 4 | 🌐 Rust | 📅 2025-12-12 🦀 🏠 🚨 🍎 🪟 🐧 - A Rust-based MCP server bridging Wazuh SIEM with AI assistants, providing real-time security alerts and event data for enhanced contextual understanding.
...
* [BurtTheCoder/mcp-virustotal](https://github.com/BurtTheCoder/mcp-virustotal) ⭐ 99 | 🐛 5 | 🌐 TypeScript | 📅 2025-03-03 📇 🪟 ☁️ - MCP server for querying the VirusTotal API. This server provides tools for scanning URLs, analyzing file hashes, and retrieving IP address reports.
* [BurtTheCoder/mcp-shodan](https://github.com/BurtTheCoder/mcp-shodan) ⭐ 98 | 🐛 4 | 🌐 JavaScript | 📅 2025-03-03 📇 🪟 ☁️ - MCP server for querying the Shodan API and Shodan CVEDB. This server provides tools for IP lookups, device searches, DNS lookups, vulnerability queries, CPE lookups, and more.
...
* [karanb192/reddit-mcp-buddy](https://github.com/karanb192/reddit-mcp-buddy) ⭐ 340 | 🐛 7 | 🌐 TypeScript | 📅 2025-12-31 📇 🏠 - Browse Reddit posts, search content, and analyze user activity without API keys. Works out-of-the-box with Claude Desktop.
* [HagaiHen/facebook-mcp-server](https://github.com/HagaiHen/facebook-mcp-server) ⭐ 92 | 🐛 1 | 🌐 Python | 📅 2025-08-20 🐍 ☁️ - Integrates with Facebook Pages to enable direct management of posts, comments, and engagement metrics through the Graph API for streamlined social media management.
* [king-of-the-grackles/reddit-research-mcp](https://github.com/king-of-the-grackles/reddit-research-mcp) ⭐ 74 | 🐛 0 | 🌐 Python | 📅 2025-12-11 🐍 ☁️ - AI-powered Reddit intelligence for market research and competitive analysis. Discover subreddits via semantic search across 20k+ indexed communities, fetch posts/comments with full citations, and manage research feeds. No Reddit API credentials needed.
...
* [r-huijts/strava-mcp](https://github.com/r-huijts/strava-mcp) ⭐ 216 | 🐛 6 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️ - A Model Context Protocol (MCP) server that connects to Strava API, providing tools to access Strava data through LLMs
...
* [Milofax/xert-mcp](https://github.com/Milofax/xert-mcp) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-01-08 📇 ☁️ - MCP server for XERT cycling analytics — access fitness signature (FTP, HIE, PP), training status, workouts, activities with XSS metrics, and MPA analysis.
...
* [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 3,937 | 🐛 138 | 🌐 Python | 📅 2026-01-06 🐍 ☁️ - MCP server for Atlassian products (Confluence and Jira). Supports Confluence Cloud, Jira Cloud, and Jira Server/Data Center. Provides comprehensive tools for searching, reading, creating, and managing content across Atlassian workspaces.
...
* [aikts/yandex-tracker-mcp](https://github.com/aikts/yandex-tracker-mcp) ⭐ 34 | 🐛 8 | 🌐 Python | 📅 2026-01-10 🐍 ☁️ 🏠 - MCP Server for Yandex Tracker. Provides tools for searching and retrieving information about issues, queues, users.
...
* [mbailey/voice-mcp](https://github.com/mbailey/voice-mcp) ⭐ 563 | 🐛 27 | 🌐 Python | 📅 2026-01-12 🐍 🏠 - Complete voice interaction server supporting speech-to-text, text-to-speech, and real-time voice conversations through local microphone, OpenAI-compatible APIs, and LiveKit integration
...
* [openbnb-org/mcp-server-airbnb](https://github.com/openbnb-org/mcp-server-airbnb) ⭐ 358 | 🐛 7 | 🌐 JavaScript | 📅 2025-07-18 📇 ☁️ - Provides tools to search Airbnb and get listing details.
* [cobanov/teslamate-mcp](https://github.com/cobanov/teslamate-mcp) ⭐ 111 | 🐛 0 | 🌐 Python | 📅 2025-11-29 🐍 🏠 - A Model Context Protocol (MCP) server that provides access to your TeslaMate database, allowing AI assistants to query Tesla vehicle data and analytics.
...
* [KyrieTangSheng/mcp-server-nationalparks](https://github.com/KyrieTangSheng/mcp-server-nationalparks) ⭐ 36 | 🐛 5 | 🌐 TypeScript | 📅 2025-06-17 📇 ☁️ - National Park Service API integration providing latest information of park details, alerts, visitor centers, campgrounds, and events for U.S. National Parks
...
* [srinath1510/alltrails-mcp-server](https://github.com/srinath1510/alltrails-mcp-server) ⭐ 8 | 🐛 2 | 🌐 Python | 📅 2025-06-19 🐍 ☁️ - A MCP server that provides access to AllTrails data, allowing you to search for hiking trails and get detailed trail information
...
* [github/github-mcp-server](https://github.com/github/github-mcp-server) ⭐ 25,823 | 🐛 240 | 🌐 Go | 📅 2026-01-10 📇 ☁️ - Official GitHub server for integration with repository management, PRs, issues, and more.
...
* [kopfrechner/gitlab-mr-mcp](https://github.com/kopfrechner/gitlab-mr-mcp) ⭐ 74 | 🐛 8 | 🌐 JavaScript | 📅 2026-01-07 📇 ☁️ - Interact seamlessly with issues and merge requests of your GitLab projects.
...
* [taylorwilsdon/google\_workspace\_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) ⭐ 1,108 | 🐛 46 | 🌐 Python | 📅 2026-01-07 🐍 ☁️ 🍎 🪟 🐧 - Comprehensive Google Workspace MCP server with full support for Google Calendar, Drive, Gmail, and Docs, Forms, Chats, Slides and Sheets over stdio, Streamable HTTP and SSE transports.
...
* [teamwork/mcp](https://github.com/teamwork/mcp) ⭐ 11 | 🐛 2 | 🌐 Go | 📅 2026-01-08 🎖️ 🏎️ ☁️ 🍎 🪟 🐧 - Project and resource management platform that keeps your client projects on track, makes managing resources a breeze, and keeps your profits on point.
...
* [modelcontextprotocol/server-everything](https://github.com/modelcontextprotocol/servers/tree/main/src/everything) ⭐ 75,979 | 🐛 266 | 🌐 TypeScript | 📅 2026-01-11 📇 🏠 - MCP server that exercises all the features of the MCP protocol
* [mediar-ai/screenpipe](https://github.com/mediar-ai/screenpipe) ⭐ 16,395 | 🐛 254 | 🌐 TypeScript | 📅 2025-12-09 - 🎖️ 🦀 🏠 🍎 Local-first system capturing screen/audio with timestamped indexing, SQL/embedding storage, semantic search, LLM-powered history analysis, and event-triggered actions - enables building context-aware AI agents through a NextJS plugin ecosystem.
* [Klavis-AI/YouTube](https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/youtube) ⭐ 5,587 | 🐛 54 | 🌐 Python | 📅 2026-01-12 🐍 📇 - Extract and convert YouTube video information.
* [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 3,937 | 🐛 138 | 🌐 Python | 📅 2026-01-06 🐍 ☁️ - MCP server for Atlassian products (Confluence and Jira). Supports Confluence Cloud, Jira Cloud, and Jira Server/Data Center. Provides comprehensive tools for searching, reading, creating, and managing content across Atlassian workspaces.
* [metorial/metorial](https://github.com/metorial/metorial) ⭐ 3,201 | 🐛 1 | 🌐 TypeScript | 📅 2026-01-12 - 🎖️ 📇 ☁️ Connect AI agents to 600+ integrations with a single interface - OAuth, scaling, and monitoring included
* [MarkusPfundstein/mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian) ⭐ 2,684 | 🐛 68 | 🌐 Python | 📅 2025-06-28 🐍 ☁️ 🏠 - Interacting with Obsidian via REST API
* [chrishayuk/mcp-cli](https://github.com/chrishayuk/mcp-cli) ⭐ 1,806 | 🐛 23 | 🌐 Python | 📅 2025-12-29 🐍 🏠 - Yet another CLI tool for testing MCP servers
* [anaisbetts/mcp-installer](https://github.com/anaisbetts/mcp-installer) ⭐ 1,492 | 🐛 21 | 🌐 JavaScript | 📅 2024-11-26 🐍 🏠 -  An MCP server that installs other MCP servers for you.
* [calclavia/mcp-obsidian](https://github.com/calclavia/mcp-obsidian) ⭐ 1,269 | 🐛 16 | 🌐 JavaScript | 📅 2026-01-02 📇 🏠 - This is a connector to allow Claude Desktop (or any MCP client) to read and search any directory containing Markdown notes (such as an Obsidian vault).
...
* [caol64/wenyan-mcp](https://github.com/caol64/wenyan-mcp) ⭐ 975 | 🐛 24 | 🌐 JavaScript | 📅 2025-12-29 📇 🏠 🍎 🪟 🐧 - Wenyan MCP Server, which lets AI automatically format Markdown articles and publish them to WeChat GZH.
...
* [apify/actors-mcp-server](https://github.com/apify/actors-mcp-server) ⭐ 690 | 🐛 31 | 🌐 TypeScript | 📅 2026-01-09 📇 ☁️ - Use 3,000+ pre-built cloud tools, known as Actors, to extract data from websites, e-commerce, social media, search engines, maps, and more
* [rusiaaman/wcgw](https://github.com/rusiaaman/wcgw/blob/main/src/wcgw/client/mcp_server/Readme.md) ⭐ 631 | 🐛 7 | 🌐 Python | 📅 2025-12-25 🐍 🏠 - Autonomous shell execution, computer control and coding agent. (Mac)
* [tevonsb/homeassistant-mcp](https://github.com/tevonsb/homeassistant-mcp) ⭐ 513 | 🐛 17 | 🌐 TypeScript | 📅 2025-02-01 📇 🏠 - Access Home Assistant data and control devices (lights, switches, thermostats, etc).
* [anaisbetts/mcp-youtube](https://github.com/anaisbetts/mcp-youtube) ⭐ 485 | 🐛 12 | 🌐 JavaScript | 📅 2025-03-20 📇 ☁️ - Fetch YouTube subtitles
...
* [wong2/mcp-cli](https://github.com/wong2/mcp-cli) ⭐ 402 | 🐛 10 | 🌐 JavaScript | 📅 2025-08-13 📇 🏠 - CLI tool for testing MCP servers
...
* [marcelmarais/Spotify](https://github.com/marcelmarais/spotify-mcp-server) ⭐ 213 | 🐛 5 | 🌐 TypeScript | 📅 2026-01-11 - 📇 🏠 Control Spotify playback and manage playlists.
...
* [ivnvxd/mcp-server-odoo](https://github.com/ivnvxd/mcp-server-odoo) ⭐ 130 | 🐛 15 | 🌐 Python | 📅 2025-12-15 🐍 ☁️/🏠 - Connect AI assistants to Odoo ERP systems for business data access, record management, and workflow automation.
...
* [anki-mcp/anki-mcp-desktop](https://github.com/anki-mcp/anki-mcp-desktop) ⭐ 77 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-14 📇 🏠 🍎 🪟 🐧 - Enterprise-grade Anki integration with natural language interaction, comprehensive note/deck management, and one-click MCPB installation. Built on NestJS with comprehensive test coverage.
...
* [orellazi/coda-mcp](https://github.com/orellazri/coda-mcp) ⭐ 40 | 🐛 0 | 🌐 TypeScript | 📅 2025-08-24 📇 ☁️ - MCP server for [Coda](https://coda.io/)
...
* [reeeeemo/ancestry-mcp](https://github.com/reeeeemo/ancestry-mcp) ⭐ 30 | 🐛 0 | 🌐 Python | 📅 2025-01-03 🐍 🏠 - Allows the AI to read .ged files and genetic data
...
> \[!NOTE]
> More frameworks, utilities, and other developer tools are available at <https://github.com/punkpeye/awesome-mcp-devtools> ⭐ 402 | 🐛 10 | 📅 2026-01-06

* [FastMCP](https://github.com/jlowin/fastmcp) ⭐ 21,857 | 🐛 221 | 🌐 Python | 📅 2026-01-11 🐍 - A high-level framework for building MCP servers in Python
* [FastMCP](https://github.com/punkpeye/fastmcp) ⭐ 2,871 | 🐛 35 | 🌐 TypeScript | 📅 2026-01-06 📇 - A high-level framework for building MCP servers in TypeScript
* [Epistates/TurboMCP](https://github.com/Epistates/turbomcp) ⭐ 60 | 🐛 1 | 🌐 Rust | 📅 2026-01-05 🦀 - TurboMCP SDK: Enterprise MCP SDK in Rust
