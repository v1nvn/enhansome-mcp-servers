...
Checkout [awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients/) ⭐ 6,148 | 🐛 53 | 📅 2025-12-23 and [glama.ai/mcp/clients](https://glama.ai/mcp/clients).
...
* [mindsdb/mindsdb](https://github.com/mindsdb/mindsdb) ⭐ 38,158 | 🐛 189 | 🌐 Python | 📅 2026-01-02 - Connect and unify data across various platforms and databases with [MindsDB as a single MCP server](https://docs.mindsdb.com/mcp/overview).
* [PipedreamHQ/pipedream](https://github.com/PipedreamHQ/pipedream/tree/master/modelcontextprotocol) ⭐ 10,936 | 🐛 4,344 | 🌐 JavaScript | 📅 2026-01-03 ☁️ 🏠 - Connect with 2,500 APIs with 8,000+ prebuilt tools, and manage servers for your users, in your own app.
* [metatool-ai/metatool-app](https://github.com/metatool-ai/metatool-app) ⭐ 1,843 | 🐛 60 | 🌐 TypeScript | 📅 2025-12-23 📇 ☁️ 🏠 🍎 🪟 🐧 - MetaMCP is the one unified middleware MCP server that manages your MCP connections with GUI.
...
* [K-Dense-AI/claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp) ⭐ 215 | 🐛 3 | 🌐 Python | 📅 2025-11-11 🐍 ☁️ 🏠 🍎 🪟 🐧 - Intelligent search capabilities to let every model and client use [Claude Agent Skills](https://www.anthropic.com/news/skills) like native.
...
* [juspay/neurolink](https://github.com/juspay/neurolink) ⭐ 102 | 🐛 403 | 🌐 TypeScript | 📅 2026-01-02 📇 ☁️ 🏠 🍎 🪟 🐧 - Making enterprise AI infrastructure universally accessible. Edge-first platform unifying 12 providers and 100+ models with multi-agent orchestration, HITL workflows, guardrails middleware, and context summarization.
...
* [portel-dev/ncp](https://github.com/portel-dev/ncp) ⭐ 55 | 🐛 2 | 🌐 JavaScript | 📅 2025-12-30 📇 ☁️ 🏠 🍎 🪟 🐧 - NCP orchestrates your entire MCP ecosystem through intelligent discovery, eliminating token overhead while maintaining 98.2% accuracy.
...
* [ahujasid/blender-mcp](https://github.com/ahujasid/blender-mcp) ⭐ 14,697 | 🐛 35 | 🌐 Python | 📅 2025-12-08 🐍 - MCP server for working with Blender
...
* [genomoncology/biomcp](https://github.com/genomoncology/biomcp) ⭐ 381 | 🐛 16 | 🌐 Python | 📅 2025-12-18 🐍 ☁️ - Biomedical research MCP server providing access to PubMed, ClinicalTrials.gov, and MyVariant.info.
* [the-momentum/apple-health-mcp-server](https://github.com/the-momentum/apple-health-mcp-server) ⭐ 91 | 🐛 8 | 🌐 Python | 📅 2025-10-22 🐍 🏠 🍎 🪟 🐧 - An MCP server that provides access to exported data from Apple Health. Data analytics included.
...
* [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) ⭐ 25,010 | 🐛 35 | 🌐 TypeScript | 📅 2025-12-31 - Official Microsoft Playwright MCP server, enabling LLMs to interact with web pages through structured accessibility snapshots
* [agent-infra/mcp-server-browser](https://github.com/bytedance/UI-TARS-desktop/tree/main/packages/agent-infra/mcp-servers/browser) ⭐ 20,350 | 🐛 312 | 🌐 TypeScript | 📅 2025-12-25 📇 🏠 - Browser automation capabilities using Puppeteer, both support local and remote browser connection.
* [browsermcp/mcp](https://github.com/browsermcp/mcp) ⭐ 5,322 | 🐛 103 | 🌐 TypeScript | 📅 2025-04-24 📇 🏠 - Automate your local Chrome browser
* [executeautomation/playwright-mcp-server](https://github.com/executeautomation/mcp-playwright) ⭐ 5,106 | 🐛 17 | 🌐 TypeScript | 📅 2025-12-13 📇 - An MCP server using Playwright for browser automation and webscrapping
* [browserbase/mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase) ⭐ 2,999 | 🐛 25 | 🌐 TypeScript | 📅 2025-12-10 🎖️ 📇 - Automate browser interactions in the cloud (e.g. web navigation, data extraction, form filling, and more)
...
* [kimtaeyoon83/mcp-server-youtube-transcript](https://github.com/kimtaeyoon83/mcp-server-youtube-transcript) ⭐ 367 | 🐛 6 | 🌐 TypeScript | 📅 2025-12-24 📇 ☁️ - Fetch YouTube subtitles and transcripts for AI analysis
* [eat-pray-ai/yutu](https://github.com/eat-pray-ai/yutu) ⭐ 357 | 🐛 1 | 🌐 Go | 📅 2025-12-25 🏎️ 🏠 🍎 🐧 🪟 - A fully functional MCP server and CLI for YouTube to automate YouTube operation
...
* [awslabs/mcp](https://github.com/awslabs/mcp) ⭐ 7,777 | 🐛 205 | 🌐 Python | 📅 2026-01-03 🎖️ ☁️ - AWS MCP servers for seamless integration with AWS services and resources.
...
* [manusa/Kubernetes MCP Server](https://github.com/manusa/kubernetes-mcp-server) ⭐ 931 | 🐛 49 | 🌐 Go | 📅 2026-01-02 🏎️ 🏠 A - powerful Kubernetes MCP server with additional support for OpenShift. Besides providing CRUD operations for **any** Kubernetes resource, this server provides specialized tools to interact with your cluster.
...
* [weibaohui/k8m](https://github.com/weibaohui/k8m) ⭐ 746 | 🐛 18 | 🌐 Go | 📅 2026-01-03 🏎️ ☁️/🏠 - Provides MCP multi-cluster Kubernetes management and operations, featuring a management interface, logging, and nearly 50 built-in tools covering common DevOps and development scenarios. Supports both standard and CRD resources.
...
* [pibblokto/cert-manager-mcp-server](https://github.com/pibblokto/cert-manager-mcp-server) ⭐ 21 | 🐛 0 | 🌐 Python | 📅 2025-08-25 🐍 🍎/🐧 ☁️ - mcp server for [cert-manager](https://github.com/cert-manager/cert-manager) ⭐ 13,432 | 🐛 217 | 🌐 Go | 📅 2026-01-01 management and troubleshooting
...
* [pydantic/pydantic-ai/mcp-run-python](https://github.com/pydantic/pydantic-ai/tree/main/mcp-run-python) ⭐ 14,095 | 🐛 423 | 🌐 Python | 📅 2026-01-02 🐍 🏠 - Run Python code in a secure sandbox via MCP tool calls
...
* [oraios/serena](https://github.com/oraios/serena) ⭐ 18,011 | 🐛 83 | 🌐 Python | 📅 2026-01-01 🐍 🏠 - A fully-featured coding agent that relies on symbolic code operations by using language servers.
...
* [rinadelph/Agent-MCP](https://github.com/rinadelph/Agent-MCP) ⭐ 1,102 | 🐛 15 | 🌐 TypeScript | 📅 2025-10-09 🐍 🏠 - A framework for creating multi-agent systems using MCP for coordinated AI collaboration, featuring task management, shared context, and RAG capabilities.
* [shashankss1205/codegraphcontext](https://github.com/Shashankss1205/CodeGraphContext) ⭐ 311 | 🐛 63 | 🌐 Python | 📅 2026-01-02 🐍 🏠 🍎 🪟 🐧 An MCP server that indexes local code into a graph database to provide context to AI assistants with a graphical code visualizations for humans.
...
* [wonderwhy-er/DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) ⭐ 5,162 | 🐛 73 | 🌐 TypeScript | 📅 2026-01-02 📇 🏠 🍎 🪟 🐧 - A swiss-army-knife that can manage/execute programs and read/write/search/edit code and text files.
* [louis030195/terminator-mcp-agent](https://github.com/mediar-ai/terminator/tree/main/terminator-mcp-agent) ⭐ 1,231 | 🐛 10 | 🌐 Rust | 📅 2025-12-23 🦀 📇 🏠 🍎 🪟 🐧 - Desktop GUI automation using accessibility APIs. Control Windows, macOS, and Linux applications without vision models or screenshots. Supports workflow recording, structured data extraction, and browser DOM inspection.
* [aymericzip/intlayer](https://github.com/aymericzip/intlayer) ⭐ 513 | 🐛 23 | 🌐 TypeScript | 📅 2026-01-03 📇 ☁️ 🏠 - A MCP Server that enhance your IDE with AI-powered assistance for Intlayer i18n / CMS tool: smart CLI access, access to the docs.
...
* [elie222/inbox-zero](https://github.com/elie222/inbox-zero/tree/main/apps/mcp-server) ⭐ 9,678 | 🐛 96 | 🌐 TypeScript | 📅 2026-01-02 🐍 ☁️ - An MCP server for Inbox Zero. Adds functionality on top of Gmail like finding out which emails you need to reply to or need to follow up on.
...
* [korotovsky/slack-mcp-server](https://github.com/korotovsky/slack-mcp-server) ⭐ 1,048 | 🐛 31 | 🌐 Go | 📅 2025-12-25 📇 ☁️ - The most powerful MCP server for Slack Workspaces.
* [chigwell/telegram-mcp](https://github.com/chigwell/telegram-mcp) ⭐ 523 | 🐛 6 | 🌐 Python | 📅 2025-12-29 🐍 🏠 - Telegram API integration for accessing user data, managing dialogs (chats, channels, groups), retrieving messages, sending messages and handling read status.
* [line/line-bot-mcp-server](https://github.com/line/line-bot-mcp-server) ⭐ 505 | 🐛 20 | 🌐 TypeScript | 📅 2026-01-02 🎖 📇 ☁️ - MCP Server for Integrating LINE Official Account
...
* [saseq/discord-mcp](https://github.com/SaseQ/discord-mcp) ⭐ 143 | 🐛 1 | 🌐 Java | 📅 2025-08-11 ☕ 📇 🏠 💬 - A MCP server for the Discord integration. Enable your AI assistants to seamlessly interact with Discord. Enhance your Discord experience with powerful automation capabilities.
...
* [antv/mcp-server-chart](https://github.com/antvis/mcp-server-chart) ⭐ 3,439 | 🐛 12 | 🌐 TypeScript | 📅 2025-12-29 🎖️ 📇 ☁️ - A Model Context Protocol server for generating visual charts using [AntV](https://github.com/antvis).
...
* [googleapis/genai-toolbox](https://github.com/googleapis/genai-toolbox) ⭐ 12,076 | 🐛 151 | 🌐 Go | 📅 2026-01-02 🏎️ ☁️ - Open source MCP server specializing in easy, fast, and secure tools for Databases.

* [get-convex/convex-backend](https://stack.convex.dev/convex-mcp-server) 📇 ☁️ - Convex database integration to introspect tables, functions, and run oneoff queries ([Source](https://github.com/get-convex/convex-backend/blob/main/npm-packages/convex/src/cli/mcp.ts) ⭐ 8,817 | 🐛 116 | 🌐 Rust | 📅 2026-01-03)

* [bram2w/baserow](https://github.com/bram2w/baserow) ⭐ 3,653 | 🐛 1,048 | 🌐 Python | 📅 2026-01-02 - Baserow database integration with table search, list, and row create, read, update, and delete capabilities.

* [supabase-community/supabase-mcp](https://github.com/supabase-community/supabase-mcp) ⭐ 2,358 | 🐛 71 | 🌐 TypeScript | 📅 2026-01-02 🎖️ 📇 ☁️ - Official Supabase MCP server to connect AI assistants directly with your Supabase project and allows them to perform tasks like managing tables, fetching config, and querying data.

* [crystaldba/postgres-mcp](https://github.com/crystaldba/postgres-mcp) ⭐ 1,742 | 🐛 37 | 🌐 Python | 📅 2025-11-11 🐍 🏠 - All-in-one MCP server for Postgres development and operations, with tools for performance analysis, tuning, and health checks

* [qdrant/mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant) ⭐ 1,148 | 🐛 35 | 🌐 Python | 📅 2025-12-10 🐍 🏠 - A Qdrant MCP server

* [designcomputer/mysql\_mcp\_server](https://github.com/designcomputer/mysql_mcp_server) ⭐ 1,051 | 🐛 52 | 🌐 Python | 📅 2025-06-05 🐍 🏠 - MySQL database integration with configurable access controls, schema inspection, and comprehensive security guidelines

* [benborla29/mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) ⭐ 1,027 | 🐛 34 | 🌐 JavaScript | 📅 2025-11-18 ☁️ 🏠 - MySQL database integration in NodeJS with configurable access controls and schema inspection
...
* [redis/mcp-redis](https://github.com/redis/mcp-redis) ⭐ 379 | 🐛 7 | 🌐 Python | 📅 2025-12-15 🐍 🏠 - The Redis official MCP Server offers an interface to manage and search data in Redis.
...
* [confluentinc/mcp-confluent](https://github.com/confluentinc/mcp-confluent) ⭐ 124 | 🐛 9 | 🌐 TypeScript | 📅 2026-01-02 🐍 ☁️ - Confluent integration to interact with Confluent Kafka and Confluent Cloud REST APIs.
...
* [s2-streamstore/s2-sdk-typescript](https://github.com/s2-streamstore/s2-sdk-typescript) ⭐ 22 | 🐛 9 | 🌐 TypeScript | 📅 2026-01-02 🎖️ 📇 ☁️ - Official MCP server for the S2.dev serverless stream platform.
...
* [ferrants/memvid-mcp-server](https://github.com/ferrants/memvid-mcp-server) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2025-06-20 🐍 🏠 - Python Streamable HTTP Server you can run locally to interact with [memvid](https://github.com/Olow304/memvid) ⭐ 10,540 | 🐛 12 | 🌐 Python | 📅 2026-01-01 storage and semantic search.
...
* [eyaltoledano/claude-task-master](https://github.com/eyaltoledano/claude-task-master) ⭐ 24,549 | 🐛 152 | 🌐 JavaScript | 📅 2026-01-02 📇 ☁️ 🏠 - AI-powered task management system for AI-driven development. Features PRD parsing, task expansion, multi-provider support (Claude, OpenAI, Gemini, Perplexity, xAI), and selective tool loading for optimized context usage.
* [GLips/Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 12,381 | 🐛 38 | 🌐 TypeScript | 📅 2026-01-01 📇 🏠 - Provide coding agents direct access to Figma data to help them one-shot design implementation.
* [idosal/git-mcp](https://github.com/idosal/git-mcp) ⭐ 7,302 | 🐛 48 | 🌐 TypeScript | 📅 2025-08-22 📇 ☁️ - [gitmcp.io](https://gitmcp.io/) is a generic remote MCP server to connect to ANY [GitHub](https://www.github.com) repository or project for documentation
* [21st-dev/Magic-MCP](https://github.com/21st-dev/magic-mcp) ⭐ 4,071 | 🐛 21 | 🌐 TypeScript | 📅 2025-12-23 - Create crafted UI components inspired by the best 21st.dev design engineers.
* [haris-musa/excel-mcp-server](https://github.com/haris-musa/excel-mcp-server) ⭐ 3,048 | 🐛 37 | 🌐 Python | 📅 2025-12-22 🐍 🏠 - An Excel manipulation server providing workbook creation, data operations, formatting, and advanced features (charts, pivot tables, formulae).
* [mobile-next/mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 2,827 | 🐛 32 | 🌐 TypeScript | 📅 2026-01-02 📇 🏠 🐧 🍎 - MCP Server for Android/iOS application and device automation, development and app scraping. Simulator/Emulator/Physical devices like iPhone, Google Pixel, Samsung supported.
* [Jpisnice/shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,576 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-29 📇 🏠 - MCP server that gives AI assistants seamless access to shadcn/ui v4 components, blocks, demos, and metadata.
...
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 1,377 | 🐛 13 | 🌐 JavaScript | 📅 2025-12-31 📇 🏠 🍎 - A Model Context Protocol (MCP) server for interacting with iOS simulators. This server allows you to interact with iOS simulators by getting information about them, controlling UI interactions, and inspecting UI elements.
* [isaacphi/mcp-language-server](https://github.com/isaacphi/mcp-language-server) ⭐ 1,356 | 🐛 45 | 🌐 Go | 📅 2026-01-01 🏎️ 🏠 - MCP Language Server helps MCP enabled clients navigate codebases more easily by giving them access to semantic tools like get definition, references, rename, and diagnostics.
* [jetbrains/mcpProxy](https://github.com/JetBrains/mcpProxy) ⭐ 939 | 🐛 37 | 🌐 JavaScript | 📅 2025-12-02 🎖️ 📇 🏠 - Connect to JetBrains IDE
* [lpigeon/ros-mcp-server](https://github.com/lpigeon/ros-mcp-server) ⭐ 906 | 🐛 18 | 🌐 Python | 📅 2026-01-02 🐍 🏠 🍎 🪟 🐧 - The ROS MCP Server supports robot control by converting user-issued natural language commands into ROS or ROS2 control commands.
...
* [bgauryy/octocode-mcp](https://github.com/bgauryy/octocode-mcp) ⭐ 660 | 🐛 3 | 🌐 TypeScript | 📅 2026-01-01 ☁️ 📇 🍎 🪟 🐧 - AI-powered developer assistant that enables advanced research, analysis and discovery across GitHub and NPM realms in realtime.
...
* [gitkraken/gk-cli](https://github.com/gitkraken/gk-cli) ⭐ 340 | 🐛 14 | 📅 2025-12-22 🎖️ 🏎️ 🏠 ☁️ 🍎 🪟 🐧 - A CLI for interacting with GitKraken APIs. Includes an MCP server via `gk mcp` that not only wraps GitKraken APIs, but also Jira, GitHub, GitLab, and more. Works with local tools and remote services.
...
* [joshuarileydev/app-store-connect-mcp-server](https://github.com/JoshuaRileyDev/app-store-connect-mcp-server) ⭐ 243 | 🐛 6 | 🌐 TypeScript | 📅 2025-09-02 📇 🏠 - An MCP server to communicate with the App Store Connect API for iOS Developers
* [public-ui/kolibri](https://github.com/public-ui/kolibri) ⭐ 242 | 🐛 162 | 🌐 TypeScript | 📅 2026-01-03 📇 ☁️ 🏠 - Streaming KoliBri MCP server (NPM: `@public-ui/mcp`) delivering 200+ guaranteed accessible web component samples, specs, docs, and scenarios via hosted HTTP endpoint or local `kolibri-mcp` CLI.
...
* [hloiseaufcms/mcp-gopls](https://github.com/hloiseaufcms/mcp-gopls) ⭐ 54 | 🐛 0 | 🌐 Go | 📅 2025-12-30 🏎️ 🏠 - A MCP server for interacting with [Go's Language Server Protocol (gopls)](https://github.com/golang/tools/tree/master/gopls) ⭐ 7,854 | 🐛 105 | 🌐 Go | 📅 2026-01-02 and benefit from advanced Go code analysis features.
...
* [api7/apisix-mcp](https://github.com/api7/apisix-mcp) ⭐ 29 | 🐛 2 | 🌐 TypeScript | 📅 2025-06-16 🎖️ 📇 🏠 MCP Server that support for querying and managing all resource in [Apache APISIX](https://github.com/apache/apisix) ⭐ 16,041 | 🐛 329 | 🌐 Lua | 📅 2026-01-01.
...
* [j4c0bs/mcp-server-sql-analyzer](https://github.com/j4c0bs/mcp-server-sql-analyzer) ⭐ 26 | 🐛 0 | 🌐 Python | 📅 2025-07-01 🐍 - MCP server that provides SQL analysis, linting, and dialect conversion using [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 8,756 | 🐛 16 | 🌐 Python | 📅 2026-01-02
...
* [higress-group/higress-ops-mcp-server](https://github.com/higress-group/higress-ops-mcp-server) ⭐ 22 | 🐛 6 | 🌐 Python | 📅 2025-03-29 🐍 🏠 - MCP server that provides comprehensive tools for managing [Higress](https://github.com/alibaba/higress) ⭐ 7,197 | 🐛 713 | 🌐 Go | 📅 2025-12-29 gateway configurations and operations.
...
* [narumiruna/gitingest-mcp](https://github.com/narumiruna/gitingest-mcp) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2025-11-21 🐍 🏠 - A MCP server that uses [gitingest](https://github.com/cyclotruc/gitingest) ⭐ 13,520 | 🐛 29 | 🌐 Python | 📅 2026-01-02 to convert any Git repository into a simple text digest of its codebase.
...
* [mckinsey/vizro-mcp](https://github.com/mckinsey/vizro/tree/main/vizro-mcp) ⭐ 3,509 | 🐛 51 | 🌐 Python | 📅 2026-01-02 🎖️ 🐍 🏠 - Tools and templates to create validated and maintainable data charts and dashboards.
...
* [datalayer/jupyter-mcp-server](https://github.com/datalayer/jupyter-mcp-server) ⭐ 835 | 🐛 21 | 🌐 Python | 📅 2026-01-02 🐍 🏠 - Model Context Protocol (MCP) Server for Jupyter.
...
* [stack-chan/stack-chan](https://github.com/stack-chan/stack-chan) ⭐ 1,030 | 🐛 28 | 🌐 TypeScript | 📅 2025-12-29 📇 📟 - A JavaScript-driven M5Stack-embedded super-kawaii robot with MCP server functionality for AI-controlled interactions and emotions.
...
* [microsoft/markitdown](https://github.com/microsoft/markitdown/tree/main/packages/markitdown-mcp) ⭐ 84,880 | 🐛 414 | 🌐 Python | 📅 2025-12-01 🎖️ 🐍 🏠 - MCP tool access to MarkItDown -- a library that converts many file formats (local or remote) to Markdown for LLM consumption.
* [mickaelkerjean/filestash](https://github.com/mickael-kerjean/filestash/tree/master/server/plugin/plg_handler_mcp) ⭐ 13,296 | 🐛 59 | 🌐 JavaScript | 📅 2025-12-31 🏎️ ☁️ - Remote Storage Access: SFTP, S3, FTP, SMB, NFS, WebDAV, GIT, FTPS, gcloud, azure blob, sharepoint, etc.
...
* [ferdousbhai/investor-agent](https://github.com/ferdousbhai/investor-agent) ⭐ 296 | 🐛 0 | 🌐 Python | 📅 2026-01-02 🐍 ☁️ - Yahoo Finance integration to fetch stock market data including options recommendations
...
* [Coding-Solo/godot-mcp](https://github.com/Coding-Solo/godot-mcp) ⭐ 1,300 | 🐛 33 | 🌐 JavaScript | 📅 2025-08-09 📇 🏠 - A MCP server for interacting with the Godot game engine, providing tools for editing, running, debugging, and managing scenes in Godot projects.
* [CoderGamester/mcp-unity](https://github.com/CoderGamester/mcp-unity) ⭐ 1,180 | 🐛 8 | 🌐 C# | 📅 2025-12-30 #️⃣ 🏠 - MCP Server for Unity3d Game Engine integration for game development
* [IvanMurzak/Unity-MCP](https://github.com/IvanMurzak/Unity-MCP) ⭐ 700 | 🐛 33 | 🌐 C# | 📅 2026-01-02 #️⃣ 🏠 🍎 🪟 🐧 - MCP Server for Unity Editor and for a game made with Unity
...
* [upstash/context7](https://github.com/upstash/context7) ⭐ 40,705 | 🐛 93 | 🌐 TypeScript | 📅 2026-01-02 📇 ☁️ - Up-to-date code documentation for LLMs and AI code editors.
* [topoteretes/cognee](https://github.com/topoteretes/cognee/tree/dev/cognee-mcp) ⭐ 10,734 | 🐛 35 | 🌐 Python | 📅 2026-01-02 📇 🏠 - Memory manager for AI apps and Agents using various graph and vector stores and allowing ingestion from 30+ data sources
...
* [vectorize-io/hindsight](https://github.com/vectorize-io/hindsight) ⭐ 895 | 🐛 10 | 🌐 Python | 📅 2026-01-02 🐍 ☁️ 🏠 - Hindsight: Agent Memory That Works Like Human Memory - Built for AI Agents to manage Long Term Memory
...
* [agentic-mcp-tools/memora](https://github.com/agentic-mcp-tools/memora) ⭐ 61 | 🐛 0 | 🌐 Python | 📅 2026-01-02 🐍 🏠 ☁️ - Persistent memory with knowledge graph visualization, semantic/hybrid search, cloud sync (S3/R2), and cross-session context management.
...
* [QGIS MCP](https://github.com/jjsantos01/qgis_mcp) ⭐ 748 | 🐛 8 | 🌐 Python | 📅 2025-10-01 - connects QGIS Desktop to Claude AI through the MCP. This integration enables prompt-assisted project creation, layer loading, code execution, and more.
...
* [pipeboard-co/meta-ads-mcp](https://github.com/pipeboard-co/meta-ads-mcp) ⭐ 394 | 🐛 6 | 🌐 Python | 📅 2025-12-19 🐍 ☁️ 🏠 - Meta Ads automation that just works. Trusted by 10,000+ businesses to analyze performance, test creatives, optimize spend, and scale results — simply and reliably.
...
* [netdata/netdata#Netdata](https://github.com/netdata/netdata/blob/master/src/web/mcp/README.md) ⭐ 77,210 | 🐛 243 | 🌐 C | 📅 2026-01-02 🎖️ 🏠 ☁️ 📟 🍎 🪟 🐧 - Discovery, exploration, reporting and root cause analysis using all observability data, including metrics, logs, systems, containers, processes, and network connections
* [grafana/mcp-grafana](https://github.com/grafana/mcp-grafana) ⭐ 2,062 | 🐛 64 | 🌐 Go | 📅 2026-01-02 🎖️ 🐍 🏠 ☁️ - Search dashboards, investigate incidents and query datasources in your Grafana instance
...
* [Pantheon-Security/notebooklm-mcp-secure](https://github.com/Pantheon-Security/notebooklm-mcp-secure) ⭐ 4 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-31 📇 🏠 🍎 🪟 🐧 - Query Google NotebookLM from Claude/AI agents with 14 security hardening layers. Session-based conversations, notebook library management, and source-grounded research responses.
...
* [exa-labs/exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) ⭐ 3,490 | 🐛 27 | 🌐 TypeScript | 📅 2025-12-22 🎖️ 📇 ☁️ – A Model Context Protocol (MCP) server lets AI assistants like Claude use the Exa AI Search API for web searches. This setup allows AI models to get real-time web information in a safe and controlled way.
...
* [blazickjp/arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) ⭐ 1,995 | 🐛 34 | 🌐 Python | 📅 2025-08-19 ☁️ 🐍 - Search ArXiv research papers
* [luminati-io/brightdata-mcp](https://github.com/luminati-io/brightdata-mcp) ⭐ 1,834 | 🐛 16 | 🌐 JavaScript | 📅 2025-12-30 📇 ☁️ - Discover, extract, and interact with the web - one interface powering automated access across the public internet.
...
* [brave/brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) ⭐ 456 | 🐛 15 | 🌐 TypeScript | 📅 2026-01-02 📇 ☁️ - Web search capabilities using Brave's Search API
* [genomoncology/biomcp](https://github.com/genomoncology/biomcp) ⭐ 381 | 🐛 16 | 🌐 Python | 📅 2025-12-18 🐍 ☁️ - Biomedical research server providing access to PubMed, ClinicalTrials.gov, and MyVariant.info.
...
* [kagisearch/kagimcp](https://github.com/kagisearch/kagimcp) ⭐ 249 | 🐛 5 | 🌐 Python | 📅 2025-11-17 ☁️ 📇 – Official Kagi Search MCP Server
* [jae-jae/g-search-mcp](https://github.com/jae-jae/g-search-mcp) ⭐ 239 | 🐛 5 | 🌐 TypeScript | 📅 2025-06-14 📇 🏠 - A powerful MCP server for Google search that enables parallel searching with multiple keywords simultaneously.
...
* [scrapeless-ai/scrapeless-mcp-server](https://github.com/scrapeless-ai/scrapeless-mcp-server) ⭐ 113 | 🐛 0 | 🌐 TypeScript | 📅 2025-09-23 🐍 ☁️ - The Scrapeless Model Context Protocol service acts as an MCP server connector to the Google SERP API, enabling web search within the MCP ecosystem without leaving it.
...
* [mikechao/brave-search-mcp](https://github.com/mikechao/brave-search-mcp) ⭐ 89 | 🐛 0 | 🌐 TypeScript | 📅 2025-07-29 📇 ☁️ - Web, Image, News, Video, and Local Point of Interest search capabilities using Brave's Search API
...
* [boikot-xyz/boikot](https://github.com/boikot-xyz/boikot) ⭐ 4 | 🐛 0 | 🌐 HTML | 📅 2026-01-02 🦀☁️ - Model Context Protocol Server for looking up company ethics information. Learn about the ethical and unethical actions of major companies.
...
* [LaurieWired/GhidraMCP](https://github.com/LaurieWired/GhidraMCP) ⭐ 6,969 | 🐛 58 | 🌐 Java | 📅 2025-06-23 ☕ 🏠 - A Model Context Protocol server for Ghidra that enables LLMs to autonomously reverse engineer applications. Provides tools for decompiling binaries, renaming methods and data, and listing methods, classes, imports, and exports.
* [mrexodia/ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) ⭐ 4,844 | 🐛 35 | 🌐 Python | 📅 2025-12-20 🐍 🏠 - MCP server for IDA Pro, allowing you to perform binary analysis with AI assistants. This plugin implement decompilation, disassembly and allows you to generate malware analysis reports automatically.
* [mariocandela/beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,797 | 🐛 6 | 🌐 Go | 📅 2025-12-24 ☁️ - Beelzebub is a honeypot framework that lets you build honeypot tools using MCP. Its purpose is to detect prompt injection or malicious agent behavior. The underlying idea is to provide the agent with tools it would never use in its normal work.
* [zinja-coder/jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp) ⭐ 987 | 🐛 6 | 🌐 Java | 📅 2025-12-29 ☕ 🏠 - JADX-AI-MCP is a plugin and MCP Server for the JADX decompiler that integrates directly with Model Context Protocol (MCP) to provide live reverse engineering support with LLMs like Claude.
* [safedep/vet](https://github.com/safedep/vet/blob/main/docs/mcp.md) ⭐ 926 | 🐛 91 | 🌐 Go | 📅 2025-12-16 🎖️ 🏎️ ☁️ 🍎 🪟 🐧 - vet-mcp checks open source packages—like those suggested by AI coding tools—for vulnerabilities and malicious code. It supports npm and PyPI, and runs locally via Docker or as a standalone binary for fast, automated vetting.
...
* [jtang613/GhidrAssistMCP](https://github.com/jtang613/GhidrAssistMCP) ⭐ 390 | 🐛 4 | 🌐 Java | 📅 2025-12-22 ☕ 🏠 - A native Model Context Protocol server for Ghidra. Includes GUI configuration and logging, 31 powerful tools and no external dependencies.
...
* [fosdickio/binary\_ninja\_mcp](https://github.com/fosdickio/binary_ninja_mcp) ⭐ 156 | 🐛 19 | 🌐 Python | 📅 2025-12-23 🐍 🏠 🍎 🪟 🐧 - A Binary Ninja plugin, MCP server, and bridge that seamlessly integrates [Binary Ninja](https://binary.ninja) with your favorite MCP client.  It enables you to automate the process of performing binary analysis and reverse engineering.
...
* [roadwy/cve-search\_mcp](https://github.com/roadwy/cve-search_mcp) ⭐ 76 | 🐛 2 | 🌐 Python | 📅 2025-07-26 🐍 🏠 - A Model Context Protocol (MCP) server for querying the CVE-Search API. This server provides comprehensive access to CVE-Search, browse vendor and product、get CVE per CVE-ID、get the last updated CVEs.
...
* [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 3,878 | 🐛 128 | 🌐 Python | 📅 2026-01-01 🐍 ☁️ - MCP server for Atlassian products (Confluence and Jira). Supports Confluence Cloud, Jira Cloud, and Jira Server/Data Center. Provides comprehensive tools for searching, reading, creating, and managing content across Atlassian workspaces.
...
* [mbailey/voice-mcp](https://github.com/mbailey/voice-mcp) ⭐ 532 | 🐛 23 | 🌐 Python | 📅 2025-12-30 🐍 🏠 - Complete voice interaction server supporting speech-to-text, text-to-speech, and real-time voice conversations through local microphone, OpenAI-compatible APIs, and LiveKit integration
...
* [github/github-mcp-server](https://github.com/github/github-mcp-server) ⭐ 25,591 | 🐛 253 | 🌐 Go | 📅 2026-01-02 📇 ☁️ - Official GitHub server for integration with repository management, PRs, issues, and more.
...
* [taylorwilsdon/google\_workspace\_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) ⭐ 1,047 | 🐛 37 | 🌐 Python | 📅 2025-12-28 🐍 ☁️ 🍎 🪟 🐧 - Comprehensive Google Workspace MCP server with full support for Google Calendar, Drive, Gmail, and Docs, Forms, Chats, Slides and Sheets over stdio, Streamable HTTP and SSE transports.
...
* [modelcontextprotocol/server-everything](https://github.com/modelcontextprotocol/servers/tree/main/src/everything) ⭐ 75,393 | 🐛 264 | 🌐 TypeScript | 📅 2025-12-19 📇 🏠 - MCP server that exercises all the features of the MCP protocol
* [mediar-ai/screenpipe](https://github.com/mediar-ai/screenpipe) ⭐ 16,330 | 🐛 237 | 🌐 TypeScript | 📅 2025-12-09 - 🎖️ 🦀 🏠 🍎 Local-first system capturing screen/audio with timestamped indexing, SQL/embedding storage, semantic search, LLM-powered history analysis, and event-triggered actions - enables building context-aware AI agents through a NextJS plugin ecosystem.
* [Klavis-AI/YouTube](https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/youtube) ⭐ 5,579 | 🐛 54 | 🌐 Python | 📅 2026-01-03 🐍 📇 - Extract and convert YouTube video information.
* [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 3,878 | 🐛 128 | 🌐 Python | 📅 2026-01-01 🐍 ☁️ - MCP server for Atlassian products (Confluence and Jira). Supports Confluence Cloud, Jira Cloud, and Jira Server/Data Center. Provides comprehensive tools for searching, reading, creating, and managing content across Atlassian workspaces.
* [metorial/metorial](https://github.com/metorial/metorial) ⭐ 3,197 | 🐛 1 | 🌐 TypeScript | 📅 2026-01-03 - 🎖️ 📇 ☁️ Connect AI agents to 600+ integrations with a single interface - OAuth, scaling, and monitoring included
* [MarkusPfundstein/mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian) ⭐ 2,627 | 🐛 68 | 🌐 Python | 📅 2025-06-28 🐍 ☁️ 🏠 - Interacting with Obsidian via REST API
...
* [calclavia/mcp-obsidian](https://github.com/calclavia/mcp-obsidian) ⭐ 1,254 | 🐛 17 | 🌐 JavaScript | 📅 2026-01-02 📇 🏠 - This is a connector to allow Claude Desktop (or any MCP client) to read and search any directory containing Markdown notes (such as an Obsidian vault).
...
* [caol64/wenyan-mcp](https://github.com/caol64/wenyan-mcp) ⭐ 954 | 🐛 24 | 🌐 JavaScript | 📅 2025-12-29 📇 🏠 🍎 🪟 🐧 - Wenyan MCP Server, which lets AI automatically format Markdown articles and publish them to WeChat GZH.
...
* [apify/actors-mcp-server](https://github.com/apify/actors-mcp-server) ⭐ 672 | 🐛 33 | 🌐 TypeScript | 📅 2025-12-24 📇 ☁️ - Use 3,000+ pre-built cloud tools, known as Actors, to extract data from websites, e-commerce, social media, search engines, maps, and more
...
* [PV-Bhat/vibe-check-mcp-server](https://github.com/PV-Bhat/vibe-check-mcp-server) ⭐ 441 | 🐛 13 | 🌐 TypeScript | 📅 2025-12-02 📇 ☁️ - An MCP server that prevents cascading errors and scope creep by calling a "Vibe-check" agent to ensure user alignment.
...
* [FastMCP](https://github.com/jlowin/fastmcp) ⭐ 21,632 | 🐛 227 | 🌐 Python | 📅 2026-01-02 🐍 - A high-level framework for building MCP servers in Python
* [FastMCP](https://github.com/punkpeye/fastmcp) ⭐ 2,859 | 🐛 37 | 🌐 TypeScript | 📅 2025-12-27 📇 - A high-level framework for building MCP servers in TypeScript
* [Epistates/TurboMCP](https://github.com/Epistates/turbomcp) ⭐ 58 | 🐛 0 | 🌐 Rust | 📅 2026-01-01 🦀 - TurboMCP SDK: Enterprise MCP SDK in Rust
