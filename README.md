...
Checkout [awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients/) ⭐ 6,136 | 🐛 53 | 📅 2025-12-23 and [glama.ai/mcp/clients](https://glama.ai/mcp/clients).
...
* [mindsdb/mindsdb](https://github.com/mindsdb/mindsdb) ⭐ 38,132 | 🐛 185 | 🌐 Python | 📅 2025-12-29 - Connect and unify data across various platforms and databases with [MindsDB as a single MCP server](https://docs.mindsdb.com/mcp/overview).
* [PipedreamHQ/pipedream](https://github.com/PipedreamHQ/pipedream/tree/master/modelcontextprotocol) ⭐ 10,926 | 🐛 4,356 | 🌐 JavaScript | 📅 2025-12-29 ☁️ 🏠 - Connect with 2,500 APIs with 8,000+ prebuilt tools, and manage servers for your users, in your own app.
* [metatool-ai/metatool-app](https://github.com/metatool-ai/metatool-app) ⭐ 1,833 | 🐛 58 | 🌐 TypeScript | 📅 2025-12-23 📇 ☁️ 🏠 🍎 🪟 🐧 - MetaMCP is the one unified middleware MCP server that manages your MCP connections with GUI.
* [julien040/anyquery](https://github.com/julien040/anyquery) ⭐ 1,574 | 🐛 8 | 🌐 Go | 📅 2025-11-11 🏎️ 🏠 ☁️ - Query more than 40 apps with one binary using SQL. It can also connect to your PostgreSQL, MySQL, or SQLite compatible database. Local-first and private by design.
...
* [TheLunarCompany/lunar#mcpx](https://github.com/TheLunarCompany/lunar/tree/main/mcpx) ⭐ 377 | 🐛 5 | 🌐 TypeScript | 📅 2025-12-29 📇 🏠  ☁️ 🍎 🪟 🐧 - MCPX is a production-ready, open-source gateway to manage MCP servers at scale—centralize tool discovery, access controls, call prioritization, and usage tracking to simplify agent workflows.
* [1mcp/agent](https://github.com/1mcp-app/agent) ⭐ 330 | 🐛 6 | 🌐 TypeScript | 📅 2025-12-29 📇 ☁️ 🏠 🍎 🪟 🐧 - A unified Model Context Protocol server implementation that aggregates multiple MCP servers into one.
...
* [K-Dense-AI/claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp) ⭐ 206 | 🐛 3 | 🌐 Python | 📅 2025-11-11 🐍 ☁️ 🏠 🍎 🪟 🐧 - Intelligent search capabilities to let every model and client use [Claude Agent Skills](https://www.anthropic.com/news/skills) like native.
...
* [juspay/neurolink](https://github.com/juspay/neurolink) ⭐ 101 | 🐛 396 | 🌐 TypeScript | 📅 2025-12-30 📇 ☁️ 🏠 🍎 🪟 🐧 - Making enterprise AI infrastructure universally accessible. Edge-first platform unifying 12 providers and 100+ models with multi-agent orchestration, HITL workflows, guardrails middleware, and context summarization.
...
* [portel-dev/ncp](https://github.com/portel-dev/ncp) ⭐ 55 | 🐛 0 | 🌐 JavaScript | 📅 2025-12-29 📇 ☁️ 🏠 🍎 🪟 🐧 - NCP orchestrates your entire MCP ecosystem through intelligent discovery, eliminating token overhead while maintaining 98.2% accuracy.
...
* [ahujasid/blender-mcp](https://github.com/ahujasid/blender-mcp) ⭐ 14,674 | 🐛 35 | 🌐 Python | 📅 2025-12-08 🐍 - MCP server for working with Blender
...
* [samuelgursky/davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp) ⭐ 449 | 🐛 10 | 🌐 Python | 📅 2025-10-20 🐍 - MCP server integration for DaVinci Resolve providing powerful tools for video editing, color grading, media management, and project control
...
* [cswkim/discogs-mcp-server](https://github.com/cswkim/discogs-mcp-server) ⭐ 77 | 🐛 2 | 🌐 TypeScript | 📅 2025-12-29 📇 ☁️ - MCP server to interact with the Discogs API
...
* [8enSmith/mcp-open-library](https://github.com/8enSmith/mcp-open-library) ⭐ 49 | 🐛 1 | 🌐 TypeScript | 📅 2025-11-20 📇 ☁️ - A MCP server for the Open Library API that enables AI assistants to search for book information.
...
* [raveenb/fal-mcp-server](https://github.com/raveenb/fal-mcp-server) ⭐ 19 | 🐛 21 | 🌐 Python | 📅 2025-12-23 🐍 ☁️ - Generate AI images, videos, and music using Fal.ai models (FLUX, Stable Diffusion, MusicGen) directly in Claude Desktop
...
* [genomoncology/biomcp](https://github.com/genomoncology/biomcp) ⭐ 379 | 🐛 14 | 🌐 Python | 📅 2025-12-18 🐍 ☁️ - Biomedical research MCP server providing access to PubMed, ClinicalTrials.gov, and MyVariant.info.
...
* [wso2/fhir-mcp-server](https://github.com/wso2/fhir-mcp-server) ⭐ 69 | 🐛 1 | 🌐 Python | 📅 2025-12-11 🐍 🏠 ☁️ - Model Context Protocol server for Fast Healthcare Interoperability Resources (FHIR) APIs. Provides seamless integration with FHIR servers, enabling AI assistants to search, retrieve, create, update, and analyze clinical healthcare data with SMART-on-FHIR authentication support.
...
* [the-momentum/fhir-mcp-server](https://github.com/the-momentum/fhir-mcp-server) ⭐ 47 | 🐛 6 | 🌐 Python | 📅 2025-10-23 🐍 🏠 ☁️ - MCP Server that connects AI agents to FHIR servers. One example use case is querying patient history in natural language.
...
* [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) ⭐ 24,908 | 🐛 32 | 🌐 TypeScript | 📅 2025-12-29 - Official Microsoft Playwright MCP server, enabling LLMs to interact with web pages through structured accessibility snapshots
* [agent-infra/mcp-server-browser](https://github.com/bytedance/UI-TARS-desktop/tree/main/packages/agent-infra/mcp-servers/browser) ⭐ 20,264 | 🐛 312 | 🌐 TypeScript | 📅 2025-12-25 📇 🏠 - Browser automation capabilities using Puppeteer, both support local and remote browser connection.
* [browsermcp/mcp](https://github.com/browsermcp/mcp) ⭐ 5,301 | 🐛 103 | 🌐 TypeScript | 📅 2025-04-24 📇 🏠 - Automate your local Chrome browser
* [executeautomation/playwright-mcp-server](https://github.com/executeautomation/mcp-playwright) ⭐ 5,098 | 🐛 17 | 🌐 TypeScript | 📅 2025-12-13 📇 - An MCP server using Playwright for browser automation and webscrapping
* [browserbase/mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase) ⭐ 2,991 | 🐛 25 | 🌐 TypeScript | 📅 2025-12-10 🎖️ 📇 - Automate browser interactions in the cloud (e.g. web navigation, data extraction, form filling, and more)
...
* [kimtaeyoon83/mcp-server-youtube-transcript](https://github.com/kimtaeyoon83/mcp-server-youtube-transcript) ⭐ 365 | 🐛 6 | 🌐 TypeScript | 📅 2025-12-24 📇 ☁️ - Fetch YouTube subtitles and transcripts for AI analysis
...
* [eyalzh/browser-control-mcp](https://github.com/eyalzh/browser-control-mcp) ⭐ 224 | 🐛 13 | 🌐 TypeScript | 📅 2025-12-26 📇 🏠 - An MCP server paired with a browser extension that enables LLM clients to control the user's browser (Firefox).
...
* [awslabs/mcp](https://github.com/awslabs/mcp) ⭐ 7,742 | 🐛 201 | 🌐 Python | 📅 2025-12-30 🎖️ ☁️ - AWS MCP servers for seamless integration with AWS services and resources.
* [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) ⭐ 3,229 | 🐛 46 | 🌐 TypeScript | 📅 2025-12-22 🎖️ 📇 ☁️ - Integration with Cloudflare services including Workers, KV, R2, and D1
* [flux159/mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) ⭐ 1,236 | 🐛 11 | 🌐 TypeScript | 📅 2025-12-28 📇 ☁️/🏠 - Typescript implementation of Kubernetes cluster operations for pods, deployments, services.
* [manusa/Kubernetes MCP Server](https://github.com/manusa/kubernetes-mcp-server) ⭐ 919 | 🐛 51 | 🌐 Go | 📅 2025-12-23 🏎️ 🏠 A - powerful Kubernetes MCP server with additional support for OpenShift. Besides providing CRUD operations for **any** Kubernetes resource, this server provides specialized tools to interact with your cluster.
* [rohitg00/kubectl-mcp-server](https://github.com/rohitg00/kubectl-mcp-server) ⭐ 749 | 🐛 16 | 🌐 Python | 📅 2025-07-14 🐍 ☁️/🏠 - A Model Context Protocol (MCP) server for Kubernetes that enables AI assistants like Claude, Cursor, and others to interact with Kubernetes clusters through natural language.
* [weibaohui/k8m](https://github.com/weibaohui/k8m) ⭐ 745 | 🐛 18 | 🌐 Go | 📅 2025-12-29 🏎️ ☁️/🏠 - Provides MCP multi-cluster Kubernetes management and operations, featuring a management interface, logging, and nearly 50 built-in tools covering common DevOps and development scenarios. Supports both standard and CRD resources.
...
* [pibblokto/cert-manager-mcp-server](https://github.com/pibblokto/cert-manager-mcp-server) ⭐ 19 | 🐛 0 | 🌐 Python | 📅 2025-08-25 🐍 🍎/🐧 ☁️ - mcp server for [cert-manager](https://github.com/cert-manager/cert-manager) ⭐ 13,424 | 🐛 215 | 🌐 Go | 📅 2025-12-29 management and troubleshooting
...
* [pydantic/pydantic-ai/mcp-run-python](https://github.com/pydantic/pydantic-ai/tree/main/mcp-run-python) ⭐ 14,041 | 🐛 412 | 🌐 Python | 📅 2025-12-29 🐍 🏠 - Run Python code in a secure sandbox via MCP tool calls
* [dagger/container-use](https://github.com/dagger/container-use) ⭐ 3,373 | 🐛 64 | 🌐 Go | 📅 2025-12-08 🏎️ 🏠 🐧 🍎 🪟 - Containerized environments for coding agents. Multiple agents can work independently, isolated in fresh containers and git branches. No conflicts, many experiments. Full execution history, terminal access to agent environments, git workflow. Any agent/model/infra stack.
...
* [oraios/serena](https://github.com/oraios/serena) ⭐ 17,863 | 🐛 81 | 🌐 Python | 📅 2025-12-28 🐍 🏠 - A fully-featured coding agent that relies on symbolic code operations by using language servers.
...
* [rinadelph/Agent-MCP](https://github.com/rinadelph/Agent-MCP) ⭐ 1,099 | 🐛 15 | 🌐 TypeScript | 📅 2025-10-09 🐍 🏠 - A framework for creating multi-agent systems using MCP for coordinated AI collaboration, featuring task management, shared context, and RAG capabilities.
...
* [shashankss1205/codegraphcontext](https://github.com/Shashankss1205/CodeGraphContext) ⭐ 283 | 🐛 61 | 🌐 Python | 📅 2025-12-29 🐍 🏠 🍎 🪟 🐧 An MCP server that indexes local code into a graph database to provide context to AI assistants with a graphical code visualizations for humans.
* [tiianhk/MaxMSP-MCP-Server](https://github.com/tiianhk/MaxMSP-MCP-Server) ⭐ 129 | 🐛 8 | 🌐 Max | 📅 2025-11-10 🐍 🏠 🎵 🎥 - A coding agent for Max (Max/MSP/Jitter), which is a visual programming language for music and multimedia.
...
* [wende/cicada](https://github.com/wende/cicada) ⭐ 19 | 🐛 2 | 🌐 Python | 📅 2025-12-29 🐍 🏠 🍎 🪟 🐧 - Code Intelligence for Elixir: module search, function tracking, and PR attribution through tree-sitter AST parsing
...
* [wonderwhy-er/DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) ⭐ 5,141 | 🐛 73 | 🌐 TypeScript | 📅 2025-12-29 📇 🏠 🍎 🪟 🐧 - A swiss-army-knife that can manage/execute programs and read/write/search/edit code and text files.
* [louis030195/terminator-mcp-agent](https://github.com/mediar-ai/terminator/tree/main/terminator-mcp-agent) ⭐ 1,225 | 🐛 10 | 🌐 Rust | 📅 2025-12-23 🦀 📇 🏠 🍎 🪟 🐧 - Desktop GUI automation using accessibility APIs. Control Windows, macOS, and Linux applications without vision models or screenshots. Supports workflow recording, structured data extraction, and browser DOM inspection.
* [aymericzip/intlayer](https://github.com/aymericzip/intlayer) ⭐ 505 | 🐛 23 | 🌐 TypeScript | 📅 2025-12-30 📇 ☁️ 🏠 - A MCP Server that enhance your IDE with AI-powered assistance for Intlayer i18n / CMS tool: smart CLI access, access to the docs.
...
* [g0t4/mcp-server-commands](https://github.com/g0t4/mcp-server-commands) ⭐ 218 | 🐛 7 | 🌐 TypeScript | 📅 2025-09-29 📇 🏠 - Run any command with `run_command` and `run_script` tools.
* [tufantunc/ssh-mcp](https://github.com/tufantunc/ssh-mcp) ⭐ 187 | 🐛 3 | 🌐 TypeScript | 📅 2025-12-15 📇 🏠 🐧 🪟 - MCP server exposing SSH control for Linux and Windows servers via Model Context Protocol. Securely execute remote shell commands with password or SSH key authentication.
...
* [blakerouse/ssh-mcp](https://github.com/blakerouse/ssh-mcp) ⭐ 7 | 🐛 5 | 🌐 Go | 📅 2025-12-22 🏎️ 🏠 🍎 🪟 🐧 - MCP server exposing SSH control for Linux and Windows servers. Allows long running commands and the ability to perform commands on multiple hosts at the same time.
* [aybelatchane/mcp-server-terminal](https://github.com/aybelatchane/mcp-server-terminal) ⭐ 4 | 🐛 9 | 🌐 Rust | 📅 2025-12-09 🦀 🏠 🍎 🪟 🐧 - Playwright for terminals - interact with TUI/CLI applications through structured Terminal State Tree representation with element detection.

### 💬 <a name="communication"></a>Communication

Integration with communication platforms for message management and channel operations. Enables AI models to interact with team communication tools.

* [elie222/inbox-zero](https://github.com/elie222/inbox-zero/tree/main/apps/mcp-server) ⭐ 9,650 | 🐛 84 | 🌐 TypeScript | 📅 2025-12-30 🐍 ☁️ - An MCP server for Inbox Zero. Adds functionality on top of Gmail like finding out which emails you need to reply to or need to follow up on.
* [lharries/whatsapp-mcp](https://github.com/lharries/whatsapp-mcp) ⭐ 5,175 | 🐛 92 | 🌐 Go | 📅 2025-07-13 🐍 🏎️ - An MCP server for searching your personal WhatsApp messages, contacts and sending messages to individuals or groups
* [korotovsky/slack-mcp-server](https://github.com/korotovsky/slack-mcp-server) ⭐ 1,041 | 🐛 29 | 🌐 Go | 📅 2025-12-25 📇 ☁️ - The most powerful MCP server for Slack Workspaces.
* [chigwell/telegram-mcp](https://github.com/chigwell/telegram-mcp) ⭐ 517 | 🐛 6 | 🌐 Python | 📅 2025-12-29 🐍 🏠 - Telegram API integration for accessing user data, managing dialogs (chats, channels, groups), retrieving messages, sending messages and handling read status.
...
* [softeria/ms-365-mcp-server](https://github.com/softeria/ms-365-mcp-server) ⭐ 371 | 🐛 6 | 🌐 TypeScript | 📅 2025-12-23 📇 ☁️ - MCP server that connects to Microsoft Office and the whole Microsoft 365 suite using Graph API (including Outlook, mail, files, Excel, calendar)
...
* [arpitbatra123/mcp-googletasks](https://github.com/arpitbatra123/mcp-googletasks) ⭐ 29 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-29 📇 ☁️ - An MCP server to interface with the Google Tasks API
...
* [antv/mcp-server-chart](https://github.com/antvis/mcp-server-chart) ⭐ 3,386 | 🐛 11 | 🌐 TypeScript | 📅 2025-12-29 🎖️ 📇 ☁️ - A Model Context Protocol server for generating visual charts using [AntV](https://github.com/antvis).
* [hustcc/mcp-mermaid](https://github.com/hustcc/mcp-mermaid) ⭐ 350 | 🐛 4 | 🌐 TypeScript | 📅 2025-12-16 📇 🏠 - Generate [mermaid](https://mermaid.js.org/) diagram and chart with AI MCP dynamically.
* [hustcc/mcp-echarts](https://github.com/hustcc/mcp-echarts) ⭐ 178 | 🐛 6 | 🌐 TypeScript | 📅 2025-10-20 📇 🏠 - Generate visual charts using [Apache ECharts](https://echarts.apache.org) with AI MCP dynamically.
...
* [googleapis/genai-toolbox](https://github.com/googleapis/genai-toolbox) ⭐ 11,981 | 🐛 167 | 🌐 Go | 📅 2025-12-30 🏎️ ☁️ - Open source MCP server specializing in easy, fast, and secure tools for Databases.

* [get-convex/convex-backend](https://stack.convex.dev/convex-mcp-server) 📇 ☁️ - Convex database integration to introspect tables, functions, and run oneoff queries ([Source](https://github.com/get-convex/convex-backend/blob/main/npm-packages/convex/src/cli/mcp.ts) ⭐ 8,744 | 🐛 115 | 🌐 Rust | 📅 2025-12-29)

* [bram2w/baserow](https://github.com/bram2w/baserow) ⭐ 3,625 | 🐛 1,045 | 🌐 Python | 📅 2025-12-29 - Baserow database integration with table search, list, and row create, read, update, and delete capabilities.

* [supabase-community/supabase-mcp](https://github.com/supabase-community/supabase-mcp) ⭐ 2,351 | 🐛 70 | 🌐 TypeScript | 📅 2025-12-29 🎖️ 📇 ☁️ - Official Supabase MCP server to connect AI assistants directly with your Supabase project and allows them to perform tasks like managing tables, fetching config, and querying data.

* [crystaldba/postgres-mcp](https://github.com/crystaldba/postgres-mcp) ⭐ 1,721 | 🐛 37 | 🌐 Python | 📅 2025-11-11 🐍 🏠 - All-in-one MCP server for Postgres development and operations, with tools for performance analysis, tuning, and health checks

* [qdrant/mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant) ⭐ 1,150 | 🐛 34 | 🌐 Python | 📅 2025-12-10 🐍 🏠 - A Qdrant MCP server

* [designcomputer/mysql\_mcp\_server](https://github.com/designcomputer/mysql_mcp_server) ⭐ 1,046 | 🐛 52 | 🌐 Python | 📅 2025-06-05 🐍 🏠 - MySQL database integration with configurable access controls, schema inspection, and comprehensive security guidelines

* [benborla29/mcp-server-mysql](https://github.com/benborla/mcp-server-mysql) ⭐ 1,021 | 🐛 32 | 🌐 JavaScript | 📅 2025-11-18 ☁️ 🏠 - MySQL database integration in NodeJS with configurable access controls and schema inspection
...
* [ClickHouse/mcp-clickhouse](https://github.com/ClickHouse/mcp-clickhouse) ⭐ 630 | 🐛 24 | 🌐 Python | 📅 2025-12-16 🐍 ☁️ - ClickHouse database integration with schema inspection and query capabilities

* [xing5/mcp-google-sheets](https://github.com/xing5/mcp-google-sheets) ⭐ 572 | 🐛 16 | 🌐 Python | 📅 2025-12-06 🐍 ☁️ - A Model Context Protocol server for interacting with Google Sheets. This server provides tools to create, read, update, and manage spreadsheets through the Google Sheets API.

* [neondatabase/mcp-server-neon](https://github.com/neondatabase/mcp-server-neon) ⭐ 531 | 🐛 19 | 🌐 TypeScript | 📅 2025-12-29 📇 ☁️ — An MCP Server for creating and managing Postgres databases using Neon Serverless Postgres

* [Canner/wren-engine](https://github.com/Canner/wren-engine) ⭐ 521 | 🐛 51 | 🌐 Java | 📅 2025-12-30 🐍 🦀 🏠 - The Semantic Engine for Model Context Protocol(MCP) Clients and AI Agents
...
* [runekaagaard/mcp-alchemy](https://github.com/runekaagaard/mcp-alchemy) ⭐ 380 | 🐛 0 | 🌐 Python | 📅 2025-08-15 🐍 🏠 - Universal SQLAlchemy-based database integration supporting PostgreSQL, MySQL, MariaDB, SQLite, Oracle, MS SQL Server and many more databases. Features schema and relationship inspection, and large dataset analysis capabilities.

* [domdomegg/airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server) ⭐ 377 | 🐛 8 | 🌐 TypeScript | 📅 2025-12-17 📇 🏠 - Airtable database integration with schema inspection, read and write capabilities
...
* [tuannvm/mcp-trino](https://github.com/tuannvm/mcp-trino) ⭐ 87 | 🐛 15 | 🌐 Go | 📅 2025-12-22 🏎️ ☁️ - A Go implementation of a Model Context Protocol (MCP) server for Trino
...
* [memgraph/mcp-memgraph](https://github.com/memgraph/ai-toolkit/tree/main/integrations/mcp-memgraph) ⭐ 68 | 🐛 25 | 🌐 Python | 📅 2025-12-19 🐍 🏠 - Memgraph MCP Server - includes a tool to run a query against Memgraph and a schema resource.
...
* [s2-streamstore/s2-sdk-typescript](https://github.com/s2-streamstore/s2-sdk-typescript) ⭐ 21 | 🐛 8 | 🌐 TypeScript | 📅 2025-12-29 🎖️ 📇 ☁️ - Official MCP server for the S2.dev serverless stream platform.
...
* [ferrants/memvid-mcp-server](https://github.com/ferrants/memvid-mcp-server) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2025-06-20 🐍 🏠 - Python Streamable HTTP Server you can run locally to interact with [memvid](https://github.com/Olow304/memvid) ⭐ 10,533 | 🐛 12 | 🌐 Python | 📅 2025-12-28 storage and semantic search.
...
* [keboola/keboola-mcp-server](https://github.com/keboola/keboola-mcp-server) ⭐ 80 | 🐛 4 | 🌐 Python | 📅 2025-12-29 🐍 - interact with Keboola Connection Data Platform. This server provides tools for listing and accessing data from Keboola Storage API.
...
* [aywengo/kafka-schema-reg-mcp](https://github.com/aywengo/kafka-schema-reg-mcp) ⭐ 27 | 🐛 2 | 🌐 Python | 📅 2025-12-29 🐍 ☁️ 🏠 🍎 🪟 🐧 - Comprehensive Kafka Schema Registry MCP server with 48 tools for multi-registry management, schema migration, and enterprise features.
...
* [eyaltoledano/claude-task-master](https://github.com/eyaltoledano/claude-task-master) ⭐ 24,488 | 🐛 149 | 🌐 JavaScript | 📅 2025-12-29 📇 ☁️ 🏠 - AI-powered task management system for AI-driven development. Features PRD parsing, task expansion, multi-provider support (Claude, OpenAI, Gemini, Perplexity, xAI), and selective tool loading for optimized context usage.
* [GLips/Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) ⭐ 12,345 | 🐛 38 | 🌐 TypeScript | 📅 2025-10-14 📇 🏠 - Provide coding agents direct access to Figma data to help them one-shot design implementation.
* [idosal/git-mcp](https://github.com/idosal/git-mcp) ⭐ 7,293 | 🐛 48 | 🌐 TypeScript | 📅 2025-08-22 📇 ☁️ - [gitmcp.io](https://gitmcp.io/) is a generic remote MCP server to connect to ANY [GitHub](https://www.github.com) repository or project for documentation
* [21st-dev/Magic-MCP](https://github.com/21st-dev/magic-mcp) ⭐ 4,054 | 🐛 21 | 🌐 TypeScript | 📅 2025-12-23 - Create crafted UI components inspired by the best 21st.dev design engineers.
* [haris-musa/excel-mcp-server](https://github.com/haris-musa/excel-mcp-server) ⭐ 3,034 | 🐛 37 | 🌐 Python | 📅 2025-12-22 🐍 🏠 - An Excel manipulation server providing workbook creation, data operations, formatting, and advanced features (charts, pivot tables, formulae).
* [mobile-next/mobile-mcp](https://github.com/mobile-next/mobile-mcp) ⭐ 2,804 | 🐛 33 | 🌐 TypeScript | 📅 2025-12-09 📇 🏠 🐧 🍎 - MCP Server for Android/iOS application and device automation, development and app scraping. Simulator/Emulator/Physical devices like iPhone, Google Pixel, Samsung supported.
* [Jpisnice/shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server) ⭐ 2,563 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-29 📇 🏠 - MCP server that gives AI assistants seamless access to shadcn/ui v4 components, blocks, demos, and metadata.
* [cjo4m06/mcp-shrimp-task-manager](https://github.com/cjo4m06/mcp-shrimp-task-manager) ⭐ 1,940 | 🐛 37 | 🌐 JavaScript | 📅 2025-08-21 📇 ☁️ 🏠 – A programming-focused task management system that boosts coding agents like Cursor AI with advanced task memory, self-reflection, and dependency management. [ShrimpTaskManager](https://cjo4m06.github.io/mcp-shrimp-task-manager)
* [ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp) ⭐ 1,363 | 🐛 14 | 🌐 JavaScript | 📅 2025-12-16 📇 🏠 🍎 - A Model Context Protocol (MCP) server for interacting with iOS simulators. This server allows you to interact with iOS simulators by getting information about them, controlling UI interactions, and inspecting UI elements.
* [isaacphi/mcp-language-server](https://github.com/isaacphi/mcp-language-server) ⭐ 1,347 | 🐛 44 | 🌐 Go | 📅 2025-12-02 🏎️ 🏠 - MCP Language Server helps MCP enabled clients navigate codebases more easily by giving them access to semantic tools like get definition, references, rename, and diagnostics.
* [jetbrains/mcpProxy](https://github.com/JetBrains/mcpProxy) ⭐ 939 | 🐛 37 | 🌐 JavaScript | 📅 2025-12-02 🎖️ 📇 🏠 - Connect to JetBrains IDE
* [lpigeon/ros-mcp-server](https://github.com/lpigeon/ros-mcp-server) ⭐ 901 | 🐛 18 | 🌐 Python | 📅 2025-12-29 🐍 🏠 🍎 🪟 🐧 - The ROS MCP Server supports robot control by converting user-issued natural language commands into ROS or ROS2 control commands.
* [snaggle-ai/openapi-mcp-server](https://github.com/snaggle-ai/openapi-mcp-server) ⭐ 867 | 🐛 1 | 🌐 TypeScript | 📅 2025-10-26 🏎️ 🏠 - Connect any HTTP/REST API server using an Open API spec (v3)
* [ckreiling/mcp-server-docker](https://github.com/ckreiling/mcp-server-docker) ⭐ 664 | 🐛 13 | 🌐 Python | 📅 2025-06-05 🐍 🏠 - Integrate with Docker to manage containers, images, volumes, and networks.
* [zcaceres/fetch-mcp](https://github.com/zcaceres/fetch-mcp) ⭐ 662 | 🐛 10 | 🌐 TypeScript | 📅 2025-09-02 📇 🏠 - An MCP server to flexibly fetch JSON, text, and HTML data
* [bgauryy/octocode-mcp](https://github.com/bgauryy/octocode-mcp) ⭐ 659 | 🐛 3 | 🌐 TypeScript | 📅 2025-12-29 ☁️ 📇 🍎 🪟 🐧 - AI-powered developer assistant that enables advanced research, analysis and discovery across GitHub and NPM realms in realtime.
...
* [etsd-tech/mcp-pointer](https://github.com/etsd-tech/mcp-pointer) ⭐ 554 | 🐛 2 | 🌐 TypeScript | 📅 2025-11-12 📇 🏠 🍎 🪟 🐧 - Visual DOM element selector for agentic coding tools. Chrome extension + MCP server bridge for Claude Code, Cursor, Windsurf etc. Option+Click to capture elements.
...
* [vivekvells/mcp-pandoc](https://github.com/vivekVells/mcp-pandoc) ⭐ 473 | 🐛 4 | 🌐 Python | 📅 2025-09-16 🗄️ 🚀 - MCP server for seamless document format conversion using Pandoc, supporting Markdown, HTML, PDF, DOCX (.docx), csv and more.
...
* [hyperb1iss/droidmind](https://github.com/hyperb1iss/droidmind) ⭐ 319 | 🐛 5 | 🌐 Python | 📅 2025-12-22 🐍 🏠 - Control Android devices with AI through MCP, enabling device control, debugging, system analysis, and UI automation with a comprehensive security framework.
...
* [public-ui/kolibri](https://github.com/public-ui/kolibri) ⭐ 242 | 🐛 163 | 🌐 TypeScript | 📅 2025-12-30 📇 ☁️ 🏠 - Streaming KoliBri MCP server (NPM: `@public-ui/mcp`) delivering 200+ guaranteed accessible web component samples, specs, docs, and scenarios via hosted HTTP endpoint or local `kolibri-mcp` CLI.
...
* [Govcraft/rust-docs-mcp-server](https://github.com/Govcraft/rust-docs-mcp-server) ⭐ 234 | 🐛 14 | 🌐 Rust | 📅 2025-11-24 🦀 🏠 - Provides up-to-date documentation context for a specific Rust crate to LLMs via an MCP tool, using semantic search (embeddings) and LLM summarization.
...
* [mhmzdev/Figma-Flutter-MCP](https://github.com/mhmzdev/Figma-Flutter-MCP) ⭐ 180 | 🐛 5 | 🌐 TypeScript | 📅 2025-09-21 📇 🏠 - Provide coding agents direct access to Figma data to help them write Flutter code for building apps including assets exports, widgets maintenance and full screens implementations.
...
* [storybookjs/addon-mcp](https://github.com/storybookjs/addon-mcp) ⭐ 153 | 🐛 9 | 🌐 TypeScript | 📅 2025-12-29 📇 🏠 - Help agents automatically write and test stories for your UI components.
...
* [yangkyeongmo@/mcp-server-apache-airflow](https://github.com/yangkyeongmo/mcp-server-apache-airflow) ⭐ 121 | 🐛 7 | 🌐 Python | 📅 2025-10-29 🐍 🏠 - MCP server that connects to [Apache Airflow](https://airflow.apache.org/) using official client.
...
* [docker/hub-mcp](https://github.com/docker/hub-mcp) ⭐ 105 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-11 🎖️ 📇 ☁️ 🏠 - Official MCP server to interact with Docker Hub, providing access to repositories, hub search and Docker Hardened Images
...
* [lpigeon/unitree-go2-mcp-server](https://github.com/lpigeon/unitree-go2-mcp-server) ⭐ 62 | 🐛 1 | 🌐 Python | 📅 2025-05-12 🐍 🏠 🐧 - The Unitree Go2 MCP Server is a server built on the MCP that enables users to control the Unitree Go2 robot using natural language commands interpreted by a LLM.
* [kadykov/mcp-openapi-schema-explorer](https://github.com/kadykov/mcp-openapi-schema-explorer) ⭐ 61 | 🐛 2 | 🌐 TypeScript | 📅 2025-12-29 📇 ☁️ 🏠 - Token-efficient access to OpenAPI/Swagger specs via MCP Resources.
* [WiseVision/mcp\_server\_ros\_2](https://github.com/wise-vision/mcp_server_ros_2) ⭐ 60 | 🐛 5 | 🌐 Python | 📅 2025-12-10 🐍 🤖 - MCP server for ROS2 enabling AI-driven robotics applications and services.
...
* [hloiseaufcms/mcp-gopls](https://github.com/hloiseaufcms/mcp-gopls) ⭐ 53 | 🐛 1 | 🌐 Go | 📅 2025-12-22 🏎️ 🏠 - A MCP server for interacting with [Go's Language Server Protocol (gopls)](https://github.com/golang/tools/tree/master/gopls) ⭐ 7,851 | 🐛 105 | 🌐 Go | 📅 2025-12-30 and benefit from advanced Go code analysis features.
...
* [veelenga/claude-mermaid](https://github.com/veelenga/claude-mermaid/) ⭐ 30 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-22 📇 🏠 🍎 🪟 🐧 - A Mermaid diagram rendering MCP server for Claude Code with live reload functionality, supporting multiple export formats (SVG, PNG, PDF) and themes.
* [api7/apisix-mcp](https://github.com/api7/apisix-mcp) ⭐ 29 | 🐛 2 | 🌐 TypeScript | 📅 2025-06-16 🎖️ 📇 🏠 MCP Server that support for querying and managing all resource in [Apache APISIX](https://github.com/apache/apisix) ⭐ 16,029 | 🐛 323 | 🌐 Lua | 📅 2025-12-30.
...
* [linw1995/nvim-mcp](https://github.com/linw1995/nvim-mcp) ⭐ 28 | 🐛 4 | 🌐 Rust | 📅 2025-12-18 🦀 🏠 🍎 🪟 🐧  -  A MCP server to interact with Neovim
...
* [j4c0bs/mcp-server-sql-analyzer](https://github.com/j4c0bs/mcp-server-sql-analyzer) ⭐ 26 | 🐛 0 | 🌐 Python | 📅 2025-07-01 🐍 - MCP server that provides SQL analysis, linting, and dialect conversion using [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 8,749 | 🐛 9 | 🌐 Python | 📅 2025-12-29
...
* [higress-group/higress-ops-mcp-server](https://github.com/higress-group/higress-ops-mcp-server) ⭐ 22 | 🐛 6 | 🌐 Python | 📅 2025-03-29 🐍 🏠 - MCP server that provides comprehensive tools for managing [Higress](https://github.com/alibaba/higress) ⭐ 7,180 | 🐛 707 | 🌐 Go | 📅 2025-12-29 gateway configurations and operations.
...
* [V0v1kkk/DotNetMetadataMcpServer](https://github.com/V0v1kkk/DotNetMetadataMcpServer) ⭐ 18 | 🐛 0 | 🌐 C# | 📅 2025-10-19 #️⃣ 🏠 🍎 🪟 🐧 - Provides AI agents with detailed type information from .NET projects including assembly exploration, namespace discovery, type reflection, and NuGet integration
...
* [hechtcarmel/jetbrains-debugger-mcp-plugin](https://github.com/hechtcarmel/jetbrains-debugger-mcp-plugin) ⭐ 12 | 🐛 9 | 🌐 Kotlin | 📅 2025-12-28 ☕ 🏠 - A JetBrains IDE plugin that exposes an MCP server, giving AI coding assistants full programmatic control over the debugger.
...
* [Wolfe-Jam/claude-faf-mcp](https://github.com/Wolfe-Jam/claude-faf-mcp) ⭐ 9 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-30 📇 🏠 - First & only persistent project context MCP. Provides .faf (Foundational AI-context Format) Project DNA with 33+ tools, Podium scoring (0-100%), and format-driven architecture. Official Anthropic Registry. 10k+ npm downloads.
...
* [narumiruna/gitingest-mcp](https://github.com/narumiruna/gitingest-mcp) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2025-11-21 🐍 🏠 - A MCP server that uses [gitingest](https://github.com/cyclotruc/gitingest) ⭐ 13,494 | 🐛 29 | 🌐 Python | 📅 2025-12-19 to convert any Git repository into a simple text digest of its codebase.
...
* [mckinsey/vizro-mcp](https://github.com/mckinsey/vizro/tree/main/vizro-mcp) ⭐ 3,509 | 🐛 49 | 🌐 Python | 📅 2025-12-29 🎖️ 🐍 🏠 - Tools and templates to create validated and maintainable data charts and dashboards.
* [zcaceres/markdownify-mcp](https://github.com/zcaceres/markdownify-mcp) ⭐ 2,327 | 🐛 17 | 🌐 TypeScript | 📅 2025-09-02 📇 🏠 - An MCP server to convert almost any file or web content into Markdown
* [datalayer/jupyter-mcp-server](https://github.com/datalayer/jupyter-mcp-server) ⭐ 832 | 🐛 20 | 🌐 Python | 📅 2025-12-25 🐍 🏠 - Model Context Protocol (MCP) Server for Jupyter.
* [DataEval/dingo](https://github.com/DataEval/dingo) ⭐ 607 | 🐛 6 | 🌐 JavaScript | 📅 2025-12-25 🎖️ 🐍 🏠 🍎 🪟 🐧 - MCP server for the Dingo: a comprehensive data quality evaluation tool. Server Enables interaction with Dingo's rule-based and LLM-based evaluation capabilities and rules\&prompts listing.
...
* [growthbook/growthbook-mcp](https://github.com/growthbook/growthbook-mcp) ⭐ 18 | 🐛 7 | 🌐 TypeScript | 📅 2025-12-24 🎖️ 📇 🏠 🪟 🐧 🍎 — Tools for creating and interacting with GrowthBook feature flags and experiments.
* [Bright-L01/networkx-mcp-server](https://github.com/Bright-L01/networkx-mcp-server) ⭐ 12 | 🐛 2 | 🌐 Python | 📅 2025-12-29 🐍 🏠 - The first NetworkX integration for Model Context Protocol, enabling graph analysis and visualization directly in AI conversations. Supports 13 operations including centrality algorithms, community detection, PageRank, and graph visualization.
...
* [stack-chan/stack-chan](https://github.com/stack-chan/stack-chan) ⭐ 1,020 | 🐛 28 | 🌐 TypeScript | 📅 2025-12-29 📇 📟 - A JavaScript-driven M5Stack-embedded super-kawaii robot with MCP server functionality for AI-controlled interactions and emotions.
...
* [microsoft/markitdown](https://github.com/microsoft/markitdown/tree/main/packages/markitdown-mcp) ⭐ 84,762 | 🐛 410 | 🌐 Python | 📅 2025-12-01 🎖️ 🐍 🏠 - MCP tool access to MarkItDown -- a library that converts many file formats (local or remote) to Markdown for LLM consumption.
* [mickaelkerjean/filestash](https://github.com/mickael-kerjean/filestash/tree/master/server/plugin/plg_handler_mcp) ⭐ 13,281 | 🐛 59 | 🌐 JavaScript | 📅 2025-12-29 🏎️ ☁️ - Remote Storage Access: SFTP, S3, FTP, SMB, NFS, WebDAV, GIT, FTPS, gcloud, azure blob, sharepoint, etc.
* [mark3labs/mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server) ⭐ 571 | 🐛 17 | 🌐 Go | 📅 2025-11-24 🏎️ 🏠 - Golang implementation for local file system access.
...
* [ariadng/metatrader-mcp-server](https://github.com/ariadng/metatrader-mcp-server) ⭐ 138 | 🐛 5 | 🌐 Python | 📅 2025-10-09 🐍 🏠 🪟 - Enable AI LLMs to execute trades using MetaTrader 5 platform
...
* [twelvedata/mcp](https://github.com/twelvedata/mcp) ⭐ 49 | 🐛 4 | 🌐 Python | 📅 2025-10-25 🐍 ☁️ - Interact with [Twelve Data](https://twelvedata.com) APIs to access real-time and historical financial market data for your AI agents.
...
* [Coding-Solo/godot-mcp](https://github.com/Coding-Solo/godot-mcp) ⭐ 1,277 | 🐛 32 | 🌐 JavaScript | 📅 2025-08-09 📇 🏠 - A MCP server for interacting with the Godot game engine, providing tools for editing, running, debugging, and managing scenes in Godot projects.
* [CoderGamester/mcp-unity](https://github.com/CoderGamester/mcp-unity) ⭐ 1,172 | 🐛 10 | 🌐 C# | 📅 2025-12-09 #️⃣ 🏠 - MCP Server for Unity3d Game Engine integration for game development
* [IvanMurzak/Unity-MCP](https://github.com/IvanMurzak/Unity-MCP) ⭐ 673 | 🐛 29 | 🌐 C# | 📅 2025-12-29 #️⃣ 🏠 🍎 🪟 🐧 - MCP Server for Unity Editor and for a game made with Unity
...
* [upstash/context7](https://github.com/upstash/context7) ⭐ 40,424 | 🐛 96 | 🌐 TypeScript | 📅 2025-12-29 📇 ☁️ - Up-to-date code documentation for LLMs and AI code editors.
* [topoteretes/cognee](https://github.com/topoteretes/cognee/tree/dev/cognee-mcp) ⭐ 10,683 | 🐛 36 | 🌐 Python | 📅 2025-12-29 📇 🏠 - Memory manager for AI apps and Agents using various graph and vector stores and allowing ingestion from 30+ data sources
...
* [apecloud/ApeRAG](https://github.com/apecloud/ApeRAG) ⭐ 996 | 🐛 51 | 🌐 Python | 📅 2025-12-06 🐍 ☁️ 🏠 - Production-ready RAG platform combining Graph RAG, vector search, and full-text search. Best choice for building your own Knowledge Graph and for Context Engineering
* [vectorize-io/hindsight](https://github.com/vectorize-io/hindsight) ⭐ 865 | 🐛 9 | 🌐 Python | 📅 2025-12-28 🐍 ☁️ 🏠 - Hindsight: Agent Memory That Works Like Human Memory - Built for AI Agents to manage Long Term Memory
* [mem0ai/mem0-mcp](https://github.com/mem0ai/mem0-mcp) ⭐ 546 | 🐛 10 | 🌐 Python | 📅 2025-12-07 🐍 🏠 - A Model Context Protocol server for Mem0 that helps manage coding preferences and patterns, providing tools for storing, retrieving and semantically handling code implementations, best practices and technical documentation in IDEs like Cursor and Windsurf
...
* [pi22by7/In-Memoria](https://github.com/pi22by7/In-Memoria) ⭐ 133 | 🐛 4 | 🌐 Rust | 📅 2025-12-23 📇 🦀 🏠 🍎 🐧 🪟 - Persistent intelligence infrastructure for agentic development that gives AI coding assistants cumulative memory and pattern learning. Hybrid TypeScript/Rust implementation with local-first storage using SQLite + SurrealDB for semantic analysis and incremental codebase understanding.
* [entanglr/zettelkasten-mcp](https://github.com/entanglr/zettelkasten-mcp) ⭐ 130 | 🐛 12 | 🌐 Python | 📅 2025-04-25 🐍 🏠 - A Model Context Protocol (MCP) server that implements the Zettelkasten knowledge management methodology, allowing you to create, link, and search atomic notes through Claude and other MCP-compatible clients.
...
* [shinpr/mcp-local-rag](https://github.com/shinpr/mcp-local-rag) ⭐ 46 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-29 📇 🏠 - Privacy-first document search server running entirely locally. Supports semantic search over PDFs, DOCX, TXT, and Markdown files with LanceDB vector storage and local embeddings - no API keys or cloud services required.
...
* [bh-rat/context-awesome](https://github.com/bh-rat/context-awesome) ⭐ 27 | 🐛 1 | 🌐 JavaScript | 📅 2025-08-23 📇 ☁️ 🏠 - MCP server for querying 8,500+ curated awesome lists (1M+ items) and fetching the best resources for your agent.
...
* [Smart-AI-Memory/empathy-framework](https://github.com/Smart-AI-Memory/empathy-framework) ⭐ 8 | 🐛 9 | 🌐 HTML | 📅 2025-12-29 🐍 🏠 - Five-level AI collaboration system with persistent memory and anticipatory capabilities. MCP-native integration for Claude and other LLMs with local-first architecture via MemDocs.
...
* [QGIS MCP](https://github.com/jjsantos01/qgis_mcp) ⭐ 743 | 🐛 8 | 🌐 Python | 📅 2025-10-01 - connects QGIS Desktop to Claude AI through the MCP. This integration enables prompt-assisted project creation, layer loading, code execution, and more.
...
* [netdata/netdata#Netdata](https://github.com/netdata/netdata/blob/master/src/web/mcp/README.md) ⭐ 77,177 | 🐛 241 | 🌐 C | 📅 2025-12-29 🎖️ 🏠 ☁️ 📟 🍎 🪟 🐧 - Discovery, exploration, reporting and root cause analysis using all observability data, including metrics, logs, systems, containers, processes, and network connections
* [grafana/mcp-grafana](https://github.com/grafana/mcp-grafana) ⭐ 2,043 | 🐛 63 | 🌐 Go | 📅 2025-12-30 🎖️ 🐍 🏠 ☁️ - Search dashboards, investigate incidents and query datasources in your Grafana instance
* [getsentry/sentry-mcp](https://github.com/getsentry/sentry-mcp) ⭐ 489 | 🐛 47 | 🌐 TypeScript | 📅 2025-12-29 🐍 ☁️ - Sentry.io integration for error tracking and performance monitoring
...
* [exa-labs/exa-mcp-server](https://github.com/exa-labs/exa-mcp-server) ⭐ 3,466 | 🐛 26 | 🌐 TypeScript | 📅 2025-12-22 🎖️ 📇 ☁️ – A Model Context Protocol (MCP) server lets AI assistants like Claude use the Exa AI Search API for web searches. This setup allows AI models to get real-time web information in a safe and controlled way.
* [devflowinc/trieve](https://github.com/devflowinc/trieve/tree/main/clients/mcp-server) ⭐ 2,590 | 🐛 2 | 🌐 Rust | 📅 2025-10-10 🎖️ 📇 ☁️ 🏠 - Crawl, embed, chunk, search, and retrieve information from datasets through [Trieve](https://trieve.ai)
* [blazickjp/arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server) ⭐ 1,983 | 🐛 33 | 🌐 Python | 📅 2025-08-19 ☁️ 🐍 - Search ArXiv research papers
* [luminati-io/brightdata-mcp](https://github.com/luminati-io/brightdata-mcp) ⭐ 1,815 | 🐛 15 | 🌐 JavaScript | 📅 2025-12-21 📇 ☁️ - Discover, extract, and interact with the web - one interface powering automated access across the public internet.
* [jae-jae/fetcher-mcp](https://github.com/jae-jae/fetcher-mcp) ⭐ 945 | 🐛 8 | 🌐 TypeScript | 📅 2025-11-24 📇 🏠 - MCP server for fetching web page content using Playwright headless browser, supporting Javascript rendering and intelligent content extraction, and outputting Markdown or HTML format.
* [nickclyde/duckduckgo-mcp-server](https://github.com/nickclyde/duckduckgo-mcp-server) ⭐ 702 | 🐛 20 | 🌐 Python | 📅 2025-03-11 🐍 ☁️ - Web search using DuckDuckGo
* [Aas-ee/open-webSearch](https://github.com/Aas-ee/open-webSearch) ⭐ 549 | 🐛 9 | 🌐 TypeScript | 📅 2025-10-26 🐍 📇 ☁️ - Web search using free multi-engine search (NO API KEYS REQUIRED) — Supports Bing, Baidu, DuckDuckGo, Brave, Exa, and CSDN.
* [brave/brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server) ⭐ 444 | 🐛 17 | 🌐 TypeScript | 📅 2025-12-28 📇 ☁️ - Web search capabilities using Brave's Search API
* [genomoncology/biomcp](https://github.com/genomoncology/biomcp) ⭐ 379 | 🐛 14 | 🌐 Python | 📅 2025-12-18 🐍 ☁️ - Biomedical research server providing access to PubMed, ClinicalTrials.gov, and MyVariant.info.
* [Ihor-Sokoliuk/MCP-SearXNG](https://github.com/ihor-sokoliuk/mcp-searxng) ⭐ 370 | 🐛 9 | 🌐 TypeScript | 📅 2025-11-09 📇 🏠/☁️ - A Model Context Protocol Server for [SearXNG](https://docs.searxng.org)
...
* [kagisearch/kagimcp](https://github.com/kagisearch/kagimcp) ⭐ 246 | 🐛 5 | 🌐 Python | 📅 2025-11-17 ☁️ 📇 – Official Kagi Search MCP Server
...
* [serpapi/serpapi-mcp](https://github.com/serpapi/serpapi-mcp) ⭐ 80 | 🐛 0 | 🌐 Python | 📅 2025-12-15 🐍 ☁️ 🏠 🍎 🪟 🐧 - SerpApi MCP Server for Google and other search engine results. Provides multi-engine search across Google, Bing, Yahoo, DuckDuckGo, YouTube, eBay, and more with real-time weather data, stock market information, and flexible JSON response modes.
...
* [leehanchung/bing-search-mcp](https://github.com/leehanchung/bing-search-mcp) ⭐ 68 | 🐛 3 | 🌐 Python | 📅 2025-04-04 📇 ☁️ - Web search capabilities using Microsoft Bing Search API
...
* [isnow890/naver-search-mcp](https://github.com/isnow890/naver-search-mcp) ⭐ 49 | 🐛 0 | 🌐 JavaScript | 📅 2025-10-19 📇 ☁️ - MCP server for Naver Search API integration, supporting blog, news, shopping search and DataLab analytics features.
...
* [jhomen368/overseerr-mcp](https://github.com/jhomen368/overseerr-mcp) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2025-12-29 📇 ☁️ 🏠 - Integrate AI assistants with Overseerr for automated media discovery, requests, and management in Plex ecosystems.
...
* [LaurieWired/GhidraMCP](https://github.com/LaurieWired/GhidraMCP) ⭐ 6,838 | 🐛 55 | 🌐 Java | 📅 2025-06-23 ☕ 🏠 - A Model Context Protocol server for Ghidra that enables LLMs to autonomously reverse engineer applications. Provides tools for decompiling binaries, renaming methods and data, and listing methods, classes, imports, and exports.
* [mrexodia/ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp) ⭐ 4,791 | 🐛 35 | 🌐 Python | 📅 2025-12-20 🐍 🏠 - MCP server for IDA Pro, allowing you to perform binary analysis with AI assistants. This plugin implement decompilation, disassembly and allows you to generate malware analysis reports automatically.
* [mariocandela/beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 1,780 | 🐛 6 | 🌐 Go | 📅 2025-12-24 ☁️ - Beelzebub is a honeypot framework that lets you build honeypot tools using MCP. Its purpose is to detect prompt injection or malicious agent behavior. The underlying idea is to provide the agent with tools it would never use in its normal work.
* [zinja-coder/jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp) ⭐ 962 | 🐛 7 | 🌐 Java | 📅 2025-12-29 ☕ 🏠 - JADX-AI-MCP is a plugin and MCP Server for the JADX decompiler that integrates directly with Model Context Protocol (MCP) to provide live reverse engineering support with LLMs like Claude.
* [safedep/vet](https://github.com/safedep/vet/blob/main/docs/mcp.md) ⭐ 925 | 🐛 91 | 🌐 Go | 📅 2025-12-16 🎖️ 🏎️ ☁️ 🍎 🪟 🐧 - vet-mcp checks open source packages—like those suggested by AI coding tools—for vulnerabilities and malicious code. It supports npm and PyPI, and runs locally via Docker or as a standalone binary for fast, automated vetting.
...
* [jtang613/GhidrAssistMCP](https://github.com/jtang613/GhidrAssistMCP) ⭐ 386 | 🐛 1 | 🌐 Java | 📅 2025-12-22 ☕ 🏠 - A native Model Context Protocol server for Ghidra. Includes GUI configuration and logging, 31 powerful tools and no external dependencies.
* [zinja-coder/apktool-mcp-server](https://github.com/zinja-coder/apktool-mcp-server) ⭐ 270 | 🐛 0 | 🌐 Python | 📅 2025-09-12 🐍 🏠 - APKTool MCP Server is a MCP server for the Apk Tool to provide automation in reverse engineering of Android APKs.
...
* [fosdickio/binary\_ninja\_mcp](https://github.com/fosdickio/binary_ninja_mcp) ⭐ 150 | 🐛 19 | 🌐 Python | 📅 2025-12-23 🐍 🏠 🍎 🪟 🐧 - A Binary Ninja plugin, MCP server, and bridge that seamlessly integrates [Binary Ninja](https://binary.ninja) with your favorite MCP client.  It enables you to automate the process of performing binary analysis and reverse engineering.
* [radareorg/r2mcp](https://github.com/radareorg/radare2-mcp) ⭐ 118 | 🐛 2 | 🌐 C | 📅 2025-12-09 🍎🪟🐧🏠🌊 - MCP server for Radare2 disassembler. Provides AI with capability to disassemble and look into binaries for reverse engineering.
* [BurtTheCoder/mcp-virustotal](https://github.com/BurtTheCoder/mcp-virustotal) ⭐ 96 | 🐛 5 | 🌐 TypeScript | 📅 2025-03-03 📇 🪟 ☁️ - MCP server for querying the VirusTotal API. This server provides tools for scanning URLs, analyzing file hashes, and retrieving IP address reports.
...
* [mobb-dev/mobb-vibe-shield-mcp](https://github.com/mobb-dev/bugsy?tab=readme-ov-file#model-context-protocol-mcp-server) ⭐ 64 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-28 🎖️ 📇 ☁️ 🍎 🪟 🐧 - [Mobb Vibe Shield](https://vibe.mobb.ai/) identifies and remediates vulnerabilities in both human and AI-written code, ensuring your applications remain secure without slowing development.
...
* [github/github-mcp-server](https://github.com/github/github-mcp-server) ⭐ 25,509 | 🐛 250 | 🌐 Go | 📅 2025-12-29 📇 ☁️ - Official GitHub server for integration with repository management, PRs, issues, and more.
* [Tiberriver256/mcp-server-azure-devops](https://github.com/Tiberriver256/mcp-server-azure-devops) ⭐ 314 | 🐛 33 | 🌐 TypeScript | 📅 2025-12-02 📇 ☁️ - Azure DevOps integration for repository management, work items, and pipelines.
...
* [taylorwilsdon/google\_workspace\_mcp](https://github.com/taylorwilsdon/google_workspace_mcp) ⭐ 1,036 | 🐛 35 | 🌐 Python | 📅 2025-12-28 🐍 ☁️ 🍎 🪟 🐧 - Comprehensive Google Workspace MCP server with full support for Google Calendar, Drive, Gmail, and Docs, Forms, Chats, Slides and Sheets over stdio, Streamable HTTP and SSE transports.
...
* [teamwork/mcp](https://github.com/teamwork/mcp) ⭐ 11 | 🐛 2 | 🌐 Go | 📅 2025-12-29 🎖️ 🏎️ ☁️ 🍎 🪟 🐧 - Project and resource management platform that keeps your client projects on track, makes managing resources a breeze, and keeps your profits on point.
...
* [modelcontextprotocol/server-everything](https://github.com/modelcontextprotocol/servers/tree/main/src/everything) ⭐ 75,214 | 🐛 256 | 🌐 TypeScript | 📅 2025-12-19 📇 🏠 - MCP server that exercises all the features of the MCP protocol
* [mediar-ai/screenpipe](https://github.com/mediar-ai/screenpipe) ⭐ 16,306 | 🐛 237 | 🌐 TypeScript | 📅 2025-12-09 - 🎖️ 🦀 🏠 🍎 Local-first system capturing screen/audio with timestamped indexing, SQL/embedding storage, semantic search, LLM-powered history analysis, and event-triggered actions - enables building context-aware AI agents through a NextJS plugin ecosystem.
* [Klavis-AI/YouTube](https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/youtube) ⭐ 5,561 | 🐛 52 | 🌐 Python | 📅 2025-12-25 🐍 📇 - Extract and convert YouTube video information.
* [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 3,865 | 🐛 158 | 🌐 Python | 📅 2025-12-29 🐍 ☁️ - MCP server for Atlassian products (Confluence and Jira). Supports Confluence Cloud, Jira Cloud, and Jira Server/Data Center. Provides comprehensive tools for searching, reading, creating, and managing content across Atlassian workspaces.
* [metorial/metorial](https://github.com/metorial/metorial) ⭐ 3,196 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-30 - 🎖️ 📇 ☁️ Connect AI agents to 600+ integrations with a single interface - OAuth, scaling, and monitoring included
* [MarkusPfundstein/mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian) ⭐ 2,605 | 🐛 68 | 🌐 Python | 📅 2025-06-28 🐍 ☁️ 🏠 - Interacting with Obsidian via REST API
...
* [anaisbetts/mcp-installer](https://github.com/anaisbetts/mcp-installer) ⭐ 1,485 | 🐛 21 | 🌐 JavaScript | 📅 2024-11-26 🐍 🏠 -  An MCP server that installs other MCP servers for you.
* [calclavia/mcp-obsidian](https://github.com/calclavia/mcp-obsidian) ⭐ 1,247 | 🐛 18 | 🌐 JavaScript | 📅 2025-08-15 📇 🏠 - This is a connector to allow Claude Desktop (or any MCP client) to read and search any directory containing Markdown notes (such as an Obsidian vault).
...
* [caol64/wenyan-mcp](https://github.com/caol64/wenyan-mcp) ⭐ 952 | 🐛 24 | 🌐 JavaScript | 📅 2025-12-29 📇 🏠 🍎 🪟 🐧 - Wenyan MCP Server, which lets AI automatically format Markdown articles and publish them to WeChat GZH.
...
* [apify/actors-mcp-server](https://github.com/apify/actors-mcp-server) ⭐ 661 | 🐛 32 | 🌐 TypeScript | 📅 2025-12-24 📇 ☁️ - Use 3,000+ pre-built cloud tools, known as Actors, to extract data from websites, e-commerce, social media, search engines, maps, and more
* [rusiaaman/wcgw](https://github.com/rusiaaman/wcgw/blob/main/src/wcgw/client/mcp_server/Readme.md) ⭐ 627 | 🐛 7 | 🌐 Python | 📅 2025-12-25 🐍 🏠 - Autonomous shell execution, computer control and coding agent. (Mac)
* [tevonsb/homeassistant-mcp](https://github.com/tevonsb/homeassistant-mcp) ⭐ 505 | 🐛 17 | 🌐 TypeScript | 📅 2025-02-01 📇 🏠 - Access Home Assistant data and control devices (lights, switches, thermostats, etc).
...
* [wong2/mcp-cli](https://github.com/wong2/mcp-cli) ⭐ 399 | 🐛 10 | 🌐 JavaScript | 📅 2025-08-13 📇 🏠 - CLI tool for testing MCP servers
...
* [anki-mcp/anki-mcp-desktop](https://github.com/anki-mcp/anki-mcp-desktop) ⭐ 62 | 🐛 0 | 🌐 TypeScript | 📅 2025-12-14 📇 🏠 🍎 🪟 🐧 - Enterprise-grade Anki integration with natural language interaction, comprehensive note/deck management, and one-click MCPB installation. Built on NestJS with comprehensive test coverage.
...
> \[!NOTE]
> More frameworks, utilities, and other developer tools are available at <https://github.com/punkpeye/awesome-mcp-devtools> ⭐ 384 | 🐛 11 | 📅 2025-12-10

* [FastMCP](https://github.com/jlowin/fastmcp) ⭐ 21,541 | 🐛 224 | 🌐 Python | 📅 2025-12-29 🐍 - A high-level framework for building MCP servers in Python
* [FastMCP](https://github.com/punkpeye/fastmcp) ⭐ 2,851 | 🐛 37 | 🌐 TypeScript | 📅 2025-12-27 📇 - A high-level framework for building MCP servers in TypeScript
